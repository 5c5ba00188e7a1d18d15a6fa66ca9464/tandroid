    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i2 < childCount2) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int widthUsed5 = child.getMeasuredHeight();
                int heightUsed5 = Math.max(heightUsed2, heightPadding + widthUsed5 + lp.topMargin + lp.bottomMargin);
                int heightUsed6 = child.getMeasuredState();
                int combineMeasuredStates = View.combineMeasuredStates(childState2, heightUsed6);
        ...
        int widthUsed6 = childState3;
        int widthUsed7 = heightUsed4;
        int width = View.resolveSizeAndState(widthUsed6, widthMeasureSpec, (-16777216) & widthUsed7);
        int height = View.resolveSizeAndState(heightUsed3, heightMeasureSpec, widthUsed7 << 16);
