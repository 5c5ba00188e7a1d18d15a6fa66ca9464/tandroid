...
public class HmsConsent {
    ...
    public final Task<Void> a(boolean z) {
        ...
        int i;
        String reportEntry = PushBiUtil.reportEntry(this.b, "push.consent");
        try {
            if (s.d(this.b)) {
                ...
                return this.a.doWrite(new ConsentTask("push.consent", JsonUtil.createJsonString(enableConsentReq), reportEntry));
            }
            ...
            PushBiUtil.reportExit(this.b, "push.consent", reportEntry, i);
