...
public class DTSTrackImpl extends AbstractTrack {
    ...
    */
    private boolean readVariables() throws IOException {
        ...
        int testHeader22 = bb.getInt();
        if (testHeader1 == 1146377032 && testHeader22 == 1145586770) {
            int testHeader23 = testHeader1;
            int testHeader24 = testHeader22;
            while (true) {
                if ((testHeader23 != 1398035021 || testHeader24 != 1145132097) && bb.remaining() > 100) {
                    ByteBuffer bb2 = bb;
                    int testHeader12 = testHeader23;
                    int testHeader25 = testHeader24;
                    int size = (int) bb2.getLong();
                    if (testHeader12 == 1146377032) {
                        testHeader2 = testHeader25;
                        if (testHeader2 == 1145586770) {
                            parseDtshdhdr(size, bb2);
                            int testHeader13 = bb2.getInt();
                            testHeader24 = bb2.getInt();
                            testHeader23 = testHeader13;
                            bb = bb2;
                        }
                    } else {
                        testHeader2 = testHeader25;
                    }
                    if (testHeader12 != 1129271877 || testHeader2 != 1397968196) {
                        if (testHeader12 != 1096110162 || testHeader2 != 759710802) {
                            if (testHeader12 == 1163416659 && testHeader2 == 1398754628) {
                                if (!parseExtssmd(size, bb2)) {
                                    return false;
                                }
                            } else {
                        ...
                        } else if (!parseAuprhdr(size, bb2)) {
                            return false;
                        }
                    } else if (!parseCoressmd(size, bb2)) {
                        return false;
                    }
                    int testHeader132 = bb2.getInt();
                    testHeader24 = bb2.getInt();
                    testHeader23 = testHeader132;
                    bb = bb2;
                }
            }
        } else {
