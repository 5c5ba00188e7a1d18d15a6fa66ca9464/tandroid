...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public static class DecoderException extends Exception {
        ...
        */
        public DecoderException(Throwable cause, MediaCodecInfo codecInfo) {
            super(r0.toString(), cause);
            StringBuilder sb = new StringBuilder();
            sb.append("Decoder failed: ");
            String str = null;
            sb.append(codecInfo == null ? null : codecInfo.name);
            this.codecInfo = codecInfo;
            this.diagnosticInfo = Util.SDK_INT >= 21 ? getDiagnosticInfoV21(cause) : str;
        }
