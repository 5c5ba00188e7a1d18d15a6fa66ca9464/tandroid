...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    */
    protected DashManifest parseMediaPresentationDescription(XmlPullParser xpp, String baseUrl) throws XmlPullParserException, IOException {
        ...
        long durationMs2 = parseDuration(xmlPullParser, "mediaPresentationDuration", C.TIME_UNSET);
        long minBufferTimeMs = parseDuration(xmlPullParser, "minBufferTime", C.TIME_UNSET);
        String typeString = xmlPullParser.getAttributeValue(null, CommonProperties.TYPE);
        boolean dynamic = "dynamic".equals(typeString);
        long minUpdateTimeMs2 = dynamic ? parseDuration(xmlPullParser, "minimumUpdatePeriod", C.TIME_UNSET) : -9223372036854775807L;
        long timeShiftBufferDepthMs = dynamic ? parseDuration(xmlPullParser, "timeShiftBufferDepth", C.TIME_UNSET) : -9223372036854775807L;
        long suggestedPresentationDelayMs = dynamic ? parseDuration(xmlPullParser, "suggestedPresentationDelay", C.TIME_UNSET) : -9223372036854775807L;
        long publishTimeMs = parseDateTime(xmlPullParser, "publishTime", C.TIME_UNSET);
        List<Period> periods2 = new ArrayList<>();
        long nextPeriodStartMs2 = dynamic ? -9223372036854775807L : 0L;
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "BaseURL")) {
                if (location2) {
                    baseUrl2 = baseUrl3;
                    nextPeriodStartMs = nextPeriodStartMs3;
                    utcTiming = utcTiming2;
                    minUpdateTimeMs = minUpdateTimeMs2;
                    periods = periods2;
                    programInformation = programInformation3;
                    seenEarlyAccessPeriod = seenEarlyAccessPeriod2;
                    seenFirstBaseUrl = location2;
                    location = location3;
                    if (XmlPullParserUtil.isEndTag(xmlPullParser, "MPD")) {
                    }
                } else {
                    baseUrl2 = dashManifestParser.parseBaseUrl(xmlPullParser, baseUrl3);
                    nextPeriodStartMs = nextPeriodStartMs3;
                    ...
                    if (XmlPullParserUtil.isEndTag(xmlPullParser, "MPD")) {
                        if (durationMs2 == C.TIME_UNSET) {
                            if (nextPeriodStartMs != C.TIME_UNSET) {
                                ...
                                return buildMediaPresentationDescription(availabilityStartTime, durationMs, minBufferTimeMs, dynamic, minUpdateTimeMs, timeShiftBufferDepthMs, suggestedPresentationDelayMs, publishTimeMs, programInformation, utcTiming, location, periods);
                            } else if (!dynamic) {
                ...
                if (XmlPullParserUtil.isStartTag(xmlPullParser, "ProgramInformation")) {
                ...
                } else if (!XmlPullParserUtil.isStartTag(xmlPullParser, "Period") || seenEarlyAccessPeriod2) {
                    baseUrl2 = baseUrl3;
                    nextPeriodStartMs = nextPeriodStartMs3;
                    utcTiming = utcTiming2;
                    minUpdateTimeMs = minUpdateTimeMs2;
                    ...
                    Pair<Period, Long> periodWithDurationMs = dashManifestParser.parsePeriod(xmlPullParser, baseUrl3, nextPeriodStartMs3);
                    baseUrl2 = baseUrl3;
                    Period period = (Period) periodWithDurationMs.first;
                    long nextPeriodStartMs4 = nextPeriodStartMs3;
                    long nextPeriodStartMs5 = period.startMs;
                    if (nextPeriodStartMs5 == C.TIME_UNSET) {
                        if (dynamic) {
                            seenEarlyAccessPeriod2 = true;
                            utcTiming = utcTiming2;
                            minUpdateTimeMs = minUpdateTimeMs2;
                            periods = periods2;
                            periodDurationMs = nextPeriodStartMs4;
                        } else {
                            throw new ParserException("Unable to determine start of period " + periods2.size());
                        }
                    } else {
                        utcTiming = utcTiming2;
                        long periodDurationMs2 = ((Long) periodWithDurationMs.second).longValue();
                        long nextPeriodStartMs6 = periodDurationMs2 == C.TIME_UNSET ? C.TIME_UNSET : period.startMs + periodDurationMs2;
                        minUpdateTimeMs = minUpdateTimeMs2;
                        periods = periods2;
                        periods.add(period);
                        periodDurationMs = nextPeriodStartMs6;
                    }
                    programInformation = programInformation3;
                    nextPeriodStartMs = periodDurationMs;
                    seenEarlyAccessPeriod = seenEarlyAccessPeriod2;
                    seenFirstBaseUrl = location2;
                    location = location3;
                }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    protected AdaptationSet parseAdaptationSet(XmlPullParser xpp, String baseUrl, SegmentBase segmentBase, long periodDurationMs) throws XmlPullParserException, IOException {
        String str;
        String str2;
        ...
        ArrayList<Descriptor> roleDescriptors2;
        DashManifestParser dashManifestParser;
        int contentType2;
        DashManifestParser dashManifestParser2 = this;
        XmlPullParser xmlPullParser2 = xpp;
        int id = parseInt(xmlPullParser2, "id", -1);
        int contentType3 = parseContentType(xpp);
        String str3 = null;
        String mimeType = xmlPullParser2.getAttributeValue(null, "mimeType");
        String codecs = xmlPullParser2.getAttributeValue(null, "codecs");
        int width = parseInt(xmlPullParser2, "width", -1);
        int height = parseInt(xmlPullParser2, "height", -1);
        float frameRate = parseFrameRate(xmlPullParser2, -1.0f);
        int audioSamplingRate = parseInt(xmlPullParser2, "audioSamplingRate", -1);
        String str4 = "lang";
        String language2 = xmlPullParser2.getAttributeValue(null, str4);
        String label = xmlPullParser2.getAttributeValue(null, Constants.ScionAnalytics.PARAM_LABEL);
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser2, "BaseURL")) {
                if (seenFirstBaseUrl) {
                    ...
                    roleDescriptors = roleDescriptors3;
                    ...
                    roleDescriptors2 = representationInfos;
                    inbandEventStreams = inbandEventStreams2;
                    contentType = contentType2;
                    if (XmlPullParserUtil.isEndTag(xmlPullParser, "AdaptationSet")) {
                    }
                } else {
                    String baseUrl3 = dashManifestParser2.parseBaseUrl(xmlPullParser2, drmSchemeType2);
                    baseUrl2 = baseUrl3;
                    seenFirstBaseUrl = true;
                    language = language3;
                    supplementalProperties = supplementalProperties2;
                    ...
                    representationInfos = roleDescriptors2;
                    ...
                    roleDescriptors3 = roleDescriptors;
                ...
                if (XmlPullParserUtil.isStartTag(xmlPullParser2, "ContentProtection")) {
                    ...
                    language = checkLanguageConsistency(language3, xmlPullParser2.getAttributeValue(str3, str4));
                    baseUrl2 = drmSchemeType2;
                    supplementalProperties = supplementalProperties2;
                    essentialProperties = essentialProperties2;
                    roleDescriptors = roleDescriptors3;
                    ...
                    xmlPullParser = xmlPullParser2;
                    dashManifestParser = dashManifestParser2;
                    contentType = checkContentTypeConsistency(contentType4, parseContentType(xpp));
                    roleDescriptors2 = representationInfos;
                    inbandEventStreams = inbandEventStreams2;
                } else {
                    if (XmlPullParserUtil.isStartTag(xmlPullParser2, "Role")) {
                        ...
                        accessibilityDescriptors2.add(parseDescriptor(xmlPullParser2, "Accessibility"));
                        language = language3;
                        baseUrl2 = drmSchemeType2;
                        supplementalProperties = supplementalProperties2;
                        essentialProperties = essentialProperties2;
                        ...
                        essentialProperties2.add(parseDescriptor(xmlPullParser2, "EssentialProperty"));
                        language = language3;
                        baseUrl2 = drmSchemeType2;
                        supplementalProperties = supplementalProperties2;
                        essentialProperties = essentialProperties2;
                        ...
                        supplementalProperties2.add(parseDescriptor(xmlPullParser2, "SupplementalProperty"));
                        language = language3;
                        baseUrl2 = drmSchemeType2;
                        supplementalProperties = supplementalProperties2;
                        essentialProperties = essentialProperties2;
                        ...
                        language = language3;
                        String language4 = drmSchemeType2;
                        baseUrl2 = drmSchemeType2;
                        supplementalProperties = supplementalProperties2;
                        essentialProperties = essentialProperties2;
                        roleDescriptors = roleDescriptors3;
                        ...
                        str2 = str4;
                        str = str3;
                        RepresentationInfo representationInfo = parseRepresentation(xpp, language4, mimeType, codecs, width, height, frameRate, audioChannels, audioSamplingRate, language, roleDescriptors, accessibilityDescriptors, essentialProperties, supplementalProperties, segmentBase2, periodDurationMs);
                        dashManifestParser = this;
                        int contentType5 = checkContentTypeConsistency(contentType4, dashManifestParser.getContentType(representationInfo.format));
                        roleDescriptors2 = representationInfos;
                        roleDescriptors2.add(representationInfo);
                        xmlPullParser = xpp;
                        ...
                        roleDescriptors = roleDescriptors3;
                        accessibilityDescriptors = accessibilityDescriptors2;
                        ArrayList<Descriptor> inbandEventStreams3 = inbandEventStreams2;
                        drmSchemeDatas = drmSchemeDatas2;
                        str2 = str4;
                        str = str3;
                        dashManifestParser = dashManifestParser2;
                        ...
                        if (XmlPullParserUtil.isStartTag(xmlPullParser, "SegmentBase")) {
                            ...
                            contentType = contentType2;
                            inbandEventStreams = inbandEventStreams3;
                            ...
                            segmentBase2 = parseSegmentTemplate(xpp, (SegmentBase.SegmentTemplate) segmentBase2, supplementalProperties, periodDurationMs);
                            contentType = contentType2;
                            inbandEventStreams = inbandEventStreams3;
        ...
        List<Representation> representations = new ArrayList<>(roleDescriptors2.size());
        for (int i = 0; i < roleDescriptors2.size(); i++) {
            representations.add(buildRepresentation((RepresentationInfo) roleDescriptors2.get(i), label2, drmSchemeType, drmSchemeDatas, inbandEventStreams));
        }
