                ...
                if (streams[i2] == null) {
                    ...
                    if (this.trackGroupToSampleQueueIndex != null) {
                        ...
                        if (!seekRequired2) {
                            ...
                            seekRequired2 = !sampleQueue.seekTo(positionUs, true) && sampleQueue.getReadIndex() != 0;
                        }
                    }
                }
            }
        ...
        if (this.enabledTrackGroupCount == 0) {
            ...
            if (!this.mediaChunks.isEmpty() && !Util.areEqual(primaryTrackSelection, oldPrimaryTrackSelection)) {
                ...
                if (!this.seenFirstTrackSelection) {
                    ...
                    long bufferedDurationUs = j;
                    HlsMediaChunk lastMediaChunk = getLastMediaChunk();
                    MediaChunkIterator[] mediaChunkIterators = this.chunkSource.createMediaChunkIterators(lastMediaChunk, positionUs);
                    primaryTrackSelection.updateSelectedTrack(positionUs, bufferedDurationUs, C.TIME_UNSET, this.readOnlyMediaChunks, mediaChunkIterators);
