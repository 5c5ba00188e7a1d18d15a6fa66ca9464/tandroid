...
public final class Format implements Parcelable {
    ...
    */
    public Format copyWithManifestFormatInfo(Format manifestFormat) {
        ...
        String str = manifestFormat.label;
        if (str == null) {
            str = this.label;
        }
        String label = str;
        ...
        if ((trackType == 3 || trackType == 1) && manifestFormat.language != null) {
            String language3 = manifestFormat.language;
            language = language3;
        } else {
            language = language2;
        }
        int i = this.bitrate;
        if (i == -1) {
            i = manifestFormat.bitrate;
        }
        int bitrate = i;
        String codecs2 = this.codecs;
        if (codecs2 == null) {
            ...
            if (Util.splitCodecs(codecsOfType).length == 1) {
                ...
                if (metadata != null) {
                    metadata2 = manifestFormat.metadata;
                } else {
                    metadata2 = metadata.copyWithAppendedEntriesFrom(manifestFormat.metadata);
                }
                frameRate = this.frameRate;
                if (frameRate != -1.0f && trackType == 2) {
                    frameRate2 = manifestFormat.frameRate;
                } else {
                ...
                String id2 = codecs;
                return new Format(id, label, selectionFlags, roleFlags, bitrate, id2, metadata2, this.containerMimeType, this.sampleMimeType, this.maxInputSize, this.initializationData, drmInitData, this.subsampleOffsetUs, this.width, this.height, frameRate2, this.rotationDegrees, this.pixelWidthHeightRatio, this.projectionData, this.stereoMode, this.colorInfo, this.channelCount, this.sampleRate, this.pcmEncoding, this.encoderDelay, this.encoderPadding, language, this.accessibilityChannel, this.exoMediaCryptoType);
            }
        }
        codecs = codecs2;
        metadata = this.metadata;
        ...
        frameRate2 = frameRate;
        int selectionFlags2 = this.selectionFlags | manifestFormat.selectionFlags;
        int roleFlags2 = this.roleFlags | manifestFormat.roleFlags;
        DrmInitData drmInitData2 = DrmInitData.createSessionCreationData(manifestFormat.drmInitData, this.drmInitData);
        String id22 = codecs;
        return new Format(id, label, selectionFlags2, roleFlags2, bitrate, id22, metadata2, this.containerMimeType, this.sampleMimeType, this.maxInputSize, this.initializationData, drmInitData2, this.subsampleOffsetUs, this.width, this.height, frameRate2, this.rotationDegrees, this.pixelWidthHeightRatio, this.projectionData, this.stereoMode, this.colorInfo, this.channelCount, this.sampleRate, this.pcmEncoding, this.encoderDelay, this.encoderPadding, language, this.accessibilityChannel, this.exoMediaCryptoType);
    }
