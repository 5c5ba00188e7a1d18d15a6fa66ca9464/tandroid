        ...
        while (column != 0) {
            ...
            switch (dataType) {
                case 16:
                    ...
                    int column2 = paint2BitPixelCodeString(data, clutEntries, clutMapTable2ToX, column, line, paint, canvas);
                    data.byteAlign();
                    column = column2;
                    break;
                case 17:
                    ...
                    int column3 = paint4BitPixelCodeString(data, clutEntries, clutMapTable4ToX, column, line, paint, canvas);
                    data.byteAlign();
                    column = column3;
                    break;
                case 18:
                    ...
                    break;
                case 32:
                    byte[] clutMapTable2To42 = buildClutMapTable(4, 4, data);
                    clutMapTable2To4 = clutMapTable2To42;
                    break;
                case 33:
