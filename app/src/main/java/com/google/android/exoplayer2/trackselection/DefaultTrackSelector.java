...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    */
    private static int[] getAdaptiveAudioTracks(TrackGroup group, int[] formatSupport, int maxAudioBitrate, boolean allowMixedMimeTypeAdaptiveness, boolean allowMixedSampleRateAdaptiveness, boolean allowAudioMixedChannelCountAdaptiveness) {
        ...
        for (int i = 0; i < selectedConfigurationTrackCount; i++) {
            ...
            if (seenConfigurationTuples.add(configuration) && (configurationCount = getAdaptiveAudioTrackCount(group, formatSupport, configuration, maxAudioBitrate, allowMixedMimeTypeAdaptiveness, allowMixedSampleRateAdaptiveness, allowAudioMixedChannelCountAdaptiveness)) > selectedConfigurationTrackCount) {
        ...
        if (selectedConfigurationTrackCount > 1) {
            ...
            for (int i2 = 0; i2 < index; i2++) {
                if (isSupportedAdaptiveAudioTrack(group.getFormat(i2), formatSupport[i2], selectedConfiguration, maxAudioBitrate, allowMixedMimeTypeAdaptiveness, allowMixedSampleRateAdaptiveness, allowAudioMixedChannelCountAdaptiveness)) {
