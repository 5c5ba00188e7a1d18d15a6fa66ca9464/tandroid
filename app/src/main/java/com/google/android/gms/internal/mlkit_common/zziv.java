        ...
        while (true) {
            ...
            if (i6 != 0) {
                ...
                if (b < -32) {
                    ...
                    i6 = i7 - 2;
                    long j7 = j4 + 1;
                    byte zza = zzip.zza(bArr, j4);
                    if (zza > -65 || ((b == -32 && zza < -96) || (b == -19 && zza >= -96))) {
                        break;
                    }
                    j4 = j7 + 1;
                    if (zzip.zza(bArr, j7) > -65) {
                        break;
                    }
                } else if (i7 < 3) {
                    return zza(bArr, b, j4, i7);
                    ...
                    i6 = i7 - 3;
                    long j8 = j4 + 1;
                    byte zza2 = zzip.zza(bArr, j4);
                    if (zza2 > -65 || (((b << 28) + (zza2 + 112)) >> 30) != 0) {
                        break;
                    }
                    long j9 = j8 + 1;
                    if (zzip.zza(bArr, j8) > -65) {
                        break;
                    }
                    long j10 = j9 + 1;
                    if (zzip.zza(bArr, j9) > -65) {
                        break;
                    }
                    j4 = j10;
                }
