        ...
        if (i == 1) {
            ...
            if (zza2 <= 128) {
                ...
                while (i2 < i) {
                    ...
                    zzdq.zza(obj3, obj4);
                    int zza4 = zzec.zza(obj3.hashCode());
                    while (true) {
                        int i8 = zza4 & i3;
                        int i9 = sArr[i8] & 65535;
                        if (i9 == 65535) {
                            break;
                        } else if (objArr[i9].equals(obj3)) {
                ...
                while (i2 < i) {
                    ...
                    zzdq.zza(obj5, obj6);
                    int zza5 = zzec.zza(obj5.hashCode());
                    while (true) {
                        int i11 = zza5 & i3;
                        int i12 = iArr2[i11];
                        if (i12 == -1) {
                            ...
                            throw zza(obj5, obj6, objArr, i12);
                        } else {
                            zza5 = i11 + 1;
                        }
                    }
