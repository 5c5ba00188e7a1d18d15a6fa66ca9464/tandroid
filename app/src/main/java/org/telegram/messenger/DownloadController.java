...
public class DownloadController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    Runnable clearUnviewedDownloadsRunnale = new AnonymousClass2();
    ...
    public DownloadController(int i) {
        ...
        ApplicationLoader.applicationContext.registerReceiver(new AnonymousClass1(), new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
    ...
    public int canDownloadMedia(TLRPC$Message tLRPC$Message) {
        ...
        if (tLRPC$Peer != null) {
            if (tLRPC$Peer.user_id == 0) {
                ...
                i2 = preset.mask[c];
                if (i == 2) {
                    j = Math.max(524288L, preset.sizes[typeToIndex(i)]);
                } else {
                    j = preset.sizes[typeToIndex(i)];
                }
                long messageSize = MessageObject.getMessageSize(tLRPC$Message);
                if (!isVideoMessage && preset.preloadVideo && messageSize > j && j > 2097152) {
                    return (i2 & i) != 0 ? 2 : 0;
    ...
    */
    ...
    public /* synthetic */ void lambda$onDownloadComplete$6(MessageObject messageObject) {
        try {
            ...
            while (queryFinalized3.next()) {
                DownloadingDocumentEntry downloadingDocumentEntry = new DownloadingDocumentEntry(this, null);
    ...
    public /* synthetic */ void lambda$onDownloadFail$8(MessageObject messageObject, int i) {
        ...
        if (z) {
            ...
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.showBulletin, 1, LocaleController.formatString("MessageNotFound", 2131626631, new Object[0]));
        }
    }
    ...
    public class DownloadingDocumentEntry {
        ...
        /* synthetic */ DownloadingDocumentEntry(DownloadController downloadController, AnonymousClass1 anonymousClass1) {
            this();
        }
    }
