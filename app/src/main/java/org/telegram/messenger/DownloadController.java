...
public class DownloadController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public DownloadController(int instance) {
        ...
        this.lowPreset = new Preset(preferences.getString("preset0", "1_1_1_1_1048576_512000_512000_524288_0_0_1_1_50"), "1_1_1_1_1048576_512000_512000_524288_0_0_1_1_50");
        this.mediumPreset = new Preset(preferences.getString("preset1", "13_13_13_13_1048576_10485760_1048576_524288_1_1_1_0_100"), "13_13_13_13_1048576_10485760_1048576_524288_1_1_1_0_100");
        this.highPreset = new Preset(preferences.getString("preset2", "13_13_13_13_1048576_15728640_3145728_524288_1_1_1_0_100"), "13_13_13_13_1048576_15728640_3145728_524288_1_1_1_0_100");
        boolean newConfig2 = preferences.contains("newConfig");
        String str6 = "currentRoamingPreset";
        String str7 = "currentWifiPreset";
        if (newConfig2) {
            defaultLow = "1_1_1_1_1048576_512000_512000_524288_0_0_1_1_50";
            defaultMedium = "13_13_13_13_1048576_10485760_1048576_524288_1_1_1_0_100";
            defaultHigh = "13_13_13_13_1048576_15728640_3145728_524288_1_1_1_0_100";
            newConfig = newConfig2;
            str4 = str6;
            defaultHigh2 = "roamingPreset";
            ...
            while (true) {
                ...
                if (a == 0 || preferences.contains(key)) {
                    ...
                    sb2.append(a == 0 ? obj : Integer.valueOf(a));
                    wifiDownloadMask[a] = preferences.getInt(sb2.toString(), 13);
                    StringBuilder sb3 = new StringBuilder();
                    sb3.append("roamingDownloadMask");
                    sb3.append(a == 0 ? obj : Integer.valueOf(a));
                    roamingDownloadMask[a] = preferences.getInt(sb3.toString(), 1);
                } else {
            ...
            mobileMaxFileSize[2] = preferences.getLong("mobileMaxDownloadSize2", this.mediumPreset.sizes[1]);
            mobileMaxFileSize[3] = preferences.getLong("mobileMaxDownloadSize3", this.mediumPreset.sizes[2]);
            wifiMaxFileSize[2] = preferences.getLong("wifiMaxDownloadSize2", this.highPreset.sizes[1]);
            wifiMaxFileSize[3] = preferences.getLong("wifiMaxDownloadSize3", this.highPreset.sizes[2]);
            roamingMaxFileSize[2] = preferences.getLong("roamingMaxDownloadSize2", this.lowPreset.sizes[1]);
            roamingMaxFileSize[3] = preferences.getLong("roamingMaxDownloadSize3", this.lowPreset.sizes[2]);
            boolean globalAutodownloadEnabled = preferences.getBoolean("globalAutodownloadEnabled", true);
            this.mobilePreset = new Preset(mobileDataDownloadMask, this.mediumPreset.sizes[0], mobileMaxFileSize[2], mobileMaxFileSize[3], true, true, globalAutodownloadEnabled, false, 100);
            this.wifiPreset = new Preset(wifiDownloadMask, this.highPreset.sizes[0], wifiMaxFileSize[2], wifiMaxFileSize[3], true, true, globalAutodownloadEnabled, false, 100);
            this.roamingPreset = new Preset(roamingDownloadMask, this.lowPreset.sizes[0], roamingMaxFileSize[2], roamingMaxFileSize[3], false, false, globalAutodownloadEnabled, true, 50);
            ...
            editor.putInt(str7, 3);
            this.currentRoamingPreset = 3;
            editor.putInt(str5, 3);
            editor.commit();
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.DownloadController$$ExternalSyntheticLambda6
                ...
                public final void run() {
                    DownloadController.this.m197lambda$new$0$orgtelegrammessengerDownloadController();
                }
            });
            BroadcastReceiver networkStateReceiver = new BroadcastReceiver() { // from class: org.telegram.messenger.DownloadController.1
        ...
        String defaultMedium2 = defaultMedium;
        this.mobilePreset = new Preset(preferences.getString("mobilePreset", defaultMedium2), defaultMedium2);
        String defaultHigh3 = defaultHigh;
        this.wifiPreset = new Preset(preferences.getString(str3, defaultHigh3), defaultHigh3);
        String defaultLow2 = defaultLow;
        this.roamingPreset = new Preset(preferences.getString(defaultHigh2, defaultLow2), defaultLow2);
        this.currentMobilePreset = preferences.getInt(str2, 3);
        this.currentWifiPreset = preferences.getInt(str, 3);
        this.currentRoamingPreset = preferences.getInt(str4, 3);
        if (!newConfig) {
        ...
        BroadcastReceiver networkStateReceiver2 = new BroadcastReceiver() { // from class: org.telegram.messenger.DownloadController.1
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
                DownloadController.this.checkAutodownloadSettings();
            }
        ...
        ApplicationLoader.applicationContext.registerReceiver(networkStateReceiver2, filter2);
        if (!getUserConfig().isClientActivated()) {
        }
    }
