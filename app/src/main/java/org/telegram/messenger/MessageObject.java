...
public class MessageObject {
    ...
    */
    public void generatePinMessageText(TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat) {
        ...
        String string152 = LocaleController.getString("ActionPinnedNoText", R.string.ActionPinnedNoText);
        if (tLRPC$Chat3 == null) {
        }
            ...
            if (!(tLRPC$Message instanceof TLRPC$TL_messageService)) {
                ...
                if (tLRPC$MessageAction != null) {
                    if (tLRPC$MessageAction instanceof TLRPC$TL_messageActionGroupCallScheduled) {
                        ...
                        this.messageText = LocaleController.formatString("NotificationUnrecognizedDevice", R.string.NotificationUnrecognizedDevice, firstName, formatString, tLRPC$MessageAction2.title, tLRPC$MessageAction2.address);
