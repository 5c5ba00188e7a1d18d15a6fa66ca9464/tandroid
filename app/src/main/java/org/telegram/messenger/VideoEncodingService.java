...
public class VideoEncodingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (this.builder == null) {
            ...
            if (booleanExtra) {
                this.builder.setTicker(LocaleController.getString("SendingGif", 2131628216));
                this.builder.setContentText(LocaleController.getString("SendingGif", 2131628216));
            } else {
                this.builder.setTicker(LocaleController.getString("SendingVideo", 2131628219));
                this.builder.setContentText(LocaleController.getString("SendingVideo", 2131628219));
            }
        }
