...
public final class ExtendedDefaultDataSourceFactory implements DataSource.Factory {
    ...
    public ExtendedDefaultDataSource mo821createDataSource() {
        return new ExtendedDefaultDataSource(this.context, this.listener, this.baseDataSourceFactory.mo821createDataSource());
    }
}
