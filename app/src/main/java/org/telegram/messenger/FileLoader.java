...
public class FileLoader extends BaseController {
    ...
    */
    public /* synthetic */ void m230lambda$uploadFile$5$orgtelegrammessengerFileLoader(boolean encrypted, String location, long estimatedSize, int type, boolean forceSmallFile, boolean small) {
        long esimated;
        FileUploadOperation operation;
        FileLoaderDelegate fileLoaderDelegate;
        FileUploadOperation operation2;
        if (encrypted) {
        ...
        if (estimatedSize != 0) {
            ...
            if (finalSize != null) {
                this.uploadSizes.remove(location);
                esimated = 0;
                operation = new FileUploadOperation(this.currentAccount, location, encrypted, esimated, type);
                fileLoaderDelegate = this.delegate;
                if (fileLoaderDelegate != null || estimatedSize == 0) {
                    operation2 = operation;
                } else {
                    operation2 = operation;
                    fileLoaderDelegate.fileUploadProgressChanged(operation, location, 0L, estimatedSize, encrypted);
                }
                if (!encrypted) {
                    this.uploadOperationPathsEnc.put(location, operation2);
                } else {
                    this.uploadOperationPaths.put(location, operation2);
                }
                if (forceSmallFile) {
                    operation2.setForceSmallFile();
                }
                operation2.setDelegate(new AnonymousClass1(encrypted, location, small));
                if (!small) {
                    ...
                    this.uploadSmallOperationQueue.add(operation2);
                    return;
                }
                ...
                this.uploadOperationQueue.add(operation2);
                return;
            }
        }
        esimated = estimatedSize;
        operation = new FileUploadOperation(this.currentAccount, location, encrypted, esimated, type);
        fileLoaderDelegate = this.delegate;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private FileLoadOperation loadFileInternal(final TLRPC.Document document, SecureDocument secureDocument, WebFile webDocument, TLRPC.TL_fileLocationToBeDeprecated location, ImageLocation imageLocation, final Object parentObject, String locationExt, long locationSize, int priority, FileLoadOperationStream stream, int streamOffset, boolean streamPriority, int cacheType) {
        String fileName;
        String fileName2;
        boolean z;
        int i;
        ...
        if (fileName != null && !fileName.contains("-2147483648")) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("checkFile operation fileName=" + fileName + " documentName=" + getDocumentFileName(document) + " operation=" + operation2);
            }
            if (operation2 != null) {
                ...
                if (stream != null || priority > 0) {
                    ...
                    SparseIntArray count2 = getLoadOperationCount(queueType2);
                    int index = downloadQueue.indexOf(operation2);
                    if (index >= 0) {
                        downloadQueue.remove(index);
                        if (stream != null) {
                            if (operation2.start(stream, streamOffset, streamPriority)) {
                                count2.put(datacenterId, count2.get(datacenterId) + 1);
                            }
            ...
            if (secureDocument != null) {
                ...
                long documentId2 = location.volume_id;
                int dcId3 = location.dc_id;
                fileName2 = fileName3;
                i = cacheType;
                z = streamPriority;
                obj = parentObject;
                ...
                if (document != null) {
                    obj = parentObject;
                    FileLoadOperation operation3 = new FileLoadOperation(document, obj);
                    long documentId3 = document.id;
                    int dcId4 = document.dc_id;
            ...
            if (i == 11) {
                ...
                if (secureDocument == null) {
                    ...
                    if (!MessageObject.isImageWebDocument(webDocument) && !MessageObject.isStickerDocument(document)) {
                        queueType = 0;
                    }
                }
                queueType = 1;
            }
            String storeFileName4 = fileName2;
            if (i == 0 || i == 10) {
                if (documentId != 0) {
                    String path = getFileDatabase().getPath(documentId, dcId2, dcId, true);
                    boolean customPath = false;
                    if (path != null) {
                        File file = new File(path);
                        if (file.exists()) {
                            customPath = true;
                            storeFileName4 = file.getName();
                            storeDir2 = file.getParentFile();
                        }
                    }
                    if (!customPath) {
                        String storeFileName5 = fileName2;
                        storeDir2 = getDirectory(dcId);
                        boolean saveCustomPath = false;
                        if (dcId != 0) {
                            storeFileName3 = storeFileName5;
                        } else {
                            storeFileName3 = storeFileName5;
                        }
                        if (canSaveToPublicStorage(obj)) {
                            if (dcId == 0) {
                                newDir = getDirectory(100);
                            } else {
                                newDir = getDirectory(101);
                            }
                            if (newDir != null) {
                                storeDir2 = newDir;
                                saveCustomPath = true;
                            }
                            storeFileName2 = storeFileName3;
                            if (saveCustomPath) {
                                operation.pathSaveData = new FilePathDatabase.PathData(documentId, dcId2, dcId);
                            }
                            storeFileName4 = storeFileName2;
                        }
                        if (!TextUtils.isEmpty(getDocumentFileName(document)) && canSaveAsFile(obj)) {
                            storeFileName2 = getDocumentFileName(document);
                            File newDir2 = getDirectory(5);
                            if (newDir2 != null) {
                                storeDir2 = newDir2;
                                saveCustomPath = true;
                            }
                    ...
                    storeDir = storeDir2;
                    storeFileName = storeFileName4;
                } else {
                    storeDir = getDirectory(dcId);
                    storeFileName = storeFileName4;
                }
            } else {
                if (i == 2) {
            ...
            operation.setPaths(this.currentAccount, fileName2, queueType, storeDir, tempDir, storeFileName);
            if (i == 10) {
                operation.setIsPreloadVideoOperation(true);
            }
            FileLoadOperation operation5 = operation;
            final String str = fileName2;
            boolean z2 = true;
            final int i2 = queueType;
            FileLoadOperation.FileLoadOperationDelegate fileLoadOperationDelegate = new FileLoadOperation.FileLoadOperationDelegate() { // from class: org.telegram.messenger.FileLoader.2
                ...
                public void didFinishLoadingFile(FileLoadOperation operation6, File finalFile) {
                    ...
                    if (document != null) {
                        Object obj2 = parentObject;
                        if ((obj2 instanceof MessageObject) && ((MessageObject) obj2).putInDownloadsStore) {
                            FileLoader.this.getDownloadController().onDownloadComplete((MessageObject) parentObject);
                        }
                    }
                    if (!operation6.isPreloadVideoOperation()) {
                        FileLoader.this.loadOperationPathsUI.remove(str);
                        if (FileLoader.this.delegate != null) {
                            FileLoader.this.delegate.fileDidLoaded(str, finalFile, parentObject, dcId);
                        }
                    }
                    FileLoader.this.checkDownloadQueue(operation6.getDatacenterId(), i2, str);
                }
                ...
                public void didFailedLoadingFile(FileLoadOperation operation6, int reason) {
                    ...
                    FileLoader.this.checkDownloadQueue(operation6.getDatacenterId(), i2, str);
                    if (FileLoader.this.delegate != null) {
                        FileLoader.this.delegate.fileDidFailedLoad(str, reason);
                    }
                    if (document != null && (parentObject instanceof MessageObject) && reason == 0) {
                        FileLoader.this.getDownloadController().onDownloadFail((MessageObject) parentObject, reason);
                    }
                }

                @Override // org.telegram.messenger.FileLoadOperation.FileLoadOperationDelegate
                public void didChangedLoadProgress(FileLoadOperation operation6, long uploadedSize, long totalSize) {
                    if (FileLoader.this.delegate != null) {
                        FileLoader.this.delegate.fileLoadProgressChanged(operation6, str, uploadedSize, totalSize);
                    }
                }

                @Override // org.telegram.messenger.FileLoadOperation.FileLoadOperationDelegate
                public void saveFilePath(FilePathDatabase.PathData pathSaveData, File cacheFileFinal) {
                    FileLoader.this.getFileDatabase().putPath(pathSaveData.id, pathSaveData.dc, pathSaveData.type, cacheFileFinal != null ? cacheFileFinal.toString() : null);
                }
            };
            operation5.setDelegate(fileLoadOperationDelegate);
            int datacenterId2 = operation5.getDatacenterId();
            String fileName4 = fileName2;
            this.loadOperationPaths.put(fileName4, operation5);
            ...
            if (queueType == 3) {
                ...
                count = this.preloadingLoadOperationsCount.get(datacenterId2);
                if (stream == null && count >= maxCount4) {
                    z2 = false;
                }
                started = z2;
                if (!z2) {
                    ...
                    maxCount3 = maxCount4;
                    if (operation5.start(stream, streamOffset, z)) {
                        this.preloadingLoadOperationsCount.put(datacenterId2, count + 1);
                    }
                }
            } else if (queueType == 2) {
                if (priority <= 0) {
                ...
                int maxCount5 = i3;
                count = this.audioLoadOperationsCount.get(datacenterId2);
                if (stream == null && count >= maxCount5) {
                    z2 = false;
                }
                started = z2;
                if (!z2) {
                    ...
                    maxCount3 = maxCount5;
                    if (operation5.start(stream, streamOffset, z)) {
                        this.audioLoadOperationsCount.put(datacenterId2, count + 1);
                    }
                }
            } else if (queueType == 1) {
                if (priority <= 0) {
                ...
                count = this.imageLoadOperationsCount.get(datacenterId2);
                if (stream == null && count >= maxCount4) {
                    z2 = false;
                }
                started = z2;
                if (!z2) {
                    ...
                    maxCount3 = maxCount4;
                    if (operation5.start(stream, streamOffset, z)) {
                        this.imageLoadOperationsCount.put(datacenterId2, count + 1);
                    }
                }
            } else {
                int maxCount6 = priority > 0 ? 4 : 1;
                count = this.fileLoadOperationsCount.get(datacenterId2);
                if (stream == null && count >= maxCount6) {
                    z2 = false;
                }
                started = z2;
                if (!z2) {
                    ...
                    maxCount2 = maxCount6;
                    if (operation5.start(stream, streamOffset, z)) {
                        this.fileLoadOperationsCount.put(datacenterId2, count + 1);
                ...
                maxCount = maxCount2;
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.d("loadFileInternal fileName=" + fileName4 + " documentName=" + getDocumentFileName(document) + " queueType=" + queueType + " maxCount=" + maxCount + " count=" + count);
                }
                if (!started) {
                    addOperationToQueue(operation5, getLoadOperationQueue(datacenterId2, queueType));
                }
                return operation5;
            }
            maxCount = maxCount3;
