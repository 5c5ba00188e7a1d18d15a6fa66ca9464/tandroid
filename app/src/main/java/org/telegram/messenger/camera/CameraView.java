                ...
                public void run() {
                    ...
                    while (!done) {
                        ...
                        if (!VideoRecorder.this.buffers.isEmpty()) {
                            buffer = (InstantCameraView.AudioBufferInfo) VideoRecorder.this.buffers.poll();
                        } else {
                        ...
                        while (true) {
                            ...
                            if (readResult <= 0) {
                                ...
                                int bufferDurationUs = ((MediaController.VIDEO_BITRATE_480 * readResult) / CameraView.audioSampleRate) / 2;
