...
class ContactsRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int i) {
        ...
        if (this.deleted) {
            ...
            remoteViews2.setTextViewText(2131230954, LocaleController.getString("TapToEditWidgetShort", 2131628613));
            ...
            while (i3 < 2) {
                ...
                if (i4 >= this.dids.size()) {
                    remoteViews3.setViewVisibility(i3 == 0 ? 2131230792 : 2131230793, 4);
                } else {
                    remoteViews3.setViewVisibility(i3 == 0 ? 2131230792 : 2131230793, 0);
                    ...
                    remoteViews3.setTextViewText(i3 == 0 ? 2131230800 : 2131230801, str);
                    ...
                    remoteViews3.setImageViewBitmap(i3 == 0 ? 2131230794 : 2131230795, createBitmap);
                    TLRPC$Dialog tLRPC$Dialog = this.dialogs.get(l.longValue());
                    int i5 = 2131230798;
                    if (tLRPC$Dialog != null && (i2 = tLRPC$Dialog.unread_count) > 0) {
                        remoteViews3.setTextViewText(i3 == 0 ? 2131230796 : 2131230797, i2 > 99 ? String.format("%d+", 99) : String.format("%d", Integer.valueOf(i2)));
                        if (i3 != 0) {
                            i5 = 2131230799;
                        }
                    ...
                    remoteViews3.setOnClickFillInIntent(i3 == 0 ? 2131230792 : 2131230793, intent2);
                }
                i3++;
            }
            return remoteViews3;
