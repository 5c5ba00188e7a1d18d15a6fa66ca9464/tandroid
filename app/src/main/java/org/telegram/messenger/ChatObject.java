    ...
    public static class Call {
        ...
        */
        public void processVoiceLevelsUpdate(int[] ssrc, float[] levels, boolean[] voice) {
            ...
            long time;
            int currentTime;
            boolean updateCurrentSpeakingList;
            boolean updated;
            boolean updated2;
            boolean updated3 = false;
            boolean updateCurrentSpeakingList2 = false;
            int currentTime2 = this.currentAccount.getConnectionsManager().getCurrentTime();
            ArrayList<Long> participantsToLoad = null;
            long time2 = SystemClock.elapsedRealtime();
            long uptime = SystemClock.uptimeMillis();
            this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.applyGroupCallVisibleParticipants, Long.valueOf(time2));
            int a = 0;
            while (a < ssrc.length) {
                if (ssrc[a] == 0) {
                    participant = this.participants.get(getSelfId());
                } else {
                    participant = this.participantsBySources.get(ssrc[a]);
                }
                if (participant != null) {
                    participant.hasVoice = voice[a];
                    if (voice[a] || time2 - participant.lastVoiceUpdateTime > 500) {
                        participant.hasVoiceDelayed = voice[a];
                        participant.lastVoiceUpdateTime = time2;
                    }
                    long peerId = MessageObject.getPeerId(participant.peer);
                    if (levels[a] > 0.1f) {
                        if (voice[a]) {
                            updateCurrentSpeakingList = updateCurrentSpeakingList2;
                            if (participant.lastTypingDate + 1 >= currentTime2) {
                                updated2 = updated3;
                            } else {
                                if (time2 != participant.lastVisibleDate) {
                                    participant.active_date = currentTime2;
                                }
                                participant.lastTypingDate = currentTime2;
                                updated = true;
                                participant.lastSpeakTime = uptime;
                                participant.amplitude = levels[a];
                                boolean updated4 = updated;
                                if (this.currentSpeakingPeers.get(peerId, null) == null) {
                                    currentTime = currentTime2;
                                    time = time2;
                                    updated3 = updated4;
                                    updateCurrentSpeakingList2 = updateCurrentSpeakingList;
                                } else {
                                    if (peerId > 0) {
                                        currentTime = currentTime2;
                                        ...
                                        currentTime = currentTime2;
                                        time = time2;
                                        TLRPC.Chat user2 = MessagesController.getInstance(this.currentAccount.getCurrentAccount()).getChat(Long.valueOf(-peerId));
                                        StringBuilder sb2 = new StringBuilder();
                                    ...
                                    this.currentSpeakingPeers.put(peerId, participant);
                                    updateCurrentSpeakingList2 = true;
                                    updated3 = updated4;
                                }
                            }
                        } else {
                        ...
                        participant.lastSpeakTime = uptime;
                        participant.amplitude = levels[a];
                        boolean updated42 = updated;
                        if (this.currentSpeakingPeers.get(peerId, null) == null) {
                        }
                    } else {
                        boolean updated5 = updated3;
                        boolean updateCurrentSpeakingList3 = updateCurrentSpeakingList2;
                        currentTime = currentTime2;
                        time = time2;
                        if (uptime - participant.lastSpeakTime >= 500 && this.currentSpeakingPeers.get(peerId, null) != null) {
                            this.currentSpeakingPeers.remove(peerId);
                            if (peerId > 0) {
                                TLRPC.User user3 = MessagesController.getInstance(this.currentAccount.getCurrentAccount()).getUser(Long.valueOf(peerId));
                                StringBuilder sb3 = new StringBuilder();
                                sb3.append("remove from speaking ");
                                sb3.append(peerId);
                                sb3.append(" ");
                                sb3.append(user3 == null ? null : user3.first_name);
                                Log.d("GroupCall", sb3.toString());
                            } else {
                                TLRPC.Chat user4 = MessagesController.getInstance(this.currentAccount.getCurrentAccount()).getChat(Long.valueOf(-peerId));
                                StringBuilder sb4 = new StringBuilder();
                                sb4.append("remove from speaking ");
                                sb4.append(peerId);
                                sb4.append(" ");
                                sb4.append(user4 == null ? null : user4.title);
                                Log.d("GroupCall", sb4.toString());
                            }
                            updateCurrentSpeakingList2 = true;
                        } else {
                            updateCurrentSpeakingList2 = updateCurrentSpeakingList3;
                        }
                        participant.amplitude = 0.0f;
                        updated3 = updated5;
                    }
                } else {
                    boolean updated6 = updated3;
                    boolean updateCurrentSpeakingList4 = updateCurrentSpeakingList2;
                    currentTime = currentTime2;
                    time = time2;
                    if (ssrc[a] == 0) {
                        updateCurrentSpeakingList2 = updateCurrentSpeakingList4;
                        updated3 = updated6;
                    } else {
                        if (participantsToLoad == null) {
                            participantsToLoad = new ArrayList<>();
            ...
            boolean updated7 = updated3;
            boolean updateCurrentSpeakingList5 = updateCurrentSpeakingList2;
            if (participantsToLoad != null) {
            ...
            if (updateCurrentSpeakingList5) {
                ...
                this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.id), false);
            }
        }
        ...
        */
        public void processParticipantsUpdate(TLRPC.TL_updateGroupCallParticipants update, boolean fromQueue) {
            ...
            boolean speakingUpdated;
            long selfId;
            int a;
            boolean reloadCall;
            boolean changedOrAdded;
            boolean reloadCall2;
            int i;
            boolean reloadCall3;
            if (!fromQueue) {
                ...
                while (true) {
                    if (a2 >= N) {
                        break;
                    } else if (!update.participants.get(a2).versioned) {
                        a2++;
                    } else {
                        versioned = true;
                        break;
                ...
                if (versioned && this.call.version + 1 < update.version) {
                    if (this.reloadingMembers || this.updatesStartWaitTime == 0 || Math.abs(System.currentTimeMillis() - this.updatesStartWaitTime) <= 1500) {
                        ...
                        if (this.checkQueueRunnable == null) {
                            ChatObject$Call$$ExternalSyntheticLambda8 chatObject$Call$$ExternalSyntheticLambda8 = new ChatObject$Call$$ExternalSyntheticLambda8(this);
                            this.checkQueueRunnable = chatObject$Call$$ExternalSyntheticLambda8;
                            AndroidUtilities.runOnUIThread(chatObject$Call$$ExternalSyntheticLambda8, 1500L);
                            return;
                        }
                        return;
                    }
                    ...
                    loadMembers(true);
                    return;
                } else if (versioned && update.version < this.call.version) {
                    if (BuildVars.LOGS_ENABLED) {
            ...
            boolean changedOrAdded2 = false;
            boolean speakingUpdated2 = false;
            long selfId2 = getSelfId();
            long time = SystemClock.elapsedRealtime();
            long justJoinedId = 0;
            if (!this.sortedParticipants.isEmpty()) {
                ArrayList<TLRPC.TL_groupCallParticipant> arrayList = this.sortedParticipants;
                lastParticipantDate = arrayList.get(arrayList.size() - 1).date;
            } else {
                lastParticipantDate = 0;
            }
            this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.applyGroupCallVisibleParticipants, Long.valueOf(time));
            int a3 = 0;
            int N2 = update.participants.size();
            boolean reloadCall4 = false;
            while (a3 < N2) {
                TLRPC.TL_groupCallParticipant participant = update.participants.get(a3);
                int N3 = N2;
                boolean selfUpdated2 = selfUpdated;
                boolean changedOrAdded3 = changedOrAdded2;
                long pid = MessageObject.getPeerId(participant.peer);
                if (!BuildVars.LOGS_ENABLED) {
                    speakingUpdated = speakingUpdated2;
                } else {
                    StringBuilder sb = new StringBuilder();
                    speakingUpdated = speakingUpdated2;
                    sb.append("process participant ");
                    sb.append(pid);
                    sb.append(" left = ");
                    sb.append(participant.left);
                    sb.append(" versioned ");
                    sb.append(participant.versioned);
                    sb.append(" flags = ");
                    sb.append(participant.flags);
                    sb.append(" self = ");
                    sb.append(selfId2);
                    sb.append(" volume = ");
                    sb.append(participant.volume);
                    FileLog.d(sb.toString());
                }
                TLRPC.TL_groupCallParticipant oldParticipant = this.participants.get(pid);
                long justJoinedId2 = justJoinedId;
                if (participant.left) {
                    if (oldParticipant == null) {
                        reloadCall3 = reloadCall4;
                        if (update.version == this.call.version) {
                            if (BuildVars.LOGS_ENABLED) {
                            ...
                            if (oldParticipant != null) {
                                a = a3;
                                reloadCall = reloadCall2;
                                selfId = selfId2;
                                i = 1;
                                speakingUpdated2 = speakingUpdated;
                            } else {
                                this.participants.remove(pid);
                                processAllSources(oldParticipant, false);
                                this.sortedParticipants.remove(oldParticipant);
                                this.visibleParticipants.remove(oldParticipant);
                                reloadCall = reloadCall2;
                                if (this.currentSpeakingPeers.get(pid, null) == null) {
                                    a = a3;
                                    selfId = selfId2;
                                    speakingUpdated2 = speakingUpdated;
                                } else {
                                    if (pid > 0) {
                                        a = a3;
                                        TLRPC.User user = MessagesController.getInstance(this.currentAccount.getCurrentAccount()).getUser(Long.valueOf(pid));
                                        StringBuilder sb2 = new StringBuilder();
                                        sb2.append("left remove from speaking ");
                                        sb2.append(pid);
                                        sb2.append(" ");
                                        sb2.append(user == null ? null : user.first_name);
                                        Log.d("GroupCall", sb2.toString());
                                        selfId = selfId2;
                                    } else {
                                        a = a3;
                                        selfId = selfId2;
                                        TLRPC.Chat user2 = MessagesController.getInstance(this.currentAccount.getCurrentAccount()).getChat(Long.valueOf(-pid));
                                        StringBuilder sb3 = new StringBuilder();
                                        sb3.append("left remove from speaking ");
                                        sb3.append(pid);
                                        sb3.append(" ");
                                        sb3.append(user2 == null ? null : user2.title);
                                        Log.d("GroupCall", sb3.toString());
                                    }
                                    this.currentSpeakingPeers.remove(pid);
                                    speakingUpdated2 = true;
                                }
                                int i2 = 0;
                                while (i2 < this.visibleVideoParticipants.size()) {
                                    VideoParticipant videoParticipant = this.visibleVideoParticipants.get(i2);
                                    if (MessageObject.getPeerId(videoParticipant.participant.peer) == MessageObject.getPeerId(oldParticipant.peer)) {
                                        this.visibleVideoParticipants.remove(i2);
                                        i2--;
                                    }
                                    i2++;
                                }
                            ...
                            this.call.participants_count -= i;
                            if (this.call.participants_count < 0) {
                                this.call.participants_count = 0;
                            }
                            updated = true;
                            changedOrAdded = changedOrAdded3;
                            justJoinedId = justJoinedId2;
                        }
                    } else {
                        reloadCall3 = reloadCall4;
                    }
                    reloadCall2 = reloadCall3;
                    if (oldParticipant != null) {
                    }
                    this.call.participants_count -= i;
                    if (this.call.participants_count < 0) {
                    ...
                    if (oldParticipant != null) {
                        ...
                        if (participant.muted && this.currentSpeakingPeers.get(pid, null) != null) {
                            this.currentSpeakingPeers.remove(pid);
                            if (pid > 0) {
                                TLRPC.User user3 = MessagesController.getInstance(this.currentAccount.getCurrentAccount()).getUser(Long.valueOf(pid));
                                StringBuilder sb4 = new StringBuilder();
                                sb4.append("muted remove from speaking ");
                                sb4.append(pid);
                                sb4.append(" ");
                                sb4.append(user3 == null ? null : user3.first_name);
                                Log.d("GroupCall", sb4.toString());
                            } else {
                                TLRPC.Chat user4 = MessagesController.getInstance(this.currentAccount.getCurrentAccount()).getChat(Long.valueOf(-pid));
                                StringBuilder sb5 = new StringBuilder();
                                sb5.append("muted remove from speaking ");
                                sb5.append(pid);
                                sb5.append(" ");
                                sb5.append(user4 == null ? null : user4.title);
                                Log.d("GroupCall", sb5.toString());
                            }
                            speakingUpdated2 = true;
                            if (participant.min) {
                        ...
                        oldParticipant.can_self_unmute = participant.can_self_unmute;
                        oldParticipant.video_joined = participant.video_joined;
                        if (oldParticipant.raise_hand_rating == 0) {
                            oldParticipant.lastRaiseHandDate = SystemClock.elapsedRealtime();
                        }
                        oldParticipant.raise_hand_rating = participant.raise_hand_rating;
                        oldParticipant.date = participant.date;
                        ...
                        if (participant.just_joined) {
                            ...
                            if (update.version == this.call.version) {
                                ...
                                boolean reloadCall5 = BuildVars.LOGS_ENABLED;
                                if (reloadCall5) {
                        ...
                        if (pid == selfId || this.sortedParticipants.size() < 20 || participant.date <= lastParticipantDate || participant.active_date != 0 || participant.can_self_unmute || !participant.muted || !participant.min || this.membersLoadEndReached) {
                            this.sortedParticipants.add(participant);
                        }
                        this.participants.put(pid, participant);
                        processAllSources(participant, true);
                    ...
                    if (pid == selfId && participant.active_date == 0 && (participant.can_self_unmute || !participant.muted)) {
                        participant.active_date = this.currentAccount.getConnectionsManager().getCurrentTime();
                    }
                    changedOrAdded = true;
                    updated = true;
                    justJoinedId = justJoinedId2;
                ...
                if (pid != selfId) {
                    selfUpdated = selfUpdated2;
                } else {
                    selfUpdated = true;
                }
                changedOrAdded2 = changedOrAdded;
                a3 = a + 1;
                N2 = N3;
                reloadCall4 = reloadCall;
                selfId2 = selfId;
            }
            boolean reloadCall6 = reloadCall4;
            boolean selfUpdated3 = selfUpdated;
            boolean changedOrAdded4 = changedOrAdded2;
            boolean speakingUpdated3 = speakingUpdated2;
            long justJoinedId3 = justJoinedId;
            boolean updated2 = updated;
            int a4 = update.version;
            if (a4 > this.call.version) {
                this.call.version = update.version;
                if (!fromQueue) {
                    processUpdatesQueue();
                }
            }
            ...
            if (updated2) {
                ...
                this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.id), Boolean.valueOf(selfUpdated3), Long.valueOf(justJoinedId3));
            }
            if (speakingUpdated3) {
                this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.id), false);
            }
