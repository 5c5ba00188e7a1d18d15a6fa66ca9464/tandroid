...
public class ContactsController extends BaseController {
    ...
    */
        ...
        if (!getUserConfig().syncContacts) {
            ...
            try {
                try {
                    ...
                    ContentResolver cr3 = ApplicationLoader.applicationContext.getContentResolver();
                    HashMap<String, Contact> shortContacts = new HashMap<>();
                    ArrayList<String> idsArr = new ArrayList<>();
                    pCur = cr3.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, contactsController.projectionPhones, null, null, null);
                    int lastContactId2 = 1;
                    int i = 0;
                    ?? r10 = 1;
                    if (pCur != null) {
                        try {
                            ...
                            if (count2 > 0) {
                                ...
                                while (pCur.moveToNext()) {
                                    ...
                                    int i4 = r10 == true ? 1 : 0;
                                    int i5 = r10 == true ? 1 : 0;
                                    String number = pCur.getString(i2);
                                    ...
                                    if (TextUtils.isEmpty(number)) {
                                        ...
                                        String number2 = PhoneFormat.stripExceptNumbers(number, r10);
                                        if (TextUtils.isEmpty(number2)) {
                                            ...
                                            if (!number2.startsWith("+")) {
                                                ...
                                                shortNumber = number2.substring(r10);
                                            }
                                            String lookup_key = pCur.getString(i);
                                            escaper.setLength(i);
                                            ...
                                            if (existingContact != null) {
                                                ...
                                                Contact contact2 = contactsMap.get(lookup_key);
                                                if (contact2 != null) {
                                                    cr2 = cr3;
                                                    contact = contact2;
                                                } else {
                                                    Contact contact3 = new Contact();
                                                    String displayName2 = pCur.getString(4);
                                                    if (displayName2 == null) {
                                                        displayName = "";
                                                    } else {
                                                        displayName = displayName2.trim();
                                                    }
                                                    if (contactsController.isNotValidNameString(displayName)) {
                                                        contact = contact3;
                                                    ...
                                                    contact.contact_id = lastContactId2;
                                                    contactsMap.put(lookup_key, contact);
                                                    lastContactId2++;
                                                }
                                                contact.shortPhones.add(shortNumber);
                                                contact.phones.add(number2);
                                                contact.phoneDeleted.add(0);
                                                if (type == 0) {
                                                    String custom = pCur.getString(3);
                                                    ArrayList<String> arrayList = contact.phoneTypes;
                                                    if (custom != null) {
                                                        lastContactId = lastContactId2;
                                                        str = custom;
                                                    } else {
                                                        lastContactId = lastContactId2;
                                                        str = LocaleController.getString("PhoneMobile", org.telegram.messenger.beta.R.string.PhoneMobile);
                                                    }
                                                    arrayList.add(str);
                                                } else {
                                                    lastContactId = lastContactId2;
                                                    if (type == 1) {
                                                        contact.phoneTypes.add(LocaleController.getString("PhoneHome", org.telegram.messenger.beta.R.string.PhoneHome));
                                                    } else if (type == 2) {
                                                        contact.phoneTypes.add(LocaleController.getString("PhoneMobile", org.telegram.messenger.beta.R.string.PhoneMobile));
                                                    } else if (type == 3) {
                                                        contact.phoneTypes.add(LocaleController.getString("PhoneWork", org.telegram.messenger.beta.R.string.PhoneWork));
                                                    } else if (type == 12) {
                                                        contact.phoneTypes.add(LocaleController.getString("PhoneMain", org.telegram.messenger.beta.R.string.PhoneMain));
                                                    } else {
                                                        contact.phoneTypes.add(LocaleController.getString("PhoneOther", org.telegram.messenger.beta.R.string.PhoneOther));
                                                    }
                                                }
                    ...
                    try {
                        pCur = cr.query(uri, this.projectionNames, "lookup IN (" + ids + ") AND mimetype = 'vnd.android.cursor.item/name'", null, null);
                        if (pCur != null) {
                            while (pCur.moveToNext()) {
                                String lookup_key2 = pCur.getString(0);
                                String fname = pCur.getString(1);
                                String sname = pCur.getString(2);
                                String mname = pCur.getString(3);
                                Contact contact4 = contactsMap != null ? contactsMap.get(lookup_key2) : null;
                                if (contact4 != null && !contact4.namesFilled) {
                                    if (!contact4.isGoodProvider) {
                                        if ((!isNotValidNameString(fname) && (contact4.first_name.contains(fname) || fname.contains(contact4.first_name))) || (!isNotValidNameString(sname) && (contact4.last_name.contains(sname) || fname.contains(contact4.last_name)))) {
                                            if (fname != null) {
                                                contact4.first_name = fname;
                                            } else {
                                                contact4.first_name = "";
                                            }
                                            if (!TextUtils.isEmpty(mname)) {
                                                if (!TextUtils.isEmpty(contact4.first_name)) {
                                                    contact4.first_name += " " + mname;
                                                } else {
                                                    contact4.first_name = mname;
                                                }
                                            }
                                            if (sname != null) {
                                                contact4.last_name = sname;
                                            } else {
                                                contact4.last_name = "";
                                            }
                                        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public /* synthetic */ void m169x3cf1c3d6(final HashMap contactHashMap, final boolean schedule, boolean request, final boolean first, boolean force, boolean checkCount, boolean canceled) {
        HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal;
        HashMap<String, Contact> phoneBookByShortPhonesFinal;
        ArrayList<String> phoneBookSectionsArrayFinal;
        int serverContactsInPhonebook;
        ...
        Iterator<Map.Entry<String, Contact>> it2;
        String str;
        Contact c;
        int alreadyImportedContacts;
        HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal2;
        HashMap<String, Contact> contactsMap;
        HashMap<String, Contact> phoneBookByShortPhonesFinal2;
        ArrayList<String> phoneBookSectionsArrayFinal2;
        HashMap<String, Contact> contactShortHashMap;
        HashMap<String, Contact> contactsBookShort2;
        HashMap<String, Contact> contactsBookShort3;
        int index;
        int alreadyImportedContacts2;
        HashMap<String, Contact> contactsBookShort4;
        HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal3;
        int index2;
        HashMap<String, Contact> contactsMap2;
        int index3;
        int newPhonebookContacts2 = 0;
        int serverContactsInPhonebook2 = 0;
        boolean disableDeletion2 = true;
        HashMap<String, Contact> contactShortHashMap2 = new HashMap<>();
        for (Map.Entry<String, Contact> entry : contactHashMap.entrySet()) {
            Contact c2 = entry.getValue();
            for (int a = 0; a < c2.shortPhones.size(); a++) {
                contactShortHashMap2.put(c2.shortPhones.get(a), c2);
            }
        }
        if (BuildVars.LOGS_ENABLED) {
        ...
        HashMap<String, Contact> contactsMap3 = readContactsFromPhoneBook();
        HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal4 = new HashMap<>();
        HashMap<String, Contact> phoneBookByShortPhonesFinal3 = new HashMap<>();
        ArrayList<String> phoneBookSectionsArrayFinal3 = new ArrayList<>();
        for (Map.Entry<String, Contact> entry2 : contactsMap3.entrySet()) {
            Contact contact = entry2.getValue();
            int a2 = 0;
            int size = contact.shortPhones.size();
            while (a2 < size) {
                String phone = contact.shortPhones.get(a2);
                int newPhonebookContacts3 = newPhonebookContacts2;
                int newPhonebookContacts4 = phone.length() - 7;
                phoneBookByShortPhonesFinal3.put(phone.substring(Math.max(0, newPhonebookContacts4)), contact);
                a2++;
                serverContactsInPhonebook2 = serverContactsInPhonebook2;
                newPhonebookContacts2 = newPhonebookContacts3;
            }
            int newPhonebookContacts5 = newPhonebookContacts2;
            int serverContactsInPhonebook3 = serverContactsInPhonebook2;
            String key = contact.getLetter();
            ArrayList<Object> arrayList = phoneBookSectionsDictFinal4.get(key);
            if (arrayList == null) {
                arrayList = new ArrayList<>();
                phoneBookSectionsDictFinal4.put(key, arrayList);
                phoneBookSectionsArrayFinal3.add(key);
            }
            arrayList.add(contact);
            serverContactsInPhonebook2 = serverContactsInPhonebook3;
            newPhonebookContacts2 = newPhonebookContacts5;
        }
        int newPhonebookContacts6 = newPhonebookContacts2;
        int serverContactsInPhonebook4 = serverContactsInPhonebook2;
        HashMap<String, Contact> contactsBookShort5 = new HashMap<>();
        int alreadyImportedContacts3 = contactHashMap.size();
        ArrayList<TLRPC.TL_inputPhoneContact> toImport = new ArrayList<>();
        String str2 = "";
        if (!contactHashMap.isEmpty()) {
            Iterator<Map.Entry<String, Contact>> it3 = contactsMap3.entrySet().iterator();
            while (it3.hasNext()) {
                Map.Entry<String, Contact> pair = it3.next();
                ...
                if (existing != null) {
                    ...
                    while (true) {
                        str = str2;
                        if (a3 >= value.shortPhones.size()) {
                            break;
                        }
                        c = contactShortHashMap2.get(value.shortPhones.get(a3));
                        if (c != null) {
                            id = c.key;
                            break;
                        } else {
                ...
                if (c != null) {
                    if (TextUtils.isEmpty(value.first_name)) {
                    }
                    if (!TextUtils.isEmpty(value.last_name)) {
                    }
                }
                boolean nameChanged = false;
                if (c == null) {
                    alreadyImportedContacts = alreadyImportedContacts3;
                    contactsBookShort3 = contactsBookShort5;
                    phoneBookSectionsArrayFinal2 = phoneBookSectionsArrayFinal3;
                    phoneBookByShortPhonesFinal2 = phoneBookByShortPhonesFinal3;
                    phoneBookSectionsDictFinal2 = phoneBookSectionsDictFinal4;
                    contactsMap = contactsMap3;
                    contactShortHashMap = contactShortHashMap2;
                } else if (nameChanged) {
                    alreadyImportedContacts = alreadyImportedContacts3;
                    contactsBookShort3 = contactsBookShort5;
                    phoneBookSectionsArrayFinal2 = phoneBookSectionsArrayFinal3;
                    ...
                    while (true) {
                        contactShortHashMap = contactShortHashMap2;
                        if (a4 >= value.phones.size()) {
                            break;
                        }
                        String sphone = value.shortPhones.get(a4);
                        HashMap<String, Contact> phoneBookByShortPhonesFinal4 = phoneBookByShortPhonesFinal3;
                        ArrayList<String> phoneBookSectionsArrayFinal4 = phoneBookSectionsArrayFinal3;
                        String sphone9 = sphone.substring(Math.max(0, sphone.length() - 7));
                        contactsBookShort5.put(sphone, value);
                        int index4 = c.shortPhones.indexOf(sphone);
                        boolean emptyNameReimport = false;
                        if (!request) {
                            alreadyImportedContacts2 = alreadyImportedContacts3;
                            contactsBookShort4 = contactsBookShort5;
                            index3 = index4;
                            phoneBookSectionsDictFinal3 = phoneBookSectionsDictFinal4;
                        } else {
                            index3 = index4;
                            TLRPC.TL_contact contact2 = this.contactsByPhone.get(sphone);
                            if (contact2 == null) {
                                alreadyImportedContacts2 = alreadyImportedContacts3;
                                contactsBookShort4 = contactsBookShort5;
                                phoneBookSectionsDictFinal3 = phoneBookSectionsDictFinal4;
                                if (this.contactsByShortPhone.containsKey(sphone9)) {
                                ...
                                alreadyImportedContacts2 = alreadyImportedContacts3;
                                contactsBookShort4 = contactsBookShort5;
                                TLRPC.User user = getMessagesController().getUser(Long.valueOf(contact2.user_id));
                                if (user != null) {
                                    serverContactsInPhonebook4++;
                            ...
                            if (index2 != -1) {
                                if (request) {
                                    if (emptyNameReimport) {
                                        contactsMap2 = contactsMap3;
                                    } else {
                                        TLRPC.TL_contact contact3 = this.contactsByPhone.get(sphone);
                                        if (contact3 == null) {
                                            contactsMap2 = contactsMap3;
                                            if (this.contactsByShortPhone.containsKey(sphone9)) {
                                                serverContactsInPhonebook4++;
                                            ...
                                            contactsMap2 = contactsMap3;
                                            TLRPC.User user2 = getMessagesController().getUser(Long.valueOf(contact3.user_id));
                                            if (user2 != null) {
                                                serverContactsInPhonebook4++;
                                                String firstName = user2.first_name != null ? user2.first_name : str;
                                                String lastName = user2.last_name != null ? user2.last_name : str;
                                ...
                                contactsMap2 = contactsMap3;
                                value.phoneDeleted.set(a4, c.phoneDeleted.get(index2));
                            ...
                            a4++;
                            contactShortHashMap2 = contactShortHashMap;
                            phoneBookSectionsArrayFinal3 = phoneBookSectionsArrayFinal4;
                            phoneBookByShortPhonesFinal3 = phoneBookByShortPhonesFinal4;
                            contactsMap3 = contactsMap2;
                            phoneBookSectionsDictFinal4 = phoneBookSectionsDictFinal3;
                            contactsBookShort5 = contactsBookShort4;
                    ...
                    alreadyImportedContacts = alreadyImportedContacts3;
                    HashMap<String, Contact> contactsBookShort6 = contactsBookShort5;
                    phoneBookSectionsArrayFinal2 = phoneBookSectionsArrayFinal3;
                    phoneBookByShortPhonesFinal2 = phoneBookByShortPhonesFinal3;
                    phoneBookSectionsDictFinal2 = phoneBookSectionsDictFinal4;
                    contactsMap = contactsMap3;
                    ...
                    contactsBookShort2 = contactsBookShort6;
                    contactsBookShort5 = contactsBookShort2;
                    str2 = str;
                    it3 = it2;
                    contactShortHashMap2 = contactShortHashMap;
                    phoneBookSectionsArrayFinal3 = phoneBookSectionsArrayFinal2;
                    phoneBookByShortPhonesFinal3 = phoneBookByShortPhonesFinal2;
                    contactsMap3 = contactsMap;
                    phoneBookSectionsDictFinal4 = phoneBookSectionsDictFinal2;
                    alreadyImportedContacts3 = alreadyImportedContacts;
                }
                int a5 = 0;
                while (a5 < value.phones.size()) {
                    String sphone2 = value.shortPhones.get(a5);
                    sphone2.substring(Math.max(0, sphone2.length() - 7));
                    HashMap<String, Contact> contactsBookShort7 = contactsBookShort3;
                    contactsBookShort7.put(sphone2, value);
                    if (c != null && (index = c.shortPhones.indexOf(sphone2)) != -1) {
                        Integer deleted = c.phoneDeleted.get(index);
                        value.phoneDeleted.set(a5, deleted);
                        if (deleted.intValue() == 1) {
                            a5++;
                            contactsBookShort3 = contactsBookShort7;
                        }
                    }
                    if (request) {
                        if (!nameChanged) {
                            if (this.contactsByPhone.containsKey(sphone2)) {
                                serverContactsInPhonebook4++;
                            } else {
                                newPhonebookContacts6++;
                            }
                        }
                        TLRPC.TL_inputPhoneContact imp2 = new TLRPC.TL_inputPhoneContact();
                        imp2.client_id = value.contact_id;
                        imp2.client_id = (a5 << 32) | imp2.client_id;
                        imp2.first_name = value.first_name;
                        imp2.last_name = value.last_name;
                        imp2.phone = value.phones.get(a5);
                        toImport.add(imp2);
                    }
                    a5++;
                    contactsBookShort3 = contactsBookShort7;
                }
                contactsBookShort2 = contactsBookShort3;
                if (c != null) {
                    contactHashMap.remove(id);
                }
                contactsBookShort5 = contactsBookShort2;
            ...
            int alreadyImportedContacts4 = alreadyImportedContacts3;
            phoneBookSectionsArrayFinal = phoneBookSectionsArrayFinal3;
            phoneBookByShortPhonesFinal = phoneBookByShortPhonesFinal3;
            phoneBookSectionsDictFinal = phoneBookSectionsDictFinal4;
            HashMap<String, Contact> contactsMap4 = contactsMap3;
            contactsBookShort = contactsBookShort5;
            if (first || !contactHashMap.isEmpty() || !toImport.isEmpty()) {
                alreadyImportedContacts3 = alreadyImportedContacts4;
            } else {
                alreadyImportedContacts3 = alreadyImportedContacts4;
                if (alreadyImportedContacts3 == contactsMap4.size()) {
                    if (BuildVars.LOGS_ENABLED) {
            ...
            if (!request || contactHashMap.isEmpty() || contactsMap4.isEmpty()) {
                contactsMap3 = contactsMap4;
            } else {
                if (!toImport.isEmpty()) {
                    contactsMap3 = contactsMap4;
                } else {
                    contactsMap3 = contactsMap4;
                    getMessagesStorage().putCachedPhoneBook(contactsMap3, false, false);
                }
                if (1 == 0 && !contactHashMap.isEmpty()) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda17
                        @Override // java.lang.Runnable
                        public final void run() {
                            ContactsController.this.m157xaf827cf5(contactHashMap);
                        }
                    });
                }
            }
            serverContactsInPhonebook = serverContactsInPhonebook4;
            newPhonebookContacts = newPhonebookContacts6;
        } else {
            phoneBookSectionsArrayFinal = phoneBookSectionsArrayFinal3;
            phoneBookByShortPhonesFinal = phoneBookByShortPhonesFinal3;
            phoneBookSectionsDictFinal = phoneBookSectionsDictFinal4;
            contactsBookShort = contactsBookShort5;
            if (request) {
                Iterator<Map.Entry<String, Contact>> it4 = contactsMap3.entrySet().iterator();
                int serverContactsInPhonebook5 = serverContactsInPhonebook4;
                while (it4.hasNext()) {
                    Map.Entry<String, Contact> pair2 = it4.next();
                    Contact value2 = pair2.getValue();
                    pair2.getKey();
                    int a6 = 0;
                    while (a6 < value2.phones.size()) {
                        if (force) {
                            it = it4;
                            disableDeletion = disableDeletion2;
                        } else {
                            String sphone3 = value2.shortPhones.get(a6);
                            String sphone92 = sphone3.substring(Math.max(0, sphone3.length() - 7));
                            TLRPC.TL_contact contact4 = this.contactsByPhone.get(sphone3);
                            if (contact4 == null) {
                                it = it4;
                                disableDeletion = disableDeletion2;
                                if (this.contactsByShortPhone.containsKey(sphone92)) {
                                    serverContactsInPhonebook5++;
                                }
                            } else {
                                it = it4;
                                disableDeletion = disableDeletion2;
                                TLRPC.User user3 = getMessagesController().getUser(Long.valueOf(contact4.user_id));
                                if (user3 != null) {
                                    serverContactsInPhonebook5++;
                                    String firstName2 = user3.first_name != null ? user3.first_name : str2;
                                    String lastName2 = user3.last_name != null ? user3.last_name : str2;
                                    if ((firstName2.equals(value2.first_name) && lastName2.equals(value2.last_name)) || (TextUtils.isEmpty(value2.first_name) && TextUtils.isEmpty(value2.last_name))) {
                                        a6++;
                                        it4 = it;
                        ...
                        TLRPC.TL_inputPhoneContact imp3 = new TLRPC.TL_inputPhoneContact();
                        imp3.client_id = value2.contact_id;
                        imp3.client_id |= a6 << 32;
                        imp3.first_name = value2.first_name;
                        imp3.last_name = value2.last_name;
                        imp3.phone = value2.phones.get(a6);
                        toImport.add(imp3);
                        a6++;
                        it4 = it;
                        disableDeletion2 = disableDeletion;
                ...
                serverContactsInPhonebook = serverContactsInPhonebook5;
                newPhonebookContacts = newPhonebookContacts6;
            } else {
                serverContactsInPhonebook = serverContactsInPhonebook4;
                newPhonebookContacts = newPhonebookContacts6;
            ...
            if (!toImport.isEmpty()) {
                ...
                if (checkCount && newPhonebookContacts != 0) {
                    if (newPhonebookContacts >= 30) {
                        checkType = 1;
                    } else if (first && alreadyImportedContacts3 == 0 && this.contactsByPhone.size() - serverContactsInPhonebook > (this.contactsByPhone.size() / 3) * 2) {
                        checkType = 2;
                    } else {
                        checkType = 0;
                    }
                ...
                if (checkType != 0) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            ContactsController.this.m158x94c3ebb6(i, contactHashMap, first, schedule);
                        }
                    });
                    return;
                }
                ArrayList<TLRPC.TL_inputPhoneContact> toImport2 = toImport;
                if (canceled) {
                    final HashMap<String, Contact> hashMap = contactsBookShort;
                    final HashMap<String, Contact> hashMap2 = contactsMap3;
                    ...
                    Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda25
                        @Override // java.lang.Runnable
                        public final void run() {
                            ContactsController.this.m160x5f46c938(hashMap, hashMap2, first, hashMap3, arrayList2, hashMap4);
                        }
                    });
                    return;
                }
                final HashMap<String, Contact> contactsBookShort8 = contactsBookShort;
                final boolean[] hasErrors = {false};
                final HashMap<String, Contact> contactsMapToSave = new HashMap<>(contactsMap3);
                SparseArray<String> contactIdToKey = new SparseArray<>();
                for (Map.Entry<String, Contact> entry3 : contactsMapToSave.entrySet()) {
                    Contact value3 = entry3.getValue();
                    contactIdToKey.put(value3.contact_id, value3.key);
                }
                this.completedRequestsCount = 0;
                double size2 = toImport2.size();
                Double.isNaN(size2);
                int count = (int) Math.ceil(size2 / 500.0d);
                int a7 = 0;
                while (a7 < count) {
                    final TLRPC.TL_contacts_importContacts req = new TLRPC.TL_contacts_importContacts();
                    int start = a7 * 500;
                    int end = Math.min(start + 500, toImport2.size());
                    req.contacts = new ArrayList<>(toImport2.subList(start, end));
                    final SparseArray<String> sparseArray = contactIdToKey;
                    final HashMap<String, Contact> hashMap5 = contactsMap3;
                    final int i2 = count;
                    final ArrayList<String> phoneBookSectionsArrayFinal5 = phoneBookSectionsArrayFinal;
                    final HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal5 = phoneBookSectionsDictFinal;
                    ArrayList<TLRPC.TL_inputPhoneContact> toImport3 = toImport2;
                    final HashMap<String, Contact> hashMap6 = phoneBookByShortPhonesFinal;
                    getConnectionsManager().sendRequest(req, new RequestDelegate() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda57
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            ContactsController.this.m164xf44c843c(contactsMapToSave, sparseArray, hasErrors, hashMap5, req, i2, contactsBookShort8, first, phoneBookSectionsDictFinal5, phoneBookSectionsArrayFinal5, hashMap6, tLObject, tL_error);
                        }
                    }, 6);
                    a7++;
                    newPhonebookContacts = newPhonebookContacts;
                    serverContactsInPhonebook = serverContactsInPhonebook;
                    phoneBookSectionsArrayFinal = phoneBookSectionsArrayFinal5;
                    count = count;
                    contactIdToKey = contactIdToKey;
                    contactsMap3 = contactsMap3;
                    toImport2 = toImport3;
                    phoneBookSectionsDictFinal = phoneBookSectionsDictFinal5;
                }
                return;
            }
            final HashMap<String, Contact> contactsBookShort9 = contactsBookShort;
            final HashMap<String, Contact> contactsMap5 = contactsMap3;
            final ArrayList<String> phoneBookSectionsArrayFinal6 = phoneBookSectionsArrayFinal;
            final HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal6 = phoneBookSectionsDictFinal;
            final HashMap<String, Contact> hashMap7 = phoneBookByShortPhonesFinal;
            Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda26
                @Override // java.lang.Runnable
                public final void run() {
                    ContactsController.this.m166x8d2d7793(contactsBookShort9, contactsMap5, first, phoneBookSectionsDictFinal6, phoneBookSectionsArrayFinal6, hashMap7);
                }
            });
            return;
        }
        final HashMap<String, Contact> contactsBookShort10 = contactsBookShort;
        final HashMap<String, Contact> contactsMap6 = contactsMap3;
        final ArrayList<String> phoneBookSectionsArrayFinal7 = phoneBookSectionsArrayFinal;
        final HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal7 = phoneBookSectionsDictFinal;
        final HashMap<String, Contact> hashMap8 = phoneBookByShortPhonesFinal;
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda27
            @Override // java.lang.Runnable
            public final void run() {
                ContactsController.this.m168x57b05515(contactsBookShort10, contactsMap6, first, phoneBookSectionsDictFinal7, phoneBookSectionsArrayFinal7, hashMap8);
            }
        });
        if (!contactsMap6.isEmpty()) {
            getMessagesStorage().putCachedPhoneBook(contactsMap6, false, false);
        }
    }
    ...
    */
    public void createOrUpdateConnectionServiceContact(long id, String firstName, String lastName) {
        ...
        try {
            ...
            Uri groupsURI = ContactsContract.Groups.CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", "true").build();
            Uri rawContactsURI = ContactsContract.RawContacts.CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", "true").build();
            String[] strArr = {"_id"};
            String[] strArr2 = new String[3];
            strArr2[0] = "TelegramConnectionService";
            strArr2[1] = this.systemAccount.type;
            try {
                strArr2[2] = this.systemAccount.name;
                Cursor cursor2 = resolver.query(groupsURI, strArr, "title=? AND account_type=? AND account_name=?", strArr2, null);
                if (cursor2 != null && cursor2.moveToFirst()) {
                    groupID = cursor2.getInt(0);
                    str = "account_type";
                    str2 = "account_name";
                } else {
                    ContentValues values = new ContentValues();
                    try {
                        ...
                        str = "account_type";
                        values.put("group_visible", (Integer) 0);
                        str2 = "account_name";
                        values.put("group_is_read_only", (Integer) 1);
                ...
                String str3 = str;
                String str4 = str2;
                Cursor cursor3 = resolver.query(ContactsContract.Data.CONTENT_URI, new String[]{"raw_contact_id"}, "mimetype=? AND data1=?", new String[]{"vnd.android.cursor.item/group_membership", groupID + ""}, null);
                int backRef = ops2.size();
                ...
                try {
                    if (cursor3 != null) {
                        try {
                            if (cursor3.moveToFirst()) {
                                int contactID = cursor3.getInt(0);
                                ContentProviderOperation.Builder newUpdate = ContentProviderOperation.newUpdate(rawContactsURI);
                                cursor = cursor3;
                                String[] strArr3 = {contactID + ""};
                                ops = ops2;
                                ops.add(newUpdate.withSelection("_id=?", strArr3).withValue("deleted", 0).build());
                                ContentProviderOperation.Builder newUpdate2 = ContentProviderOperation.newUpdate(ContactsContract.Data.CONTENT_URI);
                                ContentProviderOperation.Builder withSelection = newUpdate2.withSelection("raw_contact_id=? AND mimetype=?", new String[]{contactID + "", "vnd.android.cursor.item/phone_v2"});
                                ops.add(withSelection.withValue("data1", "+99084" + id).build());
                                ContentProviderOperation.Builder newUpdate3 = ContentProviderOperation.newUpdate(ContactsContract.Data.CONTENT_URI);
                                try {
                                    ops.add(newUpdate3.withSelection("raw_contact_id=? AND mimetype=?", new String[]{contactID + "", "vnd.android.cursor.item/name"}).withValue("data2", firstName).withValue("data3", lastName).build());
                                    if (cursor != null) {
                                        cursor.close();
                                    }
                    ...
                    ops.add(ContentProviderOperation.newInsert(rawContactsURI).withValue(str3, this.systemAccount.type).withValue(str4, this.systemAccount.name).withValue("raw_contact_is_read_only", 1).withValue("aggregation_mode", 3).build());
                    ops.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI).withValueBackReference("raw_contact_id", backRef).withValue("mimetype", "vnd.android.cursor.item/name").withValue("data2", firstName).withValue("data3", lastName).build());
                    ContentProviderOperation.Builder withValue = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI).withValueBackReference("raw_contact_id", backRef).withValue("mimetype", "vnd.android.cursor.item/phone_v2");
                    ops.add(withValue.withValue("data1", "+99084" + id).build());
                    ops.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI).withValueBackReference("raw_contact_id", backRef).withValue("mimetype", "vnd.android.cursor.item/group_membership").withValue("data1", Integer.valueOf(groupID2)).build());
                    if (cursor != null) {
                    }
                    resolver.applyBatch("com.android.contacts", ops);
                    return;
