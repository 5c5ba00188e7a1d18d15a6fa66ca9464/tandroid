...
public final /* synthetic */ class ImageLoader$5$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ ImageLoader$5$$ExternalSyntheticLambda4(ImageLoader.AnonymousClass5 anonymousClass5, int i, String str, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputEncryptedFile tLRPC$InputEncryptedFile, byte[] bArr, byte[] bArr2, long j) {
