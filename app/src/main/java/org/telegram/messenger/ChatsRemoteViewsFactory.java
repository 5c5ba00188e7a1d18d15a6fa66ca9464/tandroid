    ...
    */
    public RemoteViews getViewAt(int i) {
        ...
        if (this.deleted) {
            ...
            if (DialogObject.isUserDialog(l.longValue())) {
                ...
                if (tLRPC$User != null) {
                    if (UserObject.isUserSelf(tLRPC$User)) {
                        ...
                        charSequence = LocaleController.getString("HiddenName", 2131626178);
                    } else {
            ...
            RemoteViews remoteViews3 = new RemoteViews(this.mContext.getPackageName(), 2131427351);
            remoteViews3.setTextViewText(2131230918, charSequence);
            ...
            remoteViews3.setImageViewBitmap(2131230914, createBitmap);
            ...
            if (messageObject != null) {
                ...
                int color = this.mContext.getResources().getColor(2131034149);
                if (messageObject.messageOwner instanceof TLRPC$TL_messageService) {
                    if (ChatObject.isChannel(tLRPC$Chat)) {
                        ...
                        color = this.mContext.getResources().getColor(2131034144);
                    ...
                    if (tLRPC$Chat != null && tLRPC$Chat2 == null && (!ChatObject.isChannel(tLRPC$Chat) || ChatObject.isMegagroup(tLRPC$Chat))) {
                        ...
                        try {
                            if (charSequence6 != null) {
                                ...
                                int color2 = this.mContext.getResources().getColor(2131034144);
                ...
                remoteViews3.setTextViewText(2131230919, LocaleController.stringForMessageListDate(messageObject.messageOwner.date));
                remoteViews3.setTextViewText(2131230917, charSequence2.toString());
                remoteViews3.setTextColor(2131230917, color);
            } else {
                if (tLRPC$Dialog != null && (i3 = tLRPC$Dialog.last_message_date) != 0) {
                    remoteViews3.setTextViewText(2131230919, LocaleController.stringForMessageListDate(i3));
                } else {
                    remoteViews3.setTextViewText(2131230919, charSequence5);
                }
                remoteViews3.setTextViewText(2131230917, charSequence5);
            }
            if (tLRPC$Dialog != null && (i2 = tLRPC$Dialog.unread_count) > 0) {
                remoteViews3.setTextViewText(2131230915, String.format("%d", Integer.valueOf(i2)));
            ...
            remoteViews3.setOnClickFillInIntent(2131230913, intent2);
            remoteViews3.setViewVisibility(2131230916, i == getCount() ? 8 : 0);
            return remoteViews3;
        }
    }
