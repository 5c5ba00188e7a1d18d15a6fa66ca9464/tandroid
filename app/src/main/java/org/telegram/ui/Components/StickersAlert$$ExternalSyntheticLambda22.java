...
public final /* synthetic */ class StickersAlert$$ExternalSyntheticLambda22 implements Runnable {
    ...
    public /* synthetic */ StickersAlert$$ExternalSyntheticLambda22(StickersAlert stickersAlert, TLObject tLObject, EditTextBoldCursor editTextBoldCursor, TextView textView, TextView textView2, int[] iArr) {
    ...
    public final void run() {
        this.f$0.lambda$showNameEnterAlert$26(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
