        ...
        if (this.menuTextLayout != null) {
            ...
            if (z) {
                ...
                if (f != 1.0f) {
                    ...
                    update = true;
                    expandProgress = CubicBezierInterpolator.DEFAULT.getInterpolation(this.expandProgress);
                    if (update && expandProgress > 0.0f) {
                        this.textPaint.setAlpha((int) (255.0f * expandProgress));
                    }
                    if (this.drawBackgroundDrawable) {
                        this.rectTmp.set(0.0f, 0.0f, AndroidUtilities.dp(40.0f) + ((this.menuTextLayout.getWidth() + AndroidUtilities.dp(4.0f)) * expandProgress), getMeasuredHeight());
                        canvas.drawRoundRect(this.rectTmp, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), this.paint);
                        this.backgroundDrawable.setBounds((int) this.rectTmp.left, (int) this.rectTmp.top, (int) this.rectTmp.right, (int) this.rectTmp.bottom);
                    ...
                    if (update) {
                        onTranslationChanged((this.menuTextLayout.getWidth() + AndroidUtilities.dp(4.0f)) * expandProgress);
                    }
                }
            }
            if (!z) {
