    ...
    */
    public void onEventReceived(String str, String str2) {
        ...
        switch (c) {
            ...
            case 1:
                try {
                    final String optString = new JSONObject(str2).optString("slug");
                    if (this.currentPaymentSlug != null) {
                        ...
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Components.BotWebViewContainer$$ExternalSyntheticLambda7
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                                BotWebViewContainer.this.lambda$onEventReceived$8(optString, tLObject, tLRPC$TL_error);
                            }
                        });
                    }
                    return;
