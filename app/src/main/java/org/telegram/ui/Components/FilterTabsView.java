    ...
    public class TabView extends View {
        ...
        */
        protected void onDraw(Canvas canvas) {
            ...
            float f;
            float counterWidth2;
            boolean reorderEnabled2 = !this.currentTab.isDefault || UserConfig.getInstance(UserConfig.selectedAccount).isPremium();
            boolean showRemove = !this.currentTab.isDefault && reorderEnabled2;
            if (reorderEnabled2 && FilterTabsView.this.editingAnimationProgress != 0.0f) {
                canvas.save();
                float p = FilterTabsView.this.editingAnimationProgress * (this.currentPosition % 2 == 0 ? 1.0f : -1.0f);
                canvas.translate(AndroidUtilities.dp(0.66f) * p, 0.0f);
                canvas.rotate(p, getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f);
            }
            if (FilterTabsView.this.manualScrollingToId != -1) {
                id1 = FilterTabsView.this.manualScrollingToId;
                id2 = FilterTabsView.this.selectedTabId;
            } else {
                id1 = FilterTabsView.this.selectedTabId;
                id2 = FilterTabsView.this.previousId;
            }
            if (this.currentTab.id == id1) {
                String key = FilterTabsView.this.activeTextColorKey;
                String animateToKey = FilterTabsView.this.aActiveTextColorKey;
                String otherKey2 = FilterTabsView.this.unactiveTextColorKey;
                String animateToOtherKey3 = FilterTabsView.this.aUnactiveTextColorKey;
                animateToOtherKey = animateToOtherKey3;
                unreadKey = Theme.key_chats_tabUnreadActiveBackground;
                unreadOtherKey = Theme.key_chats_tabUnreadUnactiveBackground;
                animateToOtherKey2 = key;
                unreadKey2 = animateToKey;
                otherKey = otherKey2;
            } else {
                String key2 = FilterTabsView.this.unactiveTextColorKey;
                String animateToKey2 = FilterTabsView.this.aUnactiveTextColorKey;
                String otherKey3 = FilterTabsView.this.activeTextColorKey;
                String animateToOtherKey4 = FilterTabsView.this.aUnactiveTextColorKey;
                animateToOtherKey = animateToOtherKey4;
                unreadKey = Theme.key_chats_tabUnreadUnactiveBackground;
                unreadOtherKey = Theme.key_chats_tabUnreadActiveBackground;
                animateToOtherKey2 = key2;
                unreadKey2 = animateToKey2;
                otherKey = otherKey3;
            }
            if (unreadKey2 == null) {
                if ((FilterTabsView.this.animatingIndicator || FilterTabsView.this.manualScrollingToId != -1) && (this.currentTab.id == id1 || this.currentTab.id == id2)) {
                    FilterTabsView.this.textPaint.setColor(ColorUtils.blendARGB(Theme.getColor(otherKey), Theme.getColor(animateToOtherKey2), FilterTabsView.this.animatingIndicatorProgress));
                } else {
                    FilterTabsView.this.textPaint.setColor(Theme.getColor(animateToOtherKey2));
                }
            } else {
                int color1 = Theme.getColor(animateToOtherKey2);
                int color2 = Theme.getColor(unreadKey2);
                if ((!FilterTabsView.this.animatingIndicator && FilterTabsView.this.manualScrollingToPosition == -1) || (this.currentTab.id != id1 && this.currentTab.id != id2)) {
                    FilterTabsView.this.textPaint.setColor(ColorUtils.blendARGB(color1, color2, FilterTabsView.this.animationValue));
                } else {
                    int color3 = Theme.getColor(otherKey);
                    int color4 = Theme.getColor(animateToOtherKey);
                    FilterTabsView.this.textPaint.setColor(ColorUtils.blendARGB(ColorUtils.blendARGB(color3, color4, FilterTabsView.this.animationValue), ColorUtils.blendARGB(color1, color2, FilterTabsView.this.animationValue), FilterTabsView.this.animatingIndicatorProgress));
                }
            }
            int color12 = this.animateFromTabCount;
            boolean animateCounterEnter = color12 == 0 && this.animateTabCounter;
            boolean animateCounterRemove2 = color12 > 0 && this.currentTab.counter == 0 && this.animateTabCounter;
            boolean animateCounterReplace = this.animateFromTabCount > 0 && this.currentTab.counter > 0 && this.animateTabCounter;
            if (this.currentTab.counter > 0 || animateCounterRemove2) {
                String counterText2 = animateCounterRemove2 ? String.format("%d", Integer.valueOf(this.animateFromTabCount)) : String.format("%d", Integer.valueOf(this.currentTab.counter));
                counterWidth = (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(counterText2));
                countWidth = (int) (Math.max(AndroidUtilities.dp(10.0f), counterWidth) + AndroidUtilities.dp(10.0f));
            ...
            if (showRemove && (FilterTabsView.this.isEditing || FilterTabsView.this.editingStartAnimationProgress != 0.0f)) {
                countWidth2 = (int) (countWidth + ((AndroidUtilities.dp(20.0f) - countWidth) * FilterTabsView.this.editingStartAnimationProgress));
            } else {
                countWidth2 = countWidth;
            }
            int i2 = this.currentTab.titleWidth;
            if (countWidth2 == 0 || animateCounterRemove2) {
                i = 0;
            } else {
                i = AndroidUtilities.dp((counterText != null ? 1.0f : FilterTabsView.this.editingStartAnimationProgress) * 6.0f) + countWidth2;
            }
            this.tabWidth = i2 + i;
            float textX4 = (getMeasuredWidth() - this.tabWidth) / 2.0f;
            if (!this.animateTextX) {
                textX = textX4;
            } else {
                float f2 = this.changeProgress;
                textX = (textX4 * f2) + (this.animateFromTextX * (1.0f - f2));
            }
            if (TextUtils.equals(this.currentTab.title, this.currentText)) {
                reorderEnabled = reorderEnabled2;
            } else {
                String str = this.currentTab.title;
                this.currentText = str;
                reorderEnabled = reorderEnabled2;
                CharSequence text = Emoji.replaceEmoji(str, FilterTabsView.this.textPaint.getFontMetricsInt(), AndroidUtilities.dp(15.0f), false);
                StaticLayout staticLayout = new StaticLayout(text, FilterTabsView.this.textPaint, AndroidUtilities.dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                this.textLayout = staticLayout;
                this.textHeight = staticLayout.getHeight();
                this.textOffsetX = (int) (-this.textLayout.getLineLeft(0));
            }
            float titleOffsetX = 0.0f;
            if (this.animateTextChange) {
                titleOffsetX = this.titleXOffset * (this.animateTextChangeOut ? this.changeProgress : 1.0f - this.changeProgress);
                if (this.titleAnimateStableLayout != null) {
                    canvas.save();
                    canvas.translate(this.textOffsetX + textX + titleOffsetX, ((getMeasuredHeight() - this.textHeight) / 2.0f) + 1.0f);
                    this.titleAnimateStableLayout.draw(canvas);
                    canvas.restore();
                }
                if (this.titleAnimateInLayout == null) {
                    animateCounterRemove = animateCounterRemove2;
                } else {
                    canvas.save();
                ...
                if (this.textLayout != null) {
                    canvas.save();
                    canvas.translate(this.textOffsetX + textX, ((getMeasuredHeight() - this.textHeight) / 2.0f) + 1.0f);
                    this.textLayout.draw(canvas);
                    canvas.restore();
                }
            }
            float titleOffsetX2 = titleOffsetX;
            if (animateCounterEnter || counterText != null || (showRemove && (FilterTabsView.this.isEditing || FilterTabsView.this.editingStartAnimationProgress != 0.0f))) {
                ...
                if (!Theme.hasThemeKey(unreadKey) || !Theme.hasThemeKey(unreadOtherKey)) {
                    ...
                    int color13 = Theme.getColor(unreadKey);
                    if ((!FilterTabsView.this.animatingIndicator && FilterTabsView.this.manualScrollingToPosition == -1) || (this.currentTab.id != id1 && this.currentTab.id != id2)) {
                        FilterTabsView.this.counterPaint.setColor(color13);
                    } else {
                        int color32 = Theme.getColor(unreadOtherKey);
                        FilterTabsView.this.counterPaint.setColor(ColorUtils.blendARGB(color32, color13, FilterTabsView.this.animatingIndicatorProgress));
                    }
                }
                float titleWidth2 = this.currentTab.titleWidth;
                if (this.animateTextChange) {
                    float titleWidth3 = (this.animateFromTitleWidth * (1.0f - this.changeProgress)) + (this.currentTab.titleWidth * this.changeProgress);
                    titleWidth = titleWidth3;
                } else {
                    titleWidth = titleWidth2;
                }
                if (!this.animateTextChange || this.titleAnimateOutLayout != null) {
                    x = textX + titleWidth + AndroidUtilities.dp(6.0f);
                } else {
                    x = (textX - this.titleXOffset) + titleOffsetX2 + titleWidth + AndroidUtilities.dp(6.0f);
                }
                int countTop = (getMeasuredHeight() - AndroidUtilities.dp(20.0f)) / 2;
                if (showRemove) {
                    if (!FilterTabsView.this.isEditing && FilterTabsView.this.editingStartAnimationProgress == 0.0f) {
                        textX3 = textX;
                        ...
                        int countWidth4 = countWidth2;
                        this.rect.set(x, countTop, x + w, countTop + AndroidUtilities.dp(20.0f));
                        if (!animateCounterEnter) {
                        }
                        canvas.save();
                        float s = this.changeProgress;
                        if (!animateCounterEnter) {
                        }
                        canvas.scale(s, s, this.rect.centerX(), this.rect.centerY());
                        canvas.drawRoundRect(this.rect, AndroidUtilities.density * 11.5f, AndroidUtilities.density * 11.5f, FilterTabsView.this.counterPaint);
                        if (!animateCounterReplace) {
                        }
                        if (!animateCounterEnter) {
                        }
                        ...
                        if (animateCounterReplace) {
                            float f3 = this.animateFromCountWidth;
                            if (f3 != countWidth2) {
                                float f4 = this.changeProgress;
                                f = (f3 * (1.0f - f4)) + (countWidth2 * f4);
                                float w2 = f;
                                if (animateCounterReplace) {
                                    counterWidth2 = counterWidth;
                                } else {
                                    float f5 = this.animateFromCounterWidth;
                                    float f6 = this.changeProgress;
                                    counterWidth2 = (f5 * (1.0f - f6)) + (f6 * counterWidth);
                                }
                                int countWidth42 = countWidth2;
                                this.rect.set(x, countTop, x + w2, countTop + AndroidUtilities.dp(20.0f));
                                if (!animateCounterEnter || animateCounterRemove) {
                                    canvas.save();
                                    float s2 = this.changeProgress;
                                    if (!animateCounterEnter) {
                                        s2 = 1.0f - s2;
                                    }
                                    canvas.scale(s2, s2, this.rect.centerX(), this.rect.centerY());
                                }
                                canvas.drawRoundRect(this.rect, AndroidUtilities.density * 11.5f, AndroidUtilities.density * 11.5f, FilterTabsView.this.counterPaint);
                                if (!animateCounterReplace) {
                                    float y = countTop;
                                    if (this.inCounter != null) {
                                        y += (AndroidUtilities.dp(20.0f) - (this.inCounter.getLineBottom(0) - this.inCounter.getLineTop(0))) / 2.0f;
                                    } else if (this.outCounter != null) {
                                        y += (AndroidUtilities.dp(20.0f) - (this.outCounter.getLineBottom(0) - this.outCounter.getLineTop(0))) / 2.0f;
                                    } else if (this.stableCounter != null) {
                                        y += (AndroidUtilities.dp(20.0f) - (this.stableCounter.getLineBottom(0) - this.stableCounter.getLineTop(0))) / 2.0f;
                                    }
                                    float alpha3 = 1.0f;
                                    if (showRemove) {
                                        alpha3 = 1.0f - FilterTabsView.this.editingStartAnimationProgress;
                                    }
                                    if (this.inCounter != null) {
                                        canvas.save();
                                        FilterTabsView.this.textCounterPaint.setAlpha((int) (alpha3 * 255.0f * this.changeProgress));
                                        canvas.translate(this.rect.left + ((this.rect.width() - counterWidth2) / 2.0f), ((1.0f - this.changeProgress) * AndroidUtilities.dp(15.0f)) + y);
                                        this.inCounter.draw(canvas);
                                        canvas.restore();
                                    }
                                    if (this.outCounter != null) {
                                        canvas.save();
                                        FilterTabsView.this.textCounterPaint.setAlpha((int) (alpha3 * 255.0f * (1.0f - this.changeProgress)));
                                        canvas.translate(this.rect.left + ((this.rect.width() - counterWidth2) / 2.0f), (this.changeProgress * (-AndroidUtilities.dp(15.0f))) + y);
                                        this.outCounter.draw(canvas);
                                        canvas.restore();
                                    }
                                    if (this.stableCounter != null) {
                                        canvas.save();
                                        FilterTabsView.this.textCounterPaint.setAlpha((int) (alpha3 * 255.0f));
                                        canvas.translate(this.rect.left + ((this.rect.width() - counterWidth2) / 2.0f), y);
                                    ...
                                    canvas.drawText(counterText, this.rect.left + ((this.rect.width() - counterWidth2) / 2.0f), AndroidUtilities.dp(14.5f) + countTop, FilterTabsView.this.textCounterPaint);
                                }
                                if (!animateCounterEnter || animateCounterRemove) {
                                    canvas.restore();
                                }
                                if (showRemove) {
                                    textX2 = textX3;
                                    countWidth3 = countWidth42;
                                } else if (FilterTabsView.this.isEditing || FilterTabsView.this.editingStartAnimationProgress != 0.0f) {
                                    ...
                                    textX2 = textX3;
                                    countWidth3 = countWidth42;
                                    canvas.drawLine(this.rect.centerX() - side, this.rect.centerY() - side, side + this.rect.centerX(), side + this.rect.centerY(), FilterTabsView.this.deletePaint);
                                    canvas.drawLine(this.rect.centerX() - side, side + this.rect.centerY(), side + this.rect.centerX(), this.rect.centerY() - side, FilterTabsView.this.deletePaint);
                                } else {
                                    textX2 = textX3;
                                    countWidth3 = countWidth42;
                                }
                        ...
                        int countWidth422 = countWidth2;
                        this.rect.set(x, countTop, x + w22, countTop + AndroidUtilities.dp(20.0f));
                        if (!animateCounterEnter) {
                        }
                        canvas.save();
                        float s22 = this.changeProgress;
                        if (!animateCounterEnter) {
                        }
                        canvas.scale(s22, s22, this.rect.centerX(), this.rect.centerY());
                        canvas.drawRoundRect(this.rect, AndroidUtilities.density * 11.5f, AndroidUtilities.density * 11.5f, FilterTabsView.this.counterPaint);
                        if (!animateCounterReplace) {
                        }
                        if (!animateCounterEnter) {
                ...
                int countWidth4222 = countWidth2;
                this.rect.set(x, countTop, x + w222, countTop + AndroidUtilities.dp(20.0f));
                if (!animateCounterEnter) {
                }
                canvas.save();
                float s222 = this.changeProgress;
                if (!animateCounterEnter) {
                }
                canvas.scale(s222, s222, this.rect.centerX(), this.rect.centerY());
                canvas.drawRoundRect(this.rect, AndroidUtilities.density * 11.5f, AndroidUtilities.density * 11.5f, FilterTabsView.this.counterPaint);
                if (!animateCounterReplace) {
                }
                if (!animateCounterEnter) {
                ...
                textX2 = textX;
                countWidth3 = countWidth2;
            }
            if (reorderEnabled && FilterTabsView.this.editingAnimationProgress != 0.0f) {
                canvas.restore();
            }
            this.lastTextX = textX2;
            this.lastTabCount = this.currentTab.counter;
            this.lastTitleLayout = this.textLayout;
            this.lastTitle = this.currentText;
            this.lastTitleWidth = this.currentTab.titleWidth;
            this.lastCountWidth = countWidth3;
            ...
            if (this.currentTab.isLocked || this.progressToLocked != 0.0f) {
                ...
                if (this.currentTab.isLocked) {
                    float f7 = this.progressToLocked;
                    if (f7 != 1.0f) {
                        this.progressToLocked = f7 + 0.10666667f;
                        this.progressToLocked = Utilities.clamp(this.progressToLocked, 1.0f, 0.0f);
                        unactiveColor = Theme.getColor(FilterTabsView.this.unactiveTextColorKey);
                        if (FilterTabsView.this.aUnactiveTextColorKey != null) {
                            unactiveColor = ColorUtils.blendARGB(unactiveColor, Theme.getColor(FilterTabsView.this.aUnactiveTextColorKey), FilterTabsView.this.animationValue);
                        }
                        if (FilterTabsView.this.lockDrawableColor != unactiveColor) {
                            FilterTabsView.this.lockDrawableColor = unactiveColor;
                            FilterTabsView.this.lockDrawable.setColorFilter(new PorterDuffColorFilter(unactiveColor, PorterDuff.Mode.MULTIPLY));
                        }
                        int iconX = (int) (((getMeasuredWidth() - FilterTabsView.this.lockDrawable.getIntrinsicWidth()) / 2.0f) + this.locIconXOffset);
                        int iconY = getMeasuredHeight() - AndroidUtilities.dp(12.0f);
                        FilterTabsView.this.lockDrawable.setBounds(iconX, iconY, FilterTabsView.this.lockDrawable.getIntrinsicWidth() + iconX, FilterTabsView.this.lockDrawable.getIntrinsicHeight() + iconY);
                        if (this.progressToLocked != 1.0f) {
                            FilterTabsView.this.lockDrawable.draw(canvas);
                            return;
                        }
                        canvas.save();
                        float f8 = this.progressToLocked;
                        canvas.scale(f8, f8, FilterTabsView.this.lockDrawable.getBounds().centerX(), FilterTabsView.this.lockDrawable.getBounds().centerY());
                        FilterTabsView.this.lockDrawable.draw(canvas);
                        canvas.restore();
                        return;
                    }
                ...
                int iconX2 = (int) (((getMeasuredWidth() - FilterTabsView.this.lockDrawable.getIntrinsicWidth()) / 2.0f) + this.locIconXOffset);
                int iconY2 = getMeasuredHeight() - AndroidUtilities.dp(12.0f);
                FilterTabsView.this.lockDrawable.setBounds(iconX2, iconY2, FilterTabsView.this.lockDrawable.getIntrinsicWidth() + iconX2, FilterTabsView.this.lockDrawable.getIntrinsicHeight() + iconY2);
                if (this.progressToLocked != 1.0f) {
                }
            }
        }
    ...
    public void checkTabsCounter() {
        ...
        for (int a = 0; a < N; a++) {
            ...
            if (tab.counter != this.delegate.getTabCounter(tab.id) && this.delegate.getTabCounter(tab.id) >= 0) {
                changed = true;
                int oldWidth = this.positionToWidth.get(a);
