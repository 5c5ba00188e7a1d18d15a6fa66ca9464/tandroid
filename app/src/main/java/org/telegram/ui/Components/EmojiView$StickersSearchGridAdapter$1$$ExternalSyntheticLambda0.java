...
public final /* synthetic */ class EmojiView$StickersSearchGridAdapter$1$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ EmojiView$StickersSearchGridAdapter$1$$ExternalSyntheticLambda0(EmojiView.StickersSearchGridAdapter.AnonymousClass1 anonymousClass1, TLRPC$TL_messages_getStickers tLRPC$TL_messages_getStickers, TLObject tLObject, ArrayList arrayList, LongSparseArray longSparseArray) {
    ...
    public final void run() {
        this.f$0.lambda$run$2(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
