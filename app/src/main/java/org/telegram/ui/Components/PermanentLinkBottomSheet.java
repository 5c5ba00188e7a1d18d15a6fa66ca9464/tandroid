...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, BaseFragment baseFragment, TLRPC$ChatFull tLRPC$ChatFull, long j, boolean z2) {
        ...
        textView3.setOnClickListener(new PermanentLinkBottomSheet$$ExternalSyntheticLambda0(this, tLRPC$ChatFull, baseFragment));
    ...
    public void show() {
        super.show();
        AndroidUtilities.runOnUIThread(new PermanentLinkBottomSheet$$ExternalSyntheticLambda1(this), 50L);
    }
