...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    Runnable longClickRunnable = new AnonymousClass1();
    ...
    Runnable scrollRunnable = new AnonymousClass6();
    ...
    public ImageView addIconTab(int i, Drawable drawable) {
        ...
        imageView.setTag(2131230836, Integer.valueOf(i2));
    ...
    public /* synthetic */ void lambda$addIconTab$1(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(2131230836)).intValue());
    }
    ...
    public StickerTabView addStickerIconTab(int i, Drawable drawable) {
        ...
        stickerTabView.setTag(2131230836, Integer.valueOf(i2));
        if (i2 != this.currentPosition) {
            z = false;
        }
    ...
    public void addStickerTab(TLRPC$Chat tLRPC$Chat) {
        ...
        stickerTabView.setTag(2131230836, Integer.valueOf(i));
    ...
    public View addEmojiTab(int i, Emoji.EmojiDrawable emojiDrawable, TLRPC$Document tLRPC$Document) {
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(2131230836, Integer.valueOf(i2));
        stickerTabView.setTag(2131230878, emojiDrawable);
        stickerTabView.setTag(2131230875, tLRPC$Document);
        if (i2 != this.currentPosition) {
            z = false;
        }
        stickerTabView.setSelected(z);
    ...
    public View addStickerTab(TLObject tLObject, TLRPC$Document tLRPC$Document, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        ...
        stickerTabView.setTag(2131230836, Integer.valueOf(i));
        stickerTabView.setTag(2131230878, tLRPC$TL_messages_stickerSet);
        stickerTabView.setTag(2131230875, tLRPC$Document);
        if (i == this.currentPosition) {
            z = true;
        }
    ...
    public void expandStickers(float f, boolean z) {
        if (this.expanded != z) {
            this.expanded = z;
            if (!z) {
                fling(0);
            ...
            this.expandStickerAnimator.addListener(new AnonymousClass4(z, f));
    ...
    /* renamed from: org.telegram.ui.Components.ScrollSlidingTabStrip$4 */
    /* loaded from: classes3.dex */
    public class AnonymousClass4 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$expanded;
        final /* synthetic */ float val$x;

        AnonymousClass4(boolean z, float f) {
            ScrollSlidingTabStrip.this = r1;
            this.val$expanded = z;
            this.val$x = f;
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            scrollSlidingTabStrip.expandProgress = this.val$expanded ? 1.0f : 0.0f;
            ...
            if (!this.val$expanded) {
                ...
                float scrollX = (ScrollSlidingTabStrip.this.getScrollX() + this.val$x) / (ScrollSlidingTabStrip.this.stickerTabExpandedWidth * ScrollSlidingTabStrip.this.tabsContainer.getChildCount());
                ...
                ScrollSlidingTabStrip scrollSlidingTabStrip2 = ScrollSlidingTabStrip.this;
                scrollSlidingTabStrip2.expandOffset = (scrollSlidingTabStrip2.getScrollX() + f) - f2;
            ...
            if (scrollX < min) {
                ...
                if (childAt instanceof StickerTabView) {
                    ...
                    if (stickerTabView.type == 2) {
                        Object tag = stickerTabView.getTag(2131230878);
                        Object tag2 = stickerTabView.getTag(2131230875);
                        ...
                        Object tag4 = childAt.getTag(2131230878);
                        TLRPC$Document tLRPC$Document = (TLRPC$Document) childAt.getTag(2131230875);
    ...
    */
    protected void dispatchDraw(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < this.tabsContainer.getChildCount(); i2++) {
            if (this.tabsContainer.getChildAt(i2) instanceof StickerTabView) {
                ...
                if (this.animateToExpanded) {
                    stickerTabView.setTranslationX((i2 * f3 * (1.0f - this.expandProgress)) + f4 + stickerTabView.dragOffset);
                } else {
        ...
        if (this.animateToExpanded) {
            ...
            f2 = f5 + ((this.stickerTabExpandedWidth - f5) * this.expandProgress);
        }
        if (this.animateFromPosition) {
            ...
            f = ((f - f7) * CubicBezierInterpolator.EASE_OUT_QUINT.getInterpolation(this.positionAnimationProgress)) + f7;
            invalidate();
        }
        View view = this.draggingView;
        if (view != null) {
            float f8 = this.draggingViewIndicatorOutProgress;
            if (f8 != 1.0f) {
                float f9 = f8 + 0.10666667f;
                this.draggingViewIndicatorOutProgress = f9;
                if (f9 > 1.0f) {
                    this.draggingViewIndicatorOutProgress = 1.0f;
                } else {
                    invalidate();
                }
                i = AnonymousClass7.$SwitchMap$org$telegram$ui$Components$ScrollSlidingTabStrip$Type[this.type.ordinal()];
                if (i != 1) {
                    int i3 = this.indicatorHeight;
                    if (i3 == 0) {
                        this.indicatorDrawable.setBounds((int) f, 0, (int) (f + f2), (int) height);
                    } else {
                        this.indicatorDrawable.setBounds((int) f, (int) (height - i3), (int) (f + f2), (int) height);
                    }
                } else if (i == 2) {
                    float dp = AndroidUtilities.dp(3.0f) * this.draggingViewIndicatorOutProgress;
                    this.indicatorDrawable.setBounds(((int) f) + AndroidUtilities.dp(6.0f), (int) ((height - AndroidUtilities.dp(3.0f)) + dp), (int) ((f + f2) - AndroidUtilities.dp(6.0f)), (int) (height + dp));
                }
        ...
        if (view == null) {
            float f10 = this.draggingViewIndicatorOutProgress;
            if (f10 != 0.0f) {
                float f11 = f10 - 0.10666667f;
                this.draggingViewIndicatorOutProgress = f11;
                if (f11 < 0.0f) {
                    this.draggingViewIndicatorOutProgress = 0.0f;
                } else {
                    invalidate();
                }
            }
    ...
    /* renamed from: org.telegram.ui.Components.ScrollSlidingTabStrip$5 */
    /* loaded from: classes3.dex */
    ...
    /* renamed from: org.telegram.ui.Components.ScrollSlidingTabStrip$6 */
    /* loaded from: classes3.dex */
