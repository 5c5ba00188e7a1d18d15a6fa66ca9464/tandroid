...
public final /* synthetic */ class BotWebViewMenuContainer$$ExternalSyntheticLambda8 implements DynamicAnimation.OnAnimationUpdateListener {
    ...
    public final void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f, float f2) {
        this.f$0.lambda$animateBotButton$12(dynamicAnimation, f, f2);
    }
}
