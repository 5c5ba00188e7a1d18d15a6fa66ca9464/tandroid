...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    */
    public void updateAttachState(boolean animated) {
        ...
        if (this.call.call.rtmp_stream) {
            int padding = AndroidUtilities.dp(this.showingInFullscreen ? 36.0f : 21.0f);
            this.noRtmpStreamTextView.setPadding(padding, 0, padding, 0);
        }
        ...
        boolean needDetach = this.attached;
        if (needDetach && !this.showingInFullscreen) {
            boolean needDetach2 = VoIPService.getSharedInstance() == null;
            if (GroupCallActivity.paused || (videoParticipant = this.participant) == null || (this.secondaryView == null && (!ChatObject.Call.videoIsActive(videoParticipant.participant, this.participant.presentation, this.call) || (!this.call.canStreamVideo && this.participant != this.call.videoNotAvailableParticipant)))) {
                needDetach2 = true;
            }
            if (needDetach2 || (this.primaryView == null && this.secondaryView == null && this.tabletGridView == null && !this.showingAsScrimView && !this.animateToScrimView)) {
                this.attached = false;
                saveThumb();
                if (this.textureView.currentAnimation == null && needDetach2) {
                    ...
                    animate().scaleX(0.5f).scaleY(0.5f).alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView.4
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animation) {
                            viewToRemove.setScaleX(1.0f);
                            viewToRemove.setScaleY(1.0f);
                            viewToRemove.setAlpha(1.0f);
                            GroupCallMiniTextureView.this.parentContainer.removeView(viewToRemove);
                            GroupCallMiniTextureView.this.release();
                        }
                    }).setDuration(150L).start();
                } else {
                    if (this.parentContainer.inLayout) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda7
                            @Override // java.lang.Runnable
                            public final void run() {
                                GroupCallMiniTextureView.this.m3234x7c1937a8(viewToRemove);
                            }
                        });
                    } else {
            ...
            if (groupCallGridCell3 != null || this.secondaryView != null || this.tabletGridView != null || this.showingInFullscreen) {
                ...
                if (this.participant.participant.self) {
                    videoActive = VoIPService.getSharedInstance() != null && VoIPService.getSharedInstance().getVideoState(this.participant.presentation) == 2;
                } else {
                    videoActive = (this.call.canStreamVideo || this.participant == this.call.videoNotAvailableParticipant) && ChatObject.Call.videoIsActive(this.participant.participant, this.participant.presentation, this.call);
                }
                if (this.showingInFullscreen || (!VoIPService.getSharedInstance().isFullscreen(this.participant.participant, this.participant.presentation) && !VoIPService.getSharedInstance().isFullscreen(this.participant.participant, this.participant.presentation) && videoActive)) {
                    if (BuildVars.DEBUG_PRIVATE_VERSION) {
                        for (int i = 0; i < this.attachedRenderers.size(); i++) {
                            if (this.attachedRenderers.get(i).participant.equals(this.participant)) {
                    ...
                    if (this.activity.statusIconPool.size() > 0) {
                        this.statusIcon = this.activity.statusIconPool.remove(this.activity.statusIconPool.size() - 1);
                    } else {
                    ...
                    if (this.textureView.currentAnimation == null && this.secondaryView != null && this.primaryView == null && !hasImage()) {
                        ...
                        animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView.5
                            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                            public void onAnimationEnd(Animator animation) {
                                GroupCallMiniTextureView.this.animateEnter = false;
                                GroupCallMiniTextureView.this.invalidate();
                            }
                    ...
                    if (!this.attached) {
                        ...
                        boolean useTablet = GroupCallActivity.isTabletMode && (!this.parentContainer.inFullscreenMode || (this.secondaryView == null && this.primaryView == null));
                        if (this.showingInFullscreen) {
                            size = -1;
                        } else if (this.secondaryView != null && this.primaryView == null && !this.parentContainer.inFullscreenMode) {
                            size = 0;
                        } else if (this.showingAsScrimView) {
                            size = -1;
                        } else {
                            ...
                            if (groupCallUserCell2 != null && this.primaryView == null) {
                                ...
                                if (groupCallGridCell5 != null && useTablet) {
                                    if (groupCallGridCell5 != null) {
                                        useSpanSize = true;
                                        size = -1;
                                        spanCount = groupCallGridCell5.spanCount;
                                        gridItemsCount = this.tabletGridView.gridAdapter.getItemCount();
                                    } else {
                                        size = AndroidUtilities.dp(46.0f);
                                    }
                                } else {
                                    ...
                                    if ((groupCallGridCell6 != null && groupCallUserCell2 == null) || !this.isFullscreenMode) {
                                        if (groupCallGridCell6 != null) {
                                            useSpanSize = true;
                                            size = -1;
                                            spanCount = groupCallGridCell6.spanCount;
                                        } else {
                                            size = AndroidUtilities.dp(46.0f);
                                        }
                        ...
                        if (size != 0 && (layoutParams.height != size || forceRequestLayout || this.useSpanSize != useSpanSize || ((useSpanSize && this.spanCount != spanCount) || this.gridItemsCount != gridItemsCount))) {
                            ...
                            layoutParams.width = useSpanSize ? -1 : size;
                        ...
                        if (this.participant.participant.self && !this.participant.presentation && VoIPService.getSharedInstance() != null) {
                        ...
                        if (!ChatObject.Call.videoIsActive(this.participant.participant, this.participant.presentation, this.call) || (!this.call.canStreamVideo && this.participant != this.call.videoNotAvailableParticipant)) {
                            ...
                            if (DialogObject.isUserDialog(peerId)) {
                                ...
                                this.noVideoStubLayout.avatarDrawable.setInfo(currentUser);
                                ImageLocation imageLocation2 = ImageLocation.getForUser(currentUser, 0);
                                imageLocation = imageLocation2;
                                thumbLocation = ImageLocation.getForUser(currentUser, 1);
                                currentChat = currentUser;
                            } else {
                                TLRPC.Chat currentChat2 = AccountInstance.getInstance(UserConfig.selectedAccount).getMessagesController().getChat(Long.valueOf(-peerId));
                                this.noVideoStubLayout.avatarDrawable.setInfo(currentChat2);
                                ImageLocation imageLocation3 = ImageLocation.getForChat(currentChat2, 0);
                                thumbLocation = ImageLocation.getForChat(currentChat2, 1);
                                imageLocation = imageLocation3;
                                currentChat = currentChat2;
                            }
                            Drawable thumb2 = this.noVideoStubLayout.avatarDrawable;
                            if (thumbLocation != null) {
                                Drawable drawable = ImageLoader.getInstance().getImageFromMemory(thumbLocation.location, null, "50_50");
                                thumb = thumb2;
                                if (drawable != null) {
                                    thumb = drawable;
                                }
                            ...
                            this.noVideoStubLayout.avatarImageReceiver.setImage(imageLocation4, null, thumb, null, chat, 0);
                            this.noVideoStubLayout.backgroundImageReceiver.setImage(imageLocation4, "50_50_b", new ColorDrawable(Theme.getColor(Theme.key_voipgroup_listViewBackground)), null, chat, 0);
                            hasVideoLocal = false;
                        }
                        boolean skipNoStubTransition = animated2 && this.secondaryView != null && !this.showingInFullscreen && !hasVideoLocal;
                        if (hasVideoLocal != this.hasVideo && !skipNoStubTransition) {
                            ...
                            if (animated2) {
                                ...
                                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda1
                                    ...
                                    public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                                        GroupCallMiniTextureView.this.m3235x9064ec7(valueAnimator3);
                                    }
                                });
                                this.noVideoStubAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView.6
                                    ...
                                    public void onAnimationEnd(Animator animation) {
                                        ...
                                        GroupCallMiniTextureView.this.noVideoStubLayout.setAlpha(GroupCallMiniTextureView.this.progressToNoVideoStub);
                                ...
                                this.progressToNoVideoStub = z ? 0.0f : 1.0f;
                                this.noVideoStubLayout.setVisibility(z ? 8 : 0);
                        ...
                        this.statusIcon.setParticipant(this.participant.participant, animated2);
                        ...
                        if (this.participant.presentation) {
                            if (this.participant.participant.presentation != null && this.participant.participant.presentation.paused) {
                                pausedInternal = true;
                            }
                        } else if (this.participant.participant.video != null && this.participant.participant.video.paused) {
                            pausedInternal = true;
                        }
                        if (this.videoIsPaused != pausedInternal) {
                            this.videoIsPaused = pausedInternal;
                        ...
                        if (GroupCallActivity.paused || !this.hasVideo) {
                            ...
                            if (this.participant.participant.self) {
                                ...
                                VoIPService.getSharedInstance().addRemoteSink(this.participant.participant, this.participant.presentation, this.textureView.renderer, null);
                                VoIPService.getSharedInstance().addRemoteSink(this.participant.participant, this.participant.presentation, this.textureView.renderer, null);
                                ChatObject.Call call = this.call;
                                if (call != null && call.call.rtmp_stream && !this.textureView.renderer.isFirstFrameRendered() && !this.postedNoRtmpStreamCallback) {
