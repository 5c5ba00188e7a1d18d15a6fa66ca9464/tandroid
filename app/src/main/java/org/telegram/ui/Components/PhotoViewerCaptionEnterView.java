    ...
    public class AnonymousClass2 implements TextWatcher {
        ...
        */
        public void afterTextChanged(Editable editable) {
            int charactersLeft = MessagesController.getInstance(PhotoViewerCaptionEnterView.this.currentAccount).getCaptionMaxLengthLimit() - PhotoViewerCaptionEnterView.this.messageEditText.length();
            ...
            float f = 0.0f;
            if (MessagesController.getInstance(PhotoViewerCaptionEnterView.this.currentAccount).getCaptionMaxLengthLimit() > 0) {
                int captionMaxLengthLimit = MessagesController.getInstance(PhotoViewerCaptionEnterView.this.currentAccount).getCaptionMaxLengthLimit() - PhotoViewerCaptionEnterView.this.codePointCount;
                int beforeLimit = captionMaxLengthLimit;
                if (captionMaxLengthLimit <= 100) {
                    if (beforeLimit < -9999) {
                        beforeLimit = -9999;
                    }
                    PhotoViewerCaptionEnterView.this.captionLimitView.setNumber(beforeLimit, PhotoViewerCaptionEnterView.this.captionLimitView.getVisibility() == 0);
                    ...
                    if (PhotoViewerCaptionEnterView.this.sendButtonEnabled == sendButtonEnabledLocal) {
                        PhotoViewerCaptionEnterView.this.sendButtonEnabled = sendButtonEnabledLocal;
                        if (PhotoViewerCaptionEnterView.this.sendButtonColorAnimator != null) {
                            PhotoViewerCaptionEnterView.this.sendButtonColorAnimator.cancel();
                        }
                        PhotoViewerCaptionEnterView photoViewerCaptionEnterView = PhotoViewerCaptionEnterView.this;
                        float[] fArr = new float[2];
                        fArr[0] = photoViewerCaptionEnterView.sendButtonEnabled ? 0.0f : 1.0f;
                        if (PhotoViewerCaptionEnterView.this.sendButtonEnabled) {
                            f = 1.0f;
                        }
                        fArr[1] = f;
                        photoViewerCaptionEnterView.sendButtonColorAnimator = ValueAnimator.ofFloat(fArr);
                        PhotoViewerCaptionEnterView.this.sendButtonColorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.PhotoViewerCaptionEnterView$2$$ExternalSyntheticLambda0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                PhotoViewerCaptionEnterView.AnonymousClass2.this.m2857x66ab4dd8(valueAnimator);
                            }
                        });
