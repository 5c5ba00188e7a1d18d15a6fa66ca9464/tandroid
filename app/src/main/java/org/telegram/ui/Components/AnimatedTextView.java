    ...
    public static class AnimatedTextDrawable extends Drawable {
        ...
        */
        public void setText(CharSequence text, boolean animated, boolean moveDown) {
            CharSequence text2;
            boolean animated2 = (this.currentText == null || text == null) ? false : animated;
            if (text != null) {
                text2 = text;
            } else {
                text2 = "";
            ...
            if (animated2) {
                if (isAnimating()) {
                    this.toSetText = text2;
                    this.toSetTextMoveDown = moveDown;
                    return;
                } else if (!text2.equals(this.currentText)) {
                    this.oldText = this.currentText;
                    this.currentText = text2;
                    this.currentLayout = null;
                    this.oldLayout = null;
                    final ArrayList<Integer> currentLayoutOffsets = new ArrayList<>();
                    final ArrayList<Integer> currentLayoutToOldIndex = new ArrayList<>();
                    final ArrayList<StaticLayout> currentLayoutList = new ArrayList<>();
                    final ArrayList<Integer> oldLayoutOffsets = new ArrayList<>();
                    final ArrayList<Integer> oldLayoutToCurrentIndex = new ArrayList<>();
                    final ArrayList<StaticLayout> oldLayoutList = new ArrayList<>();
                    this.currentHeight = 0;
                    this.currentWidth = 0;
                    this.oldHeight = 0;
                    this.oldWidth = 0;
                    RegionCallback onEqualRegion = new RegionCallback() { // from class: org.telegram.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda3
                        ...
                        public final void run(CharSequence charSequence, int i, int i2) {
                            AnimatedTextView.AnimatedTextDrawable.this.m2184x604cea82(oldLayoutToCurrentIndex, currentLayoutList, currentLayoutToOldIndex, oldLayoutList, currentLayoutOffsets, oldLayoutOffsets, charSequence, i, i2);
                        }
                    };
                    RegionCallback onNewPart = new RegionCallback() { // from class: org.telegram.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda1
                        @Override // org.telegram.ui.Components.AnimatedTextView.AnimatedTextDrawable.RegionCallback
                        public final void run(CharSequence charSequence, int i, int i2) {
                            AnimatedTextView.AnimatedTextDrawable.this.m2185xca7c72a1(currentLayoutOffsets, currentLayoutList, currentLayoutToOldIndex, charSequence, i, i2);
                        }
                    };
                    RegionCallback onOldPart = new RegionCallback() { // from class: org.telegram.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda2
                        @Override // org.telegram.ui.Components.AnimatedTextView.AnimatedTextDrawable.RegionCallback
                        public final void run(CharSequence charSequence, int i, int i2) {
                            AnimatedTextView.AnimatedTextDrawable.this.m2186x34abfac0(oldLayoutOffsets, oldLayoutList, oldLayoutToCurrentIndex, charSequence, i, i2);
                        }
                    };
                    CharSequence from = this.splitByWords ? new WordSequence(this.oldText) : this.oldText;
                    CharSequence to = this.splitByWords ? new WordSequence(this.currentText) : this.currentText;
                    ...
                    currentLayoutList.toArray(this.currentLayout);
                    Integer[] numArr = this.currentLayoutOffsets;
                    if (numArr == null || numArr.length != currentLayoutOffsets.size()) {
                    ...
                    if (numArr2 == null || numArr2.length != currentLayoutToOldIndex.size()) {
                    ...
                    if (staticLayoutArr2 == null || staticLayoutArr2.length != oldLayoutList.size()) {
                        this.oldLayout = new StaticLayout[oldLayoutList.size()];
                    }
                    oldLayoutList.toArray(this.oldLayout);
                    Integer[] numArr3 = this.oldLayoutOffsets;
                    if (numArr3 == null || numArr3.length != oldLayoutOffsets.size()) {
                    ...
                    if (numArr4 == null || numArr4.length != oldLayoutToCurrentIndex.size()) {
                    ...
                    ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda0
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            AnimatedTextView.AnimatedTextDrawable.this.m2187x9edb82df(valueAnimator);
                        }
                    });
            ...
            this.t = 0.0f;
            this.currentLayout = r2;
            this.currentText = text2;
            StaticLayout[] staticLayoutArr5 = {makeLayout(text2, this.bounds.width())};
            this.currentWidth = (int) this.currentLayout[0].getLineWidth(0);
            this.currentHeight = this.currentLayout[0].getHeight();
            this.currentLayoutOffsets = r2;
            Integer[] numArr5 = {0};
