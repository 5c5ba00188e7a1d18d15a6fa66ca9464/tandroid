...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat tLRPC$Chat, boolean z) {
        ...
        if (ChatObject.isChannelOrGiga(tLRPC$Chat)) {
            textView.setText(LocaleController.getString("VoipChannelRecordVoiceChat", 2131629056));
        } else {
            textView.setText(LocaleController.getString("VoipRecordVoiceChat", 2131629259));
        }
        ...
        textView2.setText(LocaleController.getString("VoipRecordVoiceChatInfo", 2131629260));
        ...
        this.positiveButton.setText(LocaleController.getString("VoipRecordStart", 2131629258));
        ...
        while (true) {
            ...
            if (i3 == 0) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordAudio", 2131629255));
            } else if (i3 == 1) {
                this.titles[i3].setText(LocaleController.getString("VoipRecordPortrait", 2131629257));
            } else {
                this.titles[i3].setText(LocaleController.getString("VoipRecordLandscape", 2131629256));
            }
    ...
    public class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                anonymousClass1.setContentDescription(LocaleController.getString("VoipRecordAudio", 2131629255));
            } else if (i == 1) {
                anonymousClass1.setContentDescription(LocaleController.getString("VoipRecordPortrait", 2131629257));
            } else {
                anonymousClass1.setContentDescription(LocaleController.getString("VoipRecordLandscape", 2131629256));
            }
