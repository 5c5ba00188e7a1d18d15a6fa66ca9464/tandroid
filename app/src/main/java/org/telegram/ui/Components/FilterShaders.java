...
public class FilterShaders {
    ...
    */
    public boolean create() {
        ...
        int fragmentShader2 = loadShader(35632, toolsFragmentShaderCode);
        ...
        int vertexShader5 = loadShader(35633, sharpenVertexShaderCode);
        int fragmentShader3 = loadShader(35632, sharpenFragmentShaderCode);
        ...
        while (true) {
            ...
            if (a < (z2 ? 2 : 1)) {
                if (a == 1 && z2) {
                    vertexShader3 = loadShader(35633, simpleVertexVideoShaderCode);
                    fragmentShader = loadShader(35632, String.format(Locale.US, rgbToHsvFragmentShaderCode, extension, sampler2D));
                } else {
                    vertexShader3 = loadShader(35633, simpleVertexShaderCode);
                    fragmentShader = loadShader(35632, String.format(Locale.US, rgbToHsvFragmentShaderCode, "", "sampler2D"));
                }
                ...
                if (this.isVideo) {
                    vertexShader = loadShader(35633, simpleVertexVideoShaderCode);
                } else {
                    vertexShader = loadShader(35633, simpleVertexShaderCode);
                }
                int fragmentShader8 = loadShader(35632, String.format(Locale.US, greenAndBlueChannelOverlayFragmentShaderCode, extension, sampler2D));
                ...
                int fragmentShader9 = loadShader(35632, stillImageHighPassFilterFragmentShaderCode);
                int vertexShader9 = loadShader(35633, simpleTwoTextureVertexShaderCode);
                ...
                int fragmentShader10 = loadShader(35632, YUCIHighPassSkinSmoothingMaskBoostFilterFragmentShaderCode);
                int vertexShader10 = loadShader(35633, simpleVertexShaderCode);
                ...
                if (this.isVideo) {
                    vertexShader2 = loadShader(35633, simpleTwoTextureVertexVideoShaderCode);
                } else {
                    vertexShader2 = loadShader(35633, simpleTwoTextureVertexShaderCode);
                }
                int fragmentShader11 = loadShader(35632, String.format(Locale.US, highpassSkinSmoothingCompositingFilterFragmentShaderString, extension, sampler2D));
