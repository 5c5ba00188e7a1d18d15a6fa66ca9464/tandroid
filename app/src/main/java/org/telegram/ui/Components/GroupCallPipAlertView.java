...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public GroupCallPipAlertView(Context context, int i) {
        ...
        this.leaveButton.setData(2131165307, -1, -3257782, 0.3f, false, LocaleController.getString("VoipGroupLeave", 2131629069), false, false);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                if (sharedInstance != null && ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("VoipChannelOpenVoiceChat", 2131628980)));
                } else {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("VoipGroupOpenVoiceChat", 2131629086)));
                }
            }
        }
    }
    ...
    */
    ...
    private void updateMembersCount() {
        ...
        if (!sharedInstance.isSwitchingStream() && (callState == 1 || callState == 2 || callState == 6 || callState == 5)) {
            this.subtitleView.setText(LocaleController.getString("VoipGroupConnecting", 2131629040));
            return;
        }
    ...
    private void updateButtons(boolean z) {
        ...
        if (sharedInstance.mutedByAdmin()) {
            this.muteButton.setData(2131165320, -1, ColorUtils.setAlphaComponent(-1, 76), 0.1f, true, LocaleController.getString("VoipMutedByAdminShort", 2131629145), true, z);
        } else {
