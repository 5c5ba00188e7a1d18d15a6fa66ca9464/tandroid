        ...
        switch (i) {
            case 0:
                if (tLRPC$StickerSet.masks) {
                    this.titleTextView.setText(LocaleController.getString("MasksRemoved", 2131626554));
                    this.subtitleTextView.setText(LocaleController.formatString("MasksRemovedInfo", 2131626555, tLRPC$StickerSet.title));
                    return;
                }
                this.titleTextView.setText(LocaleController.getString("StickersRemoved", 2131628452));
                this.subtitleTextView.setText(LocaleController.formatString("StickersRemovedInfo", 2131628453, tLRPC$StickerSet.title));
                return;
            case 1:
                if (tLRPC$StickerSet.masks) {
                    this.titleTextView.setText(LocaleController.getString("MasksArchived", 2131626545));
                    this.subtitleTextView.setText(LocaleController.formatString("MasksArchivedInfo", 2131626546, tLRPC$StickerSet.title));
                    return;
                }
                this.titleTextView.setText(LocaleController.getString("StickersArchived", 2131628445));
                this.subtitleTextView.setText(LocaleController.formatString("StickersArchivedInfo", 2131628446, tLRPC$StickerSet.title));
                return;
            case 2:
                if (tLRPC$StickerSet.masks) {
                    this.titleTextView.setText(LocaleController.getString("AddMasksInstalled", 2131624267));
                    this.subtitleTextView.setText(LocaleController.formatString("AddMasksInstalledInfo", 2131624268, tLRPC$StickerSet.title));
                    return;
                }
                this.titleTextView.setText(LocaleController.getString("AddStickersInstalled", 2131624284));
                this.subtitleTextView.setText(LocaleController.formatString("AddStickersInstalledInfo", 2131624285, tLRPC$StickerSet.title));
                return;
            case 3:
                this.titleTextView.setText(LocaleController.getString("RemovedFromRecent", 2131627906));
                this.subtitleTextView.setVisibility(8);
                return;
            case 4:
                this.titleTextView.setText(LocaleController.getString("RemovedFromFavorites", 2131627905));
                this.subtitleTextView.setVisibility(8);
                return;
            case 5:
                this.titleTextView.setText(LocaleController.getString("AddedToFavorites", 2131624303));
                this.subtitleTextView.setVisibility(8);
                return;
            case 6:
                if (!UserConfig.getInstance(UserConfig.selectedAccount).isPremium() && !MessagesController.getInstance(UserConfig.selectedAccount).premiumLocked) {
                    this.titleTextView.setText(LocaleController.formatString("LimitReachedFavoriteStickers", 2131626414, Integer.valueOf(MessagesController.getInstance(UserConfig.selectedAccount).stickersFavedLimitDefault)));
                    this.subtitleTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString("LimitReachedFavoriteStickersSubtitle", 2131626415, Integer.valueOf(MessagesController.getInstance(UserConfig.selectedAccount).stickersFavedLimitPremium)), new StickerSetBulletinLayout$$ExternalSyntheticLambda0(context)));
                    return;
                }
                this.titleTextView.setText(LocaleController.formatString("LimitReachedFavoriteStickers", 2131626414, Integer.valueOf(MessagesController.getInstance(UserConfig.selectedAccount).stickersFavedLimitPremium)));
                this.subtitleTextView.setText(LocaleController.formatString("LimitReachedFavoriteStickersSubtitlePremium", 2131626416, new Object[0]));
                return;
            case 7:
                if (!UserConfig.getInstance(UserConfig.selectedAccount).isPremium() && !MessagesController.getInstance(UserConfig.selectedAccount).premiumLocked) {
                    this.titleTextView.setText(LocaleController.formatString("LimitReachedFavoriteGifs", 2131626411, Integer.valueOf(MessagesController.getInstance(UserConfig.selectedAccount).savedGifsLimitDefault)));
                    this.subtitleTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString("LimitReachedFavoriteGifsSubtitle", 2131626412, Integer.valueOf(MessagesController.getInstance(UserConfig.selectedAccount).savedGifsLimitPremium)), new StickerSetBulletinLayout$$ExternalSyntheticLambda1(context)));
                    return;
                }
                this.titleTextView.setText(LocaleController.formatString("LimitReachedFavoriteGifs", 2131626411, Integer.valueOf(MessagesController.getInstance(UserConfig.selectedAccount).savedGifsLimitPremium)));
                this.subtitleTextView.setText(LocaleController.formatString("LimitReachedFavoriteGifsSubtitlePremium", 2131626413, new Object[0]));
                return;
            default:
                return;
        }
