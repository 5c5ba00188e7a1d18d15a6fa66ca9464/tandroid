...
public class SwipeGestureSettingsView extends FrameLayout {
    ...
    */
    protected void onDraw(Canvas canvas) {
        float f;
        super.onDraw(canvas);
        boolean changeFolder = this.picker.getValue() == 5;
        if (changeFolder) {
            ...
            if (f2 != 1.0f) {
                ...
                this.outlinePaint.setColor(Theme.getColor(Theme.key_switchTrack));
                this.linePaint.setColor(Theme.getColor(Theme.key_switchTrack));
                int right = getMeasuredWidth() - ((AndroidUtilities.dp(132.0f) + AndroidUtilities.dp(21.0f)) + AndroidUtilities.dp(16.0f));
                int left = AndroidUtilities.dp(21.0f);
                int verticalPadding = (getMeasuredHeight() - AndroidUtilities.dp(48.0f)) / 2;
                this.rect.set(left, verticalPadding, right, getMeasuredHeight() - verticalPadding);
                if (this.currentColorKey != null) {
                    this.currentColorKey = this.backgroundKeys[this.picker.getValue()];
                    this.colorProgress = 1.0f;
                    int color = ColorUtils.blendARGB(Theme.getColor(Theme.key_windowBackgroundWhite), Theme.getColor(this.currentColorKey), 0.9f);
                ...
                int color2 = ColorUtils.blendARGB(this.fromColor, ColorUtils.blendARGB(Theme.getColor(Theme.key_windowBackgroundWhite), Theme.getColor(this.currentColorKey), 0.9f), this.colorProgress);
                this.filledPaint.setColor(color2);
                canvas.drawRoundRect(this.rect, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), this.filledPaint);
                this.filledPaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                this.filledPaint.setAlpha(255);
                this.rect.set(left, verticalPadding, right - AndroidUtilities.dp(58.0f), getMeasuredHeight() - verticalPadding);
                ...
                this.filledPaint.setColor(Theme.getColor(Theme.key_switchTrack));
                this.filledPaint.setAlpha(60);
                canvas.drawCircle(this.rect.left + 0.0f, this.rect.centerY(), AndroidUtilities.dp(15.0f), this.filledPaint);
                float y = this.rect.centerY() - AndroidUtilities.dp(6.0f);
                this.linePaint.setAlpha(57);
                canvas.drawLine(this.rect.left + AndroidUtilities.dp(23.0f) + 0.0f, y, this.rect.right - AndroidUtilities.dp(68.0f), y, this.linePaint);
                float y2 = this.rect.centerY() + AndroidUtilities.dp(6.0f);
                canvas.drawLine(this.rect.left + AndroidUtilities.dp(23.0f) + 0.0f, y2, this.rect.right - AndroidUtilities.dp(23.0f), y2, this.linePaint);
                canvas.restore();
            }
        }
        if (!changeFolder) {
        ...
        this.outlinePaint.setColor(Theme.getColor(Theme.key_switchTrack));
        this.linePaint.setColor(Theme.getColor(Theme.key_switchTrack));
        int right2 = getMeasuredWidth() - ((AndroidUtilities.dp(132.0f) + AndroidUtilities.dp(21.0f)) + AndroidUtilities.dp(16.0f));
        int left2 = AndroidUtilities.dp(21.0f);
        int verticalPadding2 = (getMeasuredHeight() - AndroidUtilities.dp(48.0f)) / 2;
        this.rect.set(left2, verticalPadding2, right2, getMeasuredHeight() - verticalPadding2);
        if (this.currentColorKey != null) {
        }
        f = this.colorProgress;
        if (f != 1.0f) {
        }
        int color22 = ColorUtils.blendARGB(this.fromColor, ColorUtils.blendARGB(Theme.getColor(Theme.key_windowBackgroundWhite), Theme.getColor(this.currentColorKey), 0.9f), this.colorProgress);
        this.filledPaint.setColor(color22);
        canvas.drawRoundRect(this.rect, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), this.filledPaint);
        this.filledPaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhite));
        this.filledPaint.setAlpha(255);
        this.rect.set(left2, verticalPadding2, right2 - AndroidUtilities.dp(58.0f), getMeasuredHeight() - verticalPadding2);
        this.rect.inset(-AndroidUtilities.dp(1.0f), -AndroidUtilities.dp(1.0f));
        canvas.drawRoundRect(this.rect, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), this.filledPaint);
        this.outlinePaint.setAlpha(31);
        canvas.drawRoundRect(this.rect, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), this.outlinePaint);
        ...
        this.filledPaint.setAlpha(60);
        canvas.drawCircle(this.rect.left + 0.0f, this.rect.centerY(), AndroidUtilities.dp(15.0f), this.filledPaint);
        float y3 = this.rect.centerY() - AndroidUtilities.dp(6.0f);
        this.linePaint.setAlpha(57);
        canvas.drawLine(this.rect.left + AndroidUtilities.dp(23.0f) + 0.0f, y3, this.rect.right - AndroidUtilities.dp(68.0f), y3, this.linePaint);
        float y22 = this.rect.centerY() + AndroidUtilities.dp(6.0f);
        canvas.drawLine(this.rect.left + AndroidUtilities.dp(23.0f) + 0.0f, y22, this.rect.right - AndroidUtilities.dp(23.0f), y22, this.linePaint);
        canvas.restore();
    }
