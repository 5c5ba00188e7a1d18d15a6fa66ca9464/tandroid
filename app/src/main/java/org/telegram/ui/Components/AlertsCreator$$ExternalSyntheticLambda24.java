...
public final /* synthetic */ class AlertsCreator$$ExternalSyntheticLambda24 implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ AlertsCreator$$ExternalSyntheticLambda24(TLRPC$User tLRPC$User, AccountInstance accountInstance, CheckBoxCell[] checkBoxCellArr, long j, TLRPC$Chat tLRPC$Chat, TLRPC$EncryptedChat tLRPC$EncryptedChat, boolean z, MessagesStorage.IntCallback intCallback) {
        this.f$0 = tLRPC$User;
