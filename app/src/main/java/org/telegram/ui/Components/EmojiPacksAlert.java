...
public class EmojiPacksAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public EmojiPacksAlert(BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider, ArrayList<TLRPC$InputStickerSet> arrayList) {
        ...
        fixNavigationBar();
        this.customEmojiPacks = new AnonymousClass1(this.currentAccount, arrayList);
        ...
        this.containerView = new AnonymousClass2(context);
        this.paddingView = new AnonymousClass3(this, context);
        this.listView = new AnonymousClass4(context);
        ...
        this.listView.addItemDecoration(new AnonymousClass5());
        this.listView.setOnItemClickListener(new EmojiPacksAlert$$ExternalSyntheticLambda7(this, arrayList, baseFragment, resourcesProvider));
        this.gridLayoutManager.setReverseLayout(false);
        this.gridLayoutManager.setSpanSizeLookup(new AnonymousClass6());
    ...
    /* loaded from: classes3.dex */
    public class AnonymousClass1 extends EmojiPacksLoader {
    ...
    /* renamed from: org.telegram.ui.Components.EmojiPacksAlert$2 */
    /* loaded from: classes3.dex */
    ...
    /* renamed from: org.telegram.ui.Components.EmojiPacksAlert$3 */
    /* loaded from: classes3.dex */
    public class AnonymousClass3 extends View {
        AnonymousClass3(EmojiPacksAlert emojiPacksAlert, Context context) {
            super(context);
        }
    ...
    /* renamed from: org.telegram.ui.Components.EmojiPacksAlert$4 */
    /* loaded from: classes3.dex */
    ...
    /* renamed from: org.telegram.ui.Components.EmojiPacksAlert$5 */
    /* loaded from: classes3.dex */
    ...
    /* renamed from: org.telegram.ui.Components.EmojiPacksAlert$6 */
    /* loaded from: classes3.dex */
    ...
    public void updateLightStatusBar(boolean z) {
        ...
        if (AndroidUtilities.computePerceivedBrightness(Theme.blendOver(getThemedColor("actionBarDefault"), 855638016)) <= 0.721f) {
            z2 = false;
        }
        if (!z) {
            z3 = z2;
    ...
    public static /* synthetic */ void lambda$installSet$3(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, boolean z, BaseFragment baseFragment, Runnable runnable, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new EmojiPacksAlert$$ExternalSyntheticLambda4(tLRPC$TL_messages_stickerSet, tLRPC$TL_error, z, baseFragment, tLObject, runnable));
    }
    ...
    public static /* synthetic */ void lambda$installSet$2(TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, TLRPC$TL_error tLRPC$TL_error, boolean z, BaseFragment baseFragment, TLObject tLObject, Runnable runnable) {
        ...
        try {
            if (tLRPC$TL_error == null) {
                ...
                Toast.makeText(baseFragment.getFragmentView().getContext(), LocaleController.getString("ErrorOccurred", 2131625695), 0).show();
            }
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public void updateButton() {
        ...
        if (arrayList3.size() > 0) {
            ...
            if (arrayList3.size() == 1) {
                this.buttonView.setText(LocaleController.formatString("AddStickersCount", 2131624291, LocaleController.formatPluralString("EmojiCountButton", ((TLRPC$TL_messages_stickerSet) arrayList3.get(0)).documents.size(), new Object[0])));
            } else {
                this.buttonView.setText(LocaleController.formatString("AddStickersCount", 2131624291, LocaleController.formatPluralString("EmojiPackCount", arrayList3.size(), new Object[0])));
            }
            ...
            if (arrayList2.size() == 1) {
                this.buttonView.setText(LocaleController.formatString("RemoveStickersCount", 2131627966, LocaleController.formatPluralString("EmojiCountButton", ((TLRPC$TL_messages_stickerSet) arrayList2.get(0)).documents.size(), new Object[0])));
            } else {
                this.buttonView.setText(LocaleController.formatString("RemoveStickersCount", 2131627966, LocaleController.formatPluralString("EmojiPackCount", arrayList2.size(), new Object[0])));
            }
    ...
    public class Adapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 1) {
                ...
                textView.setText(AndroidUtilities.replaceTags(LocaleController.getString("PremiumPreviewEmojiPack", 2131627659)));
    ...
    public class EmojiPackHeader extends FrameLayout {
        ...
        public BaseFragment dummyFragment = new AnonymousClass1();
        private boolean toggled = false;
        private float toggleT = 0.0f;

        /* renamed from: org.telegram.ui.Components.EmojiPacksAlert$EmojiPackHeader$1 */
        /* loaded from: classes3.dex */
