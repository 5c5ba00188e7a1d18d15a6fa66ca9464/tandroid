...
public class GroupVoipInviteAlert extends UsersAlertBase {
    ...
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        */
        public /* synthetic */ void m2669x8591429b(String query, int searchId, ArrayList participantsCopy) {
            String[] search;
            String search2;
            String search1;
            long userId;
            ...
            while (a < N) {
                ...
                if (UserObject.isUserSelf(user)) {
                    ...
                    while (true) {
                        ...
                        search2 = search22;
                        String search23 = search3[i2];
                        if (!name.startsWith(search23)) {
                            i = found2;
                            ...
                            if (!name.contains(sb.toString())) {
                                if (tName != null) {
                                    if (!tName.startsWith(search23)) {
                                    }
                                }
                                if (user.username != null && user.username.startsWith(search23)) {
                                    found = 2;
                                }
                                if (found != 0) {
                                    i2++;
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (object instanceof TLRPC.User) {
                        ...
                        user = MessagesController.getInstance(GroupVoipInviteAlert.this.currentAccount).getUser(Long.valueOf(MessageObject.getPeerId(((TLRPC.ChannelParticipant) object).peer)));
                    } else if (object instanceof TLRPC.ChatParticipant) {
                        user = MessagesController.getInstance(GroupVoipInviteAlert.this.currentAccount).getUser(Long.valueOf(((TLRPC.ChatParticipant) object).user_id));
                    } else {
                        return;
                    }
                    ...
                    if (count == 0) {
                        ...
                        nameSearch = null;
                        nameSearch2 = null;
                        position2 = position - (count + 1);
                    }
                    if (nameSearch2 != null || un == null) {
                        username2 = null;
                        name = null;
                    } else {
                        int count2 = this.searchAdapterHelper.getGlobalSearch().size();
                        if (count2 == 0) {
                            ...
                            try {
                                ...
                                if (index2 == -1) {
                                    ...
                                    try {
                                        spannableStringBuilder.setSpan(new ForegroundColorSpan(Theme.getColor(Theme.key_voipgroup_listeningText)), index, index + len, 33);
                                    } catch (Exception e4) {
                                        e = e4;
                                        username = un;
                                        FileLog.e(e);
                                        ...
                                        userCell.setData(user, name2, username, false);
                                        return;
                                    }
                                }
                            ...
                            if (nameSearch == null) {
                                ...
                                name2 = new SpannableStringBuilder(u);
                                int idx = AndroidUtilities.indexOfIgnoreCase(u, nameSearch);
                                if (idx != -1) {
                                    name2.setSpan(new ForegroundColorSpan(Theme.getColor(Theme.key_voipgroup_listeningText)), idx, nameSearch.length() + idx, 33);
                                }
                            }
                            ManageChatUserCell userCell2 = (ManageChatUserCell) holder.itemView;
                            userCell2.setTag(Integer.valueOf(position2));
                            userCell2.setCustomImageVisible(GroupVoipInviteAlert.this.invitedUsers.contains(Long.valueOf(user.id)));
                            userCell2.setData(user, name2, username, false);
                            return;
                        }
                    }
                    username = username2;
                    ...
                    ManageChatUserCell userCell22 = (ManageChatUserCell) holder.itemView;
                    userCell22.setTag(Integer.valueOf(position2));
                    userCell22.setCustomImageVisible(GroupVoipInviteAlert.this.invitedUsers.contains(Long.valueOf(user.id)));
                    userCell22.setData(user, name2, username, false);
                    return;
                case 1:
