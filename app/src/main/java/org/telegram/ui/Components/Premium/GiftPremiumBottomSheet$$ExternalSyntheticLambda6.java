...
public final /* synthetic */ class GiftPremiumBottomSheet$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ GiftPremiumBottomSheet$$ExternalSyntheticLambda6(GiftPremiumBottomSheet giftPremiumBottomSheet, TLObject tLObject, TLRPC$TL_inputStorePaymentGiftPremium tLRPC$TL_inputStorePaymentGiftPremium, GiftPremiumBottomSheet.GiftTier giftTier, TLRPC$TL_error tLRPC$TL_error, TLRPC$TL_payments_canPurchasePremium tLRPC$TL_payments_canPurchasePremium) {
    ...
    public final void run() {
        this.f$0.lambda$onGiftPremium$7(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
