        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (!EmojiView.this.recentStickers.contains(sticker) && !EmojiView.this.favouriteStickers.contains(sticker)) {
                        z = false;
                    }
                    cell.setRecent(z);
                    return;
                case 1:
                    ...
                    if (position == this.totalItems) {
                        ...
                        if (count == null) {
                            ...
                            int height = EmojiView.this.pager.getHeight() - (((int) Math.ceil(count.intValue() / EmojiView.this.stickersGridAdapter.stickersPerRow)) * AndroidUtilities.dp(82.0f));
                            if (height > 0) {
                                i = height;
                            }
                            cell2.setHeight(i);
                ...
                case 3:
                    ...
                    boolean installing2 = EmojiView.this.installingStickerSets.indexOfKey(stickerSetCovered.set.id) >= 0;
                    if (EmojiView.this.removingStickerSets.indexOfKey(stickerSetCovered.set.id) < 0) {
                        removing = false;
                    }
                    if (installing2 || removing) {
                        if (installing2 && cell4.isInstalled()) {
                        ...
                        cell4.setAddDrawProgress(installing, false);
                        idx = !TextUtils.isEmpty(this.searchQuery) ? -1 : AndroidUtilities.indexOfIgnoreCase(stickerSetCovered.set.title, this.searchQuery);
                        if (idx < 0) {
                            cell4.setStickerSet(stickerSetCovered, false, false, idx, this.searchQuery.length());
                            return;
                        }
