                    ...
                    if (EmojiView.this.emojiTouchedX != -10000.0f) {
                        if (Math.abs(EmojiView.this.emojiTouchedX - motionEvent.getX()) > AndroidUtilities.getPixelsInCM(0.2f, true) || Math.abs(EmojiView.this.emojiTouchedY - motionEvent.getY()) > AndroidUtilities.getPixelsInCM(0.2f, false)) {
                            ...
                            if (!z5) {
                                ...
                                if (EmojiView.this.pickerView.getSelection() != i2) {
                                    try {
                                        performHapticFeedback(9, 1);
                                    } catch (Exception unused2) {
                                    }
                                }
                                EmojiView.this.pickerView.setSelection(i2);
                            }
                        }
                    }
                    z5 = false;
            ...
            public boolean onItemClick(View view, int i2) {
                ...
                if (view instanceof ImageViewEmoji) {
                    ...
                    if (EmojiData.emojiColoredMap.contains(replace)) {
                        ...
                        int dp2 = selection + AndroidUtilities.dp(selection2 - i4);
                        if (EmojiView.this.location[0] - dp2 < AndroidUtilities.dp(5.0f)) {
                            ...
                            EmojiView.this.pickerViewPopup.showAsDropDown(view, i5, (((-view.getMeasuredHeight()) - EmojiView.this.popupHeight) + ((view.getMeasuredHeight() - EmojiView.this.emojiSize) / 2)) - i3);
                        ...
                        EmojiView.this.pickerViewPopup.setFocusable(true);
                        EmojiView.this.pickerViewPopup.showAsDropDown(view, i52, (((-view.getMeasuredHeight()) - EmojiView.this.popupHeight) + ((view.getMeasuredHeight() - EmojiView.this.emojiSize) / 2)) - i3);
                        EmojiView.this.pager.requestDisallowInterceptTouchEvent(true);
                        EmojiView.this.emojiGridView.hideSelector(true);
                        return true;
            ...
            protected boolean onTabClick(int i2) {
                ...
                if (!Emoji.recentEmoji.isEmpty()) {
                    if (i2 == 0) {
                        ...
                        if (num == null) {
                            num = Integer.valueOf(EmojiView.this.emojiAdapter.sectionToPosition.get(i2));
                        }
                        EmojiView.this.emojiGridView.stopScroll();
                        EmojiView.this.scrollEmojisToPosition(num.intValue(), 0);
        ...
        public class AnonymousClass1 implements Runnable {
            ...
            */
            public void run() {
                ...
                final int access$17904 = StickersSearchGridAdapter.access$17904(stickersSearchGridAdapter);
                ...
                if (allStickers != null && !allStickers.isEmpty() && StickersSearchGridAdapter.this.searchQuery.length() > 1) {
                    ...
                    MediaDataController.getInstance(EmojiView.this.currentAccount).getEmojiSuggestions(EmojiView.this.lastSearchKeyboardLanguage, StickersSearchGridAdapter.this.searchQuery, false, new MediaDataController.KeywordResultCallback() { // from class: org.telegram.ui.Components.EmojiView.StickersSearchGridAdapter.1.1
                        ...
                        public void run(ArrayList<MediaDataController.KeywordResult> arrayList3, String str) {
                            if (access$17904 != StickersSearchGridAdapter.this.emojiSearchId) {
                                return;
                            }
