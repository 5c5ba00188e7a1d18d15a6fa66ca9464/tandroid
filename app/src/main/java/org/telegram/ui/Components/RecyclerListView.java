    ...
    public class FastScroll extends View {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case 2:
                    ...
                    if (Math.abs(event.getY() - this.startY) > this.touchSlop) {
                        this.isMoving = true;
                    }
                    if (this.isMoving) {
        ...
        */
        protected void onDraw(Canvas canvas) {
            ...
            int y = getPaddingTop() + ((int) Math.ceil(((getMeasuredHeight() - getPaddingTop()) - AndroidUtilities.dp(54.0f)) * this.progress));
            this.rect.set(this.scrollX, AndroidUtilities.dp(12.0f) + y, this.scrollX + AndroidUtilities.dp(5.0f), AndroidUtilities.dp(42.0f) + y);
            if (this.type == 0) {
                ...
                float cy = AndroidUtilities.dp(27.0f) + y;
                this.fastScrollShadowDrawable.setBounds(getMeasuredWidth() - this.fastScrollShadowDrawable.getIntrinsicWidth(), (int) (cy - (this.fastScrollShadowDrawable.getIntrinsicHeight() / 2)), getMeasuredWidth(), (int) ((this.fastScrollShadowDrawable.getIntrinsicHeight() / 2) + cy));
                this.fastScrollShadowDrawable.draw(canvas);
                canvas.drawCircle(this.scrollX + AndroidUtilities.dp(8.0f), AndroidUtilities.dp(27.0f) + y, AndroidUtilities.dp(24.0f), this.paint);
                this.paint.setColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
                canvas.save();
                canvas.translate(this.scrollX + AndroidUtilities.dp(4.0f), AndroidUtilities.dp(34.0f) + y + (AndroidUtilities.dp(2.0f) * this.bubbleProgress));
                canvas.drawPath(this.arrowPath, this.paint);
                canvas.restore();
                canvas.save();
                canvas.translate(this.scrollX + AndroidUtilities.dp(4.0f), (AndroidUtilities.dp(24.0f) + y) - (AndroidUtilities.dp(2.0f) * this.bubbleProgress));
            ...
            if (i == 0) {
                if (this.isMoving || this.bubbleProgress != 0.0f) {
                    ...
                    int y2 = y - AndroidUtilities.dp(46.0f);
                    float diff = 0.0f;
                    if (y2 <= AndroidUtilities.dp(12.0f)) {
                        diff = AndroidUtilities.dp(12.0f) - y2;
                        y2 = AndroidUtilities.dp(12.0f);
                    }
                    canvas.translate(AndroidUtilities.dp(10.0f), y2);
                    if (diff <= AndroidUtilities.dp(29.0f)) {
                        raduisBottom = AndroidUtilities.dp(44.0f);
                        raduisBottom2 = AndroidUtilities.dp(4.0f) + ((diff / AndroidUtilities.dp(29.0f)) * AndroidUtilities.dp(40.0f));
                    } else {
                        raduisBottom2 = AndroidUtilities.dp(44.0f);
                        raduisBottom = ((1.0f - ((diff - AndroidUtilities.dp(29.0f)) / AndroidUtilities.dp(29.0f))) * AndroidUtilities.dp(40.0f)) + AndroidUtilities.dp(4.0f);
                    }
                    boolean z = this.isRtl;
                    if (z) {
                        float[] fArr = this.radii;
                        if (fArr[0] == raduisBottom) {
                        }
                        if (!z) {
                            float[] fArr2 = this.radii;
                            fArr2[1] = raduisBottom;
                            fArr2[0] = raduisBottom;
                            fArr2[7] = raduisBottom2;
                            fArr2[6] = raduisBottom2;
                        } else {
                            float[] fArr3 = this.radii;
                            fArr3[3] = raduisBottom;
                            fArr3[2] = raduisBottom;
                            fArr3[5] = raduisBottom2;
                            fArr3[4] = raduisBottom2;
                        }
                        this.path.reset();
                        ...
                        if (layoutToDraw != null) {
                            ...
                            canvas.scale(f, f, this.scrollX, progressY - y2);
                ...
                canvas.save();
                float s = (this.floatingDateProgress * 0.3f) + 0.7f;
                canvas.scale(s, s, this.rect.right - AndroidUtilities.dp(12.0f), this.rect.centerY());
                float cy2 = this.rect.centerY();
                float x = (this.rect.left - (AndroidUtilities.dp(30.0f) * this.bubbleProgress)) - AndroidUtilities.dp(8.0f);
                float height = (this.letterLayout.getHeight() / 2.0f) + AndroidUtilities.dp(6.0f);
                float width = (this.replaceLayoutProgress * this.letterLayout.getWidth()) + (this.fromWidth * (1.0f - this.replaceLayoutProgress));
                this.rect.set((x - width) - AndroidUtilities.dp(36.0f), (cy2 - (this.letterLayout.getHeight() / 2.0f)) - AndroidUtilities.dp(8.0f), x - AndroidUtilities.dp(12.0f), (this.letterLayout.getHeight() / 2.0f) + cy2 + AndroidUtilities.dp(8.0f));
                int oldAlpha1 = this.paint2.getAlpha();
                int oldAlpha2 = this.letterPaint.getAlpha();
                this.paint2.setAlpha((int) (oldAlpha1 * this.floatingDateProgress));
                this.fastScrollBackgroundDrawable.setBounds((int) this.rect.left, (int) this.rect.top, (int) this.rect.right, (int) this.rect.bottom);
                ...
                float f2 = this.replaceLayoutProgress;
                if (f2 != 1.0f) {
                    float f3 = f2 + 0.10666667f;
                    this.replaceLayoutProgress = f3;
                    if (f3 > 1.0f) {
                ...
                if (this.replaceLayoutProgress == 1.0f) {
                    this.letterPaint.setAlpha((int) (oldAlpha2 * this.floatingDateProgress));
                    canvas.save();
                    canvas.translate((x - this.letterLayout.getWidth()) - AndroidUtilities.dp(24.0f), (cy2 - (this.letterLayout.getHeight() / 2.0f)) + (AndroidUtilities.dp(15.0f) * (1.0f - this.replaceLayoutProgress)));
                    ...
                    if (this.outLetterLayout != null) {
                        this.letterPaint.setAlpha((int) (oldAlpha2 * this.floatingDateProgress * (1.0f - this.replaceLayoutProgress)));
                        canvas.save();
                        canvas.translate((x - this.outLetterLayout.getWidth()) - AndroidUtilities.dp(24.0f), (cy2 - (this.outLetterLayout.getHeight() / 2.0f)) + ((this.fromTop ? -1 : 1) * AndroidUtilities.dp(15.0f) * this.replaceLayoutProgress));
                        this.outLetterLayout.draw(canvas);
                        canvas.restore();
                    }
                    if (this.inLetterLayout != null) {
                        this.letterPaint.setAlpha((int) (oldAlpha2 * this.floatingDateProgress * this.replaceLayoutProgress));
                        canvas.save();
                        canvas.translate((x - this.inLetterLayout.getWidth()) - AndroidUtilities.dp(24.0f), (cy2 - (this.inLetterLayout.getHeight() / 2.0f)) + (AndroidUtilities.dp(15.0f) * (this.fromTop ? 1 : -1) * (1.0f - this.replaceLayoutProgress)));
                    ...
                    if (this.stableLetterLayout != null) {
                        this.letterPaint.setAlpha((int) (oldAlpha2 * this.floatingDateProgress));
                        canvas.save();
                        canvas.translate((x - this.stableLetterLayout.getWidth()) - AndroidUtilities.dp(24.0f), cy2 - (this.stableLetterLayout.getHeight() / 2.0f));
                        this.stableLetterLayout.draw(canvas);
                        canvas.restore();
                    }
                    canvas.restore();
                }
                this.paint2.setAlpha(oldAlpha1);
                this.letterPaint.setAlpha(oldAlpha2);
                canvas.restore();
            }
            ...
            if ((z2 && this.letterLayout != null && this.bubbleProgress < 1.0f) || ((!z2 || this.letterLayout == null) && this.bubbleProgress > 0.0f)) {
                ...
                if (this.isMoving && this.letterLayout != null) {
                    float f4 = this.bubbleProgress + (((float) dt) / 120.0f);
                    this.bubbleProgress = f4;
                    if (f4 > 1.0f) {
                        this.bubbleProgress = 1.0f;
                    }
                } else {
                    float f5 = this.bubbleProgress - (((float) dt) / 120.0f);
            ...
            if (z3) {
                float f6 = this.floatingDateProgress;
                if (f6 != 1.0f) {
                    float f7 = f6 + (((float) dt) / 120.0f);
                    this.floatingDateProgress = f7;
                    if (f7 > 1.0f) {
