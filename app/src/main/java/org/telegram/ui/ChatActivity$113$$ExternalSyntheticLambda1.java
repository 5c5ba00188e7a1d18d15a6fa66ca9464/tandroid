...
public final /* synthetic */ class ChatActivity$113$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ ChatActivity$113$$ExternalSyntheticLambda1(ChatActivity.AnonymousClass113 anonymousClass113, int i, boolean z, ReactionsContainerLayout reactionsContainerLayout, float f, float f2, TLRPC$TL_availableReaction tLRPC$TL_availableReaction) {
        this.f$0 = anonymousClass113;
        this.f$1 = i;
        this.f$2 = z;
