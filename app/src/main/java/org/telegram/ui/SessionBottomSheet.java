...
public class SessionBottomSheet extends BottomSheet {
    ...
    public SessionBottomSheet(BaseFragment baseFragment, TLRPC$TL_authorization tLRPC$TL_authorization, boolean z, Callback callback) {
        ...
        itemView.descriptionText.setText(LocaleController.getString("Application", 2131624385));
        ...
        if (tLRPC$TL_authorization.country.length() != 0) {
            ...
            Drawable mutate2 = ContextCompat.getDrawable(parentActivity, 2131165788).mutate();
            ...
            itemView2.descriptionText.setText(LocaleController.getString("Location", 2131626490));
        ...
        if (tLRPC$TL_authorization.ip.length() != 0) {
            ...
            Drawable mutate3 = ContextCompat.getDrawable(parentActivity, 2131165773).mutate();
            ...
            itemView3.descriptionText.setText(LocaleController.getString("IpAddress", 2131626295));
        ...
        if (secretChatsEnabled(tLRPC$TL_authorization)) {
            ...
            Drawable mutate4 = ContextCompat.getDrawable(parentActivity, 2131165923).mutate();
        ...
        if (!z) {
            ...
            textView3.setText(LocaleController.getString("TerminateSession", 2131628584));
    ...
    public class AnonymousClass8 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            builder.setMessage(LocaleController.getString("TerminateSessionText", 2131628587));
            builder.setTitle(LocaleController.getString("AreYouSureSessionTitle", 2131624463));
            builder.setPositiveButton(LocaleController.getString("Terminate", 2131628580), new SessionBottomSheet$8$$ExternalSyntheticLambda0(this, this.val$callback, this.val$session));
    ...
    public void copyText(String str) {
        ...
        builder.setItems(new CharSequence[]{LocaleController.getString("Copy", 2131625256)}, new SessionBottomSheet$$ExternalSyntheticLambda0(this, str));
        builder.show();
    }

    public /* synthetic */ void lambda$copyText$1(String str, DialogInterface dialogInterface, int i) {
        ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("label", str));
        BulletinFactory.of(getContainer(), null).createCopyBulletin(LocaleController.getString("TextCopied", 2131628595)).show();
    }
        ...
        if (lowerCase2.contains("safari")) {
            ...
            if (!lowerCase2.contains("chrome")) {
                ...
                if (lowerCase.contains("ubuntu")) {
                    ...
                    i = lowerCase2.contains("ipad") ? 2131558478 : 2131558479;
                } else {
