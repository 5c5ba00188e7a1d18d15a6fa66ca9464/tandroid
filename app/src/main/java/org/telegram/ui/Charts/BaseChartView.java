...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    */
    public void drawPicker(Canvas canvas) {
        ...
        int i = PICKER_PADDING;
        int bottom = measuredHeight - i;
        int top = (getMeasuredHeight() - this.pikerHeight) - i;
        float f3 = HORIZONTAL_PADDING;
        int start2 = (int) ((this.pickerWidth * this.pickerDelegate.pickerStart) + f3);
        int end2 = (int) ((this.pickerWidth * this.pickerDelegate.pickerEnd) + f3);
        int i2 = this.transitionMode;
        if (i2 == 1) {
            int startParent = (int) ((this.pickerWidth * this.transitionParams.pickerStartOut) + f3);
            int endParent = (int) ((this.pickerWidth * this.transitionParams.pickerEndOut) + f3);
            start2 = (int) (start2 + ((startParent - start2) * (1.0f - this.transitionParams.progress)));
            end2 = (int) (end2 + ((endParent - end2) * (1.0f - this.transitionParams.progress)));
        } else if (i2 == 3) {
            float transitionAlpha2 = this.transitionParams.progress;
            start = start2;
            end = end2;
            ...
            if (this.chartData == null) {
                ...
                if (instantDraw) {
                    ...
                    canvas.clipRect(f4, (measuredHeight2 - i4) - this.pikerHeight, getMeasuredWidth() - f4, getMeasuredHeight() - i4);
                    canvas.translate(f4, (getMeasuredHeight() - i4) - this.pikerHeight);
                ...
                if (!instantDraw) {
                    ...
                    if (i5 == 2) {
                        float pY = ((bottom - top) + top) >> 1;
                        float f5 = HORIZONTAL_PADDING;
                        this.emptyPaint.setAlpha((int) ((1.0f - this.transitionParams.progress) * 255.0f));
                        canvas.save();
                        canvas.clipRect(f5, top, getMeasuredWidth() - f5, bottom);
                        canvas.scale((this.transitionParams.progress * 2.0f) + 1.0f, 1.0f, (this.pickerWidth * this.transitionParams.xPercentage) + f5, pY);
                        canvas.drawBitmap(this.bottomChartBitmap, f5, (getMeasuredHeight() - PICKER_PADDING) - this.pikerHeight, this.emptyPaint);
                        canvas.restore();
                    } else if (i5 == 1) {
                        float pY2 = ((bottom - top) + top) >> 1;
                        float f6 = HORIZONTAL_PADDING;
                        float pX = (this.pickerWidth * this.transitionParams.xPercentage) + f6;
                        if (this.transitionParams.xPercentage > 0.5f) {
                            f2 = this.pickerWidth;
                            f = this.transitionParams.xPercentage;
                        } else {
                            f2 = this.pickerWidth;
                            f = 1.0f - this.transitionParams.xPercentage;
                        }
                        float dX = f2 * f * this.transitionParams.progress;
                        canvas.save();
                        canvas.clipRect(pX - dX, top, pX + dX, bottom);
                        this.emptyPaint.setAlpha((int) (this.transitionParams.progress * 255.0f));
                        canvas.scale(this.transitionParams.progress, 1.0f, pX, pY2);
                        canvas.drawBitmap(this.bottomChartBitmap, f6, (getMeasuredHeight() - PICKER_PADDING) - this.pikerHeight, this.emptyPaint);
                        canvas.restore();
                    } else {
                        this.emptyPaint.setAlpha((int) (transitionAlpha * 255.0f));
                ...
                int i6 = DP_12;
                canvas.drawRect(f7, top, start + i6, bottom, this.unactiveBottomChartPaint);
                canvas.drawRect(end - i6, top, getMeasuredWidth() - f7, bottom, this.unactiveBottomChartPaint);
            } else {
                canvas.drawRect(f3, top, getMeasuredWidth() - f3, bottom, this.unactiveBottomChartPaint);
            }
            SharedUiComponents sharedUiComponents = this.sharedUiComponents;
            int i7 = this.pikerHeight;
            float f8 = HORIZONTAL_PADDING;
            canvas.drawBitmap(sharedUiComponents.getPickerMaskBitmap(i7, (int) (getMeasuredWidth() - (f8 * 2.0f))), f8, (getMeasuredHeight() - PICKER_PADDING) - this.pikerHeight, this.emptyPaint);
            if (this.chartData == null) {
                this.pickerRect.set(start, top, end, bottom);
                this.pickerDelegate.middlePickerArea.set(this.pickerRect);
                int i8 = this.pickerRect.top;
                int i9 = DP_1;
                int i10 = this.pickerRect.left;
                int i11 = DP_12;
                int i12 = DP_6;
                float transitionAlpha3 = i12;
                canvas.drawPath(RoundedRect(this.pathTmp, this.pickerRect.left, i8 - i9, i10 + i11, this.pickerRect.bottom + i9, i12, transitionAlpha3, true, false, false, true), this.pickerSelectorPaint);
                canvas.drawPath(RoundedRect(this.pathTmp, this.pickerRect.right - i11, this.pickerRect.top - i9, this.pickerRect.right, this.pickerRect.bottom + i9, i12, i12, false, true, true, false), this.pickerSelectorPaint);
                canvas.drawRect(this.pickerRect.left + i11, this.pickerRect.bottom, this.pickerRect.right - i11, this.pickerRect.bottom + i9, this.pickerSelectorPaint);
                canvas.drawRect(this.pickerRect.left + i11, this.pickerRect.top - i9, this.pickerRect.right - i11, this.pickerRect.top, this.pickerSelectorPaint);
                canvas.drawLine(this.pickerRect.left + i12, this.pickerRect.centerY() - i12, this.pickerRect.left + i12, this.pickerRect.centerY() + i12, this.whiteLinePaint);
                canvas.drawLine(this.pickerRect.right - i12, this.pickerRect.centerY() - i12, this.pickerRect.right - i12, this.pickerRect.centerY() + i12, this.whiteLinePaint);
                ChartPickerDelegate.CapturesData middleCap = this.pickerDelegate.getMiddleCaptured();
                int r = (this.pickerRect.bottom - this.pickerRect.top) >> 1;
                int cY = this.pickerRect.top + r;
                if (middleCap == null) {
                    ChartPickerDelegate.CapturesData lCap = this.pickerDelegate.getLeftCaptured();
                    ChartPickerDelegate.CapturesData rCap = this.pickerDelegate.getRightCaptured();
                    if (lCap != null) {
                        canvas.drawCircle(this.pickerRect.left + DP_5, cY, (r * lCap.aValue) - DP_2, this.ripplePaint);
                    }
                    if (rCap != null) {
                        canvas.drawCircle(this.pickerRect.right - DP_5, cY, (r * rCap.aValue) - DP_2, this.ripplePaint);
                    }
                }
                int cX = start;
                Rect rect = this.pickerDelegate.leftPickerArea;
                int i13 = PICKER_CAPTURE_WIDTH;
                rect.set(cX - i13, top, (i13 >> 1) + cX, bottom);
                int cX2 = end;
                this.pickerDelegate.rightPickerArea.set(cX2 - (i13 >> 1), top, i13 + cX2, bottom);
                return;
            }
            return;
        }
        ...
        int i72 = this.pikerHeight;
        float f82 = HORIZONTAL_PADDING;
        canvas.drawBitmap(sharedUiComponents2.getPickerMaskBitmap(i72, (int) (getMeasuredWidth() - (f82 * 2.0f))), f82, (getMeasuredHeight() - PICKER_PADDING) - this.pikerHeight, this.emptyPaint);
        if (this.chartData == null) {
        }
    }
