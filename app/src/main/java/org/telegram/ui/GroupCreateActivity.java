...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.animationStarted) {
                ...
                if (GroupCreateActivity.this.currentAnimation != null) {
                    ...
                    GroupCreateActivity.this.currentAnimation.addListener(new AnonymousClass1());
        ...
        public void addSpan(GroupCreateSpan groupCreateSpan) {
            ...
            GroupCreateActivity.this.currentAnimation.addListener(new AnonymousClass2());
        ...
        /* renamed from: org.telegram.ui.GroupCreateActivity$SpansContainer$2 */
        /* loaded from: classes3.dex */
        ...
        public void removeSpan(GroupCreateSpan groupCreateSpan) {
            ...
            this.animationStarted = false;
            GroupCreateActivity.this.currentAnimation = new AnimatorSet();
            GroupCreateActivity.this.currentAnimation.addListener(new AnonymousClass3(groupCreateSpan));
            GroupCreateActivity.this.currentAnimation.setDuration(150L);
        ...
        /* renamed from: org.telegram.ui.GroupCreateActivity$SpansContainer$3 */
        /* loaded from: classes3.dex */
    ...
    public View createView(Context context) {
        ...
        if (i2 == 2) {
            this.actionBar.setTitle(LocaleController.getString("ChannelAddSubscribers", 2131624869));
        } else if (this.addToGroup) {
            if (this.channelId != 0) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddSubscribers", 2131624869));
            } else {
                this.actionBar.setTitle(LocaleController.getString("GroupAddMembers", 2131626088));
            }
        ...
        anonymousClass22.setFocusableInTouchMode(true);
        anonymousClass22.setDescendantFocusability(131072);
        ...
        anonymousClass22.setClipChildren(false);
        ...
        this.listView.setOnItemClickListener(new GroupCreateActivity$$ExternalSyntheticLambda7(this, context));
        ...
        if (i5 >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new AnonymousClass9(this));
        }
    ...
    class AnonymousClass5 implements ActionMode.Callback {
        ...
        AnonymousClass5(GroupCreateActivity groupCreateActivity) {
        }
    }
        ...
        if (i == 0 && this.adapter.inviteViaLink != 0 && !this.adapter.searching) {
            ...
            if (z) {
                ...
                if (this.chatType == 0 && this.selectedContacts.size() == getMessagesController().maxGroupCount) {
                    ...
                    builder.setMessage(LocaleController.getString("SoftUserLimitAlert", 2131628377));
                    ...
                    if (this.addToGroup && tLRPC$User.bot) {
                        ...
                        if (j2 == 0 && tLRPC$User.bot_nochats) {
                            ...
                            if (ChatObject.canAddAdmins(chat)) {
                                ...
                                builder2.setMessage(LocaleController.getString("AddBotAsAdmin", 2131624252));
                                builder2.setPositiveButton(LocaleController.getString("MakeAdmin", 2131626520), new GroupCreateActivity$$ExternalSyntheticLambda0(this, tLRPC$User));
                                builder2.setNegativeButton(LocaleController.getString("Cancel", 2131624819), null);
                            } else {
                                builder2.setMessage(LocaleController.getString("CantAddBotAsAdmin", 2131624841));
    ...
    public void updateEditTextHint() {
        ...
        if (this.chatType == 2) {
            editTextBoldCursor.setHintText(LocaleController.getString("AddMutual", 2131624274));
        } else if (this.addToGroup || ((groupCreateAdapter = this.adapter) != null && groupCreateAdapter.noContactsStubRow == 0)) {
            this.editText.setHintText(LocaleController.getString("SearchForPeople", 2131628107));
            ...
            this.editText.setHintText(LocaleController.getString("SendMessageTo", 2131628203));
        }
    }
    ...
    public void showItemsAnimated(int i) {
        ...
        this.listView.getViewTreeObserver().addOnPreDrawListener(new AnonymousClass10(i));
    }
        ...
        if (this.selectedContacts.size() != 0 || this.chatType == 2) {
            if (z && this.addToGroup) {
                ...
                if (this.selectedContacts.size() > 5) {
                    ...
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", 2131624271, objArr)));
                    ...
                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", 2131624271, objArr2)));
                }
                ...
                if (!ChatObject.isChannel(chat)) {
                    ...
                    if (this.selectedContacts.size() == 1) {
                        checkBoxCellArr[0].setText(AndroidUtilities.replaceTags(LocaleController.formatString("AddOneMemberForwardMessages", 2131624276, UserObject.getFirstName(getMessagesController().getUser(Long.valueOf(this.selectedContacts.keyAt(0)))))), "", true, false);
                    } else {
                        checkBoxCellArr[0].setText(LocaleController.getString("AddMembersForwardMessages", 2131624273), "", true, false);
                    }
                ...
                builder.setPositiveButton(LocaleController.getString("Add", 2131624237), new GroupCreateActivity$$ExternalSyntheticLambda1(this, checkBoxCellArr));
    ...
    public void updateHint() {
        if (!this.isAlwaysShare && !this.isNeverShare && !this.addToGroup) {
            if (this.chatType == 2) {
                ...
                this.actionBar.setSubtitle(LocaleController.formatString("MembersCountZero", 2131626605, LocaleController.formatPluralString("Members", this.maxCount, new Object[0])));
            } else {
        ...
        if (this.chatType != 2) {
            if (this.doneButtonVisible && this.allSpans.isEmpty()) {
                ...
                this.currentDoneButtonAnimation.addListener(new AnonymousClass11());
    ...
    public class GroupCreateAdapter extends RecyclerListView.FastScrollAdapter {
        ...
        public GroupCreateAdapter(Context context) {
            ...
            if (r8.isNeverShare || r8.isAlwaysShare) {
                ...
                Collections.sort(this.contacts, new AnonymousClass1(this, r8));
            }
            SearchAdapterHelper searchAdapterHelper = new SearchAdapterHelper(false);
            this.searchAdapterHelper = searchAdapterHelper;
            searchAdapterHelper.setDelegate(new GroupCreateActivity$GroupCreateAdapter$$ExternalSyntheticLambda4(this));
        }

        /* renamed from: org.telegram.ui.GroupCreateActivity$GroupCreateAdapter$1 */
        /* loaded from: classes3.dex */
        public class AnonymousClass1 implements Comparator<TLObject> {
            AnonymousClass1(GroupCreateAdapter groupCreateAdapter, GroupCreateActivity groupCreateActivity) {
            }
        ...
        /* renamed from: org.telegram.ui.GroupCreateActivity$GroupCreateAdapter$2 */
        /* loaded from: classes3.dex */
        class AnonymousClass2 extends StickerEmptyView {
            AnonymousClass2(GroupCreateAdapter groupCreateAdapter, Context context, View view, int i) {
        ...
        /* JADX WARN: Type inference failed for: r5v5, types: [android.widget.FrameLayout, org.telegram.ui.GroupCreateActivity$GroupCreateAdapter$2, org.telegram.ui.Components.StickerEmptyView] */
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                if (i == 1) {
                    ...
                    ?? anonymousClass2 = new AnonymousClass2(this, this.context, null, 0);
                    ...
                    groupCreateUserCell = anonymousClass2;
                } else {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                groupCreateSectionCell.setText(LocaleController.getString("GlobalSearch", 2131626079));
