    ...
    public class LayoutContainer extends FrameLayout {
        ...
        */
        public boolean dispatchTouchEvent(MotionEvent ev) {
            ...
            boolean passivePreview = ActionBarLayout.this.inPreviewMode && ActionBarLayout.this.previewMenu == null;
            if ((passivePreview || ActionBarLayout.this.transitionAnimationPreviewMode) && (ev.getActionMasked() == 0 || ev.getActionMasked() == 5)) {
                return false;
            }
            if (passivePreview) {
                try {
