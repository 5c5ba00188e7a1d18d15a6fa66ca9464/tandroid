...
public class SponsoredMessageInfoView extends FrameLayout {
    public SponsoredMessageInfoView(Activity activity, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setText(LocaleController.getString("SponsoredMessageInfo", 2131628408));
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        textView.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText", resourcesProvider));
        textView.setTextSize(1, 20.0f);
        TextView textView2 = new TextView(activity);
        textView2.setText(LocaleController.getString("SponsoredMessageInfoDescription1", 2131628409));
        textView2.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText", resourcesProvider));
        textView2.setTextSize(1, 14.0f);
        textView2.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        TextView textView3 = new TextView(activity);
        textView3.setText(LocaleController.getString("SponsoredMessageInfoDescription2", 2131628410));
        textView3.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText", resourcesProvider));
        textView3.setTextSize(1, 14.0f);
        textView3.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        TextView textView4 = new TextView(activity);
        textView4.setText(LocaleController.getString("SponsoredMessageInfoDescription3", 2131628411));
        ...
        anonymousClass1.setText(LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", 2131628405));
        ...
        textView5.setText(LocaleController.getString("SponsoredMessageInfoDescription4", 2131628412));
    ...
    public class AnonymousClass2 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Browser.openUrl(this.val$context, LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", 2131628405));
        }
    }
}
