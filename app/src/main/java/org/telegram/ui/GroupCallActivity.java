...
public class GroupCallActivity extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
        ...
        public void run() {
            ...
            if (currentTime >= 86400) {
                ...
                if (currentTime < 0 && GroupCallActivity.this.scheduleStartInTextView.getTag() == null) {
                    ...
                    GroupCallActivity.this.scheduleStartInTextView.setText(LocaleController.getString("VoipChatLateBy", 2131629005));
                }
            }
    ...
    public class VolumeSlider extends FrameLayout {
        ...
        private RLottieDrawable speakerDrawable = new RLottieDrawable(2131558536, "2131558536", AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
        ...
        if (i == NotificationCenter.groupCallUpdated) {
            ...
            if ("GROUPCALL_PARTICIPANTS_TOO_MUCH".equals(str4)) {
                if (ChatObject.isChannelOrGiga(this.currentChat)) {
                    str3 = LocaleController.getString("VoipChannelTooMuch", 2131628995);
                } else {
                    str3 = LocaleController.getString("VoipGroupTooMuch", 2131629118);
                }
            } else if (!"ANONYMOUS_CALLS_DISABLED".equals(str4) && !"GROUPCALL_ANONYMOUS_FORBIDDEN".equals(str4)) {
                str3 = LocaleController.getString("ErrorOccurred", 2131625657) + "\n" + str4;
            } else if (ChatObject.isChannelOrGiga(this.currentChat)) {
                str3 = LocaleController.getString("VoipChannelJoinAnonymousAdmin", 2131628973);
            } else {
                str3 = LocaleController.getString("VoipGroupJoinAnonymousAdmin", 2131629062);
            }
            AlertDialog.Builder createSimpleAlert = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString("VoipGroupVoiceChat", 2131629130), str3);
            ...
            while (i7 < this.currentOptionsLayout.getChildCount()) {
                ...
                if ((childAt2 instanceof ActionBarMenuSubItem) && childAt2.getTag() != null && ((Integer) childAt2.getTag()).intValue() == 10) {
                    ...
                    actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(str2, i4), TextUtils.isEmpty(tLRPC$TL_groupCallParticipant2.about) ? 2131165629 : 2131165763);
                }
                i7++;
            }
            ...
            while (i7 < this.currentOptionsLayout.getChildCount()) {
                ...
                if ((childAt3 instanceof ActionBarMenuSubItem) && childAt3.getTag() != null && ((Integer) childAt3.getTag()).intValue() == 10) {
                    ...
                    actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString(str, i3), TextUtils.isEmpty(tLRPC$TL_groupCallParticipant.about) ? 2131165629 : 2131165763);
                }
                i7++;
            }
    ...
    */
    public void updateItems() {
        ...
        if (!ChatObject.canUserDoAdminAction(this.currentChat, 3) && ((ChatObject.isChannel(this.currentChat) && !this.currentChat.megagroup) || (TextUtils.isEmpty(this.currentChat.username) && !ChatObject.canUserDoAdminAction(this.currentChat, 3)))) {
            ...
            this.noiseItem.setIcon(!SharedConfig.noiseSupression ? 2131165829 : 2131165828);
            ...
            if (!ChatObject.canManageCalls(this.currentChat)) {
                ...
                if (this.call.recording) {
                    ...
                    this.recordItem.setText(LocaleController.getString("VoipGroupStopRecordCall", 2131629114));
                } else {
                    ...
                    this.recordItem.setText(LocaleController.getString("VoipGroupRecordCall", 2131629088));
                }
                if (VoIPService.getSharedInstance() != null && VoIPService.getSharedInstance().getVideoState(true) == 2) {
                    this.screenItem.setTextAndIcon(LocaleController.getString("VoipChatStopScreenCapture", 2131629011), 2131165921);
                } else {
                    this.screenItem.setTextAndIcon(LocaleController.getString("VoipChatStartScreenCapture", 2131629009), 2131165920);
                }
                ...
                if (Build.VERSION.SDK_INT < 21 || z2 || ((!this.call.canRecordVideo() && !z) || this.call.isScheduled() || isRtmpStream())) {
                    ...
                    this.screenItem.setVisibility(0);
                    this.screenItem.setTextAndIcon(LocaleController.getString("VoipChatStopScreenCapture", 2131629011), 2131165921);
                    this.screenItem.setContentDescription(LocaleController.getString("VoipChatStopScreenCapture", 2131629011));
                } else {
                    this.screenItem.setTextAndIcon(LocaleController.getString("VoipChatStartScreenCapture", 2131629009), 2131165920);
                    this.screenItem.setContentDescription(LocaleController.getString("VoipChatStartScreenCapture", 2131629009));
                    this.screenShareItem.setVisibility(8);
                    this.screenItem.setVisibility(0);
                }
    ...
    private GroupCallActivity(Context context, AccountInstance accountInstance, ChatObject.Call call, TLRPC$Chat tLRPC$Chat, TLRPC$InputPeer tLRPC$InputPeer, boolean z, String str) {
        ...
        this.bigMicDrawable = new RLottieDrawable(2131558588, "2131558588", AndroidUtilities.dp(72.0f), AndroidUtilities.dp(72.0f), true, null);
        this.handDrawables = new RLottieDrawable(2131558459, "2131558459", AndroidUtilities.dp(72.0f), AndroidUtilities.dp(72.0f), true, null);
        ...
        if (tLRPC$InputPeer != null) {
            ...
            this.scheduleStartInTextView.setText(LocaleController.getString("VoipChatStartsIn", 2131629010));
        ...
        this.leaveButton.setData((this.call == null || !isRtmpStream()) ? 2131165307 : 2131165986, -1, Theme.getColor("voipgroup_leaveButton"), 0.3f, false, LocaleController.getString("VoipGroupLeave", 2131629069), false, false);
        ...
        this.expandButton.setImageResource(2131166207);
        ...
        this.minimizeButton.setImageResource(2131166211);
        ...
        this.pipItem.setIcon((this.call == null || !isRtmpStream()) ? 2131165981 : 2131165478);
        ...
        this.screenShareItem.setIcon(2131165920);
        ...
        accountSelectCell.setTag(2131230954, 240);
        ...
        ActionBarMenuSubItem addSubItem = this.otherItem.addSubItem(1, 0, (CharSequence) LocaleController.getString("VoipGroupAllCanSpeak", 2131629030), true);
        this.everyoneItem = addSubItem;
        addSubItem.updateSelectorBackground(true, false);
        ActionBarMenuSubItem addSubItem2 = this.otherItem.addSubItem(2, 0, (CharSequence) LocaleController.getString("VoipGroupOnlyAdminsCanSpeak", 2131629081), true);
        ...
        ActionBarMenuSubItem addSubItem3 = this.otherItem.addSubItem(10, 2131165982, null, LocaleController.getString("VoipGroupAudio", 2131629032), true, false);
        this.soundItem = addSubItem3;
        addSubItem3.setItemHeight(56);
        ActionBarMenuSubItem addSubItem4 = this.otherItem.addSubItem(11, 2131165829, null, LocaleController.getString("VoipNoiseCancellation", 2131629154), true, false);
        ...
        this.permissionItem = this.otherItem.addSubItem(7, 2131165841, this.recordCallDrawable, LocaleController.getString("VoipGroupEditPermissions", 2131629047), false, false);
        this.inviteItem = this.otherItem.addSubItem(3, 2131165782, LocaleController.getString("VoipGroupShareInviteLink", 2131629099));
        this.recordCallDrawable = new RecordCallDrawable();
        this.screenItem = this.otherItem.addSubItem(9, 2131165920, LocaleController.getString("VoipChatStartScreenCapture", 2131629009));
        ActionBarMenuSubItem addSubItem5 = this.otherItem.addSubItem(5, 0, this.recordCallDrawable, LocaleController.getString("VoipGroupRecordCall", 2131629088), true, false);
    ...
    public class AnonymousClass6 extends ActionBar.ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                ...
                if (ChatObject.isChannelOrGiga(GroupCallActivity.this.currentChat)) {
                    builder.setTitle(LocaleController.getString("VoipChannelEndAlertTitle", 2131628969));
                    builder.setMessage(LocaleController.getString("VoipChannelEndAlertText", 2131628968));
                } else {
                    builder.setTitle(LocaleController.getString("VoipGroupEndAlertTitle", 2131629051));
                    builder.setMessage(LocaleController.getString("VoipGroupEndAlertText", 2131629050));
                }
                builder.setDialogButtonColorKey("voipgroup_listeningText");
                builder.setPositiveButton(LocaleController.getString("VoipGroupEnd", 2131629049), new GroupCallActivity$6$$ExternalSyntheticLambda2(this));
                ...
                if (call.recording) {
                    ...
                    builder2.setTitle(LocaleController.getString("VoipGroupStopRecordingTitle", 2131629116));
                    if (ChatObject.isChannelOrGiga(GroupCallActivity.this.currentChat)) {
                        builder2.setMessage(LocaleController.getString("VoipChannelStopRecordingText", 2131628993));
                    } else {
                        builder2.setMessage(LocaleController.getString("VoipGroupStopRecordingText", 2131629115));
                    }
                    builder2.setPositiveButton(LocaleController.getString("Stop", 2131628463), new GroupCallActivity$6$$ExternalSyntheticLambda4(this, z));
                ...
                if (ChatObject.isChannelOrGiga(GroupCallActivity.this.currentChat)) {
                    builder3.setTitle(LocaleController.getString("VoipChannelTitle", 2131628994));
                } else {
                    builder3.setTitle(LocaleController.getString("VoipGroupTitle", 2131629117));
                }
                builder3.setCheckFocusable(false);
                builder3.setNegativeButton(LocaleController.getString("Cancel", 2131624819), new GroupCallActivity$6$$ExternalSyntheticLambda1(editTextBoldCursor));
                ...
                builder3.setPositiveButton(LocaleController.getString("Save", 2131628060), new GroupCallActivity$6$$ExternalSyntheticLambda3(this, editTextBoldCursor, builder3));
                ...
                arrayList.add(LocaleController.getString("VoipAudioRoutingSpeaker", 2131628960));
                arrayList2.add(2131165982);
                arrayList3.add(0);
                if (sharedInstance.hasEarpiece()) {
                    ...
                    arrayList2.add(Integer.valueOf(sharedInstance.isHeadsetPlugged() ? 2131165978 : 2131165980));
                    arrayList3.add(1);
                }
                if (sharedInstance.isBluetoothHeadsetConnected()) {
                    String str2 = sharedInstance.currentBluetoothDeviceName;
                    if (str2 == null) {
                        str2 = LocaleController.getString("VoipAudioRoutingBluetooth", 2131628956);
                    }
                    arrayList.add(str2);
                    arrayList2.add(2131165977);
                    arrayList3.add(2);
                }
                ...
                BottomSheet.Builder items = new BottomSheet.Builder(this.val$context).setTitle(LocaleController.getString("VoipSelectAudioOutput", 2131629189), true).setItems(charSequenceArr, iArr, new GroupCallActivity$6$$ExternalSyntheticLambda0(sharedInstance, arrayList3));
        ...
        public class AnonymousClass1 extends GroupCallRecordAlert {
            ...
            public void onStartRecord(int i) {
                ...
                builder.setDialogButtonColorKey("voipgroup_listeningText");
                GroupCallActivity.this.enterEventSent = false;
                builder.setTitle(LocaleController.getString("VoipGroupStartRecordingTitle", 2131629111));
                if (i == 0) {
                    builder.setMessage(LocaleController.getString(GroupCallActivity.this.call.call.rtmp_stream ? 2131629108 : 2131629110));
                } else {
                    int i2 = 2131629109;
                    if (ChatObject.isChannelOrGiga(GroupCallActivity.this.currentChat)) {
                ...
                editTextBoldCursor.setGravity(51);
                editTextBoldCursor.setSingleLine(true);
                editTextBoldCursor.setHint(LocaleController.getString("VoipGroupSaveFileHint", 2131629093));
                editTextBoldCursor.setImeOptions(6);
                editTextBoldCursor.setHintTextColor(Theme.getColor("voipgroup_lastSeenText"));
                editTextBoldCursor.setCursorColor(Theme.getColor("voipgroup_nameText"));
                editTextBoldCursor.setCursorSize(AndroidUtilities.dp(20.0f));
                ...
                builder.setPositiveButton(LocaleController.getString("Start", 2131628413), new GroupCallActivity$6$1$$ExternalSyntheticLambda1(this, editTextBoldCursor, i));
                builder.setNegativeButton(LocaleController.getString("Cancel", 2131624819), new GroupCallActivity$6$1$$ExternalSyntheticLambda0(editTextBoldCursor));
    ...
    public class AnonymousClass18 extends RLottieImageView {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString("VoipMute", 2131629142)));
        }
    }
    ...
    public /* synthetic */ void lambda$new$19(Context context, View view) {
        ...
        if (VoIPService.getSharedInstance() != null && (VoIPService.getSharedInstance().hasEarpiece() || VoIPService.getSharedInstance().isBluetoothHeadsetConnected())) {
            ...
            if (currentAudioRoute == 2) {
                this.soundItem.setIcon(2131165977);
                this.soundItem.setSubtext(VoIPService.getSharedInstance().currentBluetoothDeviceName != null ? VoIPService.getSharedInstance().currentBluetoothDeviceName : LocaleController.getString("VoipAudioRoutingBluetooth", 2131628956));
            } else {
                int i = 2131165980;
                if (currentAudioRoute == 0) {
                    ...
                    this.soundItem.setSubtext(VoIPService.getSharedInstance().isHeadsetPlugged() ? LocaleController.getString("VoipAudioRoutingHeadset", 2131628958) : LocaleController.getString("VoipAudioRoutingPhone", 2131628959));
                } else if (currentAudioRoute == 1) {
                    if (((AudioManager) context.getSystemService("audio")).isSpeakerphoneOn()) {
                        this.soundItem.setIcon(2131165982);
                        this.soundItem.setSubtext(LocaleController.getString("VoipAudioRoutingSpeaker", 2131628960));
                    } else {
                        this.soundItem.setIcon(2131165980);
                        this.soundItem.setSubtext(LocaleController.getString("VoipAudioRoutingPhone", 2131628959));
                    }
                }
            }
        }
    ...
    public /* synthetic */ void lambda$new$29(NumberPicker numberPicker, NumberPicker numberPicker2, NumberPicker numberPicker3, TLRPC$Chat tLRPC$Chat, AccountInstance accountInstance, TLRPC$InputPeer tLRPC$InputPeer, View view) {
        ...
        if (ChatObject.isChannelOrGiga(this.currentChat)) {
            this.titleTextView.setText(LocaleController.getString("VoipChannelVoiceChat", 2131629000), true);
        } else {
            this.titleTextView.setText(LocaleController.getString("VoipGroupVoiceChat", 2131629130), true);
        }
        Calendar calendar = Calendar.getInstance();
    ...
    private void updateScheduleUI(boolean z) {
        ...
        if (!z) {
            ...
            if (ChatObject.isChannelOrGiga(this.currentChat)) {
                this.leaveItem.setText(LocaleController.getString("VoipChannelCancelChat", 2131628965));
            } else {
                this.leaveItem.setText(LocaleController.getString("VoipGroupCancelChat", 2131629037));
            }
        }
    ...
    private void initCreatedGroupCall() {
        ...
        if (!this.callInitied && (sharedInstance = VoIPService.getSharedInstance()) != null) {
            ...
            this.leaveButton.setData(isRtmpStream() ? 2131165986 : 2131165307, -1, Theme.getColor("voipgroup_leaveButton"), 0.3f, false, LocaleController.getString("VoipGroupLeave", 2131629069), false, true);
    ...
    private void updateTitle(boolean z) {
        ...
        if (call == null) {
            if (ChatObject.isChannelOrGiga(this.currentChat)) {
                this.titleTextView.setText(LocaleController.getString("VoipChannelScheduleVoiceChat", 2131628985), z);
                return;
            } else {
                this.titleTextView.setText(LocaleController.getString("VoipGroupScheduleVoiceChat", 2131629095), z);
                return;
            }
        }
        if (!TextUtils.isEmpty(call.call.title)) {
            ...
            if (ChatObject.isChannelOrGiga(this.currentChat)) {
                this.titleTextView.setText(LocaleController.getString("VoipChannelVoiceChat", 2131629000), z);
            } else {
                this.titleTextView.setText(LocaleController.getString("VoipGroupVoiceChat", 2131629130), z);
            }
        }
        ...
        if (launchActivity != null) {
            ...
            if (baseFragment instanceof ChatActivity) {
                ...
                if (str3 == null || !z) {
                    ...
                    if (ChatObject.isChannelOrGiga(this.currentChat)) {
                        str6 = LocaleController.formatString("VoipChannelInviteText", 2131628971, str4);
                    } else {
                        str6 = LocaleController.formatString("VoipGroupInviteText", 2131629059, str4);
                    }
                    str5 = str6;
                }
    ...
    */
    public void updateState(boolean z, boolean z2) {
        ...
        if (call == null || call.isScheduled()) {
            ...
            this.leaveButton.setData(isRtmpStream() ? 2131165986 : 2131165307, -1, Theme.getColor("voipgroup_leaveButton"), 0.3f, false, LocaleController.getString("Close", 2131625167), false, false);
            updateScheduleUI(false);
            return;
        }
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        ...
        if (z4) {
            i2 = 8;
            this.cameraButton.setData(2131165321, -1, 0, 1.0f, true, LocaleController.getString("VoipCamera", 2131628964), !z6, z);
        ...
        if (i != 0) {
            this.flipButton.setData(0, -1, 0, 1.0f, true, LocaleController.getString("VoipFlip", 2131629025), false, false);
    ...
    private void updateSpeakerPhoneIcon(boolean z) {
        ...
        if (sharedInstance == null || isRtmpStream()) {
            this.soundButton.setData(2131165987, -1, 0, 0.3f, true, LocaleController.getString("VoipChatShare", 2131629008), false, z);
        ...
        if (z3) {
            this.soundButton.setData(2131165304, -1, 0, 0.1f, true, LocaleController.getString("VoipAudioRoutingBluetooth", 2131628956), false, z);
        } else if (z2) {
            this.soundButton.setData(2131165318, -1, 0, 0.3f, true, LocaleController.getString("VoipSpeaker", 2131629193), false, z);
        } else if (sharedInstance.isHeadsetPlugged()) {
            this.soundButton.setData(2131165309, -1, 0, 0.1f, true, LocaleController.getString("VoipAudioRoutingHeadset", 2131628958), false, z);
        } else {
            this.soundButton.setData(2131165318, -1, 0, 0.1f, true, LocaleController.getString("VoipSpeaker", 2131629193), false, z);
        }
    ...
    */
    public void updateMuteButton(int i, boolean z) {
        ...
        if (isRtmpStream() || this.muteButtonState != i || !z) {
            ...
            if (i == 7) {
                str2 = LocaleController.getString("VoipGroupCancelReminder", 2131629039);
                customEndFrame = this.bigMicDrawable.setCustomEndFrame(202);
            } else if (i == 6) {
                str2 = LocaleController.getString("VoipGroupSetReminder", 2131629098);
                customEndFrame = this.bigMicDrawable.setCustomEndFrame(344);
            } else if (i == 5) {
                str2 = LocaleController.getString("VoipGroupStartNow", 2131629107);
                customEndFrame = this.bigMicDrawable.setCustomEndFrame(377);
            } else {
                if (i == 0) {
                    str2 = LocaleController.getString("VoipGroupUnmute", 2131629119);
                    str = LocaleController.getString("VoipHoldAndTalk", 2131629135);
                    ...
                    str2 = LocaleController.getString("VoipTapToMute", 2131629199);
                    customEndFrame = this.bigMicDrawable.setCustomEndFrame(this.muteButtonState == 4 ? 99 : 69);
                } else if (i == 4) {
                    str2 = LocaleController.getString("VoipMutedTapedForSpeak", 2131629147);
                    str = LocaleController.getString("VoipMutedTapedForSpeakInfo", 2131629148);
                    ...
                    if (i == 3) {
                        z2 = z6;
                        str2 = LocaleController.getString("Connecting", 2131625225);
                        z3 = z4;
                        str = "";
                    } else {
                        z2 = z6;
                        str2 = LocaleController.getString("VoipMutedByAdmin", 2131629143);
                        z3 = z4;
                        str = LocaleController.getString("VoipMutedTapForSpeak", 2131629146);
                    }
                    if (isRtmpStream() && i != 3 && !this.call.isScheduled()) {
                        str2 = LocaleController.getString(!z5 ? 2131629073 : 2131629054);
    ...
    public void showRecordHint(View view) {
        if (this.recordHintView == null) {
            ...
            if (ChatObject.isChannelOrGiga(this.currentChat)) {
                this.recordHintView.setText(LocaleController.getString("VoipChannelRecording", 2131628982));
            } else {
                this.recordHintView.setText(LocaleController.getString("VoipGroupRecording", 2131629089));
            }
    ...
    public void showReminderHint() {
        ...
        if (this.reminderHintView == null) {
            ...
            this.reminderHintView.setText(LocaleController.getString("VoipChatReminderHint", 2131629007));
    ...
    public static void onLeaveClick(Context context, Runnable runnable, boolean z) {
        ...
        if (ChatObject.isChannelOrGiga(chat)) {
            builder.setTitle(LocaleController.getString("VoipChannelLeaveAlertTitle", 2131628979));
            builder.setMessage(LocaleController.getString("VoipChannelLeaveAlertText", 2131628978));
        } else {
            builder.setTitle(LocaleController.getString("VoipGroupLeaveAlertTitle", 2131629072));
            builder.setMessage(LocaleController.getString("VoipGroupLeaveAlertText", 2131629071));
        }
        ...
        if (ChatObject.isChannelOrGiga(chat)) {
            checkBoxCellArr[0].setText(LocaleController.getString("VoipChannelLeaveAlertEndChat", 2131628977), "", false, false);
        } else {
            checkBoxCellArr[0].setText(LocaleController.getString("VoipGroupLeaveAlertEndChat", 2131629070), "", false, false);
        }
        ...
        builder.setView(linearLayout);
        builder.setDialogButtonColorKey("voipgroup_listeningText");
        builder.setPositiveButton(LocaleController.getString("VoipGroupLeave", 2131629069), new GroupCallActivity$$ExternalSyntheticLambda6(call, checkBoxCellArr, selfId, runnable));
        builder.setNegativeButton(LocaleController.getString("Cancel", 2131624819), null);
        if (z) {
    ...
    public void processSelectedOption(TLRPC$TL_groupCallParticipant tLRPC$TL_groupCallParticipant, long j, int i) {
        ...
        if (i == 0 || i == 2 || i == 3) {
            ...
            if (i == 2) {
                textView3.setText(LocaleController.getString("VoipGroupRemoveMemberAlertTitle2", 2131629091));
                if (ChatObject.isChannelOrGiga(this.currentChat)) {
                    textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("VoipChannelRemoveMemberAlertText2", 2131628983, str, this.currentChat.title)));
                } else {
                    textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("VoipGroupRemoveMemberAlertText2", 2131629090, str, this.currentChat.title)));
                }
            } else {
                textView3.setText(LocaleController.getString("VoipGroupAddMemberTitle", 2131629029));
                textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("VoipGroupAddMemberText", 2131629028, str, this.currentChat.title)));
            }
            ...
            if (i == 2) {
                builder.setPositiveButton(LocaleController.getString("VoipGroupUserRemove", 2131629126), new GroupCallActivity$$ExternalSyntheticLambda7(this, tLObject2));
            } else if (z) {
                builder.setPositiveButton(LocaleController.getString("VoipGroupAdd", 2131629027), new GroupCallActivity$$ExternalSyntheticLambda8(this, (TLRPC$User) tLObject2, j));
            }
            builder.setNegativeButton(LocaleController.getString("Cancel", 2131624819), null);
            AlertDialog create = builder.create();
            create.setBackgroundColor(Theme.getColor("voipgroup_dialogBackground"));
    ...
    */
    public boolean showMenuForCell(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            scrollView = new AnonymousClass55(this, getContext(), null, 0, 2131689519, anonymousClass54);
        } else {
        ...
        if (groupCallUserCell2.isSelfUser()) {
            if (groupCallUserCell2.isHandRaised()) {
                arrayList.add(LocaleController.getString("VoipGroupCancelRaiseHand", 2131629038));
                arrayList2.add(2131165756);
                arrayList3.add(7);
            }
            ...
            arrayList2.add(Integer.valueOf(TextUtils.isEmpty(tLRPC$TL_groupCallParticipant2.about) ? 2131165629 : 2131165763));
            arrayList3.add(10);
            if (peerId > 0) {
                i5 = 2131629017;
                str2 = "VoipEditName";
            ...
            if (ChatObject.canManageCalls(this.currentChat)) {
                if (!z2 || !tLRPC$TL_groupCallParticipant2.muted) {
                    if (!tLRPC$TL_groupCallParticipant2.muted || tLRPC$TL_groupCallParticipant2.can_self_unmute) {
                        arrayList.add(LocaleController.getString("VoipGroupMute", 2131629074));
                        arrayList2.add(2131165979);
                        arrayList3.add(0);
                    } else {
                        arrayList.add(LocaleController.getString("VoipGroupAllowToSpeak", 2131629031));
                        if (tLRPC$TL_groupCallParticipant2.raise_hand_rating != 0) {
                            arrayList2.add(2131165636);
                        } else {
                            arrayList2.add(2131165983);
                        }
                        arrayList3.add(1);
                    }
                }
                ...
                if (j != 0 && !ChatObject.isMegagroup(this.currentAccount, j)) {
                    arrayList.add(LocaleController.getString("VoipGroupOpenChannel", 2131629082));
                    arrayList2.add(2131165673);
                    arrayList3.add(8);
                } else {
                    arrayList.add(LocaleController.getString("VoipGroupOpenProfile", 2131629085));
                    arrayList2.add(2131165832);
                    arrayList3.add(6);
                }
                if (!z2 && ChatObject.canBlockUsers(this.currentChat)) {
                    arrayList.add(LocaleController.getString("VoipGroupUserRemove", 2131629126));
                    arrayList2.add(2131165652);
                    arrayList3.add(2);
                }
            } else {
                if (tLRPC$TL_groupCallParticipant2.muted_by_you) {
                    arrayList.add(LocaleController.getString("VoipGroupUnmuteForMe", 2131629120));
                    arrayList2.add(2131165983);
                    arrayList3.add(4);
                } else {
                    arrayList.add(LocaleController.getString("VoipGroupMuteForMe", 2131629075));
                    arrayList2.add(2131165979);
                    arrayList3.add(5);
                }
                ...
                if (j2 != 0 && !ChatObject.isMegagroup(this.currentAccount, j2)) {
                    arrayList.add(LocaleController.getString("VoipGroupOpenChannel", 2131629082));
                    arrayList2.add(2131165815);
                    arrayList3.add(8);
                } else {
                    arrayList.add(LocaleController.getString("VoipGroupOpenChat", 2131629083));
                    arrayList2.add(2131165815);
                    arrayList3.add(6);
                }
            }
        ...
        this.scrimPopupWindow.setAnimationStyle(2131689480);
        ...
        */
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (ChatObject.isChannel(GroupCallActivity.this.currentChat)) {
                    TLRPC$Chat tLRPC$Chat = GroupCallActivity.this.currentChat;
                    if (!tLRPC$Chat.megagroup && !TextUtils.isEmpty(tLRPC$Chat.username)) {
                        groupCallTextCell.setTextAndIcon(LocaleController.getString("VoipGroupShareLink", 2131629100), 2131165782, false);
                        return;
                    }
                }
                groupCallTextCell.setTextAndIcon(LocaleController.getString("VoipGroupInviteMember", 2131629058), 2131165690, false);
                return;
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                if (ChatObject.isChannelOrGiga(GroupCallActivity.this.currentChat)) {
                    textView.setText(LocaleController.formatString("VoipChannelVideoNotAvailableAdmin", 2131628998, LocaleController.formatPluralString("Participants", GroupCallActivity.this.accountInstance.getMessagesController().groupCallVideoMaxParticipants, new Object[0])));
                } else {
                    textView.setText(LocaleController.formatString("VoipVideoNotAvailableAdmin", 2131629205, LocaleController.formatPluralString("Members", GroupCallActivity.this.accountInstance.getMessagesController().groupCallVideoMaxParticipants, new Object[0])));
                }
                view = textView;
            } else {
