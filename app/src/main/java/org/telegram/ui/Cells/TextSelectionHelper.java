    ...
    public class TextSelectionOverlay extends View {
        ...
        */
        public boolean onTouchEvent(MotionEvent event) {
            ...
            int newSelection;
            int currentLine;
            int newSelectionLine;
            int i;
            boolean newIsLetter;
            int i2;
            int newSelection2;
            CharSequence text;
            int nextWhitespaceLine;
            char newChar;
            ...
            int dx = (int) (TextSelectionHelper.this.lastX - event.getX());
            int y = (int) (TextSelectionHelper.this.lastY - event.getY());
            TextSelectionHelper.this.lastX = (int) event.getX();
            TextSelectionHelper.this.lastY = (int) event.getY();
            switch (event.getAction()) {
                case 0:
                    ...
                    int y2 = (int) event.getY();
                    if (!TextSelectionHelper.this.startArea.contains(x, y2)) {
                        if (!TextSelectionHelper.this.endArea.contains(x, y2)) {
                            ...
                            if (TextSelectionHelper.this.selectedView != null) {
                                TextSelectionHelper.this.movingHandle = true;
                                TextSelectionHelper.this.movingHandleStart = false;
                                TextSelectionHelper textSelectionHelper5 = TextSelectionHelper.this;
                                int[] cords = textSelectionHelper5.offsetToCord(textSelectionHelper5.selectionEnd);
                                float textSizeHalf = TextSelectionHelper.this.getLineHeight() / 2;
                                TextSelectionHelper.this.movingOffsetX = ((cords[0] + textSelectionHelper.textX) + TextSelectionHelper.this.selectedView.getX()) - x;
                                TextSelectionHelper.this.movingOffsetY = (((cords[1] + textSelectionHelper2.textY) + TextSelectionHelper.this.selectedView.getTop()) - y2) - textSizeHalf;
                        ...
                        if (TextSelectionHelper.this.selectedView != null) {
                            TextSelectionHelper.this.movingHandle = true;
                            TextSelectionHelper.this.movingHandleStart = true;
                            TextSelectionHelper textSelectionHelper7 = TextSelectionHelper.this;
                            int[] cords2 = textSelectionHelper7.offsetToCord(textSelectionHelper7.selectionStart);
                            float textSizeHalf2 = TextSelectionHelper.this.getLineHeight() / 2;
                            TextSelectionHelper.this.movingOffsetX = ((cords2[0] + textSelectionHelper3.textX) + TextSelectionHelper.this.selectedView.getX()) - x;
                            TextSelectionHelper.this.movingOffsetY = (((cords2[1] + textSelectionHelper4.textY) + TextSelectionHelper.this.selectedView.getTop()) - y2) - textSizeHalf2;
                            TextSelectionHelper.this.hideActions();
                            return true;
                        }
                        return false;
                ...
                case 3:
                    ...
                    TextSelectionHelper.this.movingHandle = false;
                    TextSelectionHelper.this.movingDirectionSettling = false;
                    TextSelectionHelper.this.isOneTouch = false;
                    if (TextSelectionHelper.this.isSelectionMode()) {
                        TextSelectionHelper.this.showActions();
                ...
                case 2:
                    if (TextSelectionHelper.this.movingHandle) {
                        ...
                        int y3 = (int) (event.getY() + TextSelectionHelper.this.movingOffsetY);
                        int x2 = (int) (event.getX() + TextSelectionHelper.this.movingOffsetX);
                        boolean viewChanged = TextSelectionHelper.this.selectLayout(x2, y3);
                        if (TextSelectionHelper.this.selectedView != null) {
                            if (TextSelectionHelper.this.movingHandleStart) {
                                TextSelectionHelper textSelectionHelper8 = TextSelectionHelper.this;
                                textSelectionHelper8.fillLayoutForOffset(textSelectionHelper8.selectionStart, TextSelectionHelper.this.layoutBlock);
                            } else {
                                TextSelectionHelper textSelectionHelper9 = TextSelectionHelper.this;
                                textSelectionHelper9.fillLayoutForOffset(textSelectionHelper9.selectionEnd, TextSelectionHelper.this.layoutBlock);
                            }
                            StaticLayout oldTextLayout = TextSelectionHelper.this.layoutBlock.layout;
                            if (oldTextLayout != null) {
                                float oldYoffset = TextSelectionHelper.this.layoutBlock.yOffset;
                                Cell oldSelectedView = TextSelectionHelper.this.selectedView;
                                int y4 = y3 - TextSelectionHelper.this.selectedView.getTop();
                                int x3 = (int) (x2 - TextSelectionHelper.this.selectedView.getX());
                                boolean canScrollDown = event.getY() - ((float) TextSelectionHelper.this.touchSlop) > ((float) (TextSelectionHelper.this.parentView.getMeasuredHeight() - TextSelectionHelper.this.getParentBottomPadding())) && (TextSelectionHelper.this.multiselect || TextSelectionHelper.this.selectedView.getBottom() > TextSelectionHelper.this.parentView.getMeasuredHeight() - TextSelectionHelper.this.getParentBottomPadding());
                                boolean canScrollUp = event.getY() < ((float) (((View) TextSelectionHelper.this.parentView.getParent()).getTop() + TextSelectionHelper.this.getParentTopPadding())) && (TextSelectionHelper.this.multiselect || TextSelectionHelper.this.selectedView.getTop() < TextSelectionHelper.this.getParentTopPadding());
                                if (canScrollDown || canScrollUp) {
                                    if (!TextSelectionHelper.this.scrolling) {
                                        TextSelectionHelper.this.scrolling = true;
                                        AndroidUtilities.runOnUIThread(TextSelectionHelper.this.scrollRunnable);
                                    }
                                    TextSelectionHelper.this.scrollDown = canScrollDown;
                                    y4 = canScrollDown ? (int) ((TextSelectionHelper.this.parentView.getMeasuredHeight() - TextSelectionHelper.this.selectedView.getTop()) + TextSelectionHelper.this.movingOffsetY) : (int) ((-TextSelectionHelper.this.selectedView.getTop()) + TextSelectionHelper.this.movingOffsetY);
                                } else if (TextSelectionHelper.this.scrolling) {
                                    TextSelectionHelper.this.scrolling = false;
                                    AndroidUtilities.cancelRunOnUIThread(TextSelectionHelper.this.scrollRunnable);
                                }
                                TextSelectionHelper textSelectionHelper10 = TextSelectionHelper.this;
                                int newSelection3 = textSelectionHelper10.getCharOffsetFromCord(x3, y4, textSelectionHelper10.textX, TextSelectionHelper.this.textY, TextSelectionHelper.this.selectedView, false);
                                if (newSelection3 >= 0) {
                                    if (TextSelectionHelper.this.movingDirectionSettling) {
                                        if (viewChanged) {
                                            return true;
                                        }
                                        if (newSelection3 < TextSelectionHelper.this.selectionStart) {
                                            TextSelectionHelper.this.movingDirectionSettling = false;
                                            TextSelectionHelper.this.movingHandleStart = true;
                                            TextSelectionHelper.this.hideActions();
                                        } else if (newSelection3 <= TextSelectionHelper.this.selectionEnd) {
                                            return true;
                                        } else {
                                            TextSelectionHelper.this.movingDirectionSettling = false;
                                            TextSelectionHelper.this.movingHandleStart = false;
                                    ...
                                    if (!TextSelectionHelper.this.movingHandleStart) {
                                        ...
                                        if (newSelection != TextSelectionHelper.this.selectionEnd && TextSelectionHelper.this.canSelect(newSelection)) {
                                            TextSelectionHelper textSelectionHelper11 = TextSelectionHelper.this;
                                            CharSequence text2 = textSelectionHelper11.getText(textSelectionHelper11.selectedView, false);
                                            int nextWhitespace = newSelection;
                                            while (nextWhitespace < text2.length() && TextSelectionHelper.isInterruptedCharacter(text2.charAt(nextWhitespace))) {
                                                nextWhitespace++;
                                            }
                                            TextSelectionHelper textSelectionHelper12 = TextSelectionHelper.this;
                                            textSelectionHelper12.fillLayoutForOffset(newSelection, textSelectionHelper12.layoutBlock);
                                            StaticLayout layoutOld = TextSelectionHelper.this.layoutBlock.layout;
                                            TextSelectionHelper textSelectionHelper13 = TextSelectionHelper.this;
                                            textSelectionHelper13.fillLayoutForOffset(textSelectionHelper13.selectionEnd, TextSelectionHelper.this.layoutBlock);
                                            StaticLayout layoutNew = TextSelectionHelper.this.layoutBlock.layout;
                                            if (layoutOld != null && layoutNew != null) {
                                                if (newSelection > text2.length()) {
                                                    newSelection = text2.length();
                                                }
                                                int nextWhitespaceLine2 = layoutNew.getLineForOffset(nextWhitespace);
                                                int currentLine2 = layoutNew.getLineForOffset(TextSelectionHelper.this.selectionEnd);
                                                int newSelectionLine2 = layoutNew.getLineForOffset(newSelection);
                                                if (viewChanged || layoutOld != layoutNew) {
                                                    newSelectionLine = newSelectionLine2;
                                                    currentLine = currentLine2;
                                                } else if (newSelectionLine2 == layoutNew.getLineForOffset(TextSelectionHelper.this.selectionEnd) || newSelectionLine2 != nextWhitespaceLine2) {
                                                    if (-1 != layoutNew.getParagraphDirection(layoutNew.getLineForOffset(newSelection)) && !layoutNew.isRtlCharAt(newSelection) && currentLine2 == nextWhitespaceLine2) {
                                                        if (newSelectionLine2 == nextWhitespaceLine2) {
                                                            int previousWhitespace = newSelection;
                                                            while (previousWhitespace - 1 >= 0 && TextSelectionHelper.isInterruptedCharacter(text2.charAt(previousWhitespace - 1))) {
                                                                previousWhitespace--;
                                                            }
                                                            ...
                                                            if (newSelection - 1 > 0) {
                                                                int previousWhitespace2 = newSelection - 1;
                                                                if (TextSelectionHelper.isInterruptedCharacter(text2.charAt(previousWhitespace2))) {
                                                                    newIsLetter = true;
                                                                    if (!TextSelectionHelper.this.snap) {
                                                                        TextSelectionHelper.this.snap = dx <= 0;
                                                                    }
                                                                    boolean previousIsLetter = TextSelectionHelper.this.selectionEnd <= 0 && TextSelectionHelper.isInterruptedCharacter(text2.charAt(TextSelectionHelper.this.selectionEnd - 1));
                                                                    if ((newSelection <= TextSelectionHelper.this.selectionEnd && distanceToNextWhitespace <= distanceToPreviousWhitespace) || ((newSelection < TextSelectionHelper.this.selectionEnd && dx > 0) || !newIsLetter || (previousIsLetter && !TextSelectionHelper.this.snap))) {
                                                                        if (newSelection > TextSelectionHelper.this.selectionEnd && newIsLetter) {
                                                                            if (!previousIsLetter || TextSelectionHelper.this.snap) {
                                                                                TextSelectionHelper.this.selectionEnd = nextWhitespace;
                                                                                TextSelectionHelper.this.snap = true;
                                                                                if (TextSelectionHelper.this.selectionStart <= TextSelectionHelper.this.selectionEnd) {
                                                                                    int k = TextSelectionHelper.this.selectionEnd;
                                                                                    TextSelectionHelper textSelectionHelper14 = TextSelectionHelper.this;
                                                                                    textSelectionHelper14.selectionEnd = textSelectionHelper14.selectionStart;
                                                                                    TextSelectionHelper.this.selectionStart = k;
                                                                                    i2 = 1;
                                                                                    TextSelectionHelper.this.movingHandleStart = true;
                                                                                } else {
                                                                                    i2 = 1;
                                                                                ...
                                                                                if (Build.VERSION.SDK_INT >= 27) {
                                                                                    TextSelectionHelper.this.textSelectionOverlay.performHapticFeedback(9, i2);
                                                                                }
                                                                                TextSelectionHelper.this.invalidate();
                                                                            }
                                                                        }
                                                                        TextSelectionHelper.this.selectionEnd = newSelection;
                                                                        if (TextSelectionHelper.this.selectionStart <= TextSelectionHelper.this.selectionEnd) {
                                                                        }
                                                                        if (Build.VERSION.SDK_INT >= 27) {
                                                                        }
                                                            ...
                                                            boolean previousIsLetter2 = TextSelectionHelper.this.selectionEnd <= 0 && TextSelectionHelper.isInterruptedCharacter(text2.charAt(TextSelectionHelper.this.selectionEnd - 1));
                                                            if (newSelection <= TextSelectionHelper.this.selectionEnd) {
                                                            }
                                                        }
                                                    }
                                                    TextSelectionHelper.this.selectionEnd = newSelection;
                                                    if (TextSelectionHelper.this.selectionStart <= TextSelectionHelper.this.selectionEnd) {
                                                        ...
                                                        int k2 = TextSelectionHelper.this.selectionEnd;
                                                        TextSelectionHelper textSelectionHelper15 = TextSelectionHelper.this;
                                                        textSelectionHelper15.selectionEnd = textSelectionHelper15.selectionStart;
                                                        TextSelectionHelper.this.selectionStart = k2;
                                                        i = 1;
                                                        TextSelectionHelper.this.movingHandleStart = true;
                                                    }
                                                    if (Build.VERSION.SDK_INT >= 27) {
                                                        TextSelectionHelper.this.textSelectionOverlay.performHapticFeedback(9, i);
                                                    }
                                                    TextSelectionHelper.this.invalidate();
                                                } else {
                                                    newSelectionLine = newSelectionLine2;
                                                ...
                                                textSelectionHelper16.jumpToLine(newSelection, nextWhitespace, viewChanged, textSelectionHelper16.layoutBlock.yOffset, oldYoffset, oldSelectedView);
                                                if (Build.VERSION.SDK_INT >= 27) {
                                    ...
                                    } else if (TextSelectionHelper.this.selectionStart != newSelection3 && TextSelectionHelper.this.canSelect(newSelection3)) {
                                        TextSelectionHelper textSelectionHelper17 = TextSelectionHelper.this;
                                        CharSequence text3 = textSelectionHelper17.getText(textSelectionHelper17.selectedView, false);
                                        TextSelectionHelper textSelectionHelper18 = TextSelectionHelper.this;
                                        textSelectionHelper18.fillLayoutForOffset(newSelection3, textSelectionHelper18.layoutBlock);
                                        StaticLayout layoutOld2 = TextSelectionHelper.this.layoutBlock.layout;
                                        TextSelectionHelper textSelectionHelper19 = TextSelectionHelper.this;
                                        textSelectionHelper19.fillLayoutForOffset(textSelectionHelper19.selectionStart, TextSelectionHelper.this.layoutBlock);
                                        StaticLayout layoutNew2 = TextSelectionHelper.this.layoutBlock.layout;
                                        if (layoutOld2 != null && layoutNew2 != null) {
                                            int nextWhitespace2 = newSelection3;
                                            while (nextWhitespace2 - 1 >= 0 && TextSelectionHelper.isInterruptedCharacter(text3.charAt(nextWhitespace2 - 1))) {
                                                nextWhitespace2--;
                                            }
                                            int nextWhitespaceLine3 = layoutNew2.getLineForOffset(nextWhitespace2);
                                            int currentLine3 = layoutNew2.getLineForOffset(TextSelectionHelper.this.selectionStart);
                                            int newSelectionLine3 = layoutNew2.getLineForOffset(newSelection3);
                                            if (viewChanged || layoutOld2 != layoutNew2) {
                                                nextWhitespaceLine = nextWhitespaceLine3;
                                                text = text3;
                                            } else if (newSelectionLine3 == layoutNew2.getLineForOffset(TextSelectionHelper.this.selectionStart) || newSelectionLine3 != nextWhitespaceLine3) {
                                                if (-1 != layoutNew2.getParagraphDirection(layoutNew2.getLineForOffset(newSelection3)) && !layoutNew2.isRtlCharAt(newSelection3) && nextWhitespaceLine3 == currentLine3) {
                                                    if (newSelectionLine3 == nextWhitespaceLine3) {
                                                        int previousWhitespace3 = newSelection3;
                                                        while (true) {
                                                            StaticLayout layoutNew3 = layoutNew2;
                                                            if (previousWhitespace3 + 1 < text3.length() && TextSelectionHelper.isInterruptedCharacter(text3.charAt(previousWhitespace3 + 1))) {
                                                                previousWhitespace3++;
                                                                layoutNew2 = layoutNew3;
                                                            }
                                                        }
                                                        int distanseToNextWhitspace = Math.abs(newSelection3 - nextWhitespace2);
                                                        int distanseToPreviousWhitespace = Math.abs(newSelection3 - previousWhitespace3);
                                                        if (TextSelectionHelper.this.snap) {
                                                            TextSelectionHelper.this.snap = dx >= 0;
                                                        }
                                                        boolean nextCharIsLitter = newSelection3 + (-1) > 0 && TextSelectionHelper.isInterruptedCharacter(text3.charAt(newSelection3 + (-1)));
                                                        if (newSelection3 >= text3.length()) {
                                                            newSelection3 = text3.length();
                                                            newChar = '\n';
                                                        } else {
                                                            newChar = text3.charAt(newSelection3);
                                                        }
                                                        if (TextSelectionHelper.this.selectionStart >= text3.length()) {
                                                            TextSelectionHelper.this.selectionStart = text3.length();
                                                            selectionStartChar = '\n';
                                                        } else {
                                                            selectionStartChar = text3.charAt(TextSelectionHelper.this.selectionStart);
                                                        }
                                                        if ((newSelection3 < TextSelectionHelper.this.selectionStart && distanseToNextWhitspace < distanseToPreviousWhitespace) || ((newSelection3 > TextSelectionHelper.this.selectionStart && dx < 0) || !TextSelectionHelper.isInterruptedCharacter(newChar) || ((TextSelectionHelper.isInterruptedCharacter(selectionStartChar) && !TextSelectionHelper.this.snap) || newSelection3 == 0 || !nextCharIsLitter || selectionStartChar == '\n'))) {
                                                            if (TextSelectionHelper.this.snap && newSelection3 == 1) {
                                                                return true;
                                                            }
                                                            if (newSelection3 < TextSelectionHelper.this.selectionStart && TextSelectionHelper.isInterruptedCharacter(newChar) && ((!TextSelectionHelper.isInterruptedCharacter(selectionStartChar) || TextSelectionHelper.this.snap) && selectionStartChar != '\n')) {
                                                                TextSelectionHelper.this.selectionStart = nextWhitespace2;
                                                                TextSelectionHelper.this.snap = true;
                                                            } else {
                                                                TextSelectionHelper.this.selectionStart = newSelection3;
                                                            }
                                                            if (TextSelectionHelper.this.selectionStart > TextSelectionHelper.this.selectionEnd) {
                                                                int k3 = TextSelectionHelper.this.selectionEnd;
                                                                TextSelectionHelper textSelectionHelper20 = TextSelectionHelper.this;
                                                                textSelectionHelper20.selectionEnd = textSelectionHelper20.selectionStart;
                                                                TextSelectionHelper.this.selectionStart = k3;
                                                                TextSelectionHelper.this.movingHandleStart = false;
                                                            }
                                                            if (Build.VERSION.SDK_INT >= 27) {
                                                                TextSelectionHelper.this.textSelectionOverlay.performHapticFeedback(9, 1);
                                                ...
                                                TextSelectionHelper.this.selectionStart = newSelection3;
                                                if (TextSelectionHelper.this.selectionStart > TextSelectionHelper.this.selectionEnd) {
                                                    int k4 = TextSelectionHelper.this.selectionEnd;
                                                    TextSelectionHelper textSelectionHelper21 = TextSelectionHelper.this;
                                                    textSelectionHelper21.selectionEnd = textSelectionHelper21.selectionStart;
                                                    TextSelectionHelper.this.selectionStart = k4;
                                                    TextSelectionHelper.this.movingHandleStart = false;
                                                }
                                                int k5 = Build.VERSION.SDK_INT;
                                                if (k5 >= 27) {
                                                    TextSelectionHelper.this.textSelectionOverlay.performHapticFeedback(9, 1);
                                                }
                                                TextSelectionHelper.this.invalidate();
                                            ...
                                            newSelection2 = newSelection3;
                                            textSelectionHelper22.jumpToLine(newSelection3, nextWhitespace2, viewChanged, textSelectionHelper22.layoutBlock.yOffset, oldYoffset, oldSelectedView);
                                            if (Build.VERSION.SDK_INT >= 27) {
                                                TextSelectionHelper.this.textSelectionOverlay.performHapticFeedback(9, 1);
                                            }
                                            TextSelectionHelper.this.invalidate();
                                ...
                                textSelectionHelper23.showMagnifier(textSelectionHelper23.lastX);
                                break;
                            } else {
                                return true;
                            }
