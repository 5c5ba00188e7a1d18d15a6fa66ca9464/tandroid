...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    public void setPhotoEntry(MediaController.SearchImage searchImage, boolean z, boolean z2) {
        ...
        this.isLast = z2;
        Drawable drawable = this.zoomOnSelect ? Theme.chat_attachEmptyDrawable : getResources().getDrawable(2131166003);
    ...
    */
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (photoEntry != null && photoEntry.isVideo) {
            accessibilityNodeInfo.setText(LocaleController.getString("AttachVideo", 2131624508) + ", " + LocaleController.formatDuration(this.photoEntry.duration));
        } else {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(2131230723, LocaleController.getString("Open", 2131627090)));
        }
    }
