...
public class GraySectionCell extends FrameLayout {
    ...
    public GraySectionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        AnonymousClass1 anonymousClass1 = new AnonymousClass1(this, getContext(), true, true, true);
    ...
    /* renamed from: org.telegram.ui.Cells.GraySectionCell$1 */
    /* loaded from: classes3.dex */
    public class AnonymousClass1 extends AnimatedTextView {
        AnonymousClass1(GraySectionCell graySectionCell, Context context, boolean z, boolean z2, boolean z3) {
