...
public final /* synthetic */ class StatisticActivity$MemberData$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ StatisticActivity$MemberData$$ExternalSyntheticLambda2(StatisticActivity.MemberData memberData, StatisticActivity statisticActivity, AlertDialog[] alertDialogArr, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$ChatFull tLRPC$ChatFull) {
        this.f$0 = memberData;
