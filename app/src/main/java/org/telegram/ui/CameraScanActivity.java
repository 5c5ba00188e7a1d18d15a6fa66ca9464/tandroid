...
public class CameraScanActivity extends BaseFragment {
    ...
    */
    public void processShot(Bitmap bitmap) {
        ...
        try {
            size = this.cameraView.getPreviewSize();
        } catch (Throwable th) {
        }
        try {
            if (this.currentType == 0) {
                ...
                if (res != null && !TextUtils.isEmpty(res.firstName) && !TextUtils.isEmpty(res.lastName) && !TextUtils.isEmpty(res.number) && res.birthDay != 0 && ((res.expiryDay != 0 || res.doesNotExpire) && res.gender != 0)) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CameraScanActivity$$ExternalSyntheticLambda8
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraScanActivity.this.m1617lambda$processShot$11$orgtelegramuiCameraScanActivity(res);
                        }
                    });
                    return;
                }
                ...
                final QrResult res2 = tryReadQr(null, size, x, y, side, bitmap);
                ...
                if (res2 != null) {
                    ...
                    String str = res2.text;
                    this.recognizedText = str;
                    if (!this.recognized) {
                        this.recognized = true;
                        this.qrLoading = this.delegate.processQr(str, new Runnable() { // from class: org.telegram.ui.CameraScanActivity$$ExternalSyntheticLambda3
                            @Override // java.lang.Runnable
                            public final void run() {
                                CameraScanActivity.this.m1619lambda$processShot$13$orgtelegramuiCameraScanActivity();
                            }
                        });
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CameraScanActivity$$ExternalSyntheticLambda9
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraScanActivity.this.m1620lambda$processShot$14$orgtelegramuiCameraScanActivity(res2);
                        }
                    });
                } else if (z) {
                ...
                if (((this.recognizeIndex == 0 && res2 != null && res2.bounds == null && !this.qrLoading) || (SystemClock.elapsedRealtime() - this.recognizedStart > 1000 && !this.qrLoading)) && this.recognizedText != null) {
                    CameraView cameraView = this.cameraView;
                    if (cameraView != null && cameraView.getCameraSession() != null) {
                        CameraController.getInstance().stopPreview(this.cameraView.getCameraSession());
                    }
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CameraScanActivity$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraScanActivity.this.m1621lambda$processShot$15$orgtelegramuiCameraScanActivity();
                        }
                    });
                } else if (this.recognized) {
                    long delay = Math.max(16L, (1000 / this.sps) - this.averageProcessTime);
                    this.handler.postDelayed(new Runnable() { // from class: org.telegram.ui.CameraScanActivity$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraScanActivity.this.m1622lambda$processShot$16$orgtelegramuiCameraScanActivity();
                        }
                    }, delay);
                }
            }
            ...
            this.averageProcessTime = ((f * ((float) j)) + ((float) timeout)) / ((float) j2);
            this.processTimesCount = Math.max(j2, 30L);
            if (this.recognized) {
            }
        }
        long to2 = SystemClock.elapsedRealtime();
        long timeout2 = to2 - from;
        float f2 = this.averageProcessTime;
        long j3 = this.processTimesCount;
        long j22 = j3 + 1;
        this.processTimesCount = j22;
        this.averageProcessTime = ((f2 * ((float) j3)) + ((float) timeout2)) / ((float) j22);
        this.processTimesCount = Math.max(j22, 30L);
        if (this.recognized) {
            AndroidUtilities.runOnUIThread(this.requestShot, 500L);
        }
    }
