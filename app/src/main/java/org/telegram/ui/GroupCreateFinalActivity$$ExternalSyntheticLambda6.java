...
public final /* synthetic */ class GroupCreateFinalActivity$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ GroupCreateFinalActivity$$ExternalSyntheticLambda6(GroupCreateFinalActivity groupCreateFinalActivity, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputFile tLRPC$InputFile2, String str, double d, TLRPC$PhotoSize tLRPC$PhotoSize, TLRPC$PhotoSize tLRPC$PhotoSize2) {
    ...
    public final void run() {
        this.f$0.lambda$didUploadPhoto$8(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
