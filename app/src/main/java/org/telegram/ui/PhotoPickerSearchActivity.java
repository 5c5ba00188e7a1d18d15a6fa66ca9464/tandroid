        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.PhotoPickerSearchActivity.4
            ...
            */
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                setMeasuredDimension(widthSize, heightSize3);
                measureChildWithMargins(PhotoPickerSearchActivity.this.actionBar, widthMeasureSpec, 0, heightMeasureSpec, 0);
                int keyboardSize = SharedConfig.smoothKeyboard ? 0 : measureKeyboardHeight();
                if (keyboardSize <= AndroidUtilities.dp(20.0f)) {
                    if (!AndroidUtilities.isInMultiwindow) {
                        int heightSize4 = heightSize3 - PhotoPickerSearchActivity.this.commentTextView.getEmojiPadding();
                        heightSize = heightSize4;
                        heightSize2 = View.MeasureSpec.makeMeasureSpec(heightSize4, C.BUFFER_FLAG_ENCRYPTED);
                        int actionBarHeight = PhotoPickerSearchActivity.this.actionBar.getMeasuredHeight();
                        this.globalIgnoreLayout = true;
                        for (a = 0; a < PhotoPickerSearchActivity.this.viewPages.length; a++) {
                            if (PhotoPickerSearchActivity.this.viewPages[a] != null && PhotoPickerSearchActivity.this.viewPages[a].listView != null) {
                                PhotoPickerSearchActivity.this.viewPages[a].listView.setPadding(AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f) + actionBarHeight, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f));
                            }
                        }
                        ...
                        for (i = 0; i < childCount; i++) {
                            ...
                            if (child != null && child.getVisibility() != 8 && child != PhotoPickerSearchActivity.this.actionBar) {
                                if (PhotoPickerSearchActivity.this.commentTextView != null && PhotoPickerSearchActivity.this.commentTextView.isPopupView(child)) {
                                    ...
                                    measureChildWithMargins(child, widthMeasureSpec, 0, heightSize2, 0);
                                }
                            }
                        }
                    }
                ...
                heightSize2 = heightMeasureSpec;
                int actionBarHeight2 = PhotoPickerSearchActivity.this.actionBar.getMeasuredHeight();
                this.globalIgnoreLayout = true;
                while (a < PhotoPickerSearchActivity.this.viewPages.length) {
                }
                this.globalIgnoreLayout = false;
                childCount = getChildCount();
                while (i < childCount) {
