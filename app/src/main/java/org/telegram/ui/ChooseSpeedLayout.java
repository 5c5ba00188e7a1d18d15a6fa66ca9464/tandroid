...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, PopupSwipeBackLayout popupSwipeBackLayout, Callback callback) {
        ...
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165639, LocaleController.getString("Back", 2131624636), false, null);
        ...
        ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165942, LocaleController.getString("SpeedVerySlow", 2131628401), false, null);
        ...
        ActionBarMenuSubItem addItem3 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165943, LocaleController.getString("SpeedSlow", 2131628399), false, null);
        ...
        ActionBarMenuSubItem addItem4 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165944, LocaleController.getString("SpeedNormal", 2131628398), false, null);
        ...
        ActionBarMenuSubItem addItem5 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165945, LocaleController.getString("SpeedFast", 2131628397), false, null);
        ...
        ActionBarMenuSubItem addItem6 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165946, LocaleController.getString("SpeedVeryFast", 2131628400), false, null);
