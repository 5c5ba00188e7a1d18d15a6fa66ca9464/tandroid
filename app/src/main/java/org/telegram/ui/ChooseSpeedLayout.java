...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, PopupSwipeBackLayout popupSwipeBackLayout, Callback callback) {
        ...
        ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165947, LocaleController.getString("SpeedVerySlow", 2131628465), false, null);
        ...
        ActionBarMenuSubItem addItem3 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165948, LocaleController.getString("SpeedSlow", 2131628463), false, null);
        ...
        ActionBarMenuSubItem addItem4 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165949, LocaleController.getString("SpeedNormal", 2131628462), false, null);
        ...
        ActionBarMenuSubItem addItem5 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165950, LocaleController.getString("SpeedFast", 2131628461), false, null);
        ...
        ActionBarMenuSubItem addItem6 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, 2131165951, LocaleController.getString("SpeedVeryFast", 2131628464), false, null);
