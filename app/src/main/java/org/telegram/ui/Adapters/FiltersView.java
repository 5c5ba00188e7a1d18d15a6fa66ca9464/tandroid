...
public class FiltersView extends RecyclerListView {
    ...
    public static final MediaFilterData[] filters = {new MediaFilterData(2131166132, LocaleController.getString("SharedMediaTab2", 2131628367), new TLRPC$TL_inputMessagesFilterPhotoVideo(), 0), new MediaFilterData(2131166131, LocaleController.getString("SharedLinksTab2", 2131628364), new TLRPC$TL_inputMessagesFilterUrl(), 2), new MediaFilterData(2131166130, LocaleController.getString("SharedFilesTab2", 2131628360), new TLRPC$TL_inputMessagesFilterDocument(), 1), new MediaFilterData(2131166133, LocaleController.getString("SharedMusicTab2", 2131628369), new TLRPC$TL_inputMessagesFilterMusic(), 3), new MediaFilterData(2131166135, LocaleController.getString("SharedVoiceTab2", 2131628373), new TLRPC$TL_inputMessagesFilterRoundVoice(), 5)};
    ...
    public void setUsersAndDates(ArrayList<Object> arrayList, ArrayList<DateData> arrayList2, boolean z) {
        ...
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof TLRPC$User) {
                    ...
                    MediaFilterData mediaFilterData = new MediaFilterData(2131166134, str, null, 4);
                    ...
                    MediaFilterData mediaFilterData2 = new MediaFilterData(2131166134, str2, null, 4);
        ...
        if (arrayList2 != null) {
            for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                ...
                MediaFilterData mediaFilterData3 = new MediaFilterData(2131166129, dateData.title, null, 6);
    ...
    public static void fillTipDates(String str, ArrayList<DateData> arrayList) {
        ...
        if (LocaleController.getString("SearchTipToday", 2131628186).toLowerCase().startsWith(trim) || "today".startsWith(trim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString("SearchTipToday", 2131628186), timeInMillis, calendar.getTimeInMillis() - 1, null));
        } else if (LocaleController.getString("SearchTipYesterday", 2131628187).toLowerCase().startsWith(trim) || "yesterday".startsWith(trim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString("SearchTipYesterday", 2131628187), calendar2.getTimeInMillis() - 86400000, calendar2.getTimeInMillis() - 86400001, null));
        } else {
