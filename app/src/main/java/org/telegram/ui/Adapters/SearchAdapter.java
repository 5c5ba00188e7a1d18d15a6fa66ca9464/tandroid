    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
            case 0:
                ...
                if (object != null) {
                    if (object instanceof TLRPC.User) {
                        String un2 = ((TLRPC.User) object).username;
                        long id2 = ((TLRPC.User) object).id;
                        un = un2;
                        id = id2;
                        ...
                        String un3 = ((TLRPC.Chat) object).username;
                        long id3 = ((TLRPC.Chat) object).id;
                        un = un3;
                        id = id3;
                        self = false;
                    }
                    ...
                    if (position < this.searchResult.size()) {
                        ...
                        if (name2 != null && un != null && un.length() > 0) {
                            if (name2.toString().startsWith("@" + un)) {
                                name2 = null;
                                username = name2;
                                if (this.useUserCell) {
                                    UserCell userCell = (UserCell) holder.itemView;
                                    userCell.setData(object, name2, username, 0);
                                    LongSparseArray<?> longSparseArray = this.checkedMap;
                                    if (longSparseArray != null) {
                                        userCell.setChecked(longSparseArray.indexOfKey(id) >= 0, false);
                                        return;
                                    }
                                    return;
                                }
                                ...
                                boolean z = true;
                                if (position == getItemCount() - 1 || position == this.searchResult.size() - 1) {
                                    z = false;
                                }
                        ...
                        if (foundUserName2 != null && foundUserName2.startsWith("@")) {
                        ...
                        try {
                            ...
                            if (foundUserName != null) {
                                ...
                                if (indexOfIgnoreCase != -1) {
                                    ...
                                    spannableStringBuilder.setSpan(new ForegroundColorSpanThemable(Theme.key_windowBackgroundWhiteBlueText4), index, index + len, 33);
                                }
                            }
            ...
            case 2:
                ...
                cell2.setColors(null, Theme.key_windowBackgroundWhiteBlueText2);
                cell2.setText(LocaleController.formatString("AddContactByPhone", R.string.AddContactByPhone, PhoneFormat.getInstance().format("+" + str)), false);
                return;
            default:
                return;
        }
