...
public abstract /* synthetic */ class o1 {
    ...
    public static void k(u1 u1Var, Consumer consumer) {
        if (consumer instanceof j$.util.function.f) {
            ...
            ((j$.util.t) u1Var.mo69spliterator()).forEachRemaining(consumer);
        } else {
    ...
    public static void m(y1 y1Var, Consumer consumer) {
        if (consumer instanceof j$.util.function.q) {
            ...
            ((j$.util.v) y1Var.mo69spliterator()).forEachRemaining(consumer);
        } else {
    ...
    public static u1 n(u1 u1Var, long j, long j2, j$.util.function.m mVar) {
        ...
        long j3 = j2 - j;
        j$.util.t tVar = (j$.util.t) u1Var.mo69spliterator();
        p1 j4 = x2.j(j3);
        j4.n(j3);
    ...
    public static y1 p(y1 y1Var, long j, long j2, j$.util.function.m mVar) {
        ...
        long j3 = j2 - j;
        j$.util.v vVar = (j$.util.v) y1Var.mo69spliterator();
        r1 q = x2.q(j3);
        q.n(j3);
    ...
    public static A1 q(A1 a1, long j, long j2, j$.util.function.m mVar) {
        ...
        s1 d = x2.d(j3, mVar);
        d.n(j3);
        for (int i = 0; i < j && mo69spliterator.b(n1.a); i++) {
        }
