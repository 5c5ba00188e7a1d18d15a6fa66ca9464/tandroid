...
public abstract class Z3 extends e implements Iterable, j$.lang.e {
    ...
    abstract class a implements j$.util.t {
        ...
        abstract j$.util.t f(Object obj, int i, int i2);
        ...
        abstract j$.util.t h(int i, int i2, int i3, int i4);
        ...
        public j$.util.t trySplit() {
            ...
            if (i < i2) {
                int i3 = this.c;
                Z3 z3 = Z3.this;
                j$.util.t h = h(i, i2 - 1, i3, z3.u(z3.f[i2 - 1]));
                int i4 = this.b;
                this.a = i4;
                this.c = 0;
                this.e = Z3.this.f[i4];
