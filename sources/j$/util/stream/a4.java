...
public abstract class a4 extends e implements Iterable, j$.lang.e {
    Object e;
    Object[] f;
    ...
    abstract class a implements j$.util.u {
        ...
        public a(int i, int i2, int i3, int i4) {
            ...
            this.c = i3;
            this.d = i4;
            Object[] objArr = a4.this.f;
            this.e = objArr == null ? a4.this.e : objArr[i];
        }
        ...
        public void e(Object obj) {
            ...
            if (i2 < i3 || (i2 == i3 && this.c < this.d)) {
                ...
                a4.this.t(this.a == i ? this.e : a4.this.f[i], i4, this.d, obj);
                this.a = this.b;
                this.c = this.d;
            }
        }
        ...
        public j$.util.u trySplit() {
            ...
            if (i < i2) {
                int i3 = this.c;
                a4 a4Var = a4.this;
                j$.util.u h = h(i, i2 - 1, i3, a4Var.u(a4Var.f[i2 - 1]));
                int i4 = this.b;
                this.a = i4;
                this.c = 0;
                this.e = a4.this.f[i4];
