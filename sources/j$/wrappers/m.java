...
public final /* synthetic */ class m implements s.c {
    ...
    public static /* synthetic */ s.c a(Spliterator.OfLong ofLong) {
        if (ofLong == null) {
            return null;
        }
    ...
    @Override // j$.util.s.c, j$.util.t, j$.util.s
    public /* synthetic */ s.c trySplit() {
