...
public final /* synthetic */ class M0 implements f1 {
    ...
    public static /* synthetic */ f1 l0(LongStream longStream) {
        if (longStream == null) {
            return null;
        }
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ j$.util.stream.V O(k0 k0Var) {
        return K0.l0(this.a.mapToDouble(k0Var == null ? null : k0Var.a));
    }
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ void Y(j$.util.function.q qVar) {
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ IntStream c0(m0 m0Var) {
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ Object d0(Supplier supplier, j$.util.function.w wVar, BiConsumer biConsumer) {
        return this.a.collect(z0.a(supplier), v0.a(wVar), r.a(biConsumer));
    }

    @Override // j$.util.stream.f1
    public /* synthetic */ f1 distinct() {
    ...
    @Override // j$.util.stream.f1, j$.util.stream.g
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ f1 limit(long j) {
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ f1 p(j$.util.function.q qVar) {
        return l0(this.a.peek(f0.a(qVar)));
    }

    @Override // j$.util.stream.f1, j$.util.stream.g
    public /* synthetic */ f1 parallel() {
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ f1 s(j$.util.function.r rVar) {
        return l0(this.a.flatMap(h0.a(rVar)));
    }

    @Override // j$.util.stream.f1, j$.util.stream.g
    public /* synthetic */ f1 sequential() {
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ f1 skip(long j) {
        return l0(this.a.skip(j));
    }

    @Override // j$.util.stream.f1
    public /* synthetic */ f1 sorted() {
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ f1 u(i0 i0Var) {
        return l0(this.a.filter(j0.a(i0Var)));
    }
    ...
    @Override // j$.util.stream.f1
    public /* synthetic */ f1 z(j$.util.function.t tVar) {
        return l0(this.a.map(p0.a(tVar)));
    }
}
