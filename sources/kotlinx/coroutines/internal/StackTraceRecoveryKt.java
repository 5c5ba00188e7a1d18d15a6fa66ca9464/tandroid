...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.constructor-impl(Class.forName("kotlin.coroutines.jvm.internal.BaseContinuationImpl").getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.constructor-impl(ResultKt.createFailure(th));
        }
        baseContinuationImplClassName = (String) (Result.exceptionOrNull-impl(obj) == null ? obj : "kotlin.coroutines.jvm.internal.BaseContinuationImpl");
        try {
