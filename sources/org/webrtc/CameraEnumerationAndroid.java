...
public class CameraEnumerationAndroid {
    ...
    public static class CaptureFormat {
        ...
        public int hashCode() {
            return (((this.width * 65497) + this.height) * NotificationCenter.newLocationAvailable) + 1 + this.framerate.hashCode();
        }
