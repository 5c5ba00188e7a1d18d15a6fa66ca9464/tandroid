...
public abstract class TLRPC$account_ResetPasswordResult extends TLObject {
    public static TLRPC$account_ResetPasswordResult TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$account_ResetPasswordResult tLRPC$TL_account_resetPasswordRequestedWait = i != -478701471 ? i != -383330754 ? i != -370148227 ? null : new TLRPC$TL_account_resetPasswordRequestedWait() : new TLRPC$account_ResetPasswordResult() { // from class: org.telegram.tgnet.TLRPC$TL_account_resetPasswordOk
