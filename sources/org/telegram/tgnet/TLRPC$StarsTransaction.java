...
public class TLRPC$StarsTransaction extends TLObject {
    ...
    public static TLRPC$StarsTransaction TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$StarsTransaction tLRPC$TL_starsTransaction = i != -1442789224 ? i != -865044046 ? i != 766853519 ? i != 1127934763 ? null : new TLRPC$TL_starsTransaction() : new TLRPC$TL_starsTransaction() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransaction_layer185
        ...
        } : new TLRPC$StarsTransaction() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransaction_layer181
