...
public class TLRPC$StarsTransaction extends TLObject {
    ...
    public static TLRPC$StarsTransaction TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1442789224:
                tLRPC$StarsTransaction = new TLRPC$TL_starsTransaction() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransaction_layer182
                ...
                break;
            case -865044046:
                tLRPC$StarsTransaction = new TLRPC$StarsTransaction() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransaction_layer181
            ...
            case -294313259:
                ...
                break;
            case 766853519:
                tLRPC$StarsTransaction = new TLRPC$TL_starsTransaction() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransaction_layer185
                    @Override // org.telegram.tgnet.TLRPC$TL_starsTransaction, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
                ...
                break;
            case 1127934763:
                tLRPC$StarsTransaction = new TLRPC$TL_starsTransaction() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransaction_layer186
                    @Override // org.telegram.tgnet.TLRPC$TL_starsTransaction, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
