...
public abstract class TLRPC$messages_Dialogs extends TLObject {
    ...
    public static TLRPC$messages_Dialogs TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_Dialogs tLRPC$TL_messages_dialogs = i != -253500010 ? i != 364538944 ? i != 1910543603 ? null : new TLRPC$messages_Dialogs() { // from class: org.telegram.tgnet.TLRPC$TL_messages_dialogsSlice
        ...
        } : new TLRPC$TL_messages_dialogs() : new TLRPC$messages_Dialogs() { // from class: org.telegram.tgnet.TLRPC$TL_messages_dialogsNotModified
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                this.count = abstractSerializedData2.readInt32(z2);
            }
