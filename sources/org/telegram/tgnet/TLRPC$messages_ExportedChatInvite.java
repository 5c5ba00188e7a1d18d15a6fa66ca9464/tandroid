...
public abstract class TLRPC$messages_ExportedChatInvite extends TLObject {
    ...
    public static TLRPC$messages_ExportedChatInvite TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_ExportedChatInvite tLRPC$TL_messages_exportedChatInviteReplaced = i != 410107472 ? i != 572915951 ? null : new TLRPC$TL_messages_exportedChatInviteReplaced() : new TLRPC$messages_ExportedChatInvite() { // from class: org.telegram.tgnet.TLRPC$TL_messages_exportedChatInvite
