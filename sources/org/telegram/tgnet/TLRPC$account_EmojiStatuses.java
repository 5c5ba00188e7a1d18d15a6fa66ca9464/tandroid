...
public abstract class TLRPC$account_EmojiStatuses extends TLObject {
    ...
    public static TLRPC$account_EmojiStatuses TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$account_EmojiStatuses tLRPC$TL_account_emojiStatuses = i != -1866176559 ? i != -796072379 ? null : new TLRPC$account_EmojiStatuses() { // from class: org.telegram.tgnet.TLRPC$TL_account_emojiStatusesNotModified
