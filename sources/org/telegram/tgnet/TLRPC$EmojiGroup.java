...
public class TLRPC$EmojiGroup extends TLObject {
    ...
    public static TLRPC$EmojiGroup TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -2133693241) {
            tLRPC$EmojiGroup = new TLRPC$EmojiGroup() { // from class: org.telegram.tgnet.TLRPC$TL_emojiGroupGreeting
            ...
            tLRPC$EmojiGroup = i != 2056961449 ? null : new TLRPC$EmojiGroup() { // from class: org.telegram.tgnet.TLRPC$TL_emojiGroup
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    this.title = abstractSerializedData2.readString(z2);
                    this.icon_emoji_id = abstractSerializedData2.readInt64(z2);
            ...
            tLRPC$EmojiGroup = new TLRPC$EmojiGroup() { // from class: org.telegram.tgnet.TLRPC$TL_emojiGroupPremium
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    this.title = abstractSerializedData2.readString(z2);
                    this.icon_emoji_id = abstractSerializedData2.readInt64(z2);
