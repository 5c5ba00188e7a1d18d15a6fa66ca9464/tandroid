...
public class TLRPC$Message extends TLObject {
    ...
    public static TLRPC$Message TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -1528201417:
            case 592953125:
                tLRPC$Message = new TLRPC$TL_message() { // from class: org.telegram.tgnet.TLRPC$TL_message_layer179
                    @Override // org.telegram.tgnet.TLRPC$TL_message, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
            ...
            case -1125940270:
                ...
                break;
            case -1109353426:
                tLRPC$Message = new TLRPC$TL_message() { // from class: org.telegram.tgnet.TLRPC$TL_message_layer180
                    @Override // org.telegram.tgnet.TLRPC$TL_message, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
    ...
    */
    ...
    public void writeAttachPath(AbstractSerializedData abstractSerializedData) {
        ...
        if (this.legacy) {
            ...
            this.layer = 184;
            this.params.put("legacy_layer", "184");
        }
