...
public abstract class TLRPC$messages_FoundStickerSets extends TLObject {
    public static TLRPC$messages_FoundStickerSets TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_FoundStickerSets tLRPC$TL_messages_foundStickerSets = i != -1963942446 ? i != 223655517 ? null : new TLRPC$messages_FoundStickerSets() { // from class: org.telegram.tgnet.TLRPC$TL_messages_foundStickerSetsNotModified
            @Override // org.telegram.tgnet.TLObject
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                abstractSerializedData2.writeInt32(223655517);
            }
        } : new TLRPC$TL_messages_foundStickerSets();
