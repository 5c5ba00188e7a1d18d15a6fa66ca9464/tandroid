...
public abstract class TLRPC$Poll extends TLObject {
    ...
    public static TLRPC$Poll TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_poll tLRPC$TL_poll = i != -2032041631 ? i != -1351325818 ? i != -716006138 ? i != 1484026161 ? null : new TLRPC$TL_poll() : new TLRPC$TL_poll() { // from class: org.telegram.tgnet.TLRPC$TL_poll_layer111
        ...
        } : new TLRPC$TL_poll() { // from class: org.telegram.tgnet.TLRPC$TL_poll_toDelete
            @Override // org.telegram.tgnet.TLRPC$TL_poll, org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                this.id = abstractSerializedData2.readInt64(z2);
                int readInt32 = abstractSerializedData2.readInt32(z2);
        ...
        } : new TLRPC$TL_poll() { // from class: org.telegram.tgnet.TLRPC$TL_poll_layer178
            @Override // org.telegram.tgnet.TLRPC$TL_poll, org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                this.id = abstractSerializedData2.readInt64(z2);
                int readInt32 = abstractSerializedData2.readInt32(z2);
