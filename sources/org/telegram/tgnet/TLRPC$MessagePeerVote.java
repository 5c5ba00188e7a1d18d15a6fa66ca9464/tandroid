...
public abstract class TLRPC$MessagePeerVote extends TLObject {
    ...
    public static TLRPC$MessagePeerVote TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$MessagePeerVote tLRPC$TL_messagePeerVoteInputOption = i != -1228133028 ? i != 1177089766 ? i != 1959634180 ? null : new TLRPC$TL_messagePeerVoteInputOption() : new TLRPC$MessagePeerVote() { // from class: org.telegram.tgnet.TLRPC$TL_messagePeerVoteMultiple
        ...
        } : new TLRPC$MessagePeerVote() { // from class: org.telegram.tgnet.TLRPC$TL_messagePeerVote
            public byte[] option;
