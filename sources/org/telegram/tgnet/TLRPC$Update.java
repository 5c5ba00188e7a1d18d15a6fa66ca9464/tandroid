    ...
    public static TLRPC$Update TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -1264392051:
                ...
                break;
            case -1263546448:
                tLRPC$TL_updateTheme = new TLRPC$Update() { // from class: org.telegram.tgnet.TLRPC$TL_updatePeerLocated
            ...
            case 674706841:
                ...
                break;
            case 675009298:
                tLRPC$TL_updateTheme = new TLRPC$Update() { // from class: org.telegram.tgnet.TLRPC$TL_updateBotPurchasedPaidMedia
