    ...
    public static TLRPC$Update TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -1371598819:
                ...
                break;
            case -1364222348:
                tLRPC$TL_updateTheme = new TLRPC$Update() { // from class: org.telegram.tgnet.TLRPC$TL_updateSavedDialogPinned
                    public int flags;
            ...
            case 1666927625:
                ...
                break;
            case 1751942566:
                tLRPC$TL_updateTheme = new TLRPC$Update() { // from class: org.telegram.tgnet.TLRPC$TL_updatePinnedSavedDialogs
                    public int flags;
