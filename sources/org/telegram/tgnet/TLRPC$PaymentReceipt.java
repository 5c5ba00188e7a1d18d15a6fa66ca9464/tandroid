...
public class TLRPC$PaymentReceipt extends TLObject {
    ...
    public static TLRPC$PaymentReceipt TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != -625215430) {
            tLRPC$PaymentReceipt = i != 1891958275 ? null : new TLRPC$PaymentReceipt() { // from class: org.telegram.tgnet.TLRPC$TL_payments_paymentReceipt
            ...
            tLRPC$PaymentReceipt = new TLRPC$PaymentReceipt() { // from class: org.telegram.tgnet.TLRPC$TL_payments_paymentReceiptStars
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    this.flags = abstractSerializedData2.readInt32(z2);
                    this.date = abstractSerializedData2.readInt32(z2);
