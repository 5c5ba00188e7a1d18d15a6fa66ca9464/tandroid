...
public abstract class TLRPC$messages_SavedGifs extends TLObject {
    ...
    public static TLRPC$messages_SavedGifs TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_SavedGifs tLRPC$messages_SavedGifs = i != -2069878259 ? i != -402498398 ? null : new TLRPC$messages_SavedGifs() { // from class: org.telegram.tgnet.TLRPC$TL_messages_savedGifsNotModified
            @Override // org.telegram.tgnet.TLObject
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                abstractSerializedData2.writeInt32(-402498398);
            }
        } : new TLRPC$messages_SavedGifs() { // from class: org.telegram.tgnet.TLRPC$TL_messages_savedGifs
            @Override // org.telegram.tgnet.TLObject
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ((TLRPC$Document) this.gifs.get(i2)).serializeToStream(abstractSerializedData2);
                }
            }
        };
