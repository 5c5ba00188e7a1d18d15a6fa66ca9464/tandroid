...
public abstract class TLRPC$WallPaperSettings extends TLObject {
    ...
    public static TLRPC$WallPaperSettings TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_wallPaperSettings tLRPC$TL_wallPaperSettings = i != -1590738760 ? i != 84438264 ? i != 499236004 ? i != 925826256 ? null : new TLRPC$TL_wallPaperSettings() : new TLRPC$TL_wallPaperSettings() { // from class: org.telegram.tgnet.TLRPC$TL_wallPaperSettings_layer167
        ...
        } : new TLRPC$TL_wallPaperSettings() { // from class: org.telegram.tgnet.TLRPC$TL_wallPaperSettings_layer128
            @Override // org.telegram.tgnet.TLRPC$TL_wallPaperSettings, org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
        ...
        } : new TLRPC$TL_wallPaperSettings() { // from class: org.telegram.tgnet.TLRPC$TL_wallPaperSettings_layer106
            @Override // org.telegram.tgnet.TLRPC$TL_wallPaperSettings, org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
