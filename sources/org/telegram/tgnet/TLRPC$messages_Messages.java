...
public abstract class TLRPC$messages_Messages extends TLObject {
    ...
    public static TLRPC$messages_Messages TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_Messages tLRPC$TL_messages_messages = i != -1938715001 ? i != -948520370 ? i != 978610270 ? i != 1951620897 ? null : new TLRPC$messages_Messages() { // from class: org.telegram.tgnet.TLRPC$TL_messages_messagesNotModified
        ...
        } : new TLRPC$messages_Messages() { // from class: org.telegram.tgnet.TLRPC$TL_messages_messagesSlice
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
        ...
        } : new TLRPC$messages_Messages() { // from class: org.telegram.tgnet.TLRPC$TL_messages_channelMessages
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                abstractSerializedData2.writeInt32(size2);
                for (int i4 = 0; i4 < size2; i4++) {
                    ((TLRPC$TL_forumTopic) this.topics.get(i4)).serializeToStream(abstractSerializedData2);
                }
                abstractSerializedData2.writeInt32(481674261);
        ...
        } : new TLRPC$TL_messages_messages();
