...
public abstract class TLRPC$updates_Difference extends TLObject {
    ...
    public static TLRPC$updates_Difference TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$updates_Difference tLRPC$updates_Difference = i != -1459938943 ? i != 16030880 ? i != 1258196845 ? i != 1567990072 ? null : new TLRPC$updates_Difference() { // from class: org.telegram.tgnet.TLRPC$TL_updates_differenceEmpty
        ...
        } : new TLRPC$updates_Difference() { // from class: org.telegram.tgnet.TLRPC$TL_updates_differenceTooLong
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
        ...
        } : new TLRPC$updates_Difference() { // from class: org.telegram.tgnet.TLRPC$TL_updates_difference
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ((TLRPC$Message) this.new_messages.get(i2)).serializeToStream(abstractSerializedData2);
                }
                abstractSerializedData2.writeInt32(481674261);
                int size2 = this.new_encrypted_messages.size();
                abstractSerializedData2.writeInt32(size2);
                for (int i3 = 0; i3 < size2; i3++) {
                    ((TLRPC$EncryptedMessage) this.new_encrypted_messages.get(i3)).serializeToStream(abstractSerializedData2);
                }
                abstractSerializedData2.writeInt32(481674261);
        ...
        } : new TLRPC$updates_Difference() { // from class: org.telegram.tgnet.TLRPC$TL_updates_differenceSlice
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                if (readInt32 != 481674261) {
