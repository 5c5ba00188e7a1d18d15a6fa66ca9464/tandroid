...
public abstract class TLRPC$messages_Stickers extends TLObject {
    public static TLRPC$messages_Stickers TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_Stickers tLRPC$TL_messages_stickers = i != -244016606 ? i != 816245886 ? null : new TLRPC$TL_messages_stickers() : new TLRPC$messages_Stickers() { // from class: org.telegram.tgnet.TLRPC$TL_messages_stickersNotModified
