    ...
    */
    public ConnectionsManager(int i) {
        ...
        if (!BuildVars.DEBUG_PRIVATE_VERSION) {
            ...
            init(SharedConfig.buildVersion(), 196, BuildVars.APP_ID, str3, str10, str2, str4, str9, file2, FileLog.getNetworkLogPath(), regId, certificateSHA256Fingerprint, rawOffset, getUserConfig().getClientUserId(), getUserConfig().getCurrentUser() == null ? getUserConfig().getCurrentUser().premium : false, isPushConnectionEnabled);
        }
        sb = new StringBuilder();
        sb.append(str6);
        str7 = " pbeta";
        ...
        init(SharedConfig.buildVersion(), 196, BuildVars.APP_ID, str3, str10, str2, str4, str9, file2, FileLog.getNetworkLogPath(), regId2, certificateSHA256Fingerprint2, rawOffset2, getUserConfig().getClientUserId(), getUserConfig().getCurrentUser() == null ? getUserConfig().getCurrentUser().premium : false, isPushConnectionEnabled);
    }
