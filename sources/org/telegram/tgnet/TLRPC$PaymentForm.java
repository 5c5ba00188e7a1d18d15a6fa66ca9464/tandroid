...
public class TLRPC$PaymentForm extends TLObject {
    ...
    public static TLRPC$PaymentForm TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$PaymentForm tLRPC$PaymentForm = i != -1610250415 ? i != 2079764828 ? null : new TLRPC$PaymentForm() { // from class: org.telegram.tgnet.TLRPC$TL_payments_paymentFormStars
        ...
        } : new TLRPC$PaymentForm() { // from class: org.telegram.tgnet.TLRPC$TL_payments_paymentForm
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                if ((this.flags & 64) != 0) {
                    ...
                    abstractSerializedData2.writeInt32(size);
                    for (int i4 = 0; i4 < size; i4++) {
                        ((TLRPC$TL_paymentFormMethod) this.additional_methods.get(i4)).serializeToStream(abstractSerializedData2);
                    }
                }
                if ((this.flags & 1) != 0) {
                ...
                if ((this.flags & 2) != 0) {
                    ...
                    for (int i5 = 0; i5 < size2; i5++) {
                        ((TLRPC$TL_paymentSavedCredentialsCard) this.saved_credentials.get(i5)).serializeToStream(abstractSerializedData2);
                    }
                }
                abstractSerializedData2.writeInt32(481674261);
