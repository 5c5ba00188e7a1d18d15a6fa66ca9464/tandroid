...
public class TLRPC$PaymentForm extends TLObject {
    ...
    public static TLRPC$PaymentForm TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -1610250415) {
            tLRPC$PaymentForm = new TLRPC$PaymentForm() { // from class: org.telegram.tgnet.TLRPC$TL_payments_paymentForm
            ...
            tLRPC$PaymentForm = i != 2079764828 ? null : new TLRPC$PaymentForm() { // from class: org.telegram.tgnet.TLRPC$TL_payments_paymentFormStars
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
