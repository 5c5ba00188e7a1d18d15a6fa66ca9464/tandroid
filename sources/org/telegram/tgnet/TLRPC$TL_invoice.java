...
public class TLRPC$TL_invoice extends TLObject {
    ...
    public static TLRPC$TL_invoice TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_invoice tLRPC$TL_invoice = i != 1048946971 ? i != 1572428309 ? null : new TLRPC$TL_invoice() : new TLRPC$TL_invoice() { // from class: org.telegram.tgnet.TLRPC$TL_invoice_layer163
