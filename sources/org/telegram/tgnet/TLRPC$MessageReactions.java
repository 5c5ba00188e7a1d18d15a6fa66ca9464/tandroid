...
public abstract class TLRPC$MessageReactions extends TLObject {
    ...
    public static TLRPC$TL_messageReactions TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_messageReactions tLRPC$TL_messageReactions = i != -1199954735 ? i != 142306870 ? i != 171155211 ? i != 1328256121 ? null : new TLRPC$TL_messageReactions() { // from class: org.telegram.tgnet.TLRPC$TL_messageReactions_layer185
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                abstractSerializedData2.writeInt32(1328256121);
                int i2 = this.min ? this.flags | 1 : this.flags & (-2);
                this.flags = i2;
                int i3 = this.can_see_list ? i2 | 4 : i2 & (-5);
                this.flags = i3;
                int i4 = this.reactions_as_tags ? i3 | 8 : i3 & (-9);
                this.flags = i4;
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    ((TLRPC$ReactionCount) this.results.get(i5)).serializeToStream(abstractSerializedData2);
                }
                if ((this.flags & 2) != 0) {
                    abstractSerializedData2.writeInt32(481674261);
                    ...
                    for (int i6 = 0; i6 < size2; i6++) {
                        ((TLRPC$MessagePeerReaction) this.recent_reactions.get(i6)).serializeToStream(abstractSerializedData2);
                    }
                }
            }
        } : new TLRPC$TL_messageReactions() : new TLRPC$TL_messageReactions() { // from class: org.telegram.tgnet.TLRPC$TL_messageReactionsOld
            @Override // org.telegram.tgnet.TLRPC$TL_messageReactions, org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ((TLRPC$ReactionCount) this.results.get(i4)).serializeToStream(abstractSerializedData2);
                }
                if ((this.flags & 2) != 0) {
                    abstractSerializedData2.writeInt32(481674261);
                    int size2 = this.recent_reactions.size();
                    ...
                    for (int i5 = 0; i5 < size2; i5++) {
                        ((TLRPC$MessagePeerReaction) this.recent_reactions.get(i5)).serializeToStream(abstractSerializedData2);
                    }
                }
            }
        } : new TLRPC$TL_messageReactions() { // from class: org.telegram.tgnet.TLRPC$TL_messageReactions_layer137
            @Override // org.telegram.tgnet.TLRPC$TL_messageReactions, org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ((TLRPC$ReactionCount) this.results.get(i3)).serializeToStream(abstractSerializedData2);
                }
            }
        };
