...
public abstract class TLRPC$WebPageAttribute extends TLObject {
    ...
    public static TLRPC$WebPageAttribute TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$WebPageAttribute tLRPC$TL_webPageAttributeTheme = i != -1818605967 ? i != 781501415 ? i != 1355547603 ? i != 1421174295 ? null : new TLRPC$TL_webPageAttributeTheme() : new TLRPC$TL_webPageAttributeStickerSet() : new TLRPC$TL_webPageAttributeStory() : new TLRPC$TL_webPageAttributeStory() { // from class: org.telegram.tgnet.TLRPC$TL_webPageAttributeStory_layer162
