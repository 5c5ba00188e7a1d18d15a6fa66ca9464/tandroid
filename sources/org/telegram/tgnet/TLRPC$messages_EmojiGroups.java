...
public abstract class TLRPC$messages_EmojiGroups extends TLObject {
    public static TLRPC$messages_EmojiGroups TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_EmojiGroups tLRPC$TL_messages_emojiGroups = i != -2011186869 ? i != 1874111879 ? null : new TLRPC$messages_EmojiGroups() { // from class: org.telegram.tgnet.TLRPC$TL_messages_emojiGroupsNotModified
