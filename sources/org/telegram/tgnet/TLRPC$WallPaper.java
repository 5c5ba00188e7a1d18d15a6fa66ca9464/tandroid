...
public abstract class TLRPC$WallPaper extends TLObject {
    ...
    public static TLRPC$WallPaper TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$WallPaper tLRPC$TL_wallPaperNoFile = i != -1963717851 ? i != -1539849235 ? i != -528465642 ? i != -263220756 ? null : new TLRPC$TL_wallPaper() { // from class: org.telegram.tgnet.TLRPC$TL_wallPaper_layer94
        ...
        } : new TLRPC$TL_wallPaperNoFile() : new TLRPC$TL_wallPaper() : new TLRPC$TL_wallPaperNoFile() { // from class: org.telegram.tgnet.TLRPC$TL_wallPaperNoFile_layer128
        ...
        if (tLRPC$TL_wallPaperNoFile == null && z) {
            throw new RuntimeException(String.format("can't parse magic %x in WallPaper", Integer.valueOf(i)));
        }
        if (tLRPC$TL_wallPaperNoFile != null) {
            tLRPC$TL_wallPaperNoFile.readParams(abstractSerializedData, z);
        }
        return tLRPC$TL_wallPaperNoFile;
    }
}
