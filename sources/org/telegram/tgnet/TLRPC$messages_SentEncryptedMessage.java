...
public abstract class TLRPC$messages_SentEncryptedMessage extends TLObject {
    ...
    public static TLRPC$messages_SentEncryptedMessage TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_SentEncryptedMessage tLRPC$messages_SentEncryptedMessage = i != -1802240206 ? i != 1443858741 ? null : new TLRPC$messages_SentEncryptedMessage() { // from class: org.telegram.tgnet.TLRPC$TL_messages_sentEncryptedMessage
        ...
        } : new TLRPC$messages_SentEncryptedMessage() { // from class: org.telegram.tgnet.TLRPC$TL_messages_sentEncryptedFile
            @Override // org.telegram.tgnet.TLObject
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                this.date = abstractSerializedData2.readInt32(z2);
