...
public class TL_stories$MediaArea extends TLObject {
    ...
    public static TL_stories$MediaArea TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -2057362882:
                tL_stories$MediaArea = new TL_stories$MediaArea() { // from class: org.telegram.tgnet.tl.TL_stories$TL_mediaAreaWeather2
                    public String emoji;
            ...
            case -891992787:
                ...
                break;
            case -544523486:
                tL_stories$MediaArea = new TL_stories$TL_mediaAreaGeoPoint() { // from class: org.telegram.tgnet.tl.TL_stories$TL_mediaAreaGeoPoint_layer181
            ...
            case 926421125:
                ...
                break;
            case 1132918857:
                tL_stories$MediaArea = new TL_stories$MediaArea() { // from class: org.telegram.tgnet.tl.TL_stories$TL_mediaAreaWeatherOld
                    public String emoji;
