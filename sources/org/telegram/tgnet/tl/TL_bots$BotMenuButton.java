...
public abstract class TL_bots$BotMenuButton extends TLObject {
    public static TL_bots$BotMenuButton TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -944407322) {
            ...
            tL_bots$TL_botMenuButton = i != 1966318984 ? null : new TL_bots$BotMenuButton() { // from class: org.telegram.tgnet.tl.TL_bots$TL_botMenuButtonDefault
            ...
            tL_bots$TL_botMenuButton = new TL_bots$BotMenuButton() { // from class: org.telegram.tgnet.tl.TL_bots$TL_botMenuButtonCommands
                @Override // org.telegram.tgnet.TLObject
                public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
