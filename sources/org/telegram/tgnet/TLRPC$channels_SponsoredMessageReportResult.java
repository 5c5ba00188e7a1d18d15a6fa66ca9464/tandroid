...
public abstract class TLRPC$channels_SponsoredMessageReportResult extends TLObject {
    public static TLRPC$channels_SponsoredMessageReportResult TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -2073059774) {
            ...
            tLRPC$TL_channels_sponsoredMessageReportResultChooseOption = i != 1044107055 ? null : new TLRPC$channels_SponsoredMessageReportResult() { // from class: org.telegram.tgnet.TLRPC$TL_channels_sponsoredMessageReportResultAdsHidden
            ...
            tLRPC$TL_channels_sponsoredMessageReportResultChooseOption = new TLRPC$channels_SponsoredMessageReportResult() { // from class: org.telegram.tgnet.TLRPC$TL_channels_sponsoredMessageReportResultReported
                @Override // org.telegram.tgnet.TLObject
                public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
