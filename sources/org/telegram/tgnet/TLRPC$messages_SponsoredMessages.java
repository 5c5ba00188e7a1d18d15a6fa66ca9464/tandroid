...
public abstract class TLRPC$messages_SponsoredMessages extends TLObject {
    ...
    public static TLRPC$messages_SponsoredMessages TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_SponsoredMessages tLRPC$messages_SponsoredMessages = i != -907141753 ? i != 406407439 ? null : new TLRPC$messages_SponsoredMessages() { // from class: org.telegram.tgnet.TLRPC$TL_messages_sponsoredMessagesEmpty
            @Override // org.telegram.tgnet.TLObject
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                abstractSerializedData2.writeInt32(406407439);
            }
        } : new TLRPC$messages_SponsoredMessages() { // from class: org.telegram.tgnet.TLRPC$TL_messages_sponsoredMessages
            @Override // org.telegram.tgnet.TLObject
