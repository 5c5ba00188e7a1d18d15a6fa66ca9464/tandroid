...
public abstract class TLRPC$StarsTransactionPeer extends TLObject {
    ...
    public static TLRPC$StarsTransactionPeer TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1779253276:
                tLRPC$StarsTransactionPeer = new TLRPC$StarsTransactionPeer() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransactionPeerUnsupported
                ...
                break;
            case -1269320843:
                tLRPC$StarsTransactionPeer = new TLRPC$StarsTransactionPeer() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransactionPeerAppStore
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    }
            ...
            case -670195363:
                ...
                break;
            case -382740222:
                tLRPC$StarsTransactionPeer = new TLRPC$StarsTransactionPeer() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransactionPeerFragment
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    }
                ...
                break;
            case 621656824:
                tLRPC$StarsTransactionPeer = new TLRPC$StarsTransactionPeer() { // from class: org.telegram.tgnet.TLRPC$TL_starsTransactionPeerPremiumBot
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    }
