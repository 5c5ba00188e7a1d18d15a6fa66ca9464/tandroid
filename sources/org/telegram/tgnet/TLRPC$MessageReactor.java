...
public abstract class TLRPC$MessageReactor extends TLObject {
    ...
    public static TLRPC$MessageReactor TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_messageReactor tLRPC$TL_messageReactor = i != -285158328 ? i != 1269016922 ? null : new TLRPC$TL_messageReactor() : new TLRPC$TL_messageReactor() { // from class: org.telegram.tgnet.TLRPC$TL_messageReactor_old
