...
public abstract class TLRPC$messages_StickerSetInstallResult extends TLObject {
    ...
    public static TLRPC$messages_StickerSetInstallResult TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_StickerSetInstallResult tLRPC$messages_StickerSetInstallResult = i != 904138920 ? i != 946083368 ? null : new TLRPC$messages_StickerSetInstallResult() { // from class: org.telegram.tgnet.TLRPC$TL_messages_stickerSetInstallResultSuccess
            @Override // org.telegram.tgnet.TLObject
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                abstractSerializedData2.writeInt32(946083368);
            }
        } : new TLRPC$messages_StickerSetInstallResult() { // from class: org.telegram.tgnet.TLRPC$TL_messages_stickerSetInstallResultArchive
            @Override // org.telegram.tgnet.TLObject
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ((TLRPC$StickerSetCovered) this.sets.get(i2)).serializeToStream(abstractSerializedData2);
                }
            }
        };
