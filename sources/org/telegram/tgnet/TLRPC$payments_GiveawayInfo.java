...
public abstract class TLRPC$payments_GiveawayInfo extends TLObject {
    public static TLRPC$payments_GiveawayInfo TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$payments_GiveawayInfo tLRPC$TL_payments_giveawayInfo = i != -512366993 ? i != 13456752 ? i != 1130879648 ? null : new TLRPC$TL_payments_giveawayInfo() : new TLRPC$TL_payments_giveawayInfoResults() { // from class: org.telegram.tgnet.TLRPC$TL_payments_giveawayInfoResults_layer186
