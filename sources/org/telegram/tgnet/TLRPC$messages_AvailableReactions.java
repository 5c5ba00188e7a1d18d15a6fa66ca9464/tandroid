...
public abstract class TLRPC$messages_AvailableReactions extends TLObject {
    public static TLRPC$messages_AvailableReactions TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_AvailableReactions tLRPC$TL_messages_availableReactions = i != -1626924713 ? i != 1989032621 ? null : new TLRPC$TL_messages_availableReactions() : new TLRPC$messages_AvailableReactions() { // from class: org.telegram.tgnet.TLRPC$TL_messages_availableReactionsNotModified
