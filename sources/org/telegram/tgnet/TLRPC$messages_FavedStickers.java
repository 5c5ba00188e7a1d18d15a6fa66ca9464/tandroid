...
public abstract class TLRPC$messages_FavedStickers extends TLObject {
    ...
    public static TLRPC$messages_FavedStickers TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_FavedStickers tLRPC$messages_FavedStickers = i != -1634752813 ? i != 750063767 ? null : new TLRPC$messages_FavedStickers() { // from class: org.telegram.tgnet.TLRPC$TL_messages_favedStickers
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ((TLRPC$Document) this.stickers.get(i3)).serializeToStream(abstractSerializedData2);
                }
            }
        } : new TLRPC$messages_FavedStickers() { // from class: org.telegram.tgnet.TLRPC$TL_messages_favedStickersNotModified
            @Override // org.telegram.tgnet.TLObject
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
