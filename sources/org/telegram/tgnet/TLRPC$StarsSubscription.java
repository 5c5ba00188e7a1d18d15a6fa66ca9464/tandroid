...
public class TLRPC$StarsSubscription extends TLObject {
    ...
    public static TLRPC$StarsSubscription TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_starsSubscription tLRPC$TL_starsSubscription = i != -797707802 ? i != 1401868056 ? null : new TLRPC$TL_starsSubscription() : new TLRPC$TL_starsSubscription() { // from class: org.telegram.tgnet.TLRPC$TL_starsSubscription_old
            @Override // org.telegram.tgnet.TLRPC$TL_starsSubscription, org.telegram.tgnet.TLObject
