...
public abstract class TLRPC$PeerSettings extends TLObject {
    ...
    public static TLRPC$PeerSettings TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_peerSettings tLRPC$TL_peerSettings = i != -1525149427 ? i != -1395233698 ? null : new TLRPC$TL_peerSettings() : new TLRPC$TL_peerSettings() { // from class: org.telegram.tgnet.TLRPC$TL_peerSettings_layer176
