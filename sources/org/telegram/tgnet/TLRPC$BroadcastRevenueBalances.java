...
public abstract class TLRPC$BroadcastRevenueBalances extends TLObject {
    ...
    public static TLRPC$BroadcastRevenueBalances TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_broadcastRevenueBalances tLRPC$TL_broadcastRevenueBalances = i != -2076642874 ? i != -1006669337 ? null : new TLRPC$TL_broadcastRevenueBalances() : new TLRPC$TL_broadcastRevenueBalances() { // from class: org.telegram.tgnet.TLRPC$TL_broadcastRevenueBalances_layer186
