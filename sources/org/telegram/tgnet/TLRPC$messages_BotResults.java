...
public abstract class TLRPC$messages_BotResults extends TLObject {
    ...
    public static TLRPC$messages_BotResults TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_BotResults tLRPC$TL_messages_botResults_layer153 = i != -1803769784 ? i != -858565059 ? i != -534646026 ? null : new TLRPC$messages_BotResults() { // from class: org.telegram.tgnet.TLRPC$TL_messages_botResults
        ...
        } : new TLRPC$TL_messages_botResults_layer153() { // from class: org.telegram.tgnet.TLRPC$TL_messages_botResults_layer71
