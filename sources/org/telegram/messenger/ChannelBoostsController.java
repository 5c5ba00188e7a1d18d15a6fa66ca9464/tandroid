...
public class ChannelBoostsController {
    ...
    public static /* synthetic */ void lambda$applyBoost$4(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    }
    ...
    public void getBoostsStats(long j, final Consumer<TLRPC$TL_stories_boostsStatus> consumer) {
        ...
        this.connectionsManager.sendRequest(tLRPC$TL_stories_getBoostsStatus, new RequestDelegate() { // from class: org.telegram.messenger.ChannelBoostsController$$ExternalSyntheticLambda2
    ...
    public void userCanBoostChannel(long j, final Consumer<CanApplyBoost> consumer) {
        ...
        this.connectionsManager.sendRequest(tLRPC$TL_stories_canApplyBoost, new RequestDelegate() { // from class: org.telegram.messenger.ChannelBoostsController$$ExternalSyntheticLambda3
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$userCanBoostChannel$3(final Consumer consumer, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$userCanBoostChannel$2(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error, Consumer consumer) {
    ...
    public void applyBoost(long j) {
        ...
        this.connectionsManager.sendRequest(tLRPC$TL_stories_applyBoost, ChannelBoostsController$$ExternalSyntheticLambda4.INSTANCE);
    }
