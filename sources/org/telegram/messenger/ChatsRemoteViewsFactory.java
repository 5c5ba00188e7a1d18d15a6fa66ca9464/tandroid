    ...
    */
    public RemoteViews getViewAt(int i) {
        ...
        if (messageObject != null) {
                ...
                if (tLRPC$Chat != null && chat == null && (!ChatObject.isChannel(tLRPC$Chat) || ChatObject.isMegagroup(tLRPC$Chat))) {
                    ...
                    try {
                        if (charSequence6 != null) {
                            ...
                            valueOf = SpannableStringBuilder.valueOf(String.format("%2$s: \u2068%1$s\u2069", str3 + charSequence7.replace('\n', ' '), str4));
                            ...
                            if (tLRPC$MessageMedia instanceof TLRPC$TL_messageMediaPoll) {
                                ...
                                objArr[0] = charSequence2.replace('\n', c2);
                                objArr[c] = str4;
                                SpannableStringBuilder valueOf2 = SpannableStringBuilder.valueOf(String.format("%2$s: \u2068%1$s\u2069", objArr));
                                valueOf2.setSpan(new ForegroundColorSpanThemable(Theme.key_chats_attachMessage), str4.length() + 2, valueOf2.length(), 33);
                                color = color2;
                            ...
                            valueOf22.setSpan(new ForegroundColorSpanThemable(Theme.key_chats_attachMessage), str4.length() + 2, valueOf22.length(), 33);
                            color = color2;
                            ...
                            if (str5 != null) {
                                ...
                                valueOf = SpannableStringBuilder.valueOf(String.format("%2$s: \u2068%1$s\u2069", str5.replace('\n', ' ').trim(), str4));
                            } else {
            ...
            remoteViews3.setTextViewText(i4, charSequence3.toString());
        ...
        if (tLRPC$Dialog != null && (i3 = tLRPC$Dialog.unread_count) > 0) {
            int i5 = R.id.shortcut_widget_item_badge;
            remoteViews3.setTextViewText(i5, String.format("%d", Integer.valueOf(i3)));
            remoteViews3.setViewVisibility(i5, 0);
            if (this.accountInstance.getMessagesController().isDialogMuted(tLRPC$Dialog.id, 0L)) {
                remoteViews3.setBoolean(i5, "setEnabled", false);
                remoteViews3.setInt(i5, "setBackgroundResource", R.drawable.widget_badge_muted_background);
            } else {
                remoteViews3.setBoolean(i5, "setEnabled", true);
                remoteViews3.setInt(i5, "setBackgroundResource", R.drawable.widget_badge_background);
            }
        } else {
