...
public class NotificationCenter {
    ...
    static {
        ...
        int i167 = i166 + 1;
        totalEvents = i167;
        pushMessagesUpdated = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        stopEncodingService = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        wallpapersDidLoad = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        wallpapersNeedReload = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        didReceiveSmsCode = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        didReceiveCall = i171;
        int i173 = i172 + 1;
        ...
        int i174 = i173 + 1;
        totalEvents = i174;
        invalidateMotionBackground = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        closeOtherAppActivities = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        cameraInitied = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        didReplacedPhotoInMemCache = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        didSetNewTheme = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        themeListUpdated = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        didApplyNewTheme = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        themeAccentListUpdated = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        needCheckSystemBarColors = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        needShareTheme = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        needSetDayNightTheme = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        goingToPreviewTheme = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        locationPermissionGranted = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        locationPermissionDenied = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        reloadInterface = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        suggestedLangpack = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        didSetNewWallpapper = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        proxySettingsChanged = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        proxyCheckDone = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        proxyChangedByRotation = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        liveLocationsChanged = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        newLocationAvailable = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        liveLocationsCacheChanged = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        notificationsCountUpdated = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        playerDidStartPlaying = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        closeSearchByActiveAction = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        messagePlayingSpeedChanged = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        screenStateChanged = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        didClearDatabase = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        voipServiceCreated = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        webRtcMicAmplitudeEvent = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        webRtcSpeakerAmplitudeEvent = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        showBulletin = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        appUpdateAvailable = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        onDatabaseMigration = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        onEmojiInteractionsReceived = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        emojiPreviewThemesChanged = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        reactionsDidLoad = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        attachMenuBotsDidLoad = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        chatAvailableReactionsUpdated = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        dialogsUnreadReactionsCounterChanged = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        onDatabaseOpened = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        onDownloadingFilesChanged = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        onActivityResultReceived = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        onRequestPermissionResultReceived = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        onUserRingtonesUpdated = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        currentUserPremiumStatusChanged = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        premiumPromoUpdated = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        premiumStatusChangedGlobal = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        currentUserShowLimitReachedDialog = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        billingProductDetailsUpdated = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        premiumStickersPreviewLoaded = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        userEmojiStatusUpdated = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        requestPermissions = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        permissionsGranted = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        topicsDidLoaded = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
