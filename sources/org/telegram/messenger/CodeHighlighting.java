...
public class CodeHighlighting {
    ...
    public static class StreamReader {
        ...
        public int readUint16() {
            return (this.is.read() & NotificationCenter.notificationsCountUpdated) | ((this.is.read() & NotificationCenter.notificationsCountUpdated) << 8);
        }

        public int readUint8() {
            return this.is.read() & NotificationCenter.notificationsCountUpdated;
        }
    }
