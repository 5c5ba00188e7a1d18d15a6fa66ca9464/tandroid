...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_HEAVY(new long[]{7}, new int[]{NotificationCenter.didClearDatabase}, new long[]{80}),
    IMPACT_RIGID(new long[]{3}, new int[]{NotificationCenter.didReceiveCall}, new long[]{50}),
    IMPACT_SOFT(new long[]{10}, new int[]{NotificationCenter.themeUploadedToServer}, new long[]{55}),
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{NotificationCenter.storyQualityUpdate, 0, NotificationCenter.storyQualityUpdate, 0, NotificationCenter.didClearDatabase, 0, NotificationCenter.messagePlayingDidReset}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{NotificationCenter.themeUploadedToServer, 0, NotificationCenter.didClearDatabase}, new long[]{50, 60, 65}),
    NOTIFICATION_WARNING(new long[]{14, 64, 14}, new int[]{NotificationCenter.didReceiveCall, 0, NotificationCenter.themeUploadedToServer}, new long[]{65, 60, 40}),
