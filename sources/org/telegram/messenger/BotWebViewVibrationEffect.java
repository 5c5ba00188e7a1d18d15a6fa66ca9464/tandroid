...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_HEAVY(new long[]{7}, new int[]{NotificationCenter.newLocationAvailable}, new long[]{80}),
    ...
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{NotificationCenter.storyQualityUpdate, 0, NotificationCenter.storyQualityUpdate, 0, NotificationCenter.newLocationAvailable, 0, NotificationCenter.messagePlayingDidReset}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{NotificationCenter.themeUploadedToServer, 0, NotificationCenter.newLocationAvailable}, new long[]{50, 60, 65}),
