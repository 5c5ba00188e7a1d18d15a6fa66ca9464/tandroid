    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.fileUploaded) {
            ...
            if (!this.canceled && str.equals(this.filePath)) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_uploadRingtone, new RequestDelegate() { // from class: org.telegram.messenger.ringtone.RingtoneUploader$$ExternalSyntheticLambda0
