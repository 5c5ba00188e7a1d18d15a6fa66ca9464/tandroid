...
public class TranslateController extends BaseController {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkTranslation$4(MessageObject messageObject, boolean z, long j, Integer num, TLRPC$TL_textWithEntities tLRPC$TL_textWithEntities, String str) {
    ...
    public /* synthetic */ void lambda$pushToTranslate$16(final long j, final PendingTranslation pendingTranslation) {
        ...
        int sendRequest = getConnectionsManager().sendRequest(tLRPC$TL_messages_translateText, new RequestDelegate() { // from class: org.telegram.messenger.TranslateController$$ExternalSyntheticLambda15
    ...
    */
    public boolean canTranslatePhoto(MessageObject messageObject, String str) {
        ...
        String str2;
        if (messageObject != null && (tLRPC$Message2 = messageObject.messageOwner) != null && (str2 = tLRPC$Message2.originalLanguage) != null) {
            str = str2;
        }
        if (messageObject != null && (tLRPC$Message = messageObject.messageOwner) != null && !TextUtils.isEmpty(tLRPC$Message.message)) {
            if (str == null) {
                TLRPC$Message tLRPC$Message3 = messageObject.messageOwner;
                if (tLRPC$Message3.translatedText != null) {
                }
            }
            if (str != null) {
            }
    ...
    public void detectStoryLanguage(final TL_stories$StoryItem tL_stories$StoryItem) {
        ...
        LanguageDetector.detectLanguage(tL_stories$StoryItem.caption, new LanguageDetector.StringCallback() { // from class: org.telegram.messenger.TranslateController$$ExternalSyntheticLambda33
            @Override // org.telegram.messenger.LanguageDetector.StringCallback
    ...
    public void translatePhoto(final MessageObject messageObject, final Runnable runnable) {
        ...
        if (tLRPC$Message.translatedText != null && TextUtils.equals(tLRPC$Message.translatedToLanguage, toLanguage)) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_messages_translateText, new RequestDelegate() { // from class: org.telegram.messenger.TranslateController$$ExternalSyntheticLambda32
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public void translateStory(final TL_stories$StoryItem tL_stories$StoryItem, final Runnable runnable) {
        ...
        if (tL_stories$StoryItem.translatedText != null && TextUtils.equals(tL_stories$StoryItem.translatedLng, toLanguage)) {
            ...
            tLRPC$TL_messages_translateText.text.add(tLRPC$TL_textWithEntities);
            tLRPC$TL_messages_translateText.to_lang = toLanguage;
            getConnectionsManager().sendRequest(tLRPC$TL_messages_translateText, new RequestDelegate() { // from class: org.telegram.messenger.TranslateController$$ExternalSyntheticLambda35
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
