...
public class BirthdayController {
    ...
    public void check() {
        ...
        if (z) {
            this.loading = true;
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC.TL_account_getBirthdays(), new RequestDelegate() { // from class: org.telegram.messenger.BirthdayController$$ExternalSyntheticLambda1
