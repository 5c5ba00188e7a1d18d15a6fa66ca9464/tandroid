...
public class BillingController implements PurchasesUpdatedListener, BillingClientStateListener {
    ...
    public static /* synthetic */ void lambda$consumeGiftPurchase$8(BillingResult billingResult, String str) {
    }
            ...
            for (final Purchase purchase : list) {
                ...
                if (!this.requestingTokens.contains(purchase.getPurchaseToken()) && purchase.getPurchaseState() == 1 && (extractDeveloperPayload = BillingUtilities.extractDeveloperPayload(purchase)) != null && extractDeveloperPayload.first != null) {
                    if (!purchase.isAcknowledged()) {
                        ...
                        retrievePurpose(purchase, extractDeveloperPayload, new Utilities.Callback() { // from class: org.telegram.messenger.BillingController$$ExternalSyntheticLambda11
    ...
    public /* synthetic */ void lambda$onPurchasesUpdated$5(final Purchase purchase, final BillingResult billingResult, Pair pair) {
        ...
        accountInstance.getConnectionsManager().sendRequest(tLRPC$TL_payments_assignPlayMarketTransaction, new RequestDelegate() { // from class: org.telegram.messenger.BillingController$$ExternalSyntheticLambda13
    ...
    private boolean retrievePurpose(Purchase purchase, final Pair<AccountInstance, TLRPC$InputStorePaymentPurpose> pair, final Utilities.Callback<Pair<AccountInstance, TLRPC$InputStorePaymentPurpose>> callback) {
        if (pair == null || pair.first == null) {
            ...
            callback.run(pair);
            return true;
        } else if (purchase == null || purchase.getProducts().isEmpty()) {
            ...
            if (optionsCached == null) {
                ConnectionsManager.getInstance(currentAccount).sendRequest(new TLRPC$TL_payments_getStarsTopupOptions(), new RequestDelegate() { // from class: org.telegram.messenger.BillingController$$ExternalSyntheticLambda12
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            while (true) {
                if (i >= optionsCached.size()) {
                    break;
                } else if (str.equals(optionsCached.get(i).store_product)) {
    ...
    public static /* synthetic */ void lambda$retrievePurpose$7(final String str, final Utilities.Callback callback, final Pair pair, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    public static /* synthetic */ void lambda$retrievePurpose$6(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error, String str, Utilities.Callback callback, Pair pair) {
        ...
        while (true) {
            if (i >= arrayList.size()) {
                break;
            } else if (str.equals(((TLRPC$TL_starsTopupOption) arrayList.get(i)).store_product)) {
