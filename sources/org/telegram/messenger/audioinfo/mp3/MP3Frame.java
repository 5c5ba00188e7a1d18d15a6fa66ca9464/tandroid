...
public class MP3Frame {
    ...
    public static class Header {
        ...
        private static final int[][] SIZE_COEFFICIENTS = {new int[]{-1, 72, NotificationCenter.messagePlayingProgressDidChanged, 12}, new int[]{-1, -1, -1, -1}, new int[]{-1, 72, NotificationCenter.messagePlayingProgressDidChanged, 12}, new int[]{-1, NotificationCenter.messagePlayingProgressDidChanged, NotificationCenter.messagePlayingProgressDidChanged, 12}};
