...
public class FilterChatlistActivity extends BaseFragment {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                frameLayout = new 1(FilterChatlistActivity.this.getContext(), FilterChatlistActivity.this);
            ...
            public void editname() {
                ...
                editTextBoldCursor.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda4
                    ...
                    public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                        ...
                        lambda$editname$5 = FilterChatlistActivity.ListAdapter.1.lambda$editname$5(AlertDialog.Builder.this, textView, i, keyEvent);
                ...
                builder.setPositiveButton(LocaleController.getString("Save", R.string.Save), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        FilterChatlistActivity.ListAdapter.1.this.lambda$editname$6(editTextBoldCursor, builder, dialogInterface, i);
                    }
                });
    ...
    public static class InviteLinkCell extends FrameLayout {
        ...
        public InviteLinkCell(Context context, BaseFragment baseFragment) {
            ...
            TextView textView2 = new TextView(this, context) { // from class: org.telegram.ui.FilterChatlistActivity.InviteLinkCell.2
                @Override // android.widget.TextView, android.view.View
                protected void onMeasure(int i, int i2) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i) - AndroidUtilities.dp(8.0f)) / 2, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(42.0f), 1073741824));
                }
