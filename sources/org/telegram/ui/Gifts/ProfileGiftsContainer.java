...
public abstract class ProfileGiftsContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileGiftsContainer(BaseFragment baseFragment, Context context, final int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda3
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemLongPress$1(String str) {
        AndroidUtilities.addToClipboard(str);
        BulletinFactory.of(this.fragment).createCopyLinkBulletin(false).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemLongPress$2(TL_stars.UserStarGift userStarGift) {
        new StarGiftSheet(getContext(), this.currentAccount, this.userId, this.resourcesProvider) { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer.2
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemLongPress$3(TL_stars.UserStarGift userStarGift) {
        new StarGiftSheet(getContext(), this.currentAccount, this.userId, this.resourcesProvider) { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer.3
            @Override // org.telegram.ui.Stars.StarGiftSheet
            protected BulletinFactory getBulletinFactory() {
                return BulletinFactory.of(ProfileGiftsContainer.this.fragment);
            }
    ...
    public boolean onItemLongPress(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (obj instanceof TL_stars.UserStarGift) {
            ...
            if (starGift instanceof TL_stars.TL_starGiftUnique) {
                ...
                ItemOptions.makeOptions(this.fragment, view).addIf(str != null, R.drawable.msg_link, LocaleController.getString(R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        ProfileGiftsContainer.this.lambda$onItemLongPress$1(str);
                    }
                }).addIf(str != null, R.drawable.msg_share, LocaleController.getString(R.string.ShareFile), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        ProfileGiftsContainer.this.lambda$onItemLongPress$2(userStarGift);
                    }
                }).addIf(((TL_stars.TL_starGiftUnique) userStarGift.gift).owner_id == UserConfig.getInstance(this.currentAccount).getClientUserId(), R.drawable.menu_feature_transfer, LocaleController.getString(R.string.Gift2TransferOption), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
