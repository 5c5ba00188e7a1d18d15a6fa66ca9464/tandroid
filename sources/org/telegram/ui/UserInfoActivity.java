    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (i2 == 1) {
            ...
            if (i2 == 3) {
                ...
                TLRPC$Chat tLRPC$Chat = this.channel;
                openingHoursActivity = new ChooseChannelFragment(adminedChannelsFetcher, tLRPC$Chat == null ? 0L : tLRPC$Chat.id, new Utilities.Callback() { // from class: org.telegram.ui.UserInfoActivity$$ExternalSyntheticLambda4
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
