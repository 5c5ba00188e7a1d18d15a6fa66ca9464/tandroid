...
public class UserInfoActivity extends UniversalFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onClick$2(TLRPC$TL_birthday tLRPC$TL_birthday) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onClick$3(TLRPC$Chat tLRPC$Chat) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processDone$5(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$TL_birthday tLRPC$TL_birthday, TLRPC$UserFull tLRPC$UserFull, TLObject tLObject2, int[] iArr, ArrayList arrayList) {
        String str;
    ...
    public static class ChooseChannelFragment extends UniversalFragment {
        ...
        public ChooseChannelFragment(AdminedChannelsFetcher adminedChannelsFetcher, long j, Utilities.Callback<TLRPC$Chat> callback) {
            ...
            adminedChannelsFetcher.subscribe(new Runnable() { // from class: org.telegram.ui.UserInfoActivity$ChooseChannelFragment$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onResume() {
            ...
            if (this.invalidateAfterPause) {
                this.channels.invalidate();
                this.channels.subscribe(new Runnable() { // from class: org.telegram.ui.UserInfoActivity$ChooseChannelFragment$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
