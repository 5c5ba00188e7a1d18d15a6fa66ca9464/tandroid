...
public class WebViewAttachedSheet$ErrorContainer extends FrameLayout {
    ...
    public void setDark(boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.WebViewAttachedSheet$ErrorContainer$$ExternalSyntheticLambda0
