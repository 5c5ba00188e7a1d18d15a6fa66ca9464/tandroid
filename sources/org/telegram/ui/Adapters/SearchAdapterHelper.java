    ...
    public void queryServerSearch(final String str, boolean z, final boolean z2, final boolean z3, final boolean z4, final boolean z5, long j, boolean z6, int i, final int i2, final long j2, final Runnable runnable) {
        ...
        if (str.length() > 0) {
            if (j != 0) {
                ...
                tLRPC$TL_channels_getParticipants.filter = i == 1 ? new TLRPC$TL_channelParticipantsAdmins() : i == 3 ? new TLRPC$TL_channelParticipantsBanned() : i == 0 ? new TLRPC$TL_channelParticipantsKicked() : new TLRPC$TL_channelParticipantsSearch();
                ...
                arrayList.add(new Pair(tLRPC$TL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda0
        ...
        if (z) {
            ...
            arrayList.add(new Pair(tLRPC$TL_contacts_search, new RequestDelegate() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda1
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
