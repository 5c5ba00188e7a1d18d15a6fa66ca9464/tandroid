...
public class CacheControlActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void loadDialogEntities() {
        getFileLoader().getFileDatabase().getQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadDialogEntities$4() {
        ...
        getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadDialogEntities$3(ArrayList arrayList, ArrayList arrayList2, final ArrayList arrayList3, final CacheModel cacheModel) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadDialogEntities$2(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, CacheModel cacheModel) {
        boolean z;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ int lambda$sort$5(DialogFileEntities dialogFileEntities, DialogFileEntities dialogFileEntities2) {
    ...
    */
    private void updateRows(boolean z) {
        ...
        CacheModel cacheModel;
        boolean z4 = (!z || System.currentTimeMillis() - this.fragmentCreateTime >= 80) ? z : false;
        this.oldItems.clear();
        ...
        if (this.calculating) {
            ...
            if (this.photoSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalPhotoCache), 0, this.photoSize, "statisticChartLine_lightblue"));
            }
            if (this.videoSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalVideoCache), 1, this.videoSize, "statisticChartLine_blue"));
            }
            if (this.documentsSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalDocumentCache), 2, this.documentsSize, "statisticChartLine_green"));
            }
            if (this.musicSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalMusicCache), 3, this.musicSize, "statisticChartLine_red"));
            }
            if (this.audioSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalAudioCache), 4, this.audioSize, "statisticChartLine_lightgreen"));
            }
            if (this.stickersCacheSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalStickersCache), 5, this.stickersCacheSize, "statisticChartLine_orange"));
            }
            if (this.cacheSize > 0) {
                z2 = z4;
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalProfilePhotosCache), 6, this.cacheSize, "statisticChartLine_cyan"));
            } else {
                z2 = z4;
            }
            if (this.cacheTempSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalMiscellaneousCache), 7, this.cacheTempSize, "statisticChartLine_purple"));
            }
            if (!arrayList.isEmpty()) {
                Collections.sort(arrayList, CacheControlActivity$$ExternalSyntheticLambda15.INSTANCE);
                ...
                if (arrayList.size() > 5) {
                    ...
                    this.percents[8] = i2;
                    this.itemInners.add(ItemInner.asCheckBox(LocaleController.getString(R.string.LocalOther), -1, j, "statisticChartLine_golden"));
                    if (!this.collapsed) {
                ...
                if (!z3) {
                    ...
                    this.itemInners.add(ItemInner.asInfo(LocaleController.getString("StorageUsageInfo", R.string.StorageUsageInfo)));
                } else {
                    this.sectionsEndRow = -1;
                }
                this.itemInners.add(new ItemInner(3, LocaleController.getString("AutoDeleteCachedMedia", R.string.AutoDeleteCachedMedia), null));
                ...
                if (this.totalDeviceSize > 0) {
                    ...
                    this.itemInners.add(ItemInner.asInfo(LocaleController.getString("MaxCacheSizeInfo", R.string.MaxCacheSizeInfo)));
                }
                if (z3 && (cacheModel = this.cacheModel) != null && !cacheModel.isEmpty()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ int lambda$updateRows$6(ItemInner itemInner, ItemInner itemInner2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$cleanupFolders$8() {
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$cleanupFoldersInternal$9(boolean z, long j) {
        if (z) {
    ...
    public View createView(Context context) {
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda17
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$11(int i, int i2) {
    ...
    public void clearSelectedFiles() {
        ...
        builder.setPositiveButton(LocaleController.getString("ClearButton", R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda2
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$clearSelectedFiles$13(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateActionBar$14(ValueAnimator valueAnimator) {
    ...
    public void cleanupDialogFiles(DialogFileEntities dialogFileEntities, StorageDiagramView.ClearViewData[] clearViewDataArr, CacheModel cacheModel) {
        ...
        getFileLoader().cancelLoadAllFiles();
        getFileLoader().getFileLoaderQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$cleanupDialogFiles$16(ArrayList arrayList, final AlertDialog alertDialog) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$cleanupDialogFiles$15(AlertDialog alertDialog) {
        FileLoader.getInstance(this.currentAccount).checkCurrentDownloadsFiles();
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
    ...
    public void clearDatabase() {
        ...
        builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("CacheClear", R.string.CacheClear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$clearDatabase$17(DialogInterface dialogInterface, int i) {
        if (getParentActivity() == null) {
            return;
        }
        AlertDialog alertDialog = new AlertDialog(getParentActivity(), 3);
    ...
    public class CacheChartHeader extends FrameLayout {
        ...
        AnimatedFloat percentAnimated = new AnimatedFloat(this);
        AnimatedFloat loadingFloat = new AnimatedFloat(this);
        Paint loadingBackgroundPaint = new Paint(1);
        Paint percentPaint = new Paint(1);
        ...
        public void setData(boolean z, float f) {
            ...
            if (this.firstSet) {
                ...
                animate.alpha(f2).setDuration(365L).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).start();
            }
            this.firstSet = false;
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.progressRect, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), this.loadingBackgroundPaint);
            ...
            rectF.set(f4, rectF2.top, ((1.0f - f) * Math.max(AndroidUtilities.dp(4.0f), f3 * this.progressRect.width())) + f4, this.progressRect.bottom);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), this.percentPaint);
            ...
            if (itemViewType == 0) {
                ...
                if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType != 0) {
                    if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType != 1) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("CacheChannels", R.string.CacheChannels), keepMediaString, true, false);
                        textCell.setColorfulIcon(CacheControlActivity.this.getThemedColor("statisticChartLine_golden"), R.drawable.msg_filled_menu_channels);
                        return;
                    }
                    textCell.setTextAndValue(LocaleController.getString("GroupChats", R.string.GroupChats), keepMediaString, true, true);
                    textCell.setColorfulIcon(CacheControlActivity.this.getThemedColor("statisticChartLine_green"), R.drawable.msg_filled_menu_groups);
                    return;
                }
                textCell.setTextAndValue(LocaleController.getString("PrivateChats", R.string.PrivateChats), keepMediaString, true, true);
                textCell.setColorfulIcon(CacheControlActivity.this.getThemedColor("statisticChartLine_lightblue"), R.drawable.msg_filled_menu_users);
                ...
                cacheChartHeader.setData(z, CacheControlActivity.this.totalDeviceSize <= 0 ? 0.0f : ((float) CacheControlActivity.this.totalSize) / ((float) CacheControlActivity.this.totalDeviceSize));
                ...
                checkBoxCell.setText(checkBoxTitle, formatFileSize, isOtherSelected, z);
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda16
    ...
    public static class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public UserCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            addView(this.imageView, LayoutHelper.createFrame(38, 38.0f, (!LocaleController.isRTL ? 3 : i) | 16, 17.0f, 0.0f, 17.0f, 0.0f));
        }
