...
public class CacheControlActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    class ClearingCacheView extends FrameLayout {
        ...
        public ClearingCacheView(Context context) {
            ...
            addView(progressView, LayoutHelper.createFrame(NotificationCenter.themeListUpdated, 5.0f, 49, 0.0f, 226.0f, 0.0f, 0.0f));
            TextView textView = new TextView(context);
            this.title = textView;
            ...
            addView(this.subtitle, LayoutHelper.createFrame(NotificationCenter.themeListUpdated, -2.0f, 49, 0.0f, 289.0f, 0.0f, 0.0f));
            setProgress(0.0f);
        }
