...
public class SpeedButtonsLayout extends LinearLayout {
    ...
    public SpeedButtonsLayout(Context context, final Callback callback) {
        ...
        addItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.SpeedButtonsLayout$$ExternalSyntheticLambda0
        ...
        addItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.SpeedButtonsLayout$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        addItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.SpeedButtonsLayout$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        addItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.SpeedButtonsLayout$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        addItem5.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.SpeedButtonsLayout$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
