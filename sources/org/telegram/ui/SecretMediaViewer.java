...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
        ...
        if (this.isPhotoVisible) {
            ...
            if (this.photoAnimationInProgress != 3) {
                if (this.scale != 1.0f || f9 == -1.0f || this.zoomAnimation) {
                    this.photoBackgroundDrawable.setAlpha(NotificationCenter.liveLocationsChanged);
                } else {
    ...
    */
    ...
    public void openMedia(final MessageObject messageObject, PhotoViewer.PhotoViewerProvider photoViewerProvider, final Runnable runnable, Runnable runnable2) {
        ...
        ObjectAnimator ofInt = ObjectAnimator.ofInt(this.photoBackgroundDrawable, (Property<PhotoBackgroundDrawable, Integer>) AnimationProperties.COLOR_DRAWABLE_ALPHA, 0, NotificationCenter.liveLocationsChanged);
