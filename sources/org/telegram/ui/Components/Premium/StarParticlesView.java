        ...
        private void generateBitmaps() {
            ...
            while (i2 < 3) {
                ...
                if (i3 == 9) {
                    ...
                    if (i2 == 0) {
                        this.stars[i2] = SvgHelper.getBitmap(R.raw.filled_premium_dollar, dp, dp, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey, this.resourcesProvider), NotificationCenter.voipServiceCreated));
                        this.flip[i2] = true;
                    }
