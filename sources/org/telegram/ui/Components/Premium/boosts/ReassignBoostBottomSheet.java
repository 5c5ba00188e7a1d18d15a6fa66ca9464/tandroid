        ...
        public void showChats(List<TLRPC$Chat> list, TLRPC$Chat tLRPC$Chat) {
            ...
            for (TLRPC$Chat tLRPC$Chat4 : arrayList) {
                ...
                if (avatarHolderView2 != null) {
                    avatarHolderView2.animate().alpha(0.0f).translationXBy(60.0f).scaleX(f).scaleY(f).setDuration(150L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet.TopCell.1
