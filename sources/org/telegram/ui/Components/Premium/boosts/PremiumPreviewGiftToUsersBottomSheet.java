...
public class PremiumPreviewGiftToUsersBottomSheet extends PremiumPreviewBottomSheet {
    ...
    public PremiumPreviewGiftToUsersBottomSheet(BaseFragment baseFragment, int i, List list, List list2, Theme.ResourcesProvider resourcesProvider) {
    ...
    public static void show(List list, List list2) {
    ...
    private void updateActionButton(boolean z) {
        ...
        if (this.selectedUsers.size() == 1) {
            ...
            gradientButtonWithCounterView = this.actionBtn;
            formatPluralString = LocaleController.formatPluralString("GiftSubscriptionCountFor", this.selectedUsers.size(), formatCurrency);
        }
        gradientButtonWithCounterView.setText(formatPluralString, z);
    }
