...
public class BoostViaGiftsBottomSheet extends BottomSheetWithRecyclerListView implements SelectorBottomSheet.SelectedObjectsListener, NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$new$11(ChatActivity chatActivity, TLRPC$TL_starsGiveawayOption tLRPC$TL_starsGiveawayOption) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$12(final TLRPC$TL_starsGiveawayOption tLRPC$TL_starsGiveawayOption, Boolean bool, String str) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$15(TLRPC$TL_error tLRPC$TL_error) {
        this.actionBtn.updateLoading(false);
        BoostDialogs.showToastError(getContext(), tLRPC$TL_error);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$16(TLRPC$TL_premiumGiftCodeOption tLRPC$TL_premiumGiftCodeOption) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$19(TLRPC$TL_error tLRPC$TL_error) {
        this.actionBtn.updateLoading(false);
        BoostDialogs.showToastError(getContext(), tLRPC$TL_error);
    }
        ...
        if (this.selectedBoostType == BoostTypeCell.TYPE_STARS) {
            ...
            for (int i = 0; i < filterGiftOptions.size(); i++) {
                ...
                if (tLRPC$TL_premiumGiftCodeOption.months == this.selectedMonths && this.selectedUsers.size() > 0) {
                    ...
                    this.actionBtn.updateLoading(true);
                    BoostRepository.payGiftCode(this.selectedUsers, tLRPC$TL_premiumGiftCodeOption, this.currentChat, baseFragment, new Utilities.Callback() { // from class: org.telegram.ui.Components.Premium.boosts.BoostViaGiftsBottomSheet$$ExternalSyntheticLambda13
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj) {
    ...
    private void updateRows(boolean z, boolean z2) {
        ...
        if (this.selectedBoostType != BoostTypeCell.TYPE_STARS) {
            ...
            if (this.selectedBoostSubType == BoostTypeCell.TYPE_GIVEAWAY) {
                ...
                arrayList4.add(BoostAdapter.Item.asChat(tLRPC$Chat, z3, selectedSliderValueWithBoosts));
            ...
            if (!isPreparedGiveaway()) {
                ...
                while (i2 < filterGiftOptions.size()) {
                    TLRPC$TL_premiumGiftCodeOption tLRPC$TL_premiumGiftCodeOption = (TLRPC$TL_premiumGiftCodeOption) filterGiftOptions.get(i2);
                    this.items.add(BoostAdapter.Item.asDuration(tLRPC$TL_premiumGiftCodeOption, tLRPC$TL_premiumGiftCodeOption.months, isGiveaway() ? getSelectedSliderValue() : this.selectedUsers.size(), tLRPC$TL_premiumGiftCodeOption.amount, this.selectedMonths, tLRPC$TL_premiumGiftCodeOption.currency, i2 != filterGiftOptions.size() - 1));
                    i2++;
                }
            }
            if (!isPreparedGiveaway()) {
        ...
        if (isPreparedGiveaway()) {
            ...
            if (tL_stories$PrepaidGiveaway instanceof TL_stories$TL_prepaidStarsGiveaway) {
                this.selectedStars = ((TL_stories$TL_prepaidStarsGiveaway) tL_stories$PrepaidGiveaway).stars;
            }
        } else {
            ...
            while (i3 < starsOptions.size()) {
                TLRPC$TL_starsGiveawayOption selectedStarsOption = getSelectedStarsOption(((Long) starsOptions.get(i3)).longValue());
        ...
        arrayList10.add(BoostAdapter.Item.asChat(tLRPC$Chat2, z8, selectedSliderValueWithBoosts2));
