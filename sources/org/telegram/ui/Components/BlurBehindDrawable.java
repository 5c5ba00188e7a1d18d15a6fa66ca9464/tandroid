    ...
    public class BlurBackgroundTask implements Runnable {
        ...
        public void run() {
            ...
            while (i2 < 2) {
                ...
                BlurBehindDrawable.this.emptyPaint.setAlpha(NotificationCenter.closeSearchByActiveAction);
    ...
    private void generateBlurredBitmaps() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (bitmap == null || bitmap.getHeight() != dp || bitmapArr[i].getWidth() != this.parentView.getMeasuredWidth()) {
                ...
                this.emptyPaint.setAlpha(NotificationCenter.closeSearchByActiveAction);
                if (i == 1) {
