    ...
    */
    public void onDraw(Canvas canvas) {
        ...
        if (this.ellipsizeByGradient) {
            canvas.saveLayerAlpha((getScrollX() + getPaddingLeft()) - this.ellipsizeWidth, 0.0f, ((getScrollX() + getWidth()) - getPaddingRight()) + this.ellipsizeWidth, getHeight(), NotificationCenter.messagePlayingSpeedChanged, 31);
        }
