...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate, SuggestEmojiView.AnchorViewDelegate {
    ...
    public static /* synthetic */ boolean lambda$createRecordPanel$51(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    public class RecordCircle extends View {
        ...
        */
        protected void onDraw(Canvas canvas) {
            ...
            float f5 = dp;
            this.drawingCy = f5;
            float f6 = ChatActivityEnterView.this.scale <= 0.5f ? ChatActivityEnterView.this.scale / 0.5f : ChatActivityEnterView.this.scale <= 0.75f ? 1.0f - (((ChatActivityEnterView.this.scale - 0.5f) / 0.25f) * 0.1f) : 0.9f + (((ChatActivityEnterView.this.scale - 0.75f) / 0.25f) * 0.1f);
            long currentTimeMillis = System.currentTimeMillis() - this.lastUpdateTime;
            float f7 = this.animateToAmplitude;
            float f8 = this.amplitude;
            if (f7 != f8) {
                float f9 = this.animateAmplitudeDiff;
                float f10 = f8 + (((float) currentTimeMillis) * f9);
                this.amplitude = f10;
                if (f9 > 0.0f) {
                    if (f10 > f7) {
                        this.amplitude = f7;
            ...
            float interpolation = (this.circleRadius + (this.circleRadiusAmplitude * this.amplitude)) * f6 * (ChatActivityEnterView.this.canceledByGesture ? CubicBezierInterpolator.EASE_OUT.getInterpolation(1.0f - ChatActivityEnterView.this.slideToCancelProgress) * 0.7f : (ChatActivityEnterView.this.slideToCancelProgress * 0.3f) + 0.7f);
            ...
            if (ChatActivityEnterView.this.transformToSeekbar == 0.0f || ChatActivityEnterView.this.recordedAudioBackground == null) {
                if (ChatActivityEnterView.this.exitTransition != 0.0f) {
                    ...
                    float f12 = chatActivityEnterView.exitTransition;
                    if (!z) {
                        f12 = Math.max(0.0f, (f12 - 0.6f) / 0.4f);
                    }
                    CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_BOTH;
                    float interpolation2 = cubicBezierInterpolator.getInterpolation(f11);
                    float interpolation3 = cubicBezierInterpolator.getInterpolation(f12);
                    interpolation = (interpolation + (AndroidUtilities.dp(16.0f) * interpolation2)) * (1.0f - interpolation3);
                    if (LiteMode.isEnabled(LiteMode.FLAGS_CHAT) && ChatActivityEnterView.this.exitTransition > 0.6f) {
                        max = Math.max(0.0f, 1.0f - ((ChatActivityEnterView.this.exitTransition - 0.6f) / 0.4f));
                        f2 = interpolation2;
                        f = interpolation3;
                        f3 = 0.0f;
                        if (ChatActivityEnterView.this.canceledByGesture && ChatActivityEnterView.this.slideToCancelProgress > 0.7f) {
                            max *= 1.0f - ((ChatActivityEnterView.this.slideToCancelProgress - 0.7f) / 0.3f);
                        }
                        ...
                        if (!isSendButtonVisible()) {
                            ...
                            if (f13 != 1.0f) {
                                float f14 = f13 + (((float) currentTimeMillis) / 150.0f);
                                this.progressToSendButton = f14;
                                if (f14 > 1.0f) {
                                    this.progressToSendButton = 1.0f;
                                }
                                drawable5 = ChatActivityEnterView.this.isInVideoMode() ? ChatActivityEnterView.this.cameraDrawable : ChatActivityEnterView.this.micDrawable;
                            }
                        ...
                        float f16 = max;
                        ChatActivityEnterView.this.sendRect.set(measuredWidth - (drawable.getIntrinsicWidth() / 2), dp - (drawable.getIntrinsicHeight() / 2), measuredWidth + (drawable.getIntrinsicWidth() / 2), dp + (drawable.getIntrinsicHeight() / 2));
                        drawable.setBounds(ChatActivityEnterView.this.sendRect);
                        if (drawable2 != null) {
                            drawable2.setBounds(measuredWidth - (drawable2.getIntrinsicWidth() / 2), dp - (drawable2.getIntrinsicHeight() / 2), (drawable2.getIntrinsicWidth() / 2) + measuredWidth, dp + (drawable2.getIntrinsicHeight() / 2));
                        }
                        int i = 0;
                        if (!this.incIdle) {
                            ChatActivityEnterView chatActivityEnterView2 = ChatActivityEnterView.this;
                        ...
                        if (LiteMode.isEnabled(LiteMode.FLAGS_CHAT) && f3 != 1.0f && f < 0.4f && f19 > 0.0f && !ChatActivityEnterView.this.canceledByGesture) {
                            if (this.showWaves) {
                            ...
                            if (!this.voiceEnterTransitionInProgress) {
                                float interpolation4 = CubicBezierInterpolator.EASE_OUT.getInterpolation(this.wavesEnterAnimation);
                                canvas.save();
                                float f22 = 1.0f - f2;
                                float f23 = ChatActivityEnterView.this.scale * f22 * f19 * interpolation4 * (BlobDrawable.SCALE_BIG_MIN + (this.bigWaveDrawable.amplitude * 1.4f));
                                canvas2 = canvas;
                                canvas2.scale(f23, f23, ChatActivityEnterView.this.slideDelta + measuredWidth, f5);
                                this.bigWaveDrawable.draw(ChatActivityEnterView.this.slideDelta + measuredWidth, f5, canvas2, this.bigWaveDrawable.paint);
                                canvas.restore();
                                float f24 = ChatActivityEnterView.this.scale * f22 * f19 * interpolation4 * (BlobDrawable.SCALE_SMALL_MIN + (this.tinyWaveDrawable.amplitude * 1.4f));
                                canvas.save();
                                canvas2.scale(f24, f24, ChatActivityEnterView.this.slideDelta + measuredWidth, f5);
                                this.tinyWaveDrawable.draw(ChatActivityEnterView.this.slideDelta + measuredWidth, f5, canvas2, this.tinyWaveDrawable.paint);
                                canvas.restore();
                                if (!this.voiceEnterTransitionInProgress) {
                                    ...
                                    if (ChatActivityEnterView.this.scale == 1.0f) {
                                        if (ChatActivityEnterView.this.transformToSeekbar != 0.0f) {
                                            if (ChatActivityEnterView.this.isInVideoMode || this.progressToSeekbarStep3 <= 0.0f || ChatActivityEnterView.this.recordedAudioBackground == null) {
                                                drawable3 = drawable;
                                                drawable4 = drawable2;
                                                canvas2.drawCircle(ChatActivityEnterView.this.slideDelta + measuredWidth, f5, f15 * (1.0f - this.progressToSeekbarStep3), ChatActivityEnterView.this.paint);
                                            } else {
                                                float f25 = f5 + f15;
                                                float f26 = f5 - f15;
                                                float f27 = ChatActivityEnterView.this.slideDelta + measuredWidth + f15;
                                                ...
                                                float f29 = i;
                                                float y = (view.getY() + f29) - getY();
                                                drawable3 = drawable;
                                                float y2 = ((view.getY() + view.getMeasuredHeight()) + f29) - getY();
                                                float f30 = i2;
                                                float x = (((view.getX() + view.getMeasuredWidth()) + f30) - getX()) - ChatActivityEnterView.this.horizontalPadding;
                                                float x2 = ((view.getX() + f30) - getX()) + ChatActivityEnterView.this.horizontalPadding;
                                                float measuredHeight = ChatActivityEnterView.this.isInVideoMode() ? 0.0f : view.getMeasuredHeight() / 2.0f;
                                                float f31 = this.progressToSeekbarStep3;
                                                float f32 = measuredHeight + ((f15 - measuredHeight) * (1.0f - f31));
                                                this.rectF.set(x2 + ((f28 - x2) * (1.0f - f31)), y + ((f26 - y) * (1.0f - f31)), x + ((f27 - x) * (1.0f - f31)), y2 + ((f25 - y2) * (1.0f - f31)));
                                                canvas2.drawRoundRect(this.rectF, f32, f32, ChatActivityEnterView.this.paint);
                                            }
                                            f4 = f15;
                                        } else {
                                            drawable3 = drawable;
                                            drawable4 = drawable2;
                                            f4 = f15;
                                            canvas2.drawCircle(ChatActivityEnterView.this.slideDelta + measuredWidth, f5, f4, ChatActivityEnterView.this.paint);
                                        }
                                        canvas.save();
                                        canvas2.translate(ChatActivityEnterView.this.slideDelta, 0.0f);
                                        drawIconInternal(canvas, drawable3, drawable4, this.progressToSendButton, (int) ((1.0f - f3) * (1.0f - f) * 255.0f));
                                        canvas.restore();
                                        if (ChatActivityEnterView.this.scale != 1.0f) {
                                            canvas2.drawCircle(measuredWidth + ChatActivityEnterView.this.slideDelta, f5, f4, ChatActivityEnterView.this.paint);
                                            float f33 = ChatActivityEnterView.this.canceledByGesture ? 1.0f - ChatActivityEnterView.this.slideToCancelProgress : 1.0f;
                                            canvas.save();
                                            canvas2.translate(ChatActivityEnterView.this.slideDelta, 0.0f);
                                            drawIconInternal(canvas, drawable3, drawable4, this.progressToSendButton, (int) (f33 * 255.0f));
                                            canvas.restore();
                                        }
                                        this.drawingCircleRadius = f4;
                                    }
                                }
                                drawable3 = drawable;
                                drawable4 = drawable2;
                ...
                float f34 = ChatActivityEnterView.this.transformToSeekbar > 0.38f ? 1.0f : ChatActivityEnterView.this.transformToSeekbar / 0.38f;
                float max2 = ChatActivityEnterView.this.transformToSeekbar > 0.63f ? 1.0f : Math.max(0.0f, (ChatActivityEnterView.this.transformToSeekbar - 0.38f) / 0.25f);
                this.progressToSeekbarStep3 = Math.max(0.0f, ((ChatActivityEnterView.this.transformToSeekbar - 0.38f) - 0.25f) / 0.37f);
                CubicBezierInterpolator cubicBezierInterpolator2 = CubicBezierInterpolator.EASE_BOTH;
                f2 = cubicBezierInterpolator2.getInterpolation(f34);
                f3 = cubicBezierInterpolator2.getInterpolation(max2);
                this.progressToSeekbarStep3 = cubicBezierInterpolator2.getInterpolation(this.progressToSeekbarStep3);
                float measuredHeight2 = ChatActivityEnterView.this.recordedAudioBackground.getMeasuredHeight() / 2.0f;
                interpolation = (((interpolation + (AndroidUtilities.dp(16.0f) * f2)) - measuredHeight2) * (1.0f - f3)) + measuredHeight2;
                f = 0.0f;
            }
            max = 1.0f;
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.dismissSendPreview = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.topViewUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda0
        ...
        16 r1 = new 16(activity);
        this.messageEditTextContainer = r1;
        r1.setClipChildren(false);
        this.textFieldContainer.addView(r1, LayoutHelper.createFrame(-1, -2.0f, 80, 0.0f, 0.0f, 48.0f, 0.0f));
        ...
        if (z) {
            ...
            this.attachButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda21
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        20 r5 = new 20(activity, resourcesProvider);
        this.audioVideoButtonContainer = r5;
        r5.setSoundEffectsEnabled(false);
        ...
        this.sendButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda16
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ...
                if (motionEvent.getAction() != 3 || !ChatActivityEnterView.this.recordingAudioVideo) {
                    if ((ChatActivityEnterView.this.recordCircle == null || !ChatActivityEnterView.this.recordCircle.isSendButtonVisible()) && ((frameLayout = ChatActivityEnterView.this.recordedAudioPanel) == null || frameLayout.getVisibility() != 0)) {
                        if ((((motionEvent.getX() + ChatActivityEnterView.this.audioVideoButtonContainer.getX()) - ChatActivityEnterView.this.startedDraggingX) / ChatActivityEnterView.this.distCanMove) + 1.0f < 0.45d) {
                            ...
                            AndroidUtilities.runOnUIThread(chatActivityEnterView6.moveToSendStateRunnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$20$$ExternalSyntheticLambda1
                                @Override // java.lang.Runnable
                                public final void run() {
    ...
    private void createScheduledButton() {
        ...
        this.scheduledButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda14
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$createGiftButton$10(View view) {
        ...
        if (new ArrayList(getParentFragment().getCurrentUserInfo().premium_gifts).isEmpty()) {
            ...
            final int loadGiftOptions = BoostRepository.loadGiftOptions(null, new Utilities.Callback() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda73
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    ChatActivityEnterView.lambda$createGiftButton$8(AlertDialog.this, currentUser, (List) obj);
                }
            });
            alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda8
    ...
    private void createExpandStickersButton() {
        ...
        ImageView imageView = new ImageView(this, getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.25
            @Override // android.view.View
            public boolean onTouchEvent(MotionEvent motionEvent) {
                if (getAlpha() <= 0.0f) {
                    return false;
        ...
        this.expandStickersButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void createRecordAudioPanel() {
        ...
        this.recordDeleteImageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda19
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.recordedAudioPlayButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda18
            @Override // android.view.View.OnClickListener
    ...
    public void createSenderSelectView() {
        ...
        senderSelectView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda24
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$createSenderSelectView$21(View view) {
        ...
        if (this.delegate.measureKeyboardHeight() > AndroidUtilities.dp(20.0f)) {
            ...
            if (contentViewHeight < AndroidUtilities.dp(200.0f)) {
                this.onKeyboardClosed = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda47
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$createSenderSelectView$19(final SimpleAvatarView simpleAvatarView, int[] iArr, SenderSelectPopup.SenderView senderView) {
        ...
        simpleAvatarView.getViewTreeObserver().addOnDrawListener(new 30(this, simpleAvatarView, senderView));
        dialog.show();
        ...
        }).addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda37
            @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationEndListener
            public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f4, float f5) {
    ...
    public class 30 implements ViewTreeObserver.OnDrawListener {
        ...
        30(ChatActivityEnterView chatActivityEnterView, SimpleAvatarView simpleAvatarView, SenderSelectPopup.SenderView senderView) {
    ...
    public void openWebViewMenu() {
        ...
        final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda62
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, this.dialog_id)) {
            ...
            }, new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda61
                @Override // java.lang.Runnable
                public final void run() {
    ...
    */
    public boolean onSendLongClick(View view) {
        ...
        if (this.isStories || (((editTextCaption = this.messageEditText) == null || TextUtils.isEmpty(editTextCaption.getText())) && (chatActivity2 = this.parentFragment) != null && (messagePreviewParams = chatActivity2.messagePreviewParams) != null && (messages = messagePreviewParams.forwardMessages) != null && (arrayList = messages.messages) != null && !arrayList.isEmpty())) {
            ...
            if (this.sendPopupLayout == null) {
                ...
                if (z6) {
                    ActionBarMenuSubItem actionBarMenuSubItem = new ActionBarMenuSubItem(getContext(), true, !z7, this.resourcesProvider);
                    ...
                    this.actionScheduleButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda23
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                    ...
                    if (!z5 && this.dialog_id > 0) {
                        ActionBarMenuSubItem actionBarMenuSubItem2 = new ActionBarMenuSubItem(getContext(), true, !z7, this.resourcesProvider);
                        ...
                        this.sendWhenOnlineButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda20
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view2) {
                ...
                if (z7) {
                    ...
                    actionBarMenuSubItem3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda27
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
        ...
        messageSendPreview2.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda10
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
                ChatActivityEnterView.this.lambda$onSendLongClick$31(dialogInterface);
            }
        });
        final boolean z8 = (this.audioToSendMessageObject == null && ((editTextCaption2 = this.messageEditText) == null || TextUtils.isEmpty(editTextCaption2.getText()))) ? false : true;
        ...
        if (this.audioToSend != null) {
            ...
            if (chatActivity7 != null && (instantCameraView = chatActivity7.instantCameraView) != null && instantCameraView.getTextureView() != null) {
                ...
                if (z8 && this.audioToSend == null) {
                    this.messageSendPreview.setEditText(this.messageEditText, new Utilities.Callback2() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda72
                        ...
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj) {
                            ChatActivityEnterView.this.lambda$onSendLongClick$32((Canvas) obj);
                        }
                    });
                }
                this.messageSendPreview.setSendButton(this.sendButton, true, new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda31
                    ...
                    public final void onClick(View view3) {
                        ChatActivityEnterView.this.lambda$onSendLongClick$33(z8, view3);
                    }
                });
                ...
                if (z3) {
                    makeOptions.add(R.drawable.msg_calendar2, LocaleController.getString(z2 ? R.string.SetReminder : R.string.ScheduleMessage), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda41
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    if (!z2 && this.dialog_id > 0) {
                        makeOptions.add(R.drawable.msg_online, LocaleController.getString(R.string.SendWhenOnline), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda43
                            @Override // java.lang.Runnable
                            public final void run() {
                ...
                if (z4) {
                    makeOptions.add(R.drawable.input_notify_off, LocaleController.getString(R.string.SendWithoutSound), new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda70
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatActivityEnterView.this.lambda$onSendLongClick$36(z8);
                        }
                    });
                }
    ...
    public /* synthetic */ void lambda$onSendLongClick$31(DialogInterface dialogInterface) {
        this.messageSendPreview = null;
    }

    public /* synthetic */ void lambda$onSendLongClick$32(Canvas canvas) {
        drawBackground(canvas, false);
    }

    public /* synthetic */ void lambda$onSendLongClick$33(boolean z, View view) {
    ...
    public /* synthetic */ void lambda$onSendLongClick$34() {
    ...
    public /* synthetic */ void lambda$onSendLongClick$36(boolean z) {
        MessageSendPreview messageSendPreview;
        this.sentFromPreview = System.currentTimeMillis();
        sendMessageInternal(false, 0, true);
        if (!z && (messageSendPreview = this.messageSendPreview) != null) {
    ...
    private void createBotWebViewMenuContainer() {
        ...
        BotWebViewMenuContainer botWebViewMenuContainer = new BotWebViewMenuContainer(getContext(), this) { // from class: org.telegram.ui.Components.ChatActivityEnterView.42
            {
                ChatActivityEnterView.this = this;
            }

            @Override // org.telegram.ui.bots.BotWebViewMenuContainer
            public void onDismiss() {
                super.onDismiss();
                if (ChatActivityEnterView.this.botCommandsMenuButton != null) {
                    ChatActivityEnterView.this.botCommandsMenuButton.setOpened(false);
    ...
    public /* synthetic */ void lambda$createBotWebViewMenuContainer$37() {
    ...
    /* loaded from: classes3.dex */
    public class 46 implements TextWatcher {
            ...
            if (this.prevText == null) {
                ...
                if (ChatActivityEnterView.this.currentLimit <= 0 || (i = ChatActivityEnterView.this.currentLimit - ChatActivityEnterView.this.codePointCount) > 100) {
                    if (ChatActivityEnterView.this.captionLimitView != null) {
                        ChatActivityEnterView.this.captionLimitView.animate().alpha(0.0f).scaleX(0.5f).scaleY(0.5f).setDuration(100L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.46.1
                            {
                                46.this = this;
                            }
    ...
    public void hideTopView(boolean z) {
        ...
        if (this.allowShowTopView) {
            ...
            if (z) {
                ...
                this.currentTopViewAnimation = ofFloat;
                ofFloat.addUpdateListener(this.topViewUpdateListener);
                this.currentTopViewAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.48
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    private void hideRecordedAudioPanel(boolean z) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            if (z) {
                ...
                this.recordPannelAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.50
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    public void sendMessage() {
        if (isInScheduleMode()) {
            AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView.51
                {
                    ChatActivityEnterView.this = this;
                }
    ...
    public /* synthetic */ void lambda$sendMessageInternal$42(boolean z, int i) {
    ...
    public /* synthetic */ void lambda$sendMessageInternal$45(CharSequence charSequence, boolean z, int i) {
    ...
    */
    ...
    public void showCaptionLimitBulletin() {
        ...
        BulletinFactory.of(this.parentFragment).createCaptionLimitBulletin(MessagesController.getInstance(this.currentAccount).captionLengthLimitPremium, new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda45
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$saveBusinessLink$48() {
    ...
    public /* synthetic */ void lambda$doneEditingMessage$49() {
        this.waitingForKeyboardOpenAfterAnimation = false;
        openKeyboardInternal();
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:280:0x01e4  */
    /* JADX WARN: Removed duplicated region for block: B:281:0x01ea  */
    /* JADX WARN: Removed duplicated region for block: B:301:0x021b  */
    /* JADX WARN: Removed duplicated region for block: B:309:0x024a A[LOOP:0: B:189:0x0053->B:309:0x024a, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:311:0x0248 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:488:0x03e4  */
    ...
    */
    public void updateRecordInterface(final int i, boolean z) {
        ...
        if (this.recordingAudioVideo) {
            ...
            isRecordingStateChanged();
            AnimatorSet animatorSet3 = new AnimatorSet();
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.emojiButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) this.EMOJI_BUTTON_SCALE, 0.0f), ObjectAnimator.ofFloat(this.emojiButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) this.EMOJI_BUTTON_ALPHA, 0.0f), ObjectAnimator.ofFloat(this.recordDot, View.SCALE_Y, 1.0f), ObjectAnimator.ofFloat(this.recordDot, View.SCALE_X, 1.0f), ObjectAnimator.ofFloat(this.recordTimerView, View.TRANSLATION_X, 0.0f), ObjectAnimator.ofFloat(this.recordTimerView, View.ALPHA, 1.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.slideText, View.TRANSLATION_X, 0.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.slideText, View.ALPHA, 1.0f));
            ControlsView controlsView3 = this.controlsView;
            if (controlsView3 != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(controlsView3, View.ALPHA, 1.0f));
            }
            ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView = this.audioVideoSendButton;
            if (chatActivityEnterViewAnimatedIconView != null) {
            ...
            if (z3) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.recordedAudioSeekBar, View.ALPHA, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.recordedAudioPlayButton, View.ALPHA, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.recordedAudioBackground, View.ALPHA, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.recordedAudioTimeTextView, View.ALPHA, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.recordDeleteImageView, View.ALPHA, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_X, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_Y, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.videoTimelineView, View.ALPHA, 0.0f));
            }
            ...
            if (z2 || i == 4) {
                ...
                animatorArr[5] = ObjectAnimator.ofFloat(this.recordCircle, this.recordControlsCircleScale, 0.0f);
                animatorArr[6] = ObjectAnimator.ofFloat(this.audioVideoButtonContainer, View.ALPHA, 1.0f);
                animatorArr[7] = ObjectAnimator.ofFloat(this.recordTimerView, View.ALPHA, 0.0f);
                ...
                animatorArr[11] = ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f);
                animatorSet7.playTogether(animatorArr);
                ControlsView controlsView4 = this.controlsView;
                if (controlsView4 != null) {
                    this.runningAnimationAudio.playTogether(ObjectAnimator.ofFloat(controlsView4, View.ALPHA, 0.0f));
                    this.controlsView.hideHintView();
                }
                BotCommandsMenuView botCommandsMenuView2 = this.botCommandsMenuButton;
                if (botCommandsMenuView2 != null) {
                ...
                if (chatActivityEnterViewAnimatedIconView5 != null) {
                    chatActivityEnterViewAnimatedIconView5.setScaleX(f);
                    this.audioVideoSendButton.setScaleY(f);
                    this.runningAnimationAudio.playTogether(ObjectAnimator.ofFloat(this.audioVideoSendButton, View.ALPHA, f));
                ...
                if (!z) {
                    ...
                    if (!isInVideoMode()) {
                        ...
                        if (f5 != 0.0f && this.recordedAudioBackground != null) {
                            float interpolation = CubicBezierInterpolator.EASE_BOTH.getInterpolation(Math.max(0.0f, ((f5 - 0.38f) - 0.25f) / 0.37f));
                    ...
                    if (botCommandsMenuView3 != null) {
                        botCommandsMenuView3.setAlpha(0.0f);
                        this.botCommandsMenuButton.setScaleX(0.0f);
                        this.botCommandsMenuButton.setScaleY(0.0f);
                    }
                    if (isInVideoMode()) {
                    ...
                    ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda1
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatActivityEnterView.this.lambda$updateRecordInterface$50(valueAnimator);
                        }
                    });
                    ofFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.61
                        {
                            ChatActivityEnterView.this = this;
                        }
                    ...
                    if (chatActivityEnterViewAnimatedIconView7 != null) {
                        animatorSet9.playTogether(ObjectAnimator.ofFloat(chatActivityEnterViewAnimatedIconView7, View.ALPHA, 1.0f), ObjectAnimator.ofFloat(this.audioVideoSendButton, View.SCALE_X, 1.0f), ObjectAnimator.ofFloat(this.audioVideoSendButton, View.SCALE_Y, 1.0f));
                        this.audioVideoSendButton.setState(isInVideoMode() ? ChatActivityEnterViewAnimatedIconView.State.VIDEO : ChatActivityEnterViewAnimatedIconView.State.VOICE, true);
                    }
                    BotCommandsMenuView botCommandsMenuView4 = this.botCommandsMenuButton;
                    if (botCommandsMenuView4 != null) {
                        animatorSet9.playTogether(ObjectAnimator.ofFloat(botCommandsMenuView4, View.ALPHA, 0.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.SCALE_X, 0.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.SCALE_Y, 0.0f));
                    }
                    animatorSet9.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.62
                        {
                            ChatActivityEnterView.this = this;
                        }
                    ...
                    animatorSet9.setStartDelay(150L);
                    if (isInVideoMode()) {
                        this.recordedAudioTimeTextView.setAlpha(0.0f);
                    ...
                    this.runningAnimationAudio.playTogether(animatorSet9, ofFloat, animatorSet8);
                    this.runningAnimationAudio.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.63
                        ...
                        public void onAnimationEnd(Animator animator) {
                            if (viewGroup2 != null) {
                                ...
                                viewGroup2.addView(ChatActivityEnterView.this.recordedAudioPanel, layoutParams);
                            }
                ...
                ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView9 = this.emojiButton;
                Property<? super View, Float> property2 = this.EMOJI_BUTTON_ALPHA;
                float[] fArr2 = new float[1];
                fArr2[0] = this.emojiButtonRestricted ? 0.5f : 1.0f;
                animatorArr2[1] = ObjectAnimator.ofFloat(chatActivityEnterViewAnimatedIconView9, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property2, fArr2);
                ...
                if (botCommandsMenuView5 != null) {
                    animatorSet10.playTogether(ObjectAnimator.ofFloat(botCommandsMenuView5, View.SCALE_Y, 1.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.SCALE_X, 1.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.ALPHA, 1.0f));
                }
                ...
                if (i != 5) {
                    ...
                    animatorSet10.playTogether(ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f), ObjectAnimator.ofFloat(this.audioVideoButtonContainer, View.SCALE_X, 1.0f), ObjectAnimator.ofFloat(this.audioVideoButtonContainer, View.SCALE_Y, 1.0f), ObjectAnimator.ofFloat(this.audioVideoButtonContainer, View.ALPHA, 1.0f));
                    LinearLayout linearLayout3 = this.attachLayout;
                    ...
                    ImageView imageView8 = this.botButton;
                    if (imageView8 != null) {
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(imageView8, View.SCALE_X, f3), ObjectAnimator.ofFloat(this.botButton, View.SCALE_Y, f3));
                    }
                    ...
                    if (chatActivityEnterViewAnimatedIconView10 != null) {
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(chatActivityEnterViewAnimatedIconView10, View.ALPHA, f3));
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(this.audioVideoSendButton, View.SCALE_X, f3));
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(this.audioVideoSendButton, View.SCALE_Y, f3));
                        this.audioVideoSendButton.setState(isInVideoMode() ? ChatActivityEnterViewAnimatedIconView.State.VIDEO : ChatActivityEnterViewAnimatedIconView.State.VOICE, true);
                    }
                    ...
                    if (imageView10 != null) {
                        animatorSet12.playTogether(ObjectAnimator.ofFloat(imageView10, View.ALPHA, f2), ObjectAnimator.ofFloat(this.scheduledButton, View.TRANSLATION_X, 0.0f));
                    }
                    j = 150;
                    animatorSet12.setDuration(150L);
                    animatorSet12.setStartDelay(110L);
                    animatorSet12.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.64
                        {
                            ChatActivityEnterView.this = this;
                        }
                ...
                ofFloat2.setDuration(200L);
                this.runningAnimationAudio.playTogether(animatorSet10, animatorSet11, ofFloat2, ObjectAnimator.ofFloat(this, "lockAnimatedTranslation", this.startTranslation).setDuration(200L));
                if (i == 5) {
                    ...
                    ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this, "exitTransition", 1.0f);
                ...
                ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView12 = this.emojiButton;
                Property<? super View, Float> property3 = this.EMOJI_BUTTON_ALPHA;
                float[] fArr3 = new float[1];
                fArr3[0] = this.emojiButtonRestricted ? 0.5f : 1.0f;
                animatorArr3[1] = ObjectAnimator.ofFloat(chatActivityEnterViewAnimatedIconView12, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property3, fArr3);
                ...
                if (botCommandsMenuView6 != null) {
                    f4 = 1.0f;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(botCommandsMenuView6, View.SCALE_Y, 1.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.SCALE_X, 1.0f), ObjectAnimator.ofFloat(this.botCommandsMenuButton, View.ALPHA, 1.0f));
                } else {
                    f4 = 1.0f;
                }
                ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView13 = this.audioVideoSendButton;
                if (chatActivityEnterViewAnimatedIconView13 != null) {
                    chatActivityEnterViewAnimatedIconView13.setScaleX(f4);
                    this.audioVideoSendButton.setScaleY(f4);
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(this.audioVideoSendButton, View.ALPHA, f4));
                    this.audioVideoSendButton.setState(isInVideoMode() ? ChatActivityEnterViewAnimatedIconView.State.VIDEO : ChatActivityEnterViewAnimatedIconView.State.VOICE, true);
                }
                if (this.attachLayout != null) {
                    this.attachLayoutTranslationX = 0.0f;
                    updateAttachLayoutParams();
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(this.attachLayout, (Property<LinearLayout, Float>) this.ATTACH_LAYOUT_ALPHA, 1.0f));
                }
                ImageView imageView11 = this.scheduledButton;
                if (imageView11 != null) {
                ...
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this, "exitTransition", 1.0f);
    ...
    public /* synthetic */ void lambda$updateRecordInterface$50(ValueAnimator valueAnimator) {
    ...
    private void createRecordPanel() {
        ...
        FrameLayout frameLayout = new FrameLayout(this, getContext()) { // from class: org.telegram.ui.Components.ChatActivityEnterView.66
            @Override // android.view.View
            public boolean onTouchEvent(MotionEvent motionEvent) {
                return super.onTouchEvent(motionEvent);
            }
        ...
        this.recordPanel.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda35
            @Override // android.view.View.OnTouchListener
    ...
    public void setEditingBusinessLink(TLRPC$TL_businessChatLink tLRPC$TL_businessChatLink) {
        ...
        if (this.editingBusinessLink != null) {
            ...
            this.doneButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda12
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$setEditingBusinessLink$52(View view) {
        saveBusinessLink();
    }
    ...
    private MessageObject editingMessageObjectPreview(MessageObject messageObject, boolean z) {
        MessageObject messageObject2 = new MessageObject(this, messageObject.currentAccount, messageObject.messageOwner, true, true) { // from class: org.telegram.ui.Components.ChatActivityEnterView.67
    ...
    public void setEditingMessageObject(final MessageObject messageObject, final MessageObject.GroupedMessages groupedMessages, boolean z) {
        ...
        if (this.audioToSend == null && this.videoToSendMessageObject == null && this.editingMessageObject != messageObject) {
            ...
            if (messageObject != null) {
                ...
                this.doneButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda17
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        ChatActivityEnterView.this.lambda$setEditingMessageObject$53(view);
                    }
                });
                this.doneButton.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda34
                    @Override // android.view.View.OnLongClickListener
                    public final boolean onLongClick(View view) {
    ...
    public /* synthetic */ void lambda$setEditingMessageObject$53(View view) {
        doneEditingMessage();
    }

    public /* synthetic */ boolean lambda$setEditingMessageObject$56(final MessageObject messageObject, final MessageObject.GroupedMessages groupedMessages, View view) {
        EditTextCaption editTextCaption;
    ...
    public /* synthetic */ void lambda$setEditingMessageObject$54(ArrayList arrayList, MessagePreviewView.ToggleButton toggleButton, MessageSendPreview messageSendPreview, View view) {
    ...
    public /* synthetic */ void lambda$setEditingMessageObject$55(MessageObject.GroupedMessages groupedMessages, MessageObject messageObject, MessageSendPreview messageSendPreview, View view) {
        if (groupedMessages != null) {
    ...
    */
    ...
    public void checkBirthdayHint() {
        ...
        if (mainSettings.getBoolean(Calendar.getInstance().get(1) + "bdayhint_" + this.parentFragment.getDialogId(), true)) {
            ...
            this.birthdayHint.setOnHiddenListener(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda51
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$checkBirthdayHint$59() {
    ...
    public void updateScheduleButton(boolean z) {
        ...
        if (!z || z2) {
            ...
            if (imageView12 != null) {
                ...
                this.scheduledButtonAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.68
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    public void updateSendAsButton(boolean z) {
        ...
        if (z2 != z3) {
            ...
            if (this.parentFragment.getOtherSameChatsDiff() == 0 && this.parentFragment.fragmentOpened && z) {
                ...
                final float f10 = f;
                final float f11 = f2;
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.69
                    {
                        ChatActivityEnterView.this = this;
                    }
    ...
    */
    public void setButtons(MessageObject messageObject, boolean z) {
        ...
        if (messageObject3 == null || messageObject3 != messageObject) {
            ...
            if (this.botKeyboardView == null) {
                BotKeyboardView botKeyboardView = new BotKeyboardView(this.parentActivity, this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatActivityEnterView.70
                    {
                        ChatActivityEnterView.this = this;
                    }
                ...
                this.botKeyboardView.setDelegate(new BotKeyboardView.BotKeyboardViewDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda82
                    ...
                    public final void didPressedButton(TLRPC$KeyboardButton tLRPC$KeyboardButton) {
                        ChatActivityEnterView.this.lambda$setButtons$61(tLRPC$KeyboardButton);
                    }
                });
                SizeNotifierFrameLayout sizeNotifierFrameLayout = this.sizeNotifierLayout;
    ...
    public boolean didPressedBotButton(final TLRPC$KeyboardButton tLRPC$KeyboardButton, final MessageObject messageObject, final MessageObject messageObject2, Browser.Progress progress) {
        ...
        if (chatActivity == null || chatActivity.getChatMode() != 5) {
            if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButton) {
                ...
                final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView.71
                    {
                        ChatActivityEnterView.this = this;
                    }
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda9
    ...
    public /* synthetic */ boolean lambda$didPressedBotButton$66(MessageObject messageObject, TLRPC$TL_keyboardButtonRequestPeer tLRPC$TL_keyboardButtonRequestPeer, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment) {
    ...
    private void createEmojiView() {
        ...
        EmojiView emojiView2 = new EmojiView(this.parentFragment, this.allowAnimatedEmoji, true, true, getContext(), true, this.info, this.sizeNotifierLayout, this.shouldDrawBackground, this.resourcesProvider, this.emojiViewFrozen) { // from class: org.telegram.ui.Components.ChatActivityEnterView.72
            {
                ChatActivityEnterView.this = this;
            }
        ...
        this.emojiView.setDelegate(new 73());
        this.emojiView.setDragListener(new EmojiView.DragListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView.74
            int initialOffset;
            boolean wasExpanded;
    ...
    /* loaded from: classes3.dex */
    public class 73 implements EmojiView.EmojiViewDelegate {
        73() {
            ChatActivityEnterView.this = r1;
        }
        ...
        public void onCustomEmojiSelected(final long j, final TLRPC$Document tLRPC$Document, final String str, final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$73$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ChatActivityEnterView.73.this.lambda$onCustomEmojiSelected$0(str, tLRPC$Document, j, z);
                }
            });
        }
        ...
        public void lambda$onGifSelected$1(final View view, final Object obj, final String str, final Object obj2, final boolean z, final int i) {
            if (ChatActivityEnterView.this.replyingQuote != null && ChatActivityEnterView.this.parentFragment != null && ChatActivityEnterView.this.replyingQuote.outdated) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$73$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatActivityEnterView.73.this.lambda$onGifSelected$2(obj, str, z, i, obj2);
                    }
                };
                ...
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatActivityEnterView$73$$ExternalSyntheticLambda3
                    @Override // org.telegram.ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                    public final void didSelectDate(boolean z2, int i2) {
                        ChatActivityEnterView.73.this.lambda$onGifSelected$1(view, obj, str, obj2, z2, i2);
                    }
                }, ChatActivityEnterView.this.resourcesProvider);
            }
        }
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setPositiveButton(LocaleController.getString(R.string.ClearForAll), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.ChatActivityEnterView$73$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.73.this.lambda$onClearEmojiRecent$3(dialogInterface, i);
                }
            });
        ...
        public void showTrendingStickersAlert(TrendingStickersLayout trendingStickersLayout) {
            ...
            if (baseFragment != null) {
                ChatActivityEnterView.this.trendingStickersAlert = new TrendingStickersAlert(ChatActivityEnterView.this.getContext(), baseFragment, trendingStickersLayout, ChatActivityEnterView.this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatActivityEnterView.73.1
                    {
                        73.this = this;
                    }
    ...
    public /* synthetic */ void lambda$onStickerSelected$68(TLRPC$Document tLRPC$Document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, Object obj, boolean z2) {
        if (this.slowModeTimer > 0 && !isInScheduleMode()) {
            ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
            if (chatActivityEnterViewDelegate != null) {
                SlowModeBtn slowModeBtn = this.slowModeButton;
            ...
            if (emojiView3 != null) {
                if (i != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                    if (this.smoothKeyboard && !this.keyboardVisible && !this.stickersExpanded) {
                        ...
                        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.ChatActivityEnterView$$ExternalSyntheticLambda63
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    public void setSearchingTypeInternal(int i, boolean z) {
        ...
        if (z2 != (this.searchingType != 0)) {
            ...
            if (!z) {
                ...
                this.searchAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.78
                    {
                        ChatActivityEnterView.this = this;
                    }
        ...
        if (z3 || this.stickersExpanded != z) {
            ...
            if (this.stickersExpanded) {
                ...
                if (z2) {
                    ...
                    animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatActivityEnterView.83
                        {
                            ChatActivityEnterView.this = this;
                        }
