    ...
    */
    ...
    public void drawCustomParamsPass() {
        ...
        if (filterShadersDelegate == null || filterShadersDelegate.shouldShowOriginal()) {
            ...
            GLES20.glUniform3f(this.highlightsTintColorHandle, ((tintHighlightsColor >> 16) & NotificationCenter.closeSearchByActiveAction) / 255.0f, ((tintHighlightsColor >> 8) & NotificationCenter.closeSearchByActiveAction) / 255.0f, (tintHighlightsColor & NotificationCenter.closeSearchByActiveAction) / 255.0f);
            GLES20.glUniform1f(this.highlightsTintIntensityHandle, this.delegate.getTintHighlightsIntensityValue());
            GLES20.glUniform3f(this.shadowsTintColorHandle, ((tintShadowsColor >> 16) & NotificationCenter.closeSearchByActiveAction) / 255.0f, ((tintShadowsColor >> 8) & NotificationCenter.closeSearchByActiveAction) / 255.0f, (tintShadowsColor & NotificationCenter.closeSearchByActiveAction) / 255.0f);
