    ...
    public void draw(Canvas canvas) {
        ...
        if (i30 == 3 || i30 == 14 || (i30 == 4 && ((i21 = this.nextIcon) == 14 || i21 == 3))) {
                        ...
                        if (i31 != 8 && i31 != 9 && i31 != 7) {
                            ...
                            if (i31 != 6) {
                                if (i31 == 4) {
                                    ...
                                    f15 = 0.0f;
                                    f14 = 0.0f;
                                    min = NotificationCenter.newLocationAvailable;
                                    f13 = 1.0f;
                                }
                            }
                            if (i31 == i7) {
            ...
            if (i30 == 10 || this.nextIcon == 10 || i30 == 13) {
                ...
                int i36 = (i35 == 4 || i35 == 6) ? (int) ((1.0f - this.transitionProgress) * 255.0f) : NotificationCenter.newLocationAvailable;
                if (i36 != 0) {
                    applyShaderMatrix(false);
        ...
        if (i38 == 15) {
            ...
            if (this.currentIcon == 15) {
                ...
                if (this.currentIcon != i6 || i38 == i6) {
                    applyShaderMatrix(false);
                    this.paint.setAlpha(this.currentIcon != this.nextIcon ? NotificationCenter.newLocationAvailable : (int) (this.transitionProgress * 255.0f));
                ...
                if (this.currentIcon != 12 || this.nextIcon == 12) {
                    ...
                    this.paint.setAlpha(i39 != i40 ? NotificationCenter.newLocationAvailable : (int) (f67 * 255.0f));
                ...
                if (i15 != 0 || i15 == 1 || (i20 = this.nextIcon) == 0 || i20 == 1) {
                    ...
                    if ((i42 == 0 || i42 == i16) && (i15 == 0 || i15 == i16)) {
                        ...
                        if (i42 == 4) {
                            ...
                            this.paint2.setAlpha(i15 == i42 ? NotificationCenter.newLocationAvailable : (int) (this.transitionProgress * 255.0f));
                        }
                        z = true;
                        i17 = NotificationCenter.newLocationAvailable;
                    }
                ...
                if (drawable3 != null && drawable3 != drawable4) {
                    ...
                    drawable3.setAlpha(this.currentIcon == this.nextIcon ? NotificationCenter.newLocationAvailable : (int) ((1.0f - this.transitionProgress) * 255.0f));
                ...
                if (drawable4 != null) {
                    ...
                    drawable4.setAlpha(this.currentIcon == this.nextIcon ? NotificationCenter.newLocationAvailable : (int) (this.transitionProgress * 255.0f));
                ...
                if (pathArr7 != null && pathArr7 != pathArr8) {
                    ...
                    this.paint2.setAlpha(this.currentIcon == this.nextIcon ? NotificationCenter.newLocationAvailable : (int) ((1.0f - this.transitionProgress) * 255.0f));
                ...
                if (pathArr8 != null) {
                    ...
                    int i48 = this.currentIcon == this.nextIcon ? NotificationCenter.newLocationAvailable : (int) (this.transitionProgress * 255.0f);
                    this.paint2.setStyle(Paint.Style.FILL_AND_STROKE);
        ...
        this.paint.setAlpha(i392 != i402 ? NotificationCenter.newLocationAvailable : (int) (f67 * 255.0f));
        AndroidUtilities.dp(7.0f);
        AndroidUtilities.dp(3.0f);
        if (this.currentIcon != this.nextIcon) {
        }
