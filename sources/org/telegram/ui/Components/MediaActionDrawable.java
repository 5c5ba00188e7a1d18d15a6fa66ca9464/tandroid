...
public class MediaActionDrawable extends Drawable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:353:0x0872, code lost:
        if (r42.nextIcon == 1) goto L243;
     */
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.currentIcon == 2 || this.nextIcon == 2) {
            ...
            if (this.animatingTransition) {
                ...
                if (i26 == 2 || f2 <= 0.5f) {
                    ...
                    float dp9 = (AndroidUtilities.dp(13.0f) * f31 * f31) + (this.isMini ? AndroidUtilities.dp(2.0f) : 0);
                    float f32 = f2 - 0.5f;
                    float f33 = f32 / 0.5f;
                    if (f32 > 0.2f) {
                        f10 = (f32 - 0.2f) / 0.3f;
        ...
        if (i30 == 3 || i30 == 14 || (i30 == 4 && ((i21 = this.nextIcon) == 14 || i21 == 3))) {
                        ...
                        if (i31 != 8 && i31 != 9 && i31 != 7) {
                            ...
                            if (i31 != 6) {
                                if (i31 == 4) {
                                    ...
                                    f15 = 0.0f;
                                    f14 = 0.0f;
                                    min = NotificationCenter.messagePlayingSpeedChanged;
                                    f13 = 1.0f;
                                }
                            }
                            if (i31 == i7) {
            ...
            if (i30 == 10 || this.nextIcon == 10 || i30 == 13) {
                ...
                int i36 = (i35 == 4 || i35 == 6) ? (int) ((1.0f - this.transitionProgress) * 255.0f) : NotificationCenter.messagePlayingSpeedChanged;
                if (i36 != 0) {
                    applyShaderMatrix(false);
        ...
        if (i38 == 15) {
            ...
            if (this.currentIcon != i6 || i38 == i6) {
                applyShaderMatrix(false);
                this.paint.setAlpha(this.currentIcon != this.nextIcon ? NotificationCenter.messagePlayingSpeedChanged : (int) (this.transitionProgress * 255.0f));
                ...
                pathArr5 = pathArr4;
                pathArr6 = pathArr3;
                canvas.drawLine(dp16 - AndroidUtilities.dp(6.0f), dp15 - AndroidUtilities.dp(6.0f), f65, f66, this.paint);
                canvas.drawLine(f65, f66, dp16 + AndroidUtilities.dp(12.0f), dp15 - AndroidUtilities.dp(12.0f), this.paint);
                if (this.currentIcon != this.nextIcon) {
                    canvas.restore();
                }
            } else {
            ...
            if (this.currentIcon != 12 || this.nextIcon == 12) {
                ...
                this.paint.setAlpha(i39 != i40 ? NotificationCenter.messagePlayingSpeedChanged : (int) (f67 * 255.0f));
            ...
            if (this.currentIcon != 13 || this.nextIcon == 13) {
                ...
                canvas.drawText(this.percentString, i41, dp18, this.textPaint);
                if (this.currentIcon != this.nextIcon) {
                    canvas.restore();
                }
            }
            ...
            if (i15 != 0 || i15 == 1 || (i20 = this.nextIcon) == 0 || i20 == 1) {
                ...
                if ((i42 == 0 || i42 == i16) && (i15 == 0 || i15 == i16)) {
                    ...
                    i17 = NotificationCenter.messagePlayingSpeedChanged;
                    ...
                    if (i42 == 4) {
                        ...
                        this.paint2.setAlpha(i15 == i42 ? NotificationCenter.messagePlayingSpeedChanged : (int) (this.transitionProgress * 255.0f));
                    }
                    z = true;
                    i17 = NotificationCenter.messagePlayingSpeedChanged;
                }
            ...
            if (this.currentIcon == 6 || this.nextIcon == 6) {
                ...
                if (this.currentIcon != 6) {
                    ...
                    if (f26 >= 1.0f) {
                        i19 = dp20;
                        canvas.drawLine(dp20 - AndroidUtilities.dp(6.0f), dp19 - AndroidUtilities.dp(6.0f), dp20 - (AndroidUtilities.dp(6.0f) * f26), dp19 - (AndroidUtilities.dp(6.0f) * f26), this.paint);
                    } else {
                        i19 = dp20;
                    }
                    if (f27 > 0.0f) {
                ...
                f27 = f25;
                int dp192 = i4 + AndroidUtilities.dp(7.0f);
                int dp202 = i2 - AndroidUtilities.dp(3.0f);
                if (f26 >= 1.0f) {
                }
                if (f27 > 0.0f) {
                }
            ...
            if (drawable3 != null && drawable3 != drawable4) {
                ...
                drawable3.setAlpha(this.currentIcon == this.nextIcon ? NotificationCenter.messagePlayingSpeedChanged : (int) ((1.0f - this.transitionProgress) * 255.0f));
            ...
            if (drawable4 != null) {
                ...
                drawable4.setAlpha(this.currentIcon == this.nextIcon ? NotificationCenter.messagePlayingSpeedChanged : (int) (this.transitionProgress * 255.0f));
            ...
            if (pathArr7 != null && pathArr7 != pathArr8) {
                ...
                this.paint2.setAlpha(this.currentIcon == this.nextIcon ? NotificationCenter.messagePlayingSpeedChanged : (int) ((1.0f - this.transitionProgress) * 255.0f));
            ...
            if (pathArr8 != null) {
                ...
                int i48 = this.currentIcon == this.nextIcon ? NotificationCenter.messagePlayingSpeedChanged : (int) (this.transitionProgress * 255.0f);
                this.paint2.setStyle(Paint.Style.FILL_AND_STROKE);
        ...
        pathArr5 = pathArr4;
        pathArr6 = pathArr3;
        canvas.drawLine(dp162 - AndroidUtilities.dp(6.0f), dp152 - AndroidUtilities.dp(6.0f), f652, f662, this.paint);
        canvas.drawLine(f652, f662, dp162 + AndroidUtilities.dp(12.0f), dp152 - AndroidUtilities.dp(12.0f), this.paint);
        if (this.currentIcon != this.nextIcon) {
        }
        ...
        this.paint.setAlpha(i392 != i402 ? NotificationCenter.messagePlayingSpeedChanged : (int) (f67 * 255.0f));
        AndroidUtilities.dp(7.0f);
        AndroidUtilities.dp(3.0f);
        if (this.currentIcon != this.nextIcon) {
        }
        ...
        float f682 = i2;
        float f692 = f682 - dp172;
        float f702 = i4;
        float f712 = f702 - dp172;
        float f722 = f682 + dp172;
        float f732 = f702 + dp172;
        ...
        this.percentString = String.format("%d%%", Integer.valueOf(i14));
        this.percentStringWidth = (int) Math.ceil(this.textPaint.measureText(format));
        canvas.drawText(this.percentString, i412, dp182, this.textPaint);
        if (this.currentIcon != this.nextIcon) {
        }
        i15 = this.currentIcon;
        if (i15 != 0) {
