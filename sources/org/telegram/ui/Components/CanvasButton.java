...
public class CanvasButton {
    ...
    public CanvasButton(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            paint2.setColor(-1);
            this.selectorDrawable = new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{Theme.getColor("listSelectorSDK21") & 436207615}), null, new Drawable() { // from class: org.telegram.ui.Components.CanvasButton.1
