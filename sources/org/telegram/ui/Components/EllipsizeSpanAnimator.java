...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.messagePlayingSpeedChanged, 0, NotificationCenter.storiesReadUpdated), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.messagePlayingSpeedChanged, 150, NotificationCenter.storiesReadUpdated), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.messagePlayingSpeedChanged, NotificationCenter.storiesReadUpdated, NotificationCenter.storiesReadUpdated), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.messagePlayingSpeedChanged, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.messagePlayingSpeedChanged, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.messagePlayingSpeedChanged, 0, 1000, 400));
