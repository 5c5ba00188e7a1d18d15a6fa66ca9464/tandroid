...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.notificationsCountUpdated, 0, NotificationCenter.customTypefacesLoaded), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.notificationsCountUpdated, 150, NotificationCenter.customTypefacesLoaded), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.notificationsCountUpdated, NotificationCenter.customTypefacesLoaded, NotificationCenter.customTypefacesLoaded), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.notificationsCountUpdated, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.notificationsCountUpdated, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.notificationsCountUpdated, 0, 1000, 400));
