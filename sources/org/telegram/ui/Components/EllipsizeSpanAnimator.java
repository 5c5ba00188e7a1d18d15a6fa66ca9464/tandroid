...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.playerDidStartPlaying, 0, NotificationCenter.stealthModeChanged), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.playerDidStartPlaying, 150, NotificationCenter.stealthModeChanged), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.playerDidStartPlaying, NotificationCenter.stealthModeChanged, NotificationCenter.stealthModeChanged), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.playerDidStartPlaying, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.playerDidStartPlaying, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.playerDidStartPlaying, 0, 1000, 400));
