...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.didClearDatabase, 0, 300), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.didClearDatabase, 150, 300), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.didClearDatabase, 300, 300), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.didClearDatabase, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.didClearDatabase, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.didClearDatabase, 0, 1000, 400));
