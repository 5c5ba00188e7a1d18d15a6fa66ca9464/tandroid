...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.closeSearchByActiveAction, 0, NotificationCenter.onReceivedChannelDifference), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.closeSearchByActiveAction, 150, NotificationCenter.onReceivedChannelDifference), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.closeSearchByActiveAction, NotificationCenter.onReceivedChannelDifference, NotificationCenter.onReceivedChannelDifference), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.closeSearchByActiveAction, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.closeSearchByActiveAction, 0, 1000, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.closeSearchByActiveAction, 0, 1000, 400));
