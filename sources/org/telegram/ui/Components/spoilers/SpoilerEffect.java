...
public class SpoilerEffect extends Drawable {
    ...
    public SpoilerEffect() {
        ...
        this.mAlpha = NotificationCenter.closeSearchByActiveAction;
    ...
    public void startRipple(float f, float f2, float f3, boolean z) {
        ...
        final int alpha = this.reverseAnimator ? NotificationCenter.closeSearchByActiveAction : this.particlePaints[ALPHAS.length - 1].getAlpha();
