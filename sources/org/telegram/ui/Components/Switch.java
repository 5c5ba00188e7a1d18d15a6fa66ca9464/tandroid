    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i4 < i2) {
            if (i4 != 1 || this.overrideColorProgress != 0) {
                ...
                int alpha = ((((int) (red + ((red2 - red) * f2))) & NotificationCenter.newLocationAvailable) << 16) | ((((int) (Color.alpha(processColor) + ((Color.alpha(processColor2) - r6) * f2))) & NotificationCenter.newLocationAvailable) << 24) | ((((int) (green + ((green2 - green) * f2))) & NotificationCenter.newLocationAvailable) << 8) | (((int) (blue + ((blue2 - blue) * f2))) & NotificationCenter.newLocationAvailable);
        ...
        while (i7 < 2) {
            if (i7 != 1 || this.overrideColorProgress != 0) {
                ...
                this.paint.setColor(((((int) (Color.alpha(color) + ((Color.alpha(processColor3) - r4) * f))) & NotificationCenter.newLocationAvailable) << 24) | ((((int) (red3 + ((red4 - red3) * f))) & NotificationCenter.newLocationAvailable) << 16) | ((((int) (green3 + ((green4 - green3) * f))) & NotificationCenter.newLocationAvailable) << 8) | (((int) (blue3 + ((blue4 - blue3) * f))) & NotificationCenter.newLocationAvailable));
                float f3 = dp2;
