...
public class ContactsEmptyView extends LinearLayout {
    ...
    public ContactsEmptyView(Context context) {
        ...
        this.buttonTextView.setText(AndroidUtilities.replaceArrows(AndroidUtilities.makeClickable(LocaleController.getString(R.string.NoContactsYet2Invite), new Runnable() { // from class: org.telegram.ui.Components.ContactsEmptyView$$ExternalSyntheticLambda0
