    ...
    public void draw(Canvas canvas, View view) {
        ...
        if (this.exploding || this.explosionRate > 0.0f) {
            ...
            if (this.particles == null) {
                this.particles = new Particles(NotificationCenter.liveLocationsChanged, new Runnable() { // from class: org.telegram.ui.Components.SeekBarWaveform$$ExternalSyntheticLambda0
