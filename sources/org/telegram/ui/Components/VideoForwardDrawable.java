...
public class VideoForwardDrawable extends Drawable {
    ...
    */
    public void draw(Canvas canvas) {
        ...
        if (f7 <= 0.6f) {
            int min = f7 < 0.4f ? Math.min(NotificationCenter.newLocationAvailable, (int) ((f7 * 255.0f) / 0.2f)) : (int) ((1.0f - ((f7 - 0.4f) / 0.2f)) * 255.0f);
            if (!this.isOneShootAnimation) {
        ...
        if (f8 >= 0.2f && f8 <= 0.8f) {
            float f9 = f8 - 0.2f;
            int min2 = f9 < 0.4f ? Math.min(NotificationCenter.newLocationAvailable, (int) ((f9 * 255.0f) / 0.2f)) : (int) ((1.0f - ((f9 - 0.4f) / 0.2f)) * 255.0f);
            if (!this.isOneShootAnimation) {
        ...
        if (f10 >= 0.4f && f10 <= 1.0f) {
            float f11 = f10 - 0.4f;
            int min3 = f11 < 0.4f ? Math.min(NotificationCenter.newLocationAvailable, (int) ((f11 * 255.0f) / 0.2f)) : (int) ((1.0f - ((f11 - 0.4f) / 0.2f)) * 255.0f);
            if (!this.isOneShootAnimation) {
