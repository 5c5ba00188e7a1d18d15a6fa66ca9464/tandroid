    ...
    public int texture() {
        ...
        try {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = iArr2[i4];
                iArr2[i4] = ((i5 >> 16) & NotificationCenter.liveLocationsChanged) | (i5 & (-16711936)) | ((i5 & NotificationCenter.liveLocationsChanged) << 16);
            }
        ...
        if (!this.bitmap.isRecycled() && Build.VERSION.SDK_INT <= 28) {
            ...
            int i6 = ((-16711936) & pixel) | ((pixel & NotificationCenter.liveLocationsChanged) << 16) | ((pixel >> 16) & NotificationCenter.liveLocationsChanged);
