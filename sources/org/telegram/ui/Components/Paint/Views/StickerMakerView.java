...
public class StickerMakerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ThanosEffect getThanosEffect() {
        if (ThanosEffect.supports()) {
            if (this.thanosEffect == null) {
                ThanosEffect thanosEffect = new ThanosEffect(getContext(), new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda5
    ...
    public void lambda$segmentImage$6(final Bitmap bitmap, final int i, final int i2, final int i3) {
        ...
        client.process(InputImage.fromBitmap(bitmap, i)).addOnSuccessListener(new OnSuccessListener() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda3
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$segmentImage$5(final int i, final int i2, final int i3, final SubjectSegmentationResult subjectSegmentationResult) {
        if (this.sourceBitmap == null) {
            return;
        }
        final ArrayList arrayList = new ArrayList();
        Utilities.themeQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$segmentImage$4(SubjectSegmentationResult subjectSegmentationResult, int i, int i2, int i3, final ArrayList arrayList) {
        if (this.sourceBitmap == null) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$segmentImage$3(ArrayList arrayList) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$segmentImage$7(final Bitmap bitmap, final int i, final int i2, final int i3, Exception exc) {
        this.segmentingLoading = false;
        FileLog.e(exc);
    ...
    public void uploadStickerFile(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z, final TLRPC$StickerSet tLRPC$StickerSet, final TLRPC$Document tLRPC$Document) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$uploadStickerFile$8(String str, String str2, CharSequence charSequence, boolean z, TLRPC$StickerSet tLRPC$StickerSet, TLRPC$Document tLRPC$Document, VideoEditedInfo videoEditedInfo) {
    ...
    private void uploadMedia() {
        ...
        ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$TL_messages_uploadMedia, new RequestDelegate() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda17
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$uploadMedia$10(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$uploadMedia$9(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    private void afterUploadingMedia() {
        ...
        if (stickerUploader.replacedSticker != null) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_stickers_replaceSticker, new RequestDelegate() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda18
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_stickers_createStickerSet, new RequestDelegate() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda20
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_stickers_addStickerToSet, new RequestDelegate() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda19
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$13(final int i, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$12(final TLObject tLObject, int i, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$11(TLObject tLObject) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$16(final int i, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$15(final TLObject tLObject, int i, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject instanceof TLRPC$TL_messages_stickerSet) {
            MediaDataController.getInstance(i).toggleStickerSet(null, tLObject, 2, null, false, false);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$14(TLObject tLObject) {
        NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject, this.stickerUploader.mediaDocument.document);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$17() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$20(final int i, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$19(final TLObject tLObject, int i, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject instanceof TLRPC$TL_messages_stickerSet) {
            MediaDataController.getInstance(i).toggleStickerSet(null, tLObject, 2, null, false, false);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$18(TLObject tLObject) {
        NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject, this.stickerUploader.mediaDocument.document);
    }
