...
public class AvatarConstructorFragment extends BaseFragment {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (backgroundGradient != null) {
                ...
                if (this.changeBackgroundProgress != 1.0f) {
                    ...
                    this.outGradientTools.paint.setAlpha(NotificationCenter.newLocationAvailable);
                    ...
                    this.gradientTools.paint.setAlpha(NotificationCenter.newLocationAvailable);
    ...
    public void startFrom(TLRPC.VideoSize videoSize) {
        long j;
        BackgroundGradient backgroundGradient = new BackgroundGradient();
        backgroundGradient.color1 = ColorUtils.setAlphaComponent(videoSize.background_colors.get(0).intValue(), NotificationCenter.newLocationAvailable);
        backgroundGradient.color2 = videoSize.background_colors.size() > 1 ? ColorUtils.setAlphaComponent(videoSize.background_colors.get(1).intValue(), NotificationCenter.newLocationAvailable) : 0;
        backgroundGradient.color3 = videoSize.background_colors.size() > 2 ? ColorUtils.setAlphaComponent(videoSize.background_colors.get(2).intValue(), NotificationCenter.newLocationAvailable) : 0;
        backgroundGradient.color4 = videoSize.background_colors.size() > 3 ? ColorUtils.setAlphaComponent(videoSize.background_colors.get(3).intValue(), NotificationCenter.newLocationAvailable) : 0;
