...
public class VoIpGradientLayout extends FrameLayout {
    ...
    public void switchToConnectedAnimator() {
        ...
        this.alphaGreen = NotificationCenter.notificationsCountUpdated;
        this.connectedAnimatorSet = new AnimatorSet();
        ValueAnimator ofInt = ValueAnimator.ofInt(0, NotificationCenter.notificationsCountUpdated, NotificationCenter.notificationsCountUpdated, NotificationCenter.notificationsCountUpdated, 0);
        ...
        ofInt.setRepeatCount(-1);
        ofInt.setRepeatMode(1);
        ValueAnimator ofInt2 = ValueAnimator.ofInt(0, 0, NotificationCenter.notificationsCountUpdated, 0, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.showClip) {
            ...
            this.bgGreen.setAlpha(NotificationCenter.notificationsCountUpdated);
            this.bgGreen.draw(canvas);
            this.clipPath.rewind();
            ...
            this.bgGreenLightReveal.setAlpha(NotificationCenter.notificationsCountUpdated);
            ...
            this.bgGreenDarkReveal.setAlpha(NotificationCenter.notificationsCountUpdated);
    ...
    public void showToBadConnection() {
        ...
        this.state = gradientState2;
        ValueAnimator ofInt = ValueAnimator.ofInt(this.alphaOrangeRed, NotificationCenter.notificationsCountUpdated);
        this.badConnectionAnimator = ofInt;
    ...
    public void switchToCalling() {
        ...
        this.state = gradientState2;
        this.alphaBlueGreen = NotificationCenter.notificationsCountUpdated;
        ValueAnimator ofInt = ValueAnimator.ofInt(NotificationCenter.notificationsCountUpdated, 0, NotificationCenter.notificationsCountUpdated);
