    ...
    public static class VoIpButtonView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.singleIcon != null) {
                ...
                this.whiteCirclePaint.setAlpha((int) ((this.singleIconBackgroundAlphaPercent * NotificationCenter.notificationsCountUpdated) / 100.0f));
            ...
            if (i3 == i2 && i > 0 && i != i2) {
                ...
                this.selectedIcon.setAlpha(NotificationCenter.notificationsCountUpdated);
