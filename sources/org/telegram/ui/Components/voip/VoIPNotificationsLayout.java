...
public class VoIPNotificationsLayout extends LinearLayout {
    ...
    public static class NotificationView extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            this.backgroundProvider.getDarkPaint(this.ignoreShader).setAlpha(NotificationCenter.closeSearchByActiveAction);
            ...
            if (this.backgroundProvider.isReveal()) {
                ...
                this.backgroundProvider.getRevealDarkPaint().setAlpha(NotificationCenter.closeSearchByActiveAction);
        ...
        while (i < this.viewToAdd.size()) {
            ...
            while (true) {
                if (i2 >= this.viewToRemove.size()) {
                    break;
                } else if (notificationView.tag.equals(((NotificationView) this.viewToRemove.get(i2)).tag)) {
    ...
    public void removeNotification(String str) {
        ...
        if (notificationView != null) {
            ...
            } else if (this.viewToAdd.remove(notificationView)) {
            } else {
