...
public class StorageUsageView extends FrameLayout {
    ...
    public StorageUsageView(Context context) {
        ...
        this.cellFlickerDrawable = new CellFlickerDrawable(NotificationCenter.pushMessagesUpdated, NotificationCenter.voipServiceCreated);
    ...
    public class ProgressView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            StorageUsageView.this.paintProgress.setAlpha(NotificationCenter.voipServiceCreated);
