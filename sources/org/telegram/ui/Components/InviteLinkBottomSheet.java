...
public class InviteLinkBottomSheet extends BottomSheet {
    ...
    */
    private void updateRows() {
        ...
        boolean z4 = i5 > 0 || tLRPC$TL_chatInviteExported.usage_limit > 0 || tLRPC$TL_chatInviteExported.requested > 0;
        if (i5 <= this.joinedUsers.size()) {
            ...
            if (!tLRPC$TL_chatInviteExported2.request_needed || tLRPC$TL_chatInviteExported2.requested <= this.requestedUsers.size()) {
                ...
                if (this.requestedUsers.isEmpty()) {
                    ...
                    int size2 = i11 + this.requestedUsers.size();
                    this.rowCount = size2;
        ...
        int i132 = i122 + 1;
        this.rowCount = i132;
        this.dividerRow = i122;
        int i142 = i132 + 1;
        this.rowCount = i142;
        this.loadingRow = i132;
        this.rowCount = i142 + 1;
        this.emptyView2 = i142;
        if (this.emptyHintRow == -1) {
        }
        this.adapter.notifyDataSetChanged();
    }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                default:
                    ...
                    headerCell2.getTextView2().setTypeface(AndroidUtilities.bold());
