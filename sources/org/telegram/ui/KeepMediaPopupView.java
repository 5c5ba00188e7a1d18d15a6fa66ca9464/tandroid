...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public KeepMediaPopupView(final BaseFragment baseFragment, Context context) {
        ...
        if (BuildVars.DEBUG_PRIVATE_VERSION) {
            ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this, R.drawable.msg_autodelete, LocaleController.formatPluralString("Minutes", 1, new Object[0]), false, null);
        ...
        ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(this, R.drawable.msg_delete, LocaleController.getString("DeleteException", R.string.DeleteException), false, null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$1(final DialogsActivity dialogsActivity, DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z) {
