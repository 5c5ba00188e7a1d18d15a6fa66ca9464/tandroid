...
public class ChatActivityBotWebViewButton extends FrameLayout {
    ...
    public void setupButtonParams(boolean z, String str, int i, int i2, final boolean z2) {
        ...
        if (this.progressWasVisible != z2) {
            ...
            this.progressView.animate().alpha(z2 ? 1.0f : 0.0f).scaleX(z2 ? 1.0f : 0.1f).scaleY(z2 ? 1.0f : 0.1f).setDuration(250L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.bots.ChatActivityBotWebViewButton.1
