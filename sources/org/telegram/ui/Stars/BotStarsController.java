...
public class BotStarsController {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getChannelRevenueStats$3(final long j, final TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getRevenueStats$1(final long j, final TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public TL_stats.TL_broadcastRevenueStats getChannelRevenueStats(final long j, boolean z) {
        ...
        if (l == null || System.currentTimeMillis() - l.longValue() > 300000 || z) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_getBroadcastRevenueStats, new RequestDelegate() { // from class: org.telegram.ui.Stars.BotStarsController$$ExternalSyntheticLambda0
    ...
    public TLRPC.TL_payments_starsRevenueStats getRevenueStats(final long j, boolean z) {
        ...
        if (l == null || System.currentTimeMillis() - l.longValue() > 300000 || z) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getStarsRevenueStats, new RequestDelegate() { // from class: org.telegram.ui.Stars.BotStarsController$$ExternalSyntheticLambda2
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
