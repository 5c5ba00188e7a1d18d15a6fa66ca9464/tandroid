        ...
        */
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (!this.search) {
                ...
                z = false;
            } else if (i >= 0 && i < RestrictedLanguagesSelectActivity.this.searchResult.size()) {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.RestrictedLanguagesSelectActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    RestrictedLanguagesSelectActivity.this.lambda$onBackPressed$321();
                }
            }
        });
