    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            while (i < 2) {
                ...
                if (drawable != null) {
                    drawable.setAlpha((i != 1 || this.oldBackgroundDrawable == null || ((BaseFragment) EditWidgetActivity.this).parentLayout == null) ? NotificationCenter.newLocationAvailable : (int) (255.0f * themeAnimationValue));
