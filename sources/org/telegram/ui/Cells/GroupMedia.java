    ...
    */
    ...
    public void drawImages(Canvas canvas, boolean z) {
        ...
        while (i < this.holders.size()) {
            ...
            if (messageObject.isSending()) {
                ...
                if (!isSendingMessage || progress >= 1.0f) {
                    i8 = mediaHolder.album ? 6 : mediaHolder.getDefaultIcon();
                }
                mediaHolder.setIcon(i8);
        ...
        if (f > 0.0f && z) {
            ...
            this.spoilerEffect.draw(canvas, this.cell, i9, i10, 1.0f);
            canvas.restore();
            canvas.restore();
            this.cell.invalidate();
        }
        for (int i11 = 0; i11 < this.holders.size(); i11++) {
            MediaHolder mediaHolder2 = this.holders.get(i11);
            if (mediaHolder2.durationText != null) {
                ...
                RectF rectF2 = this.clipRect;
                int i12 = this.x;
                int i13 = mediaHolder2.l;
                int i14 = this.y;
                int i15 = mediaHolder2.t;
