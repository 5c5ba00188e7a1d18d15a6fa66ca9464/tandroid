...
public class EditTextCell extends FrameLayout {
    ...
    public EditTextCell(Context context, String str, boolean z, final int i) {
        ...
        editTextBoldCursor.setInputType((z ? 131072 : 0) | 16385 | LiteMode.FLAG_CHAT_SCALE);
        editTextBoldCursor.setRawInputType(49153);
        ...
        if (z) {
            arrayList.add(new InputFilter(this) { // from class: org.telegram.ui.Cells.EditTextCell.5
