...
public class StoriesUtilities {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x0181, code lost:
        if (r11.stories.get(r6).close_friends != false) goto L60;
     */
        ...
        if (avatarStoryParams.drawHiddenStoriesAsSegments) {
            ...
            if (i <= 1) {
                ...
                while (i3 < i) {
                    ...
                    if (avatarStoryParams.drawHiddenStoriesAsSegments) {
                        int unreadState2 = storiesController.getUnreadState(DialogObject.getPeerDialogId(storiesController.getHiddenList().get((i - 1) - i3).peer));
                        if (unreadState2 != i2) {
                        }
                        paint5 = paint3;
                    } else {
            ...
            size = tL_stories$PeerStories.stories.size();
        }
        i = size;
        if (unreadState != 2) {
        }
