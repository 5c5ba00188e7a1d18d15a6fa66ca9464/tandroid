...
public class SelfStoryViewsPage extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$new$0(StoryViewer storyViewer, View view, int i) {
        ...
        storyViewer.presentFragment(ProfileActivity.of(tL_stories$TL_storyView.user_id));
    }
            ...
            if (view instanceof ReactedUserHolderView) {
                ...
                ItemOptions cutTextInFancyHalf = ItemOptions.makeOptions(this.val$storyViewer.containerView, SelfStoryViewsPage.this.resourcesProvider, view).setGravity(3).ignoreX().setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_dialogBackground, SelfStoryViewsPage.this.resourcesProvider))).setDimAlpha(133).addIf((!isStoryShownToUser || isBlocked || z) ? false : true, R.drawable.msg_stories_myhide, LocaleController.formatString(R.string.StoryHideFrom, str2), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda2
                    ...
                    public final void run() {
                        SelfStoryViewsPage.4.this.lambda$onItemClick$0(messagesController, user, str2, reactedUserHolderView, tL_stories$TL_storyView);
                    }
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.4.this.lambda$onItemClick$1(messagesController, user, str2, reactedUserHolderView, tL_stories$TL_storyView);
                    }
                ...
                final ItemOptions addIf = cutTextInFancyHalf.addIf(z3, i2, LocaleController.getString(R.string.BlockUser), true, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.4.this.lambda$onItemClick$2(messagesController, user, reactedUserHolderView, tL_stories$TL_storyView);
                    }
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.4.this.lambda$onItemClick$3(messagesController, user, reactedUserHolderView, tL_stories$TL_storyView);
                    }
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        SelfStoryViewsPage.4.this.lambda$onItemClick$4(user, str2, reactedUserHolderView, tL_stories$TL_storyView);
                    }
                });
                ...
                if (viewsModel5.loading || viewsModel5.hasNext || !viewsModel5.views.isEmpty() || !TextUtils.isEmpty(this.currentModel.state.searchQuery)) {
                    ...
                    if (tL_stories$StoryViews3 == null || tL_stories$StoryViews3.views_count == 0) {
                        ...
                        if (viewsModel6.showReactionOnly) {
                            ...
                            this.showContactsFilter = (i4 < 20 || tL_stories$StoryItem.contacts || tL_stories$StoryItem.close_friends || tL_stories$StoryItem.selected_contacts) ? false : false;
                            this.titleView.setText(LocaleController.getString("Viewers", R.string.Viewers));
                        }
            ...
            if (tLObject != null) {
                ...
                if (i2 > tL_stories$StoryViews.views_count) {
                    ...
                    for (int i3 = 0; i3 < Math.min(3, tL_stories$TL_stories_storyViewsList.users.size()); i3++) {
                        this.storyItem.views.recent_viewers.add(Long.valueOf(tL_stories$TL_stories_storyViewsList.users.get(i3).id));
                    }
