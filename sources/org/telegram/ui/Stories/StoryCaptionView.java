    ...
    public class StoryCaptionTextView extends View {
        ...
        */
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.fullLayout == null || StoryCaptionView.this.disableTouches) {
                return false;
            }
            if (this.showMore != null) {
                ...
                if (rectF.contains(motionEvent.getX(), motionEvent.getY())) {
                    ...
                    if ((!z && motionEvent.getAction() == 0) || ((this.pressedLink != null || this.pressedEmoji != null) && motionEvent.getAction() == 1)) {
                        int y = (int) (motionEvent.getY() - this.textY);
                        int lineForVertical = this.fullLayout.getLineForVertical(y);
                        float x = (int) (motionEvent.getX() - this.textX);
                        ...
                        if (lineLeft > x || lineLeft + this.fullLayout.getLineWidth(lineForVertical) < x || y < 0 || y > this.fullLayout.getHeight()) {
                            ...
                            if (characterStyleArr == null || characterStyleArr.length == 0) {
                                ...
                                if (motionEvent.getAction() == 0) {
                                    ...
                                    obtainNewPath.setCurrentLayout(this.fullLayout, spanStart, getPaddingTop());
                                    ...
                                    postDelayed(new Runnable() { // from class: org.telegram.ui.Stories.StoryCaptionView$StoryCaptionTextView$$ExternalSyntheticLambda3
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            StoryCaptionView.StoryCaptionTextView.this.lambda$onTouchEvent$4(linkSpanDrawable2);
                                        }
                        ...
                        if (motionEvent.getAction() == 1) {
                            ...
                            if (linkSpanDrawable3 != null && linkSpanDrawable3.getSpan() == characterStyle) {
                                StoryCaptionView.this.onLinkClick(this.pressedLink.getSpan(), this);
                            } else {
