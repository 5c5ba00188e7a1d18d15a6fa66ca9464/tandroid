...
public class GroupCallActivity extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    */
    ...
    private GroupCallActivity(final Context context, final AccountInstance accountInstance, ChatObject.Call call, final TLRPC$Chat tLRPC$Chat, TLRPC$InputPeer tLRPC$InputPeer, boolean z, String str) {
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                while (i10 < childCount) {
                    ...
                    if (findContainingViewHolder == null || findContainingViewHolder.getItemViewType() == 3 || findContainingViewHolder.getItemViewType() == 4 || findContainingViewHolder.getItemViewType() == 5 || findContainingViewHolder.getItemViewType() == 6) {
                        ...
                        if (findContainingViewHolder.getItemViewType() == i8) {
                            View view = findContainingViewHolder.itemView;
                            if (view instanceof GroupCallUserCell) {
                                GroupCallUserCell groupCallUserCell = (GroupCallUserCell) view;
                                i7 = i10;
                                GroupCallActivity.this.visiblePeerIds.append(groupCallUserCell.getPeerId(), i8);
                                i6 = childCount;
        ...
        27 r7 = new 27(context, this.listView, this.fullscreenUsersListView, this.attachedRenderers, this.call, this);
        this.renderersContainer = r7;
    ...
    public class 6 extends ActionBar.ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                ...
                GroupCallActivity groupCallActivity4 = GroupCallActivity.this;
                1 r15 = new 1(context, groupCallActivity4.currentChat, groupCallActivity4.hasVideo);
                if (GroupCallActivity.this.isRtmpStream()) {
                    r15.onStartRecord(2);
                } else {
                    r15.show();
            ...
            public void onStartRecord(final int i) {
                ...
                editTextBoldCursor.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.GroupCallActivity$6$1$$ExternalSyntheticLambda4
                    ...
                    public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                        ...
                        lambda$onStartRecord$0 = GroupCallActivity.6.1.lambda$onStartRecord$0(AlertDialog.Builder.this, textView, i2, keyEvent);
                ...
                builder.setPositiveButton(LocaleController.getString("Start", R.string.Start), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$6$1$$ExternalSyntheticLambda1
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        GroupCallActivity.6.1.this.lambda$onStartRecord$3(editTextBoldCursor, i, dialogInterface, i2);
                    }
                });
                    ...
                    if (z) {
                        ...
                        if (GroupCallActivity.this.invalidateColors && GroupCallActivity.this.currentState != null) {
                            ...
                            if (GroupCallActivity.this.prevState != null) {
                                ...
                                i2 = ColorUtils.blendARGB(i8, GroupCallActivity.this.colorsTmp[0], GroupCallActivity.this.switchProgress);
                                i3 = ColorUtils.blendARGB(i9, GroupCallActivity.this.colorsTmp[1], GroupCallActivity.this.switchProgress);
                                i4 = ColorUtils.blendARGB(i10, GroupCallActivity.this.colorsTmp[2], GroupCallActivity.this.switchProgress);
                            } else {
                                GroupCallActivity groupCallActivity6 = GroupCallActivity.this;
                                ...
                                if (i6 == i7 && GroupCallActivity.this.currentState != null) {
                                    ...
                                    if (GroupCallActivity.isLandscapeMode) {
                                        if (i6 == 0) {
                                            ...
                                            float f14 = (measuredWidth2 + ((dp3 - measuredWidth2) * r4)) * GroupCallActivity.this.scheduleButtonsScale;
                                            float f15 = (dp6 + ((dp3 - dp6) * r4)) * GroupCallActivity.this.scheduleButtonsScale;
                                            GroupCallActivity.this.rect.set(x2 - f14, y2 - f15, f14 + x2, f15 + y2);
                                            float dp7 = AndroidUtilities.dp(4.0f) + ((dp3 - AndroidUtilities.dp(4.0f)) * r4);
                                            ...
                                            float f142 = (measuredWidth22 + ((dp3 - measuredWidth22) * r4)) * GroupCallActivity.this.scheduleButtonsScale;
                                            float f152 = (dp62 + ((dp3 - dp62) * r4)) * GroupCallActivity.this.scheduleButtonsScale;
                                            GroupCallActivity.this.rect.set(x2 - f142, y2 - f152, f142 + x2, f152 + y2);
                                            float dp72 = AndroidUtilities.dp(4.0f) + ((dp3 - AndroidUtilities.dp(4.0f)) * r4);
                                        ...
                                        float f16 = !GroupCallActivity.isLandscapeMode ? 1.0f : GroupCallActivity.this.switchToButtonInt2;
                                        float measuredWidth222 = (getMeasuredWidth() / 2) - AndroidUtilities.dp(21.0f);
                                        float dp622 = AndroidUtilities.dp(24.0f);
                                        float f1422 = (measuredWidth222 + ((dp3 - measuredWidth222) * f16)) * GroupCallActivity.this.scheduleButtonsScale;
                                        float f1522 = (dp622 + ((dp3 - dp622) * f16)) * GroupCallActivity.this.scheduleButtonsScale;
                                        GroupCallActivity.this.rect.set(x2 - f1422, y2 - f1522, f1422 + x2, f1522 + y2);
                                        float dp722 = AndroidUtilities.dp(4.0f) + ((dp3 - AndroidUtilities.dp(4.0f)) * f16);
                                        ...
                                        float f14222 = (measuredWidth2222 + ((dp3 - measuredWidth2222) * f16)) * GroupCallActivity.this.scheduleButtonsScale;
                                        float f15222 = (dp6222 + ((dp3 - dp6222) * f16)) * GroupCallActivity.this.scheduleButtonsScale;
                                        GroupCallActivity.this.rect.set(x2 - f14222, y2 - f15222, f14222 + x2, f15222 + y2);
                                        float dp7222 = AndroidUtilities.dp(4.0f) + ((dp3 - AndroidUtilities.dp(4.0f)) * f16);
        ...
        if (i == 0 || i == 2 || i == 3) {
            ...
            if (i == 2) {
                builder.setPositiveButton(LocaleController.getString("VoipGroupUserRemove", R.string.VoipGroupUserRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$$ExternalSyntheticLambda7
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        GroupCallActivity.this.lambda$processSelectedOption$55(tLObject, dialogInterface, i2);
                    }
                });
            } else if (z2) {
                ...
                builder.setPositiveButton(LocaleController.getString("VoipGroupAdd", R.string.VoipGroupAdd), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$$ExternalSyntheticLambda8
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        GroupCallActivity.this.lambda$processSelectedOption$57(tLRPC$User2, j, dialogInterface, i2);
                    }
                });
            }
            builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    public boolean showMenuForCell(View view) {
        ...
        if (groupCallUserCell2.isSelfUser()) {
            ...
            if (peerId > 0) {
                ...
                arrayList.add(LocaleController.getString(str5, i7));
            } else {
                tLRPC$TL_groupCallParticipant2 = tLRPC$TL_groupCallParticipant;
                if (TextUtils.isEmpty(tLRPC$TL_groupCallParticipant2.about)) {
            ...
            if (ChatObject.canManageCalls(this.currentChat)) {
                ...
                } else if (!tLRPC$TL_groupCallParticipant2.muted || tLRPC$TL_groupCallParticipant2.can_self_unmute) {
                    str = "VoipGroupOpenChannel";
        ...
        while (i9 < size2) {
            ...
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.GroupCallActivity$$ExternalSyntheticLambda21
                ...
                public final void onClick(View view2) {
                    GroupCallActivity.this.lambda$showMenuForCell$61(i9, arrayList3, tLRPC$TL_groupCallParticipant2, view2);
                }
            });
            i9++;
        }
        ...
        if (forUserOrChat != null || z5) {
            if (z) {
                ...
                this.avatarsViewPager.initIfEmpty(forUserOrChat, forUserOrChat2, true);
        ...
        if (groupCallUserCell7 != null) {
            if (isLandscapeMode) {
                i3 = (((int) ((groupCallUserCell7.getX() + this.fullscreenUsersListView.getX()) + this.renderersContainer.getX())) - actionBarPopupWindowLayout3.getMeasuredWidth()) + AndroidUtilities.dp(32.0f);
                ...
                i3 = ((int) ((groupCallUserCell7.getX() + this.fullscreenUsersListView.getX()) + this.renderersContainer.getX())) - AndroidUtilities.dp(14.0f);
                i2 = (int) (((this.scrimFullscreenView.getY() + this.fullscreenUsersListView.getY()) + this.renderersContainer.getY()) - actionBarPopupWindowLayout3.getMeasuredHeight());
            }
        } else {
            ...
            if (this.hasScrimAnchorView) {
                i = (int) (this.listView.getY() + groupCallUserCell5.getY() + groupCallUserCell5.getClipHeight());
            } else {
        ...
        this.scrimPopupWindow.showAtLocation(this.listView, 51, i3, i2);
