    ...
    */
    public void onDraw(Canvas canvas) {
        ...
        if (z2) {
            ...
            f2 = f25;
            f3 = interpolation;
            canvas.saveLayerAlpha(0.0f, Math.max(0.0f, top), this.container.getMeasuredWidth(), this.container.getMeasuredHeight(), NotificationCenter.playerDidStartPlaying, 31);
        } else {
            i = measuredHeight;
            f = interpolation2;
            f2 = f25;
        ...
        if (currentBackgroundDrawable != null) {
            ...
            if (shadowDrawable != null) {
                ...
                shadowDrawable.setAlpha(NotificationCenter.playerDidStartPlaying);
            }
            ...
            currentBackgroundDrawable.setAlpha(NotificationCenter.playerDidStartPlaying);
        } else {
            f4 = f3;
            f5 = x;
            f6 = f;
