...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    */
    ...
    public void onDraw(Canvas canvas) {
        ...
        int saveLayerAlpha = (z || this.ellipsizeByGradient) ? canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), NotificationCenter.didClearDatabase, 31) : Integer.MIN_VALUE;
