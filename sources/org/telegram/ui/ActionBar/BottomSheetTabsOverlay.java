...
public class BottomSheetTabsOverlay extends FrameLayout {
    ...
    public boolean dismissSheet(BotWebViewSheet botWebViewSheet) {
        ...
        this.dismissingAnimator.addListener(new 2(saveState, botWebViewSheet));
        AndroidUtilities.applySpring(this.dismissingAnimator, 350.0f, 30.0f, 1.0f);
        ValueAnimator valueAnimator3 = this.dismissingAnimator;
    ...
    public class 2 extends AnimatorListenerAdapter {
        final /* synthetic */ BotWebViewSheet val$sheet;
        final /* synthetic */ BottomSheetTabs.WebTabData val$tab;

        2(BottomSheetTabs.WebTabData webTabData, BotWebViewSheet botWebViewSheet) {
            this.val$tab = webTabData;
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (myWebView != null && webTabData.previewBitmap == null && (i = webTabData.webViewWidth) > 0 && (i2 = webTabData.webViewHeight) > 0) {
                if (Build.VERSION.SDK_INT >= 26) {
                    BottomSheetTabsOverlay.renderHardwareViewToBitmap(myWebView, new Utilities.Callback() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$2$$ExternalSyntheticLambda0
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj) {
                            BottomSheetTabs.WebTabData.this.previewBitmap = (Bitmap) obj;
                        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$dismissSheet$2(ValueAnimator valueAnimator) {
        this.dismissProgress = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        invalidate();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$scrollTo$3(ValueAnimator valueAnimator) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$animateOpen$4(ValueAnimator valueAnimator) {
