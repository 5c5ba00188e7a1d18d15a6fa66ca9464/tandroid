...
public final class FloatingToolbar {
    ...
    public final class FloatingToolbarPopup {
        ...
        private void closeOverflow() {
            ...
            animation.setDuration(getAdjustedDuration(NotificationCenter.newLocationAvailable));
            animation2.setInterpolator(this.mLogAccelerateInterpolator);
            animation2.setDuration(getAdjustedDuration(NotificationCenter.newLocationAvailable));
            animation3.setInterpolator(this.mFastOutSlowInInterpolator);
            animation3.setDuration(getAdjustedDuration(NotificationCenter.newLocationAvailable));
