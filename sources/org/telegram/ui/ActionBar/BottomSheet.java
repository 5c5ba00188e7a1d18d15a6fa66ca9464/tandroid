...
public class BottomSheet extends Dialog implements BaseFragment.AttachedSheet {
                    ...
                    if (viewGroup != null) {
                        if (!bottomSheet13.fullWidth) {
                            if (AndroidUtilities.isTablet()) {
                                ...
                                makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(bottomSheet14.getBottomSheetWidth(bottomSheet14.isPortrait, i10, i9) + (BottomSheet.this.backgroundPaddingLeft * 2), 1073741824);
                            }
                            BottomSheet.this.containerView.measure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(i9, Integer.MIN_VALUE));
                        } else {
                            viewGroup.measure(View.MeasureSpec.makeMeasureSpec((bottomSheet13.backgroundPaddingLeft * 2) + i10, 1073741824), View.MeasureSpec.makeMeasureSpec(i9, Integer.MIN_VALUE));
                        }
                    }
            ...
            if (viewGroup2 != null) {
                ...
                if (BottomSheet.this.lastInsets == null || (i15 = Build.VERSION.SDK_INT) < 21) {
                    ...
                    if (bottomSheet3.useSmoothKeyboard) {
                        ...
                        systemWindowInsetBottom = bottomSheet3.lastInsets.getSystemWindowInsetBottom();
                        measuredHeight = (int) (f - ((systemWindowInsetBottom * (1.0f - BottomSheet.this.hideSystemVerticalInsetsProgress)) - (BottomSheet.this.drawNavigationBar ? 0 : bottomSheet2.getBottomInset())));
                        if (i15 >= 29) {
    ...
    public void startOpenAnimation() {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(this.containerView, View.TRANSLATION_X, 0.0f), ObjectAnimator.ofFloat(this.containerView, View.ALPHA, 1.0f), ObjectAnimator.ofFloat(this.containerView, View.TRANSLATION_Y, 0.0f), ObjectAnimator.ofInt(this.backDrawable, AnimationProperties.COLOR_DRAWABLE_ALPHA, this.dimBehind ? this.dimBehindAlpha : 0), this.navigationBarAnimation);
        if (this.transitionFromRight) {
    ...
    public void dismissWithButtonClick(final int i) {
        ...
        AnimatorSet animatorSet = new AnimatorSet();
        this.currentSheetAnimation = animatorSet;
        animatorSet.playTogether(ObjectAnimator.ofFloat(this.containerView, View.TRANSLATION_Y, getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.dp(10.0f) + (this.scrollNavBar ? getBottomInset() : 0)), ObjectAnimator.ofInt(this.backDrawable, AnimationProperties.COLOR_DRAWABLE_ALPHA, 0));
            ...
            if (this.skipDismissAnimation) {
                ...
                if (viewGroup != null) {
                    if (this.transitionFromRight) {
                        ...
                        arrayList.add(ObjectAnimator.ofFloat(viewGroup, View.TRANSLATION_Y, getContainerViewHeight() + (this.forceKeyboardOnDismiss ? this.lastKeyboardHeight : this.keyboardHeight) + AndroidUtilities.dp(10.0f) + (this.scrollNavBar ? getBottomInset() : 0)));
                    }
                }
