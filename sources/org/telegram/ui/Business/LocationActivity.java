...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$onClick$6(DialogInterface dialogInterface, int i) {
        ...
        getConnectionsManager().sendRequest(tL_account_updateBusinessLocation, new RequestDelegate() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda6
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLocationAlert$7(org.telegram.ui.LocationActivity locationActivity, TLRPC.MessageMedia messageMedia, int i, boolean z, int i2) {
    ...
    public void processDone() {
        ...
        getConnectionsManager().sendRequest(tL_account_updateBusinessLocation, new RequestDelegate() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda4
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    private void updateMapPreview() {
        ...
        TLRPC.GeoPoint geoPoint = this.geo;
        backupImageView2.setImage(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(geoPoint.lat, geoPoint._long, 0L, min * i, min * NotificationCenter.needCheckSystemBarColors, 15, min)), i + "_" + NotificationCenter.needCheckSystemBarColors, this.mapLoadingDrawable, 0, (Object) null);
    }
