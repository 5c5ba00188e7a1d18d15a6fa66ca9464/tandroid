        ...
        while (i6 < 7) {
            ...
            if (i10 >= i9) {
                ...
                if (!arrayListArr[i6].isEmpty() && !arrayListArr[i13].isEmpty()) {
                    ...
                    Period period2 = arrayListArr[i13].get(0);
                    int i14 = period.end;
