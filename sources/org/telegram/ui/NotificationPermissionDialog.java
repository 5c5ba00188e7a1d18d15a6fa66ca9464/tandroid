...
public class NotificationPermissionDialog extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void askLater() {
        long j = MessagesController.getGlobalMainSettings().getLong("askNotificationsDuration", 259200000L);
        MessagesController.getGlobalMainSettings().edit().putLong("askNotificationsAfter", System.currentTimeMillis() + j).putLong("askNotificationsDuration", j >= 604800000 ? 2592000000L : 604800000L).apply();
    }
}
