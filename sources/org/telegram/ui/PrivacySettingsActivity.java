...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$createView$6(AlertDialog.Builder builder, View view) {
        ...
        int i = num.intValue() == 0 ? 30 : num.intValue() == 1 ? 90 : num.intValue() == 2 ? NotificationCenter.didStartedMultiGiftsSelector : num.intValue() == 3 ? 365 : num.intValue() == 4 ? 548 : 0;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadPasswordSettings$21(TLRPC$account_Password tLRPC$account_Password) {
    ...
    */
    public void onFragmentDestroy() {
        ...
        if (z4 != this.currentSuggest) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_contacts_toggleTopPeers, new RequestDelegate() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (globalPrivacySettings != null) {
            ...
            if (z5 != z6) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_account_setGlobalPrivacySettings, new RequestDelegate() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda1
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
