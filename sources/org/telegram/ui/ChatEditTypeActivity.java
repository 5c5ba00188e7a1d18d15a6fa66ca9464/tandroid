...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private Runnable enableDoneLoading = new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda4
    ...
    public class UsernamesListView extends RecyclerListView {
        ...
        public class 1 implements RecyclerListView.OnItemClickListener {
            ...
            public /* synthetic */ void lambda$onItemClick$1(final TLRPC.TL_username tL_username, final boolean z) {
                new AlertDialog.Builder(UsernamesListView.this.getContext(), ((RecyclerListView) UsernamesListView.this).resourcesProvider).setTitle(LocaleController.getString(R.string.UsernameActivateErrorTitle)).setMessage(LocaleController.getString(R.string.UsernameActivateErrorMessage)).setPositiveButton(LocaleController.getString(R.string.OK), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        ChatEditTypeActivity.UsernamesListView.1.this.lambda$onItemClick$0(tL_username, z, dialogInterface, i);
                    }
                }).show();
            }
            ...
            public /* synthetic */ void lambda$onItemClick$2(TLRPC.TL_channels_toggleUsername tL_channels_toggleUsername, TLObject tLObject, final TLRPC.TL_username tL_username, final boolean z, TLRPC.TL_error tL_error) {
                ...
                if (tLObject instanceof TLRPC.TL_boolTrue) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatEditTypeActivity.UsernamesListView.1.this.lambda$onItemClick$1(tL_username, z);
                        }
                    });
                }
            ...
            public /* synthetic */ void lambda$onItemClick$3(final TLRPC.TL_channels_toggleUsername tL_channels_toggleUsername, final TLRPC.TL_username tL_username, final boolean z, final TLObject tLObject, final TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatEditTypeActivity.UsernamesListView.1.this.lambda$onItemClick$2(tL_channels_toggleUsername, tLObject, tL_username, z, tL_error);
                    }
                });
            }

            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onItemClick$4(final TLRPC.TL_username tL_username, View view, DialogInterface dialogInterface, int i) {
                if (tL_username.editable) {
                    ...
                    ChatEditTypeActivity.this.getConnectionsManager().sendRequest(tL_channels_toggleUsername, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda3
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            ChatEditTypeActivity.UsernamesListView.1.this.lambda$onItemClick$3(tL_channels_toggleUsername, tL_username, z2, tLObject, tL_error);
                        }
                    });
            ...
            public void onItemClick(final View view, int i) {
                ...
                if (!tL_username.editable) {
                    new AlertDialog.Builder(UsernamesListView.this.getContext(), ChatEditTypeActivity.this.getResourceProvider()).setTitle(LocaleController.getString(tL_username.active ? R.string.UsernameDeactivateLink : R.string.UsernameActivateLink)).setMessage(LocaleController.getString(tL_username.active ? R.string.UsernameDeactivateLinkChannelMessage : R.string.UsernameActivateLinkChannelMessage)).setPositiveButton(LocaleController.getString(tL_username.active ? R.string.Hide : R.string.Show), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda1
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                            ChatEditTypeActivity.UsernamesListView.1.this.lambda$onItemClick$4(tL_username, view, dialogInterface, i2);
                        }
                    }).setNegativeButton(LocaleController.getString(R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda2
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ void lambda$sendReorder$0(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public boolean checkUserName(final String str) {
        ...
        if (str == null || str.length() < 4) {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void generateLink(final boolean z) {
        ...
        getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tL_messages_exportChatInvite, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda10
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ChatEditTypeActivity.this.lambda$generateLink$27(z, tLObject, tL_error);
            }
        }), this.classGuid);
    }
    ...
    public /* synthetic */ void lambda$checkUserName$25(final String str) {
        ...
        this.checkReqId = getConnectionsManager().sendRequest(tL_channels_checkUsername, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda23
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadAdminedChannels$19(TLRPC.Chat chat, DialogInterface dialogInterface, int i) {
        TLRPC.TL_channels_updateUsername tL_channels_updateUsername = new TLRPC.TL_channels_updateUsername();
        tL_channels_updateUsername.channel = MessagesController.getInputChannel(chat);
        tL_channels_updateUsername.username = "";
        getConnectionsManager().sendRequest(tL_channels_updateUsername, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda1
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$20(View view) {
        ...
        if (this.isChannel) {
            ...
            formatString = LocaleController.formatString("RevokeLinkAlertChannel", i, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title);
        } else {
            int i2 = R.string.RevokeLinkAlert;
            formatString = LocaleController.formatString("RevokeLinkAlert", i2, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title);
        }
        builder.setMessage(AndroidUtilities.replaceTags(formatString));
        builder.setNegativeButton(LocaleController.getString(R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$21(TLObject tLObject) {
        ...
        for (int i2 = 0; i2 < tL_messages_chats.chats.size(); i2++) {
            AdminedChannelCell adminedChannelCell = new AdminedChannelCell(getParentActivity(), new View.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda27
    ...
    private void showPremiumIncreaseLimitDialog() {
        ...
        limitReachedBottomSheet.onSuccessRunnable = new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private boolean trySetUsername() {
        ...
        if (publicUsername.equals(obj)) {
            ...
            getMessagesController().updateChannelUserName(this, this.chatId, obj, new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda17
                @Override // java.lang.Runnable
                public final void run() {
                    ChatEditTypeActivity.this.lambda$trySetUsername$12();
                }
            }, new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda18
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void updateDoneProgress(boolean z) {
        ...
        if (this.doneButtonDrawable != null) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda14
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x010f, code lost:
        if (r9.isPrivate != false) goto L93;
     */
    ...
    */
    private void updatePrivatePublic() {
        ...
        UsernamesListView usernamesListView;
        ...
        if (!this.isPrivate && !this.canCreatePublic && getUserConfig().isPremium()) {
            ...
            if (this.loadingAdminedChannels) {
                ...
                joinToSendSettingsView = this.joinContainer;
                if (joinToSendSettingsView != null) {
                }
                usernamesListView = this.usernamesListView;
        ...
        if (!this.isPrivate) {
            ...
            if (this.checkTextView.getVisibility() != 0) {
                drawable = Theme.getThemedDrawableByKey(this.typeInfoCell.getContext(), i7, i8);
            }
            view.setBackgroundDrawable(drawable);
            boolean z22 = true;
            this.radioButtonCell1.setChecked(!this.isPrivate, true);
        ...
        textInfoPrivacyCell6.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell6.getContext(), R.drawable.greydivider, i8));
        ...
        if (joinToSendSettingsView != null) {
            ...
            joinToSendSettingsView2.showJoinToSend((chatFull2 == null || chatFull2.linked_chat_id == 0) ? false : false);
        }
        usernamesListView = this.usernamesListView;
        if (usernamesListView != null) {
            ...
            usernamesListView.setVisibility(i2);
        }
        checkDoneButton();
    }
    ...
    public View createView(final Context context) {
        ...
        r0.setBackgroundDrawable(Theme.getThemedDrawableByKey(context, R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    public ArrayList getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda9
    ...
    */
    public boolean onFragmentCreate() {
        ...
        TLRPC.Chat chat2 = this.currentChat;
        this.isSaveRestricted = chat2.noforwards;
        if ((this.isForcePublic && !ChatObject.isPublic(chat2)) || (this.isPrivate && this.currentChat.creator)) {
            ...
            getConnectionsManager().sendRequest(tL_channels_checkUsername, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda3
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ChatEditTypeActivity.this.lambda$onFragmentCreate$1(tLObject, tL_error);
                }
            });
        }
        ...
        if (this.currentChat != null) {
            ...
            for (int i = 0; i < this.currentChat.usernames.size(); i++) {
                if (this.currentChat.usernames.get(i).active) {
                    this.usernames.add(this.currentChat.usernames.get(i));
                }
            }
            for (int i2 = 0; i2 < this.currentChat.usernames.size(); i2++) {
                if (!this.currentChat.usernames.get(i2).active) {
                    this.usernames.add(this.currentChat.usernames.get(i2));
                }
            }
        }
