                    ...
                    if (f15 != f8) {
                        ...
                        if (((PieChartViewData) this.lines.get(i7)).selectionA > f8) {
                            ...
                            if (canvas3 != null) {
                                ...
                                ((PieChartViewData) this.lines.get(i5)).paint.setAlpha(NotificationCenter.playerDidStartPlaying);
                                f14 += f15 * 360.0f;
                                i7 = i5 + 1;
                                f = f5;
                                i6 = i4;
            ...
            if (canvas3 != null) {
                ...
                while (i9 < size) {
                    if (((PieChartViewData) this.lines.get(i9)).alpha > 0.0f || ((PieChartViewData) this.lines.get(i9)).enabled) {
                        ...
                        canvas.restore();
                        ((PieChartViewData) this.lines.get(i9)).paint.setAlpha(NotificationCenter.playerDidStartPlaying);
                        f13 += f4 * 360.0f;
                    } else {
                        canvas2 = canvas3;
                        i3 = i8;
