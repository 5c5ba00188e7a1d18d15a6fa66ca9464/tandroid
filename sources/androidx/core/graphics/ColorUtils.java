...
public abstract class ColorUtils {
    ...
    public static int HSLToColor(float[] fArr) {
        ...
        return Color.rgb(constrain(round, 0, NotificationCenter.newLocationAvailable), constrain(round2, 0, NotificationCenter.newLocationAvailable), constrain(round3, 0, NotificationCenter.newLocationAvailable));
    }
    ...
    public static int XYZToColor(double d, double d2, double d3) {
        ...
        return Color.rgb(constrain((int) Math.round((d4 > 0.0031308d ? (Math.pow(d4, 0.4166666666666667d) * 1.055d) - 0.055d : d4 * 12.92d) * 255.0d), 0, NotificationCenter.newLocationAvailable), constrain((int) Math.round((d5 > 0.0031308d ? (Math.pow(d5, 0.4166666666666667d) * 1.055d) - 0.055d : d5 * 12.92d) * 255.0d), 0, NotificationCenter.newLocationAvailable), constrain((int) Math.round((d6 > 0.0031308d ? (Math.pow(d6, 0.4166666666666667d) * 1.055d) - 0.055d : 12.92d * d6) * 255.0d), 0, NotificationCenter.newLocationAvailable));
    }
    ...
    private static int compositeAlpha(int i, int i2) {
        return 255 - (((255 - i2) * (255 - i)) / NotificationCenter.newLocationAvailable);
    }
    ...
    private static int compositeComponent(int i, int i2, int i3, int i4, int i5) {
        ...
        return (((i * NotificationCenter.newLocationAvailable) * i2) + ((i3 * i4) * (255 - i2))) / (i5 * NotificationCenter.newLocationAvailable);
    }
