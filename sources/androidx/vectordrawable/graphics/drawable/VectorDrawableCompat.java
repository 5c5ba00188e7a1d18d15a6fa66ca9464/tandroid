...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VPathRenderer {
        ...
        public VPathRenderer() {
            ...
            this.mRootAlpha = NotificationCenter.notificationsCountUpdated;
            this.mRootName = null;
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            if (vFullPath.mFillColor.willDraw()) {
                ...
                if (complexColorCompat.isGradient()) {
                    ...
                    paint2.setAlpha(NotificationCenter.notificationsCountUpdated);
            ...
            if (vFullPath.mStrokeColor.willDraw()) {
                ...
                if (complexColorCompat2.isGradient()) {
                    ...
                    paint4.setAlpha(NotificationCenter.notificationsCountUpdated);
