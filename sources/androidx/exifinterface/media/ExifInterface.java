...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.proxyChangedByRotation, 4), new ExifTag("SubfileType", NotificationCenter.liveLocationsChanged, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.liveLocationsCacheChanged, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.notificationsCountUpdated, 3), new ExifTag("Compression", NotificationCenter.playerDidStartPlaying, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.screenStateChanged, 3), new ExifTag("ImageDescription", NotificationCenter.onEmojiInteractionsReceived, 2), new ExifTag("Make", NotificationCenter.emojiPreviewThemesChanged, 2), new ExifTag("Model", NotificationCenter.reactionsDidLoad, 2), new ExifTag("StripOffsets", NotificationCenter.attachMenuBotsDidLoad, 3, 4), new ExifTag("Orientation", NotificationCenter.chatAvailableReactionsUpdated, 3), new ExifTag("SamplesPerPixel", NotificationCenter.onDownloadingFilesChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.onActivityResultReceived, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.onRequestPermissionResultReceived, 3, 4), new ExifTag("XResolution", NotificationCenter.premiumPromoUpdated, 5), new ExifTag("YResolution", NotificationCenter.premiumStatusChangedGlobal, 5), new ExifTag("PlanarConfiguration", NotificationCenter.currentUserShowLimitReachedDialog, 3), new ExifTag("ResolutionUnit", NotificationCenter.wallpaperSettedToUser, 3), new ExifTag("TransferFunction", NotificationCenter.uploadStoryProgress, 3), new ExifTag("Software", NotificationCenter.onReceivedChannelDifference, 2), new ExifTag("DateTime", NotificationCenter.storiesReadUpdated, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.proxyChangedByRotation, 4), new ExifTag("SubfileType", NotificationCenter.liveLocationsChanged, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.liveLocationsCacheChanged, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.notificationsCountUpdated, 3), new ExifTag("Compression", NotificationCenter.playerDidStartPlaying, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.screenStateChanged, 3), new ExifTag("ImageDescription", NotificationCenter.onEmojiInteractionsReceived, 2), new ExifTag("Make", NotificationCenter.emojiPreviewThemesChanged, 2), new ExifTag("Model", NotificationCenter.reactionsDidLoad, 2), new ExifTag("StripOffsets", NotificationCenter.attachMenuBotsDidLoad, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.chatAvailableReactionsUpdated, 3), new ExifTag("SamplesPerPixel", NotificationCenter.onDownloadingFilesChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.onActivityResultReceived, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.onRequestPermissionResultReceived, 3, 4), new ExifTag("XResolution", NotificationCenter.premiumPromoUpdated, 5), new ExifTag("YResolution", NotificationCenter.premiumStatusChangedGlobal, 5), new ExifTag("PlanarConfiguration", NotificationCenter.currentUserShowLimitReachedDialog, 3), new ExifTag("ResolutionUnit", NotificationCenter.wallpaperSettedToUser, 3), new ExifTag("TransferFunction", NotificationCenter.uploadStoryProgress, 3), new ExifTag("Software", NotificationCenter.onReceivedChannelDifference, 2), new ExifTag("DateTime", NotificationCenter.storiesReadUpdated, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.attachMenuBotsDidLoad, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.liveLocationsCacheChanged, 4), new ExifTag("PreviewImageLength", NotificationCenter.notificationsCountUpdated, 4)};
