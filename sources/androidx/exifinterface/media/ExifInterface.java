...
public class ExifInterface {
    ...
    static {
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.screenStateChanged, 4), new ExifTag("PreviewImageLength", NotificationCenter.didClearDatabase, 4)};
