...
class GradientStrokeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", ImageLoader.AUTOPLAY_FILTER, "o", "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str2.equals("o")) {
                            ...
                            if (str2.equals("d") || str2.equals(ImageLoader.AUTOPLAY_FILTER)) {
