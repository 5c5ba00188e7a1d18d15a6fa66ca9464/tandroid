...
public class ShapeStroke implements ContentModel {
    ...
    public enum LineCapType {
        ...
        public Paint.Cap toPaintCap() {
            int i = 1.$SwitchMap$com$airbnb$lottie$model$content$ShapeStroke$LineCapType[ordinal()];
            if (i != 1) {
                if (i == 2) {
    ...
    public enum LineJoinType {
        ...
        public Paint.Join toPaintJoin() {
            int i = 1.$SwitchMap$com$airbnb$lottie$model$content$ShapeStroke$LineJoinType[ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        return null;
