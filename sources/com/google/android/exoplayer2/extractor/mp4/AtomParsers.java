...
public abstract class AtomParsers {
    ...
    public static final class Stz2SampleSizeBox implements SampleSizeBox {
        ...
        public Stz2SampleSizeBox(Atom.LeafAtom leafAtom) {
            ...
            this.data = parsableByteArray;
            parsableByteArray.setPosition(12);
            this.fieldSize = parsableByteArray.readUnsignedIntToInt() & NotificationCenter.notificationsCountUpdated;
            this.sampleCount = parsableByteArray.readUnsignedIntToInt();
        }
        ...
        public int readNextSampleSize() {
            ...
            return (readUnsignedByte & NotificationCenter.needCheckSystemBarColors) >> 4;
        }
    }
        ...
        while (true) {
            ...
            if (parsableByteArray.readInt() == 1952804451) {
                ...
                if (parseFullAtomVersion == 0) {
                    ...
                    i4 = (readUnsignedByte & NotificationCenter.needCheckSystemBarColors) >> 4;
                }
    ...
    */
    ...
    private static TkhdData parseTkhd(ParsableByteArray parsableByteArray) {
        ...
        if (readInt2 == 0 && readInt3 == 65536 && readInt4 == -65536 && readInt5 == 0) {
            ...
            i2 = NotificationCenter.attachMenuBotsDidLoad;
