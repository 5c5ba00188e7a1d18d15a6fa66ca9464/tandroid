...
final class DvbParser {
    ...
    private static int[] generateDefault4BitClutEntries() {
        ...
        for (int i = 1; i < 16; i++) {
            if (i < 8) {
                iArr[i] = getColor(NotificationCenter.closeSearchByActiveAction, (i & 1) != 0 ? NotificationCenter.closeSearchByActiveAction : 0, (i & 2) != 0 ? NotificationCenter.closeSearchByActiveAction : 0, (i & 4) != 0 ? NotificationCenter.closeSearchByActiveAction : 0);
            } else {
                int i2 = i & 1;
                ...
                iArr[i] = getColor(NotificationCenter.closeSearchByActiveAction, i4, i5, i3);
            }
        }
        return iArr;
    }
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            int i3 = NotificationCenter.closeSearchByActiveAction;
            if (i2 < 8) {
                int i4 = (i2 & 1) != 0 ? NotificationCenter.closeSearchByActiveAction : 0;
                int i5 = (i2 & 2) != 0 ? NotificationCenter.closeSearchByActiveAction : 0;
                if ((i2 & 4) == 0) {
                    i3 = 0;
                }
                ...
                if (i6 == 0) {
                    ...
                    iArr[i2] = getColor(NotificationCenter.closeSearchByActiveAction, i8, i9, i + i7);
                } else if (i6 == 8) {
                    ...
                    iArr[i2] = getColor(NotificationCenter.closeSearchByActiveAction, ((i2 & 1) != 0 ? 43 : 0) + NotificationCenter.dialogTranslate + ((i2 & 16) != 0 ? 85 : 0), ((i2 & 2) != 0 ? 43 : 0) + NotificationCenter.dialogTranslate + ((i2 & 32) != 0 ? 85 : 0), ((i2 & 4) == 0 ? 0 : 43) + NotificationCenter.dialogTranslate + ((i2 & 64) == 0 ? 0 : 85));
                } else if (i6 == 136) {
                    iArr[i2] = getColor(NotificationCenter.closeSearchByActiveAction, ((i2 & 1) != 0 ? 43 : 0) + ((i2 & 16) != 0 ? 85 : 0), ((i2 & 2) != 0 ? 43 : 0) + ((i2 & 32) != 0 ? 85 : 0), ((i2 & 4) == 0 ? 0 : 43) + ((i2 & 64) == 0 ? 0 : 85));
                }
            }
        }
        return iArr;
