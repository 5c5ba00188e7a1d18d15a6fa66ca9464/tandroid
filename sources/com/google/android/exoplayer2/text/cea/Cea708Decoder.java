...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private static final class CueInfoBuilder {
        ...
        public static int getArgbColorFromCeaColor(int i, int i2, int i3, int i4) {
            ...
            return Color.argb(i4 != 2 ? i4 != 3 ? NotificationCenter.notificationsCountUpdated : 0 : NotificationCenter.dialogTranslate, i > 1 ? NotificationCenter.notificationsCountUpdated : 0, i2 > 1 ? NotificationCenter.notificationsCountUpdated : 0, i3 > 1 ? NotificationCenter.notificationsCountUpdated : 0);
        }
    ...
    private void handleG0Character(int i) {
        if (i == 127) {
            ...
            this.currentCueInfoBuilder.append((char) (i & NotificationCenter.notificationsCountUpdated));
        }
    }
