...
public abstract class AbstractConcatenatedTimeline extends Timeline {
    ...
    public int getNextWindowIndex(int i, int i2, boolean z) {
        ...
        do {
            childIndexByWindowIndex = getNextChildIndex(childIndexByWindowIndex, z);
            if (childIndexByWindowIndex == -1) {
                break;
            }
        } while (getTimelineByChildIndex(childIndexByWindowIndex).isEmpty());
        if (childIndexByWindowIndex != -1) {
            return getFirstWindowIndexByChildIndex(childIndexByWindowIndex) + getTimelineByChildIndex(childIndexByWindowIndex).getFirstWindowIndex(z);
        }
        if (i2 == 2) {
    ...
    public int getPreviousWindowIndex(int i, int i2, boolean z) {
        ...
        do {
            childIndexByWindowIndex = getPreviousChildIndex(childIndexByWindowIndex, z);
            if (childIndexByWindowIndex == -1) {
                break;
            }
        } while (getTimelineByChildIndex(childIndexByWindowIndex).isEmpty());
        if (childIndexByWindowIndex != -1) {
            return getFirstWindowIndexByChildIndex(childIndexByWindowIndex) + getTimelineByChildIndex(childIndexByWindowIndex).getLastWindowIndex(z);
        }
        if (i2 == 2) {
