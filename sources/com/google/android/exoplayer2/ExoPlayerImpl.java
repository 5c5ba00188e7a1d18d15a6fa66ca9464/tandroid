...
public final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public void release() {
        ...
        if (!this.internalPlayer.release()) {
            this.listeners.sendEvent(10, ExoPlayerImpl$$ExternalSyntheticLambda20.INSTANCE);
        }
    ...
    private void updatePlaybackInfo(final PlaybackInfo playbackInfo, final int i, final int i2, boolean z, boolean z2, final int i3, long j, int i4, boolean z3) {
        ...
        if (z) {
            this.listeners.queueEvent(-1, ExoPlayerImpl$$ExternalSyntheticLambda21.INSTANCE);
        }
        updateAvailableCommands();
        this.listeners.flushEvents();
