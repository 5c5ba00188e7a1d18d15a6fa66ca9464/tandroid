...
public final class HlsMediaPeriod implements MediaPeriod, HlsPlaylistTracker.PlaylistEventListener {
    ...
    */
    private void buildAndPrepareMainSampleStreamWrapper(HlsMultivariantPlaylist hlsMultivariantPlaylist, long j, List list, List list2, Map map) {
        ...
        HlsSampleStreamWrapper buildSampleStreamWrapper2 = buildSampleStreamWrapper("main", (!z || codecCountOfType22 <= 0) ? 0 : 1, uriArr2, formatArr4, hlsMultivariantPlaylist.muxedAudioFormat, hlsMultivariantPlaylist.muxedCaptionFormats, map, j);
    ...
    private void buildAndPrepareSampleStreamWrappers(long j) {
        ...
        Map deriveOverridingDrmInitData = this.useSessionKeys ? deriveOverridingDrmInitData(hlsMultivariantPlaylist.sessionKeyDrmInitData) : Collections.emptyMap();
