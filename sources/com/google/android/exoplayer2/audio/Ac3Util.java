...
public abstract class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, NotificationCenter.audioRouteChanged, NotificationCenter.dialogPhotosUpdate, NotificationCenter.pushMessagesUpdated, 256, 320, 384, 448, 512, 576, 640};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, NotificationCenter.fileLoadFailed, NotificationCenter.newEmojiSuggestionsAvailable, NotificationCenter.availableEffectsUpdate, NotificationCenter.locationPermissionDenied, NotificationCenter.premiumStatusChangedGlobal, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
