...
interface zzib {
    ...
    void zza(int i, zzdn zzdnVar);

    void zza(int i, zzfq zzfqVar, Map map);

    void zza(int i, Object obj);

    void zza(int i, Object obj, zzgp zzgpVar);

    void zza(int i, String str);

    void zza(int i, List list);

    void zza(int i, List list, zzgp zzgpVar);
    ...
    void zzb(int i, Object obj, zzgp zzgpVar);

    void zzb(int i, List list);

    void zzb(int i, List list, zzgp zzgpVar);
