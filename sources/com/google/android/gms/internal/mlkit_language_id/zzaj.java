...
public enum zzaj implements zzet {
    ...
    zzab(NotificationCenter.needSetDayNightTheme),
    zzac(NotificationCenter.goingToPreviewTheme),
    zzad(NotificationCenter.locationPermissionGranted),
    zzae(NotificationCenter.locationPermissionDenied),
    zzaf(NotificationCenter.reloadInterface),
    ...
    zzcr(100),
    zzcs(101),
    zzct(NotificationCenter.liveLocationsChanged),
    zzcu(NotificationCenter.newLocationAvailable),
    zzcv(NotificationCenter.voipServiceCreated),
    ...
    zzdh(NotificationCenter.dialogsUnreadReactionsCounterChanged),
    zzdi(NotificationCenter.onDatabaseOpened),
    zzdj(NotificationCenter.billingProductDetailsUpdated),
    zzdk(NotificationCenter.onDatabaseReset),
    zzdl(NotificationCenter.wallpaperSettedToUser),
    zzdm(NotificationCenter.storiesUpdated),
    zzdn(NotificationCenter.onReceivedChannelDifference),
    zzdo(NotificationCenter.storiesReadUpdated),
    zzdp(361),
    zzdq(371);
