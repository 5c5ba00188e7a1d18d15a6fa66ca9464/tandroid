...
public enum zzaj implements zzet {
    ...
    zzab(NotificationCenter.reloadInterface),
    zzac(NotificationCenter.suggestedLangpack),
    zzad(NotificationCenter.didSetNewWallpapper),
    zzae(NotificationCenter.proxySettingsChanged),
    zzaf(NotificationCenter.proxyCheckDone),
    ...
    zzcr(100),
    zzcs(101),
    zzct(NotificationCenter.playerDidStartPlaying),
    zzcu(NotificationCenter.closeSearchByActiveAction),
    zzcv(NotificationCenter.appUpdateAvailable),
    ...
    zzdh(NotificationCenter.onRequestPermissionResultReceived),
    zzdi(NotificationCenter.onUserRingtonesUpdated),
    zzdj(NotificationCenter.requestPermissions),
    zzdk(NotificationCenter.storiesDraftsUpdated),
    zzdl(NotificationCenter.chatlistFolderUpdate),
    zzdm(NotificationCenter.uploadStoryProgress),
    zzdn(301),
    zzdo(302),
    zzdp(361),
    zzdq(371);
