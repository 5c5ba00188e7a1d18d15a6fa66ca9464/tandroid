...
public enum zzaj implements zzet {
    ...
    zzab(NotificationCenter.didApplyNewTheme),
    zzac(NotificationCenter.themeAccentListUpdated),
    zzad(NotificationCenter.needCheckSystemBarColors),
    zzae(NotificationCenter.needShareTheme),
    zzaf(NotificationCenter.needSetDayNightTheme),
    ...
    zzcr(100),
    zzcs(101),
    zzct(NotificationCenter.didSetNewWallpapper),
    zzcu(NotificationCenter.proxySettingsChanged),
    zzcv(NotificationCenter.closeSearchByActiveAction),
    ...
    zzdh(NotificationCenter.emojiPreviewThemesChanged),
    zzdi(NotificationCenter.reactionsDidLoad),
    zzdj(NotificationCenter.currentUserPremiumStatusChanged),
    zzdk(NotificationCenter.activityPermissionsGranted),
    zzdl(NotificationCenter.topicsDidLoaded),
    zzdm(NotificationCenter.chatSwithcedToForum),
    zzdn(NotificationCenter.uploadStoryProgress),
    zzdo(NotificationCenter.uploadStoryEnd),
    zzdp(361),
    zzdq(371);
