...
public enum zzaj implements zzet {
    ...
    zzab(NotificationCenter.needShareTheme),
    zzac(NotificationCenter.needSetDayNightTheme),
    zzad(NotificationCenter.goingToPreviewTheme),
    zzae(NotificationCenter.locationPermissionGranted),
    zzaf(NotificationCenter.locationPermissionDenied),
    ...
    zzcr(100),
    zzcs(101),
    zzct(NotificationCenter.proxyChangedByRotation),
    zzcu(NotificationCenter.liveLocationsChanged),
    zzcv(NotificationCenter.didClearDatabase),
    ...
    zzdh(NotificationCenter.chatAvailableReactionsUpdated),
    zzdi(NotificationCenter.dialogsUnreadReactionsCounterChanged),
    zzdj(NotificationCenter.currentUserShowLimitReachedDialog),
    zzdk(NotificationCenter.didUpdateGlobalAutoDeleteTimer),
    zzdl(NotificationCenter.onDatabaseReset),
    zzdm(NotificationCenter.wallpaperSettedToUser),
    zzdn(NotificationCenter.stealthModeChanged),
    zzdo(NotificationCenter.onReceivedChannelDifference),
    zzdp(361),
    zzdq(371);
