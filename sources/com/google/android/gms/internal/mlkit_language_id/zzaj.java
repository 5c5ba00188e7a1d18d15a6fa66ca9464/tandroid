...
public enum zzaj implements zzet {
    ...
    zzab(NotificationCenter.locationPermissionGranted),
    zzac(NotificationCenter.locationPermissionDenied),
    zzad(NotificationCenter.reloadInterface),
    zzae(NotificationCenter.suggestedLangpack),
    zzaf(NotificationCenter.didSetNewWallpapper),
    ...
    zzcr(100),
    zzcs(101),
    zzct(NotificationCenter.liveLocationsCacheChanged),
    zzcu(NotificationCenter.notificationsCountUpdated),
    zzcv(NotificationCenter.webRtcSpeakerAmplitudeEvent),
    ...
    zzdh(NotificationCenter.onDownloadingFilesChanged),
    zzdi(NotificationCenter.onActivityResultReceived),
    zzdj(NotificationCenter.premiumStickersPreviewLoaded),
    zzdk(NotificationCenter.storiesUpdated),
    zzdl(NotificationCenter.storiesListUpdated),
    zzdm(NotificationCenter.storiesDraftsUpdated),
    zzdn(NotificationCenter.nearEarEvent),
    zzdo(302),
    zzdp(361),
    zzdq(371);
