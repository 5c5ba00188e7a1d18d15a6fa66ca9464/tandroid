...
public enum zzaj implements zzet {
    ...
    zzab(NotificationCenter.themeAccentListUpdated),
    zzac(NotificationCenter.needCheckSystemBarColors),
    zzad(NotificationCenter.needShareTheme),
    zzae(NotificationCenter.needSetDayNightTheme),
    zzaf(NotificationCenter.goingToPreviewTheme),
    ...
    zzcr(100),
    zzcs(101),
    zzct(NotificationCenter.proxySettingsChanged),
    zzcu(NotificationCenter.proxyCheckDone),
    zzcv(NotificationCenter.messagePlayingSpeedChanged),
    ...
    zzdh(NotificationCenter.reactionsDidLoad),
    zzdi(NotificationCenter.attachMenuBotsDidLoad),
    zzdj(NotificationCenter.premiumPromoUpdated),
    zzdk(NotificationCenter.topicsDidLoaded),
    zzdl(NotificationCenter.chatSwithcedToForum),
    zzdm(NotificationCenter.didUpdateGlobalAutoDeleteTimer),
    zzdn(NotificationCenter.uploadStoryEnd),
    zzdo(NotificationCenter.customTypefacesLoaded),
    zzdp(361),
    zzdq(371);
