    ...
    public static boolean isPackageGoogleSigned(Context context, String str) {
        try {
            ...
            if (signatureArr != null && signatureArr.length == 1) {
                ...
                Log.d("SAVerificationClientU", String.format("Package %s GSA signed status %s AssistantGo signed status %s", str, Boolean.valueOf(equals), Boolean.valueOf(equals2)));
