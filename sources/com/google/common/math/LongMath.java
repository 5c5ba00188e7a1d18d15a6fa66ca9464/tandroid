...
public abstract class LongMath {
    ...
    static final int[] biggestBinomials = {ConnectionsManager.DEFAULT_DATACENTER_ID, ConnectionsManager.DEFAULT_DATACENTER_ID, ConnectionsManager.DEFAULT_DATACENTER_ID, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, NotificationCenter.onEmojiInteractionsReceived, NotificationCenter.customStickerCreated, NotificationCenter.closeInCallActivity, NotificationCenter.dialogsUnreadCounterChanged, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {ConnectionsManager.DEFAULT_DATACENTER_ID, ConnectionsManager.DEFAULT_DATACENTER_ID, ConnectionsManager.DEFAULT_DATACENTER_ID, 2642246, 86251, 11724, 3218, 1313, 684, 419, NotificationCenter.topicsDidLoaded, NotificationCenter.starSubscriptionsLoaded, NotificationCenter.closeInCallActivity, NotificationCenter.fileLoadFailed, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
